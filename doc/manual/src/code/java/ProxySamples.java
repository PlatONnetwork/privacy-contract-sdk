...
public class ProxySamples extends ProxyClient {
    private String irHash = "e5817e81f92ec1dec1530824acbc83c7";
    ...
    private static HashMap<Method, MethodInfo> mapMethodInfo = new HashMap<Method, MethodInfo>() {{
        ...
        put(Method.int_TestEor_int_int, new MethodInfo("TestEor", "TestEor(int,int)", "bb4f43445b224c9e2582a748d2539e8d", "", "int_TestEor_int_int"));
