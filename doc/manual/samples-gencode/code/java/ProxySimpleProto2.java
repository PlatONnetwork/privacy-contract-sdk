...
public class ProxySimpleProto2 extends ProxyClient {
    private String irHash = "31de6414162f6b4d65446f2b5c57d92c";
    ...
    /**
     * Get com.abc.simpleproto2.SimpleProto2.Bar
     */
    public com.abc.simpleproto2.SimpleProto2.Bar getBar(byte[] val) {
        com.abc.simpleproto2.SimpleProto2.Bar __Bar = null;
        try {
            __Bar = com.abc.simpleproto2.SimpleProto2.Bar.parseFrom(ethECIES.Decrypt(priHexString, val));
    ...
    public com.abc.simpleproto2.SimpleProto2.Bar getBar(String cipher) {
