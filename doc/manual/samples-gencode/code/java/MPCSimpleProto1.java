 ...
 * IR HASH: cf0cb39d74a20aea6ba05d5a9c786824
 * <p>
...
interface mpc_ii_cf0cb39d74a20aea6ba05d5a9c786824 extends IIInterface {
}

public class MPCSimpleProto1 implements mpc_ii_cf0cb39d74a20aea6ba05d5a9c786824 {
    ...
    abstract class MpcCallbackBase_cf0cb39d74a20aea6ba05d5a9c786824 implements MpcCallbackInterface {
    ...
    abstract class mpc_i_cf0cb39d74a20aea6ba05d5a9c786824 extends MpcCallbackBase_cf0cb39d74a20aea6ba05d5a9c786824 {
    }
    
    abstract class mpc_f_5ab2b5492eebb9fffe14c94278372bff_01 extends mpc_i_cf0cb39d74a20aea6ba05d5a9c786824 {
        public byte[] input_x_default(){
            return com.abc.simpleproto1.SimpleProto1.Point.newBuilder().build().toByteArray();
        }
    }

    abstract class mpc_f_5ab2b5492eebb9fffe14c94278372bff_02 extends mpc_i_cf0cb39d74a20aea6ba05d5a9c786824 {
        public byte[] input_x_default(){
            return com.abc.simpleproto1.SimpleProto1.Point.newBuilder().build().toByteArray();
        }
    }
    ...
    final class MPCSimpleProto1_EuclideanDistance_Point_Point_01 extends mpc_f_5ab2b5492eebb9fffe14c94278372bff_01 {
        public byte[] inputImpl(final InputRequestPara para) {
            com.abc.simpleproto1.SimpleProto1.Point.Builder builder = com.abc.simpleproto1.SimpleProto1.Point.newBuilder();
            // TODO: assemble data
