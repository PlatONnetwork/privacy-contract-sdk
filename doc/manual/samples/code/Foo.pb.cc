...
namespace google {
namespace protobuf {
template<> GOOGLE_PROTOBUF_ATTRIBUTE_NOINLINE ::multiproto::Foo* Arena::CreateMaybeMessage< ::multiproto::Foo >(Arena* arena) {
  return Arena::CreateInternal< ::multiproto::Foo >(arena);
}
}  // namespace protobuf
}  // namespace google
