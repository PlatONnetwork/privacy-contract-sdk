...
namespace google {
namespace protobuf {
template<> ::multiproto::Bar* Arena::CreateMaybeMessage<::multiproto::Bar>(Arena*);
}  // namespace protobuf
}  // namespace google
namespace multiproto {
...
class Bar : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:multiproto.Bar) */ {
 public:
  Bar();
  virtual ~Bar();
