...
#ifndef PROTOBUF_INCLUDED_SimpleProto2_2eproto
#define PROTOBUF_INCLUDED_SimpleProto2_2eproto
...
#define PROTOBUF_INTERNAL_EXPORT_protobuf_SimpleProto2_2eproto 
...
namespace google {
namespace protobuf {
template<> ::simpleproto2::Bar* Arena::CreateMaybeMessage<::simpleproto2::Bar>(Arena*);
template<> ::simpleproto2::Foo* Arena::CreateMaybeMessage<::simpleproto2::Foo>(Arena*);
}  // namespace protobuf
}  // namespace google
namespace simpleproto2 {
...
class Foo : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:simpleproto2.Foo) */ {
 public:
  Foo();
  virtual ~Foo();
 ...
 private:
  ...
  friend struct ::protobuf_SimpleProto2_2eproto::TableStruct;
};
// -------------------------------------------------------------------

class Bar : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:simpleproto2.Bar) */ {
 public:
  Bar();
  virtual ~Bar();
  ...
  private:
  const ::simpleproto2::Foo& _internal_foo() const;
  public:
...
inline const ::simpleproto2::Foo& Bar::_internal_foo() const {
  return *foo_;
}
...
inline ::simpleproto2::Foo* Bar::mutable_foo() {
  ...
  if (foo_ == NULL) {
    auto* p = CreateMaybeMessage<::simpleproto2::Foo>(GetArenaNoVirtual());
    foo_ = p;
  }
...
#endif  // PROTOBUF_INCLUDED_SimpleProto2_2eproto
