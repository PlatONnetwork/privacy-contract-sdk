...
#define PROTOBUF_INTERNAL_EXPORT_protobuf_TestProto_2eproto 
...
template<> ::testproto::Point* Arena::CreateMaybeMessage<::testproto::Point>(Arena*);
template<> ::testproto::Points* Arena::CreateMaybeMessage<::testproto::Points>(Arena*);
}  // namespace protobuf
}  // namespace google
namespace testproto {
...
inline const ::testproto::Foo& Bar::_internal_foo() const {
  return *foo_;
}
