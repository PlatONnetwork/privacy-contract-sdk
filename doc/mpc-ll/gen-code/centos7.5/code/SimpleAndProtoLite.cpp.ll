...
@.str.3.7 = private unnamed_addr constant [45 x i8] c"f == __null || dynamic_cast<To>(f) != __null\00", align 1
...
; Function Attrs: noinline optnone uwtable
define void @_ZNK14simpleandproto3Foo11GetTypeNameEv(%"class.google::protobuf::internal::InternalMetadataWithArena"* noalias sret, %"class.simpleandproto::Foo.3"*) unnamed_addr #4 align 2 personality i8* bitcast (i32 (...)* @__gxx_personality_v0 to i8*) {
  ...
  invoke void @_ZNSsC1EPKcRKSaIcE(%"class.google::protobuf::internal::InternalMetadataWithArena"* %0, i8* getelementptr inbounds ([19 x i8], [19 x i8]* @.str.2.10, i32 0, i32 0), %"class.std::ios_base::Init"* dereferenceable(1) %4)
