...
interface mpc_ii_831a76ceef82c5394bf0ef5a76a1ab0b extends IIInterface {
}

public class MPCSimpleAndProto implements mpc_ii_831a76ceef82c5394bf0ef5a76a1ab0b {
    ...
    abstract class MpcCallbackBase_831a76ceef82c5394bf0ef5a76a1ab0b implements MpcCallbackInterface {
    ...
    abstract class mpc_i_831a76ceef82c5394bf0ef5a76a1ab0b extends MpcCallbackBase_831a76ceef82c5394bf0ef5a76a1ab0b {
    }
    
    abstract class mpc_f_d26161114e7457c9be1414e51637c641_01 extends mpc_i_831a76ceef82c5394bf0ef5a76a1ab0b {
        public byte[] input_x_default(){
            return Data.Int32(0);
        }
    }

    abstract class mpc_f_d26161114e7457c9be1414e51637c641_02 extends mpc_i_831a76ceef82c5394bf0ef5a76a1ab0b {
        public byte[] input_x_default(){
            return Data.Int32(0);
        }
    }

    abstract class mpc_f_91e30d5109c47916f14cdd5ba7aa1e13_01 extends mpc_i_831a76ceef82c5394bf0ef5a76a1ab0b {
        public byte[] input_x_default(){
            return com.abc.simpleandproto.SimpleAndProtoLite.Foo.newBuilder().build().toByteArray();
        }
    }

    abstract class mpc_f_91e30d5109c47916f14cdd5ba7aa1e13_02 extends mpc_i_831a76ceef82c5394bf0ef5a76a1ab0b {
        public byte[] input_x_default(){
            return com.abc.simpleandproto.SimpleAndProtoLite.Foo.newBuilder().build().toByteArray();
        }
    }
