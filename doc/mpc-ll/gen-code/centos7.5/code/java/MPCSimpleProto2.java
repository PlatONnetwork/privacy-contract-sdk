...
interface mpc_ii_88a4d701d55d8e64963df8c46b24b561 extends IIInterface {
}

public class MPCSimpleProto2 implements mpc_ii_88a4d701d55d8e64963df8c46b24b561 {
    ...
    abstract class MpcCallbackBase_88a4d701d55d8e64963df8c46b24b561 implements MpcCallbackInterface {
    ...
    abstract class mpc_i_88a4d701d55d8e64963df8c46b24b561 extends MpcCallbackBase_88a4d701d55d8e64963df8c46b24b561 {
    }
    
    abstract class mpc_f_913b11f78f06e4a1d58688a4190afade_01 extends mpc_i_88a4d701d55d8e64963df8c46b24b561 {
        public byte[] input_x_default(){
            return com.abc.simpleproto2.SimpleProtoLite2.Bar.newBuilder().build().toByteArray();
        }
    }

    abstract class mpc_f_913b11f78f06e4a1d58688a4190afade_02 extends mpc_i_88a4d701d55d8e64963df8c46b24b561 {
        public byte[] input_x_default(){
            return com.abc.simpleproto2.SimpleProtoLite2.Bar.newBuilder().build().toByteArray();
        }
    }
