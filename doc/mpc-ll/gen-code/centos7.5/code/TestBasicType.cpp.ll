...
$_ZStplIcSt11char_traitsIcESaIcEESbIT_T0_T1_ERKS6_S8_ = comdat any
...
@__FUNCTION__._Z10TestStringRKSsS0_ = private unnamed_addr constant [11 x i8] c"TestString\00", align 1
...
; Function Attrs: noinline optnone uwtable
define void @_Z10TestStringRKSsS0_(%"class.std::basic_string"* noalias sret, %"class.std::basic_string"* dereferenceable(8), %"class.std::basic_string"* dereferenceable(8)) #0 personality i8* bitcast (i32 (...)* @__gxx_personality_v0 to i8*) {
  %4 = alloca %"class.std::basic_string"*, align 8
  %5 = alloca %"class.std::basic_string"*, align 8
  %6 = alloca i1, align 1
  %7 = alloca i8*
  %8 = alloca i32
  store %"class.std::basic_string"* %1, %"class.std::basic_string"** %4, align 8
  ...
  %10 = call i8* @_ZNKSs5c_strEv(%"class.std::basic_string"* %9) #3
  %11 = load %"class.std::basic_string"*, %"class.std::basic_string"** %5, align 8
  %12 = call i8* @_ZNKSs5c_strEv(%"class.std::basic_string"* %11) #3
  %13 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([28 x i8], [28 x i8]* @.str.15, i32 0, i32 0), i8* getelementptr inbounds ([11 x i8], [11 x i8]* @__FUNCTION__._Z10TestStringRKSsS0_, i32 0, i32 0), i8* %10, i8* %12)
  store i1 false, i1* %6, align 1
  %14 = load %"class.std::basic_string"*, %"class.std::basic_string"** %4, align 8
  %15 = load %"class.std::basic_string"*, %"class.std::basic_string"** %5, align 8
  call void @_ZStplIcSt11char_traitsIcESaIcEESbIT_T0_T1_ERKS6_S8_(%"class.std::basic_string"* sret %0, %"class.std::basic_string"* dereferenceable(8) %14, %"class.std::basic_string"* dereferenceable(8) %15)
  %16 = call i8* @_ZNKSs5c_strEv(%"class.std::basic_string"* %0) #3
  %17 = invoke i32 (i8*, ...) @printf(i8* getelementptr inbounds ([29 x i8], [29 x i8]* @.str.16, i32 0, i32 0), i8* getelementptr inbounds ([11 x i8], [11 x i8]* @__FUNCTION__._Z10TestStringRKSsS0_, i32 0, i32 0), i8* %16)
...
; <label>:20:                                     ; preds = %3
  ...
  call void @_ZNSsD1Ev(%"class.std::basic_string"* %0) #3
  br label %26
...
; Function Attrs: noinline optnone uwtable
define linkonce_odr void @_ZStplIcSt11char_traitsIcESaIcEESbIT_T0_T1_ERKS6_S8_(%"class.std::basic_string"* noalias sret, %"class.std::basic_string"* dereferenceable(8), %"class.std::basic_string"* dereferenceable(8)) #0 comdat personality i8* bitcast (i32 (...)* @__gxx_personality_v0 to i8*) {
  %4 = alloca %"class.std::basic_string"*, align 8
  %5 = alloca %"class.std::basic_string"*, align 8
  %6 = alloca i1, align 1
  %7 = alloca i8*
  ...
  store i1 false, i1* %6, align 1
  %9 = load %"class.std::basic_string"*, %"class.std::basic_string"** %4, align 8
  call void @_ZNSsC1ERKSs(%"class.std::basic_string"* %0, %"class.std::basic_string"* dereferenceable(8) %9)
  %10 = load %"class.std::basic_string"*, %"class.std::basic_string"** %5, align 8
  %11 = invoke dereferenceable(8) %"class.std::basic_string"* @_ZNSs6appendERKSs(%"class.std::basic_string"* %0, %"class.std::basic_string"* dereferenceable(8) %10)
...
declare dereferenceable(8) %"class.std::basic_string"* @_ZNSs6appendERKSs(%"class.std::basic_string"*, %"class.std::basic_string"* dereferenceable(8)) #1
