...
interface mpc_ii_42a12f59d721e7e45b10f537052667e8 extends IIInterface {
}

public class MPCSimpleProto1 implements mpc_ii_42a12f59d721e7e45b10f537052667e8 {
    ...
    abstract class MpcCallbackBase_42a12f59d721e7e45b10f537052667e8 implements MpcCallbackInterface {
    ...
    abstract class mpc_i_42a12f59d721e7e45b10f537052667e8 extends MpcCallbackBase_42a12f59d721e7e45b10f537052667e8 {
    }
    
    abstract class mpc_f_5ab2b5492eebb9fffe14c94278372bff_01 extends mpc_i_42a12f59d721e7e45b10f537052667e8 {
        public byte[] input_x_default(){
            return com.abc.simpleproto1.SimpleProtoLite1.Point.newBuilder().build().toByteArray();
        }
    }

    abstract class mpc_f_5ab2b5492eebb9fffe14c94278372bff_02 extends mpc_i_42a12f59d721e7e45b10f537052667e8 {
        public byte[] input_x_default(){
            return com.abc.simpleproto1.SimpleProtoLite1.Point.newBuilder().build().toByteArray();
        }
    }
