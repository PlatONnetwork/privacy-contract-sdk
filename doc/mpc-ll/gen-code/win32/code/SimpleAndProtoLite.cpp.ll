...
%"class.simpleandproto::Foo.2" = type { %"class.google::protobuf::MessageLite", %"class.google::protobuf::internal::InternalMetadataWithArena", i32, float, i32 }
...
$"\01??$down_cast@PBVFoo@simpleandproto@@$$CBVMessageLite@protobuf@google@@@internal@protobuf@google@@YAPBVFoo@simpleandproto@@PBVMessageLite@12@@Z" = comdat any
...
$"\01??$OwnInternal@VFoo@simpleandproto@@@Arena@protobuf@google@@AAEXPAVFoo@simpleandproto@@U?$integral_constant@_N$0A@@internal@12@@Z" = comdat any

$"\01??$arena_delete_object@VFoo@simpleandproto@@@internal@protobuf@google@@YAXPAX@Z" = comdat any
...
$"\01??_C@_0FA@KPMJBJBF@E?3?2work?2local?2private?9contract?9s@" = comdat any
...
$"\01??_C@_0BD@DBGCKBJ@simpleandproto?4Foo?$AA@" = comdat any
...
@"\01??_C@_0FA@KPMJBJBF@E?3?2work?2local?2private?9contract?9s@" = linkonce_odr unnamed_addr constant [80 x i8] c"E:\5Cwork\5Clocal\5Cprivate-contract-sdk\5Cdoc\5Cmpc-ll\5Csrc\5Ccode\5CSimpleAndProtoLite.pb.cc\00", comdat, align 1
@"\01?once@?1??InitDefaultsFoo@protobuf_SimpleAndProtoLite_2eproto@@YAXXZ@4HA" = internal global i32 0, align 4
...
@2 = private unnamed_addr constant { [18 x i8*] } { [18 x i8*] [i8* bitcast (%rtti.CompleteObjectLocator* @"\01??_R4Foo@simpleandproto@@6B@" to i8*), i8* bitcast (i8* (%"class.simpleandproto::Foo.2"*, i32)* @"\01??_GFoo@simpleandproto@@UAEPAXI@Z" to i8*), i8* bitcast (void (%"class.simpleandproto::Foo.2"*, %"class.std::basic_string"*)* @"\01?GetTypeName@Foo@simpleandproto@@UBE?AV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@XZ" to i8*), i8* bitcast (%"class.simpleandproto::Foo.2"* (%"class.simpleandproto::Foo.2"*, %"class.google::protobuf::Arena"*)* @"\01?New@Foo@simpleandproto@@UBEPAV12@PAVArena@protobuf@google@@@Z" to i8*), i8* bitcast (%"class.simpleandproto::Foo.2"* (%"class.simpleandproto::Foo.2"*)* @"\01?New@Foo@simpleandproto@@UBEPAV12@XZ" to i8*), i8* bitcast (%"class.google::protobuf::Arena"* (%"class.google::protobuf::MessageLite"*)* @"\01?GetArena@MessageLite@protobuf@google@@UBEPAVArena@23@XZ" to i8*), i8* bitcast (i8* (%"class.google::protobuf::MessageLite"*)* @"\01?GetMaybeArenaPointer@MessageLite@protobuf@google@@UBEPAXXZ" to i8*), i8* bitcast (void (%"class.simpleandproto::Foo.2"*)* @"\01?Clear@Foo@simpleandproto@@UAEXXZ" to i8*), i8* bitcast (i1 (%"class.simpleandproto::Foo.2"*)* @"\01?IsInitialized@Foo@simpleandproto@@UBE_NXZ" to i8*), i8* bitcast (void (%"class.google::protobuf::MessageLite"*, %"class.std::basic_string"*)* @"\01?InitializationErrorString@MessageLite@protobuf@google@@UBE?AV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@XZ" to i8*), i8* bitcast (void (%"class.simpleandproto::Foo.2"*, %"class.google::protobuf::MessageLite"*)* @"\01?CheckTypeAndMergeFrom@Foo@simpleandproto@@UAEXABVMessageLite@protobuf@google@@@Z" to i8*), i8* bitcast (i1 (%"class.simpleandproto::Foo.2"*, %"class.google::protobuf::io::CodedInputStream"*)* @"\01?MergePartialFromCodedStream@Foo@simpleandproto@@UAE_NPAVCodedInputStream@io@protobuf@google@@@Z" to i8*), i8* bitcast (i32 (%"class.simpleandproto::Foo.2"*)* @"\01?ByteSizeLong@Foo@simpleandproto@@UBEIXZ" to i8*), i8* bitcast (void (%"class.simpleandproto::Foo.2"*, %"class.google::protobuf::io::CodedOutputStream"*)* @"\01?SerializeWithCachedSizes@Foo@simpleandproto@@UBEXPAVCodedOutputStream@io@protobuf@google@@@Z" to i8*), i8* bitcast (i8* (%"class.google::protobuf::MessageLite"*, i8*)* @"\01?SerializeWithCachedSizesToArray@MessageLite@protobuf@google@@UBEPAEPAE@Z" to i8*), i8* bitcast (i32 (%"class.simpleandproto::Foo.2"*)* @"\01?GetCachedSize@Foo@simpleandproto@@UBEHXZ" to i8*), i8* bitcast (i8* (%"class.google::protobuf::MessageLite"*, i1, i8*)* @"\01?InternalSerializeWithCachedSizesToArray@MessageLite@protobuf@google@@UBEPAE_NPAE@Z" to i8*), i8* bitcast (i8* (%"class.google::protobuf::MessageLite"*)* @"\01?InternalGetTable@MessageLite@protobuf@google@@EBEPBXXZ" to i8*)] }, comdat($"\01??_7Foo@simpleandproto@@6B@")
...
@"\01??_C@_0BD@DBGCKBJ@simpleandproto?4Foo?$AA@" = linkonce_odr unnamed_addr constant [19 x i8] c"simpleandproto.Foo\00", comdat, align 1
@"\01??_R3Foo@simpleandproto@@8" = linkonce_odr constant %rtti.ClassHierarchyDescriptor { i32 0, i32 0, i32 2, %rtti.BaseClassDescriptor** getelementptr inbounds ([3 x %rtti.BaseClassDescriptor*], [3 x %rtti.BaseClassDescriptor*]* @"\01??_R2Foo@simpleandproto@@8", i32 0, i32 0) }, comdat
@"\01??_R2Foo@simpleandproto@@8" = linkonce_odr constant [3 x %rtti.BaseClassDescriptor*] [%rtti.BaseClassDescriptor* @"\01??_R1A@?0A@EA@Foo@simpleandproto@@8", %rtti.BaseClassDescriptor* @"\01??_R1A@?0A@EA@MessageLite@protobuf@google@@8", %rtti.BaseClassDescriptor* null], comdat
@"\01??_R1A@?0A@EA@Foo@simpleandproto@@8" = linkonce_odr constant %rtti.BaseClassDescriptor { i8* bitcast (%rtti.TypeDescriptor24* @"\01??_R0?AVFoo@simpleandproto@@@8" to i8*), i32 1, i32 0, i32 -1, i32 0, i32 64, %rtti.ClassHierarchyDescriptor* @"\01??_R3Foo@simpleandproto@@8" }, comdat
...
@"\01??_7Foo@simpleandproto@@6B@" = unnamed_addr alias i8*, getelementptr inbounds ({ [18 x i8*] }, { [18 x i8*] }* @2, i32 0, i32 0, i32 1)
...
; <label>:23:                                     ; preds = %15
  ...
  call x86_thiscallcc void @"\01??1Integer@emp@@QAE@XZ"(%"class.emp::Integer"* %8) #10 [ "funclet"(token %24) ]
  cleanupret from %24 unwind label %25

; <label>:25:                                     ; preds = %17, %23, %14
  %26 = cleanuppad within none []
  call x86_thiscallcc void @"\01??1Integer@emp@@QAE@XZ"(%"class.emp::Integer"* %6) #10 [ "funclet"(token %26) ]
  cleanupret from %26 unwind label %27

; <label>:27:                                     ; preds = %25, %2
  %28 = cleanuppad within none []
  call x86_thiscallcc void @"\01??1Integer@emp@@QAE@XZ"(%"class.emp::Integer"* %5) #10 [ "funclet"(token %28) ]
...
; <label>:32:                                     ; preds = %28
  ...
  %33 = invoke x86_thiscallcc %"class.simpleandproto::Foo"* bitcast (%"class.simpleandproto::Foo.2"* (%"class.simpleandproto::Foo.2"*)* @"\01??0Foo@simpleandproto@@QAE@XZ" to %"class.simpleandproto::Foo"* (%"class.simpleandproto::Foo"*)*)(%"class.simpleandproto::Foo"* %0)
...
; <label>:43:                                     ; preds = %26
  ...
  call x86_thiscallcc void @"\01??1Integer@emp@@QAE@XZ"(%"class.emp::Integer"* %11) #10 [ "funclet"(token %44) ]
  cleanupret from %44 unwind label %49

; <label>:45:                                     ; preds = %41
  call x86_thiscallcc void bitcast (void (%"class.simpleandproto::Foo.2"*)* @"\01??1Foo@simpleandproto@@UAE@XZ" to void (%"class.simpleandproto::Foo"*)*)(%"class.simpleandproto::Foo"* %0) #10
  br label %46
...
; <label>:47:                                     ; preds = %36, %34
  ...
  call x86_thiscallcc void bitcast (void (%"class.simpleandproto::Foo.2"*)* @"\01??1Foo@simpleandproto@@UAE@XZ" to void (%"class.simpleandproto::Foo"*)*)(%"class.simpleandproto::Foo"* %0) #10 [ "funclet"(token %48) ]
  cleanupret from %48 unwind label %49

; <label>:49:                                     ; preds = %47, %32, %28, %43, %25
  %50 = cleanuppad within none []
  call x86_thiscallcc void @"\01??1Integer@emp@@QAE@XZ"(%"class.emp::Integer"* %8) #10 [ "funclet"(token %50) ]
  cleanupret from %50 unwind label %51

; <label>:51:                                     ; preds = %49, %23, %3
  %52 = cleanuppad within none []
  call x86_thiscallcc void @"\01??1Integer@emp@@QAE@XZ"(%"class.emp::Integer"* %6) #10 [ "funclet"(token %52) ]
...
define i32 @PlatON_entry_TestFooAdd(i8**, i8**, i32*) {
  ...
  call void bitcast (%"class.simpleandproto::Foo.2"* (%"class.simpleandproto::Foo.2"*)* @"\01??0Foo@simpleandproto@@QAE@XZ" to void (%"class.simpleandproto::Foo"*)*)(%"class.simpleandproto::Foo"* %5)
  ...
  call void bitcast (%"class.simpleandproto::Foo.2"* (%"class.simpleandproto::Foo.2"*)* @"\01??0Foo@simpleandproto@@QAE@XZ" to void (%"class.simpleandproto::Foo"*)*)(%"class.simpleandproto::Foo"* %12)
  ...
  %20 = call i64 bitcast (i32 (%"class.simpleandproto::Foo.2"*)* @"\01?ByteSizeLong@Foo@simpleandproto@@UBEIXZ" to i64 (%"class.simpleandproto::Foo"*)*)(%"class.simpleandproto::Foo"* %4)
  ...
  call void bitcast (void (%"class.simpleandproto::Foo.2"*)* @"\01??1Foo@simpleandproto@@UAE@XZ" to void (%"class.simpleandproto::Foo"*)*)(%"class.simpleandproto::Foo"* %4)
  call void bitcast (void (%"class.simpleandproto::Foo.2"*)* @"\01??1Foo@simpleandproto@@UAE@XZ" to void (%"class.simpleandproto::Foo"*)*)(%"class.simpleandproto::Foo"* %5)
  call void bitcast (void (%"class.simpleandproto::Foo.2"*)* @"\01??1Foo@simpleandproto@@UAE@XZ" to void (%"class.simpleandproto::Foo"*)*)(%"class.simpleandproto::Foo"* %12)
  ret i32 %21
}
...
; Function Attrs: noinline optnone
define void @"\01?InitDefaultsFooImpl@protobuf_SimpleAndProtoLite_2eproto@@YAXXZ"() #0 {
  %1 = alloca i8*, align 4
  call void @"\01?VerifyVersion@internal@protobuf@google@@YAXHHPBD@Z"(i32 3005001, i32 3005000, i8* getelementptr inbounds ([80 x i8], [80 x i8]* @"\01??_C@_0FA@KPMJBJBF@E?3?2work?2local?2private?9contract?9s@", i32 0, i32 0))
  ...
  %3 = bitcast i8* %2 to %"class.simpleandproto::Foo.2"*
  %4 = call x86_thiscallcc %"class.simpleandproto::Foo.2"* @"\01??0Foo@simpleandproto@@QAE@XZ"(%"class.simpleandproto::Foo.2"* %3)
...
; Function Attrs: noinline optnone
define x86_thiscallcc %"class.simpleandproto::Foo.2"* @"\01??0Foo@simpleandproto@@QAE@XZ"(%"class.simpleandproto::Foo.2"* returned) unnamed_addr #0 align 2 personality i8* bitcast (i32 (...)* @__CxxFrameHandler3 to i8*) {
  %2 = alloca %"class.simpleandproto::Foo.2"*, align 4
  %3 = alloca %"class.simpleandproto::Foo.2"*, align 4
  store %"class.simpleandproto::Foo.2"* %0, %"class.simpleandproto::Foo.2"** %3, align 4
  %4 = load %"class.simpleandproto::Foo.2"*, %"class.simpleandproto::Foo.2"** %3, align 4
  store %"class.simpleandproto::Foo.2"* %4, %"class.simpleandproto::Foo.2"** %2, align 4
  %5 = bitcast %"class.simpleandproto::Foo.2"* %4 to %"class.google::protobuf::MessageLite"*
  ...
  %7 = bitcast %"class.simpleandproto::Foo.2"* %4 to i32 (...)***
  store i32 (...)** bitcast (i8** @"\01??_7Foo@simpleandproto@@6B@" to i32 (...)**), i32 (...)*** %7, align 4
  %8 = getelementptr inbounds %"class.simpleandproto::Foo.2", %"class.simpleandproto::Foo.2"* %4, i32 0, i32 1
...
; <label>:10:                                     ; preds = %1
  %11 = invoke %"class.simpleandproto::Foo.2"* @"\01?internal_default_instance@Foo@simpleandproto@@SAPBV12@XZ"()
          to label %12 unwind label %19

; <label>:12:                                     ; preds = %10
  %13 = icmp ne %"class.simpleandproto::Foo.2"* %4, %11
  br i1 %13, label %14, label %16

; <label>:14:                                     ; preds = %12
  invoke void @"\01?InitDefaultsFoo@protobuf_SimpleAndProtoLite_2eproto@@YAXXZ"()
...
; <label>:16:                                     ; preds = %15, %12
  invoke x86_thiscallcc void @"\01?SharedCtor@Foo@simpleandproto@@AAEXXZ"(%"class.simpleandproto::Foo.2"* %4)
          to label %17 unwind label %19

; <label>:17:                                     ; preds = %16
  %18 = load %"class.simpleandproto::Foo.2"*, %"class.simpleandproto::Foo.2"** %2, align 4
  ret %"class.simpleandproto::Foo.2"* %18
...
; <label>:21:                                     ; preds = %19, %1
  ...
  %23 = bitcast %"class.simpleandproto::Foo.2"* %4 to %"class.google::protobuf::MessageLite"*
...
; Function Attrs: noinline nounwind optnone
define linkonce_odr %"class.simpleandproto::Foo.2"* @"\01?internal_default_instance@Foo@simpleandproto@@SAPBV12@XZ"() #3 comdat align 2 {
  ret %"class.simpleandproto::Foo.2"* bitcast (%"class.simpleandproto::FooDefaultTypeInternal"* @"\01?_Foo_default_instance_@simpleandproto@@3VFooDefaultTypeInternal@1@A" to %"class.simpleandproto::Foo.2"*)
}

; Function Attrs: noinline optnone
define void @"\01?InitDefaultsFoo@protobuf_SimpleAndProtoLite_2eproto@@YAXXZ"() #0 {
  call void @"\01?GoogleOnceInit@protobuf@google@@YAXPAHP6AXXZ@Z"(i32* @"\01?once@?1??InitDefaultsFoo@protobuf_SimpleAndProtoLite_2eproto@@YAXXZ@4HA", void ()* @"\01?InitDefaultsFooImpl@protobuf_SimpleAndProtoLite_2eproto@@YAXXZ")
  ret void
}

; Function Attrs: noinline nounwind optnone
define x86_thiscallcc void @"\01?SharedCtor@Foo@simpleandproto@@AAEXXZ"(%"class.simpleandproto::Foo.2"*) #3 align 2 {
  %2 = alloca %"class.simpleandproto::Foo.2"*, align 4
  store %"class.simpleandproto::Foo.2"* %0, %"class.simpleandproto::Foo.2"** %2, align 4
  %3 = load %"class.simpleandproto::Foo.2"*, %"class.simpleandproto::Foo.2"** %2, align 4
  %4 = getelementptr inbounds %"class.simpleandproto::Foo.2", %"class.simpleandproto::Foo.2"* %3, i32 0, i32 2
  %5 = bitcast i32* %4 to i8*
  %6 = getelementptr inbounds %"class.simpleandproto::Foo.2", %"class.simpleandproto::Foo.2"* %3, i32 0, i32 3
  %7 = bitcast float* %6 to i8*
  %8 = getelementptr inbounds %"class.simpleandproto::Foo.2", %"class.simpleandproto::Foo.2"* %3, i32 0, i32 2
  ...
  %14 = getelementptr inbounds %"class.simpleandproto::Foo.2", %"class.simpleandproto::Foo.2"* %3, i32 0, i32 4
...
define linkonce_odr x86_thiscallcc void @"\01??1InternalMetadataWithArenaLite@internal@protobuf@google@@QAE@XZ"(%"class.google::protobuf::internal::InternalMetadataWithArena"*) unnamed_addr #3 comdat align 2 {
  ...
  call x86_thiscallcc void @"\01??1?$InternalMetadataWithArenaBase@V?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@VInternalMetadataWithArenaLite@internal@protobuf@google@@@internal@protobuf@google@@QAE@XZ"(%struct._iobuf* %4) #10
  ret void
}
...
; Function Attrs: noinline nounwind optnone
define linkonce_odr x86_thiscallcc i8* @"\01??_GFoo@simpleandproto@@UAEPAXI@Z"(%"class.simpleandproto::Foo.2"*, i32) unnamed_addr #3 comdat align 2 {
  %3 = alloca i8*, align 4
  %4 = alloca i32, align 4
  %5 = alloca %"class.simpleandproto::Foo.2"*, align 4
  store i32 %1, i32* %4, align 4
  store %"class.simpleandproto::Foo.2"* %0, %"class.simpleandproto::Foo.2"** %5, align 4
  %6 = load %"class.simpleandproto::Foo.2"*, %"class.simpleandproto::Foo.2"** %5, align 4
  %7 = bitcast %"class.simpleandproto::Foo.2"* %6 to i8*
  store i8* %7, i8** %3, align 4
  %8 = load i32, i32* %4, align 4
  call x86_thiscallcc void @"\01??1Foo@simpleandproto@@UAE@XZ"(%"class.simpleandproto::Foo.2"* %6) #10
  %9 = icmp eq i32 %8, 0
  br i1 %9, label %12, label %10

; <label>:10:                                     ; preds = %2
  %11 = bitcast %"class.simpleandproto::Foo.2"* %6 to i8*
  call void @"\01??3@YAXPAX@Z"(i8* %11) #11
  br label %12
...
; Function Attrs: noinline optnone
define x86_thiscallcc void @"\01?GetTypeName@Foo@simpleandproto@@UBE?AV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@XZ"(%"class.simpleandproto::Foo.2"*, %"class.std::basic_string"* noalias sret) unnamed_addr #0 align 2 {
  %3 = alloca %"class.simpleandproto::Foo.2"*, align 4
  store %"class.simpleandproto::Foo.2"* %0, %"class.simpleandproto::Foo.2"** %3, align 4
  %4 = load %"class.simpleandproto::Foo.2"*, %"class.simpleandproto::Foo.2"** %3, align 4
  %5 = call x86_thiscallcc %"class.std::basic_string"* @"\01??0?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@QBD@Z"(%"class.std::basic_string"* %1, i8* getelementptr inbounds ([19 x i8], [19 x i8]* @"\01??_C@_0BD@DBGCKBJ@simpleandproto?4Foo?$AA@", i32 0, i32 0))
  ret void
}

; Function Attrs: noinline optnone
define x86_thiscallcc %"class.simpleandproto::Foo.2"* @"\01?New@Foo@simpleandproto@@UBEPAV12@PAVArena@protobuf@google@@@Z"(%"class.simpleandproto::Foo.2"*, %"class.google::protobuf::Arena"*) unnamed_addr #0 align 2 personality i8* bitcast (i32 (...)* @__CxxFrameHandler3 to i8*) {
  %3 = alloca %"class.google::protobuf::Arena"*, align 4
  %4 = alloca %"class.simpleandproto::Foo.2"*, align 4
  %5 = alloca %"class.simpleandproto::Foo.2"*, align 4
  store %"class.google::protobuf::Arena"* %1, %"class.google::protobuf::Arena"** %3, align 4
  store %"class.simpleandproto::Foo.2"* %0, %"class.simpleandproto::Foo.2"** %4, align 4
  %6 = load %"class.simpleandproto::Foo.2"*, %"class.simpleandproto::Foo.2"** %4, align 4
  %7 = call i8* @"\01??2@YAPAXI@Z"(i32 20) #13
  %8 = bitcast i8* %7 to %"class.simpleandproto::Foo.2"*
  %9 = invoke x86_thiscallcc %"class.simpleandproto::Foo.2"* @"\01??0Foo@simpleandproto@@QAE@XZ"(%"class.simpleandproto::Foo.2"* %8)
          to label %10 unwind label %16

; <label>:10:                                     ; preds = %2
  store %"class.simpleandproto::Foo.2"* %8, %"class.simpleandproto::Foo.2"** %5, align 4
...
; <label>:13:                                     ; preds = %10
  ...
  %15 = load %"class.simpleandproto::Foo.2"*, %"class.simpleandproto::Foo.2"** %5, align 4
  call x86_thiscallcc void @"\01??$Own@VFoo@simpleandproto@@@Arena@protobuf@google@@QAEXPAVFoo@simpleandproto@@@Z"(%"class.google::protobuf::Arena"* %14, %"class.simpleandproto::Foo.2"* %15)
  br label %18
...
; <label>:18:                                     ; preds = %13, %10
  %19 = load %"class.simpleandproto::Foo.2"*, %"class.simpleandproto::Foo.2"** %5, align 4
  ret %"class.simpleandproto::Foo.2"* %19
}

; Function Attrs: noinline optnone
define linkonce_odr x86_thiscallcc %"class.simpleandproto::Foo.2"* @"\01?New@Foo@simpleandproto@@UBEPAV12@XZ"(%"class.simpleandproto::Foo.2"*) unnamed_addr #0 comdat align 2 {
  %2 = alloca %"class.simpleandproto::Foo.2"*, align 4
  store %"class.simpleandproto::Foo.2"* %0, %"class.simpleandproto::Foo.2"** %2, align 4
  %3 = load %"class.simpleandproto::Foo.2"*, %"class.simpleandproto::Foo.2"** %2, align 4
  %4 = call x86_thiscallcc %"class.simpleandproto::Foo.2"* @"\01?New@Foo@simpleandproto@@UBEPAV12@PAVArena@protobuf@google@@@Z"(%"class.simpleandproto::Foo.2"* %3, %"class.google::protobuf::Arena"* null)
  ret %"class.simpleandproto::Foo.2"* %4
}
...
; Function Attrs: noinline optnone
define x86_thiscallcc void @"\01?Clear@Foo@simpleandproto@@UAEXXZ"(%"class.simpleandproto::Foo.2"*) unnamed_addr #0 align 2 {
  %2 = alloca %"class.simpleandproto::Foo.2"*, align 4
  %3 = alloca i32, align 4
  store %"class.simpleandproto::Foo.2"* %0, %"class.simpleandproto::Foo.2"** %2, align 4
  %4 = load %"class.simpleandproto::Foo.2"*, %"class.simpleandproto::Foo.2"** %2, align 4
  store i32 0, i32* %3, align 4
  %5 = getelementptr inbounds %"class.simpleandproto::Foo.2", %"class.simpleandproto::Foo.2"* %4, i32 0, i32 2
  %6 = bitcast i32* %5 to i8*
  %7 = getelementptr inbounds %"class.simpleandproto::Foo.2", %"class.simpleandproto::Foo.2"* %4, i32 0, i32 3
  %8 = bitcast float* %7 to i8*
  %9 = getelementptr inbounds %"class.simpleandproto::Foo.2", %"class.simpleandproto::Foo.2"* %4, i32 0, i32 2
  ...
  %15 = getelementptr inbounds %"class.simpleandproto::Foo.2", %"class.simpleandproto::Foo.2"* %4, i32 0, i32 1
...
; Function Attrs: noinline nounwind optnone
define x86_thiscallcc zeroext i1 @"\01?IsInitialized@Foo@simpleandproto@@UBE_NXZ"(%"class.simpleandproto::Foo.2"*) unnamed_addr #3 align 2 {
  %2 = alloca %"class.simpleandproto::Foo.2"*, align 4
  store %"class.simpleandproto::Foo.2"* %0, %"class.simpleandproto::Foo.2"** %2, align 4
  %3 = load %"class.simpleandproto::Foo.2"*, %"class.simpleandproto::Foo.2"** %2, align 4
  ret i1 true
...
; Function Attrs: noinline optnone
define x86_thiscallcc void @"\01?CheckTypeAndMergeFrom@Foo@simpleandproto@@UAEXABVMessageLite@protobuf@google@@@Z"(%"class.simpleandproto::Foo.2"*, %"class.google::protobuf::MessageLite"* dereferenceable(4)) unnamed_addr #0 align 2 {
  ...
  store %"class.simpleandproto::Foo.2"* %0, %"class.simpleandproto::Foo.2"** %4, align 4
  %5 = load %"class.simpleandproto::Foo.2"*, %"class.simpleandproto::Foo.2"** %4, align 4
  %6 = load %"class.google::protobuf::MessageLite"*, %"class.google::protobuf::MessageLite"** %3, align 4
  %7 = call %"class.simpleandproto::Foo.2"* @"\01??$down_cast@PBVFoo@simpleandproto@@$$CBVMessageLite@protobuf@google@@@internal@protobuf@google@@YAPBVFoo@simpleandproto@@PBVMessageLite@12@@Z"(%"class.google::protobuf::MessageLite"* %6)
  call x86_thiscallcc void @"\01?MergeFrom@Foo@simpleandproto@@QAEXABV12@@Z"(%"class.simpleandproto::Foo.2"* %5, %"class.simpleandproto::Foo.2"* dereferenceable(20) %7)
  ret void
}

; Function Attrs: noinline optnone
define x86_thiscallcc zeroext i1 @"\01?MergePartialFromCodedStream@Foo@simpleandproto@@UAE_NPAVCodedInputStream@io@protobuf@google@@@Z"(%"class.simpleandproto::Foo.2"*, %"class.google::protobuf::io::CodedInputStream"*) unnamed_addr #0 align 2 personality i8* bitcast (i32 (...)* @__CxxFrameHandler3 to i8*) {
  %3 = alloca i1, align 1
  ...
  store %"class.simpleandproto::Foo.2"* %0, %"class.simpleandproto::Foo.2"** %5, align 4
  %12 = load %"class.simpleandproto::Foo.2"*, %"class.simpleandproto::Foo.2"** %5, align 4
  %13 = getelementptr inbounds %"class.simpleandproto::Foo.2", %"class.simpleandproto::Foo.2"* %12, i32 0, i32 1
...
; <label>:40:                                     ; preds = %35
  %41 = getelementptr inbounds %"class.simpleandproto::Foo.2", %"class.simpleandproto::Foo.2"* %12, i32 0, i32 2
...
; <label>:54:                                     ; preds = %49
  %55 = getelementptr inbounds %"class.simpleandproto::Foo.2", %"class.simpleandproto::Foo.2"* %12, i32 0, i32 3
...
; Function Attrs: noinline optnone
define x86_thiscallcc i32 @"\01?ByteSizeLong@Foo@simpleandproto@@UBEIXZ"(%"class.simpleandproto::Foo.2"*) #0 align 2 {
  %2 = alloca %"class.simpleandproto::Foo.2"*, align 4
  %3 = alloca i32, align 4
  %4 = alloca i32, align 4
  store %"class.simpleandproto::Foo.2"* %0, %"class.simpleandproto::Foo.2"** %2, align 4
  %5 = load %"class.simpleandproto::Foo.2"*, %"class.simpleandproto::Foo.2"** %2, align 4
  store i32 0, i32* %3, align 4
  %6 = call zeroext i1 @"\01?GetProto3PreserveUnknownsDefault@internal@protobuf@google@@YA_NXZ"()
  br i1 %6, label %7, label %11

; <label>:7:                                      ; preds = %1
  %8 = getelementptr inbounds %"class.simpleandproto::Foo.2", %"class.simpleandproto::Foo.2"* %5, i32 0, i32 1
...
; <label>:11:                                     ; preds = %1
  %12 = getelementptr inbounds %"class.simpleandproto::Foo.2", %"class.simpleandproto::Foo.2"* %5, i32 0, i32 1
...
; <label>:14:                                     ; preds = %11, %7
  ...
  %19 = call x86_thiscallcc i32 bitcast (i32 (%"class.simpleandproto::Foo"*)* @"\01?i32@Foo@simpleandproto@@QBEHXZ" to i32 (%"class.simpleandproto::Foo.2"*)*)(%"class.simpleandproto::Foo.2"* %5)
  %20 = icmp ne i32 %19, 0
  br i1 %20, label %21, label %27

; <label>:21:                                     ; preds = %14
  %22 = call x86_thiscallcc i32 bitcast (i32 (%"class.simpleandproto::Foo"*)* @"\01?i32@Foo@simpleandproto@@QBEHXZ" to i32 (%"class.simpleandproto::Foo.2"*)*)(%"class.simpleandproto::Foo.2"* %5)
...
; <label>:27:                                     ; preds = %21, %14
  %28 = call x86_thiscallcc float @"\01?f@Foo@simpleandproto@@QBEMXZ"(%"class.simpleandproto::Foo.2"* %5)
...
; <label>:33:                                     ; preds = %30, %27
  ...
  %35 = call i32 @"\01?ToCachedSize@internal@protobuf@google@@YAHI@Z"(i32 %34)
  store i32 %35, i32* %4, align 4
  %36 = load i32, i32* %4, align 4
  %37 = getelementptr inbounds %"class.simpleandproto::Foo.2", %"class.simpleandproto::Foo.2"* %5, i32 0, i32 4
...
; Function Attrs: noinline optnone
define x86_thiscallcc void @"\01?SerializeWithCachedSizes@Foo@simpleandproto@@UBEXPAVCodedOutputStream@io@protobuf@google@@@Z"(%"class.simpleandproto::Foo.2"*, %"class.google::protobuf::io::CodedOutputStream"*) unnamed_addr #0 align 2 {
  ...
  %7 = call x86_thiscallcc i32 bitcast (i32 (%"class.simpleandproto::Foo"*)* @"\01?i32@Foo@simpleandproto@@QBEHXZ" to i32 (%"class.simpleandproto::Foo.2"*)*)(%"class.simpleandproto::Foo.2"* %6)
  %8 = icmp ne i32 %7, 0
  br i1 %8, label %9, label %12

; <label>:9:                                      ; preds = %2
  %10 = load %"class.google::protobuf::io::CodedOutputStream"*, %"class.google::protobuf::io::CodedOutputStream"** %3, align 4
  %11 = call x86_thiscallcc i32 bitcast (i32 (%"class.simpleandproto::Foo"*)* @"\01?i32@Foo@simpleandproto@@QBEHXZ" to i32 (%"class.simpleandproto::Foo.2"*)*)(%"class.simpleandproto::Foo.2"* %6)
...
; <label>:12:                                     ; preds = %9, %2
  %13 = call x86_thiscallcc float @"\01?f@Foo@simpleandproto@@QBEMXZ"(%"class.simpleandproto::Foo.2"* %6)
...
; <label>:15:                                     ; preds = %12
  ...
  %17 = call x86_thiscallcc float @"\01?f@Foo@simpleandproto@@QBEMXZ"(%"class.simpleandproto::Foo.2"* %6)
...
; <label>:21:                                     ; preds = %18
  %22 = getelementptr inbounds %"class.simpleandproto::Foo.2", %"class.simpleandproto::Foo.2"* %6, i32 0, i32 1
...
; <label>:25:                                     ; preds = %18
  %26 = getelementptr inbounds %"class.simpleandproto::Foo.2", %"class.simpleandproto::Foo.2"* %6, i32 0, i32 1
...
; <label>:32:                                     ; preds = %28
  %33 = getelementptr inbounds %"class.simpleandproto::Foo.2", %"class.simpleandproto::Foo.2"* %6, i32 0, i32 1
...
; <label>:36:                                     ; preds = %28
  %37 = getelementptr inbounds %"class.simpleandproto::Foo.2", %"class.simpleandproto::Foo.2"* %6, i32 0, i32 1
...
; Function Attrs: noinline nounwind optnone
define linkonce_odr x86_thiscallcc i32 @"\01?GetCachedSize@Foo@simpleandproto@@UBEHXZ"(%"class.simpleandproto::Foo.2"*) unnamed_addr #3 comdat align 2 {
  %2 = alloca %"class.simpleandproto::Foo.2"*, align 4
  store %"class.simpleandproto::Foo.2"* %0, %"class.simpleandproto::Foo.2"** %2, align 4
  %3 = load %"class.simpleandproto::Foo.2"*, %"class.simpleandproto::Foo.2"** %2, align 4
  %4 = getelementptr inbounds %"class.simpleandproto::Foo.2", %"class.simpleandproto::Foo.2"* %3, i32 0, i32 4
  %5 = load i32, i32* %4, align 4
  ret i32 %5
}
...
; Function Attrs: noinline nounwind optnone
define linkonce_odr x86_thiscallcc float @"\01?f@Foo@simpleandproto@@QBEMXZ"(%"class.simpleandproto::Foo.2"*) #3 comdat align 2 {
  %2 = alloca %"class.simpleandproto::Foo.2"*, align 4
  store %"class.simpleandproto::Foo.2"* %0, %"class.simpleandproto::Foo.2"** %2, align 4
  %3 = load %"class.simpleandproto::Foo.2"*, %"class.simpleandproto::Foo.2"** %2, align 4
  %4 = getelementptr inbounds %"class.simpleandproto::Foo.2", %"class.simpleandproto::Foo.2"* %3, i32 0, i32 3
...
define linkonce_odr x86_thiscallcc dereferenceable(24) %"class.std::basic_string"* @"\01?get@?$ExplicitlyConstructed@V?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@@internal@protobuf@google@@QBEABV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@XZ"(%"class.google::protobuf::internal::ExplicitlyConstructed"*) #3 comdat align 2 {
  ...
  %5 = bitcast %"union.google::protobuf::internal::ExplicitlyConstructed<simpleandproto::Foo>::AlignedUnion"* %4 to %"class.std::basic_string"*
...
; Function Attrs: noinline optnone
define linkonce_odr %"class.simpleandproto::Foo.2"* @"\01??$down_cast@PBVFoo@simpleandproto@@$$CBVMessageLite@protobuf@google@@@internal@protobuf@google@@YAPBVFoo@simpleandproto@@PBVMessageLite@12@@Z"(%"class.google::protobuf::MessageLite"*) #0 comdat {
  %2 = alloca %"class.google::protobuf::MessageLite"*, align 4
  store %"class.google::protobuf::MessageLite"* %0, %"class.google::protobuf::MessageLite"** %2, align 4
  %3 = load %"class.google::protobuf::MessageLite"*, %"class.google::protobuf::MessageLite"** %2, align 4
...
; <label>:5:                                      ; preds = %1
  ...
  %7 = bitcast %"class.google::protobuf::MessageLite"* %6 to i8*
  %8 = call i8* @__RTDynamicCast(i8* %7, i32 0, i8* bitcast (%rtti.TypeDescriptor33* @"\01??_R0?AVMessageLite@protobuf@google@@@8" to i8*), i8* bitcast (%rtti.TypeDescriptor24* @"\01??_R0?AVFoo@simpleandproto@@@8" to i8*), i32 0)
  %9 = bitcast i8* %8 to %"class.simpleandproto::Foo.2"*
  br label %10

; <label>:10:                                     ; preds = %5
  %11 = icmp ne %"class.simpleandproto::Foo.2"* %9, null
...
; <label>:13:                                     ; preds = %12, %10, %1
  ...
  %16 = bitcast %"class.google::protobuf::MessageLite"* %15 to %"class.simpleandproto::Foo.2"*
  ret %"class.simpleandproto::Foo.2"* %16
}

; Function Attrs: noinline optnone
define x86_thiscallcc void @"\01?MergeFrom@Foo@simpleandproto@@QAEXABV12@@Z"(%"class.simpleandproto::Foo.2"*, %"class.simpleandproto::Foo.2"* dereferenceable(20)) #0 align 2 personality i8* bitcast (i32 (...)* @__CxxFrameHandler3 to i8*) {
  %3 = alloca %"class.simpleandproto::Foo.2"*, align 4
  %4 = alloca %"class.simpleandproto::Foo.2"*, align 4
  ...
  %8 = alloca i32, align 4
  store %"class.simpleandproto::Foo.2"* %1, %"class.simpleandproto::Foo.2"** %3, align 4
  store %"class.simpleandproto::Foo.2"* %0, %"class.simpleandproto::Foo.2"** %4, align 4
  %9 = load %"class.simpleandproto::Foo.2"*, %"class.simpleandproto::Foo.2"** %4, align 4
  %10 = load %"class.simpleandproto::Foo.2"*, %"class.simpleandproto::Foo.2"** %3, align 4
  %11 = icmp ne %"class.simpleandproto::Foo.2"* %10, %9
...
; <label>:13:                                     ; preds = %2
  %14 = call x86_thiscallcc %"class.google::protobuf::internal::LogMessage"* @"\01??0LogMessage@internal@protobuf@google@@QAE@W4LogLevel@23@PBDH@Z"(%"class.google::protobuf::internal::LogMessage"* %5, i32 3, i8* getelementptr inbounds ([80 x i8], [80 x i8]* @"\01??_C@_0FA@KPMJBJBF@E?3?2work?2local?2private?9contract?9s@", i32 0, i32 0), i32 241)
...
; <label>:21:                                     ; preds = %20, %18
  %22 = getelementptr inbounds %"class.simpleandproto::Foo.2", %"class.simpleandproto::Foo.2"* %9, i32 0, i32 1
  %23 = bitcast %"class.google::protobuf::internal::InternalMetadataWithArena"* %22 to %struct._iobuf*
  %24 = load %"class.simpleandproto::Foo.2"*, %"class.simpleandproto::Foo.2"** %3, align 4
  %25 = getelementptr inbounds %"class.simpleandproto::Foo.2", %"class.simpleandproto::Foo.2"* %24, i32 0, i32 1
  ...
  store i32 0, i32* %8, align 4
  %26 = load %"class.simpleandproto::Foo.2"*, %"class.simpleandproto::Foo.2"** %3, align 4
  %27 = call x86_thiscallcc i32 bitcast (i32 (%"class.simpleandproto::Foo"*)* @"\01?i32@Foo@simpleandproto@@QBEHXZ" to i32 (%"class.simpleandproto::Foo.2"*)*)(%"class.simpleandproto::Foo.2"* %26)
  %28 = icmp ne i32 %27, 0
  br i1 %28, label %29, label %37

; <label>:29:                                     ; preds = %21
  %30 = load %"class.simpleandproto::Foo.2"*, %"class.simpleandproto::Foo.2"** %3, align 4
  %31 = call x86_thiscallcc i32 bitcast (i32 (%"class.simpleandproto::Foo"*)* @"\01?i32@Foo@simpleandproto@@QBEHXZ" to i32 (%"class.simpleandproto::Foo.2"*)*)(%"class.simpleandproto::Foo.2"* %30)
  call x86_thiscallcc void bitcast (void (%"class.simpleandproto::Foo"*, i32)* @"\01?set_i32@Foo@simpleandproto@@QAEXH@Z" to void (%"class.simpleandproto::Foo.2"*, i32)*)(%"class.simpleandproto::Foo.2"* %9, i32 %31)
  br label %37
...
; <label>:37:                                     ; preds = %29, %21
  %38 = load %"class.simpleandproto::Foo.2"*, %"class.simpleandproto::Foo.2"** %3, align 4
  %39 = call x86_thiscallcc float @"\01?f@Foo@simpleandproto@@QBEMXZ"(%"class.simpleandproto::Foo.2"* %38)
  %40 = fcmp une float %39, 0.000000e+00
  br i1 %40, label %41, label %44

; <label>:41:                                     ; preds = %37
  %42 = load %"class.simpleandproto::Foo.2"*, %"class.simpleandproto::Foo.2"** %3, align 4
  %43 = call x86_thiscallcc float @"\01?f@Foo@simpleandproto@@QBEMXZ"(%"class.simpleandproto::Foo.2"* %42)
  call x86_thiscallcc void bitcast (void (%"class.simpleandproto::Foo"*, float)* @"\01?set_f@Foo@simpleandproto@@QAEXM@Z" to void (%"class.simpleandproto::Foo.2"*, float)*)(%"class.simpleandproto::Foo.2"* %9, float %43)
  br label %44
...
; Function Attrs: noinline optnone
define linkonce_odr x86_thiscallcc void @"\01??$Own@VFoo@simpleandproto@@@Arena@protobuf@google@@QAEXPAVFoo@simpleandproto@@@Z"(%"class.google::protobuf::Arena"*, %"class.simpleandproto::Foo.2"*) #0 comdat align 2 {
  %3 = alloca %"class.simpleandproto::Foo.2"*, align 4
  %4 = alloca %"class.google::protobuf::Arena"*, align 4
  %5 = alloca %struct.__vcrt_assert_va_start_is_not_reference, align 4
  ...
  %9 = load %"class.simpleandproto::Foo.2"*, %"class.simpleandproto::Foo.2"** %3, align 4
  call x86_thiscallcc void @"\01??$OwnInternal@VFoo@simpleandproto@@@Arena@protobuf@google@@AAEXPAVFoo@simpleandproto@@U?$integral_constant@_N$0A@@internal@12@@Z"(%"class.google::protobuf::Arena"* %7, %"class.simpleandproto::Foo.2"* %9, %struct.__vcrt_assert_va_start_is_not_reference* byval align 4 %5)
  ret void
}

; Function Attrs: noinline optnone
define linkonce_odr x86_thiscallcc void @"\01??$OwnInternal@VFoo@simpleandproto@@@Arena@protobuf@google@@AAEXPAVFoo@simpleandproto@@U?$integral_constant@_N$0A@@internal@12@@Z"(%"class.google::protobuf::Arena"*, %"class.simpleandproto::Foo.2"*, %struct.__vcrt_assert_va_start_is_not_reference* byval align 4) #0 comdat align 2 {
  %4 = alloca %"class.simpleandproto::Foo.2"*, align 4
  %5 = alloca %"class.google::protobuf::Arena"*, align 4
  store %"class.simpleandproto::Foo.2"* %1, %"class.simpleandproto::Foo.2"** %4, align 4
  store %"class.google::protobuf::Arena"* %0, %"class.google::protobuf::Arena"** %5, align 4
  %6 = load %"class.google::protobuf::Arena"*, %"class.google::protobuf::Arena"** %5, align 4
  %7 = load %"class.simpleandproto::Foo.2"*, %"class.simpleandproto::Foo.2"** %4, align 4
  %8 = icmp ne %"class.simpleandproto::Foo.2"* %7, null
  br i1 %8, label %9, label %13

; <label>:9:                                      ; preds = %3
  %10 = getelementptr inbounds %"class.google::protobuf::Arena", %"class.google::protobuf::Arena"* %6, i32 0, i32 0
  %11 = load %"class.simpleandproto::Foo.2"*, %"class.simpleandproto::Foo.2"** %4, align 4
  %12 = bitcast %"class.simpleandproto::Foo.2"* %11 to i8*
  call x86_thiscallcc void @"\01?AddCleanup@ArenaImpl@internal@protobuf@google@@QAEXPAXP6AX0@Z@Z"(%"class.google::protobuf::internal::ArenaImpl"* %10, i8* %12, void (i8*)* @"\01??$arena_delete_object@VFoo@simpleandproto@@@internal@protobuf@google@@YAXPAX@Z")
  br label %13
...
; Function Attrs: noinline nounwind optnone
define linkonce_odr void @"\01??$arena_delete_object@VFoo@simpleandproto@@@internal@protobuf@google@@YAXPAX@Z"(i8*) #3 comdat {
  %2 = alloca i8*, align 4
  store i8* %0, i8** %2, align 4
  %3 = load i8*, i8** %2, align 4
  %4 = bitcast i8* %3 to %"class.simpleandproto::Foo.2"*
  %5 = icmp eq %"class.simpleandproto::Foo.2"* %4, null
  br i1 %5, label %12, label %6

; <label>:6:                                      ; preds = %1
  %7 = bitcast %"class.simpleandproto::Foo.2"* %4 to i8* (%"class.simpleandproto::Foo.2"*, i32)***
  %8 = load i8* (%"class.simpleandproto::Foo.2"*, i32)**, i8* (%"class.simpleandproto::Foo.2"*, i32)*** %7, align 4
  %9 = getelementptr inbounds i8* (%"class.simpleandproto::Foo.2"*, i32)*, i8* (%"class.simpleandproto::Foo.2"*, i32)** %8, i64 0
  %10 = load i8* (%"class.simpleandproto::Foo.2"*, i32)*, i8* (%"class.simpleandproto::Foo.2"*, i32)** %9, align 4
  %11 = call x86_thiscallcc i8* %10(%"class.simpleandproto::Foo.2"* %4, i32 1) #10
  br label %12
...
; Function Attrs: noinline nounwind optnone
define x86_thiscallcc void @"\01??1Foo@simpleandproto@@UAE@XZ"(%"class.simpleandproto::Foo.2"*) unnamed_addr #3 align 2 personality i8* bitcast (i32 (...)* @__CxxFrameHandler3 to i8*) {
  %2 = alloca %"class.simpleandproto::Foo.2"*, align 4
  store %"class.simpleandproto::Foo.2"* %0, %"class.simpleandproto::Foo.2"** %2, align 4
  %3 = load %"class.simpleandproto::Foo.2"*, %"class.simpleandproto::Foo.2"** %2, align 4
  %4 = bitcast %"class.simpleandproto::Foo.2"* %3 to i32 (...)***
  store i32 (...)** bitcast (i8** @"\01??_7Foo@simpleandproto@@6B@" to i32 (...)**), i32 (...)*** %4, align 4
  invoke x86_thiscallcc void @"\01?SharedDtor@Foo@simpleandproto@@AAEXXZ"(%"class.simpleandproto::Foo.2"* %3)
          to label %5 unwind label %8

; <label>:5:                                      ; preds = %1
  %6 = getelementptr inbounds %"class.simpleandproto::Foo.2", %"class.simpleandproto::Foo.2"* %3, i32 0, i32 1
  ...
  %7 = bitcast %"class.simpleandproto::Foo.2"* %3 to %"class.google::protobuf::MessageLite"*
  call x86_thiscallcc void @"\01??1MessageLite@protobuf@google@@UAE@XZ"(%"class.google::protobuf::MessageLite"* %7) #10
  ret void

; <label>:8:                                      ; preds = %1
  %9 = cleanuppad within none []
  %10 = getelementptr inbounds %"class.simpleandproto::Foo.2", %"class.simpleandproto::Foo.2"* %3, i32 0, i32 1
...
; <label>:11:                                     ; preds = %8
  %12 = cleanuppad within none []
  %13 = bitcast %"class.simpleandproto::Foo.2"* %3 to %"class.google::protobuf::MessageLite"*
...
; Function Attrs: noinline nounwind optnone
define x86_thiscallcc void @"\01?SharedDtor@Foo@simpleandproto@@AAEXXZ"(%"class.simpleandproto::Foo.2"*) #3 align 2 {
  %2 = alloca %"class.simpleandproto::Foo.2"*, align 4
  store %"class.simpleandproto::Foo.2"* %0, %"class.simpleandproto::Foo.2"** %2, align 4
  %3 = load %"class.simpleandproto::Foo.2"*, %"class.simpleandproto::Foo.2"** %2, align 4
  ret void
...
; Function Attrs: noinline optnone
define x86_thiscallcc %"class.simpleandproto::Foo.2"* @"\01??0Foo@simpleandproto@@QAE@ABV01@@Z"(%"class.simpleandproto::Foo.2"* returned, %"class.simpleandproto::Foo.2"* dereferenceable(20)) unnamed_addr #0 align 2 personality i8* bitcast (i32 (...)* @__CxxFrameHandler3 to i8*) {
  %3 = alloca %"class.simpleandproto::Foo.2"*, align 4
  %4 = alloca %"class.simpleandproto::Foo.2"*, align 4
  store %"class.simpleandproto::Foo.2"* %1, %"class.simpleandproto::Foo.2"** %3, align 4
  store %"class.simpleandproto::Foo.2"* %0, %"class.simpleandproto::Foo.2"** %4, align 4
  %5 = load %"class.simpleandproto::Foo.2"*, %"class.simpleandproto::Foo.2"** %4, align 4
  %6 = bitcast %"class.simpleandproto::Foo.2"* %5 to %"class.google::protobuf::MessageLite"*
  ...
  %8 = bitcast %"class.simpleandproto::Foo.2"* %5 to i32 (...)***
  store i32 (...)** bitcast (i8** @"\01??_7Foo@simpleandproto@@6B@" to i32 (...)**), i32 (...)*** %8, align 4
  %9 = getelementptr inbounds %"class.simpleandproto::Foo.2", %"class.simpleandproto::Foo.2"* %5, i32 0, i32 1
...
; <label>:11:                                     ; preds = %2
  %12 = getelementptr inbounds %"class.simpleandproto::Foo.2", %"class.simpleandproto::Foo.2"* %5, i32 0, i32 4
  store i32 0, i32* %12, align 4
  %13 = getelementptr inbounds %"class.simpleandproto::Foo.2", %"class.simpleandproto::Foo.2"* %5, i32 0, i32 1
  %14 = bitcast %"class.google::protobuf::internal::InternalMetadataWithArena"* %13 to %struct._iobuf*
  %15 = load %"class.simpleandproto::Foo.2"*, %"class.simpleandproto::Foo.2"** %3, align 4
  %16 = getelementptr inbounds %"class.simpleandproto::Foo.2", %"class.simpleandproto::Foo.2"* %15, i32 0, i32 1
...
; <label>:17:                                     ; preds = %11
  %18 = getelementptr inbounds %"class.simpleandproto::Foo.2", %"class.simpleandproto::Foo.2"* %5, i32 0, i32 2
  %19 = bitcast i32* %18 to i8*
  %20 = load %"class.simpleandproto::Foo.2"*, %"class.simpleandproto::Foo.2"** %3, align 4
  %21 = getelementptr inbounds %"class.simpleandproto::Foo.2", %"class.simpleandproto::Foo.2"* %20, i32 0, i32 2
  %22 = bitcast i32* %21 to i8*
  %23 = getelementptr inbounds %"class.simpleandproto::Foo.2", %"class.simpleandproto::Foo.2"* %5, i32 0, i32 3
  %24 = bitcast float* %23 to i8*
  %25 = getelementptr inbounds %"class.simpleandproto::Foo.2", %"class.simpleandproto::Foo.2"* %5, i32 0, i32 2
  ...
  ret %"class.simpleandproto::Foo.2"* %5
...
; <label>:33:                                     ; preds = %31, %2
  ...
  %35 = bitcast %"class.simpleandproto::Foo.2"* %5 to %"class.google::protobuf::MessageLite"*
...
; Function Attrs: noinline nounwind optnone
define x86_thiscallcc void @"\01?SetCachedSize@Foo@simpleandproto@@ABEXH@Z"(%"class.simpleandproto::Foo.2"*, i32) #3 align 2 {
  %3 = alloca i32, align 4
  %4 = alloca %"class.simpleandproto::Foo.2"*, align 4
  store i32 %1, i32* %3, align 4
  store %"class.simpleandproto::Foo.2"* %0, %"class.simpleandproto::Foo.2"** %4, align 4
  %5 = load %"class.simpleandproto::Foo.2"*, %"class.simpleandproto::Foo.2"** %4, align 4
  %6 = load i32, i32* %3, align 4
  %7 = getelementptr inbounds %"class.simpleandproto::Foo.2", %"class.simpleandproto::Foo.2"* %5, i32 0, i32 4
  store i32 %6, i32* %7, align 4
  ret void
}

; Function Attrs: noinline optnone
define dereferenceable(20) %"class.simpleandproto::Foo.2"* @"\01?default_instance@Foo@simpleandproto@@SAABV12@XZ"() #0 align 2 {
  call void @"\01?InitDefaultsFoo@protobuf_SimpleAndProtoLite_2eproto@@YAXXZ"()
  %1 = call %"class.simpleandproto::Foo.2"* @"\01?internal_default_instance@Foo@simpleandproto@@SAPBV12@XZ"()
  ret %"class.simpleandproto::Foo.2"* %1
}

; Function Attrs: noinline optnone
define x86_thiscallcc void @"\01?CopyFrom@Foo@simpleandproto@@QAEXABV12@@Z"(%"class.simpleandproto::Foo.2"*, %"class.simpleandproto::Foo.2"* dereferenceable(20)) #0 align 2 {
  %3 = alloca %"class.simpleandproto::Foo.2"*, align 4
  %4 = alloca %"class.simpleandproto::Foo.2"*, align 4
  store %"class.simpleandproto::Foo.2"* %1, %"class.simpleandproto::Foo.2"** %3, align 4
  store %"class.simpleandproto::Foo.2"* %0, %"class.simpleandproto::Foo.2"** %4, align 4
  %5 = load %"class.simpleandproto::Foo.2"*, %"class.simpleandproto::Foo.2"** %4, align 4
  %6 = load %"class.simpleandproto::Foo.2"*, %"class.simpleandproto::Foo.2"** %3, align 4
  %7 = icmp eq %"class.simpleandproto::Foo.2"* %6, %5
...
; <label>:9:                                      ; preds = %2
  call x86_thiscallcc void @"\01?Clear@Foo@simpleandproto@@UAEXXZ"(%"class.simpleandproto::Foo.2"* %5)
  %10 = load %"class.simpleandproto::Foo.2"*, %"class.simpleandproto::Foo.2"** %3, align 4
  call x86_thiscallcc void @"\01?MergeFrom@Foo@simpleandproto@@QAEXABV12@@Z"(%"class.simpleandproto::Foo.2"* %5, %"class.simpleandproto::Foo.2"* dereferenceable(20) %10)
  br label %11
...
; Function Attrs: noinline optnone
define x86_thiscallcc void @"\01?Swap@Foo@simpleandproto@@QAEXPAV12@@Z"(%"class.simpleandproto::Foo.2"*, %"class.simpleandproto::Foo.2"*) #0 align 2 {
  %3 = alloca %"class.simpleandproto::Foo.2"*, align 4
  %4 = alloca %"class.simpleandproto::Foo.2"*, align 4
  store %"class.simpleandproto::Foo.2"* %1, %"class.simpleandproto::Foo.2"** %3, align 4
  store %"class.simpleandproto::Foo.2"* %0, %"class.simpleandproto::Foo.2"** %4, align 4
...
; <label>:9:                                      ; preds = %2
  %10 = load %"class.simpleandproto::Foo.2"*, %"class.simpleandproto::Foo.2"** %3, align 4
  call x86_thiscallcc void @"\01?InternalSwap@Foo@simpleandproto@@AAEXPAV12@@Z"(%"class.simpleandproto::Foo.2"* %5, %"class.simpleandproto::Foo.2"* %10)
  br label %11
...
; Function Attrs: noinline optnone
define x86_thiscallcc void @"\01?InternalSwap@Foo@simpleandproto@@AAEXPAV12@@Z"(%"class.simpleandproto::Foo.2"*, %"class.simpleandproto::Foo.2"*) #0 align 2 {
  %3 = alloca %"class.simpleandproto::Foo.2"*, align 4
  %4 = alloca %"class.simpleandproto::Foo.2"*, align 4
  store %"class.simpleandproto::Foo.2"* %1, %"class.simpleandproto::Foo.2"** %3, align 4
  store %"class.simpleandproto::Foo.2"* %0, %"class.simpleandproto::Foo.2"** %4, align 4
  %5 = load %"class.simpleandproto::Foo.2"*, %"class.simpleandproto::Foo.2"** %4, align 4
  %6 = load %"class.simpleandproto::Foo.2"*, %"class.simpleandproto::Foo.2"** %3, align 4
  %7 = getelementptr inbounds %"class.simpleandproto::Foo.2", %"class.simpleandproto::Foo.2"* %6, i32 0, i32 2
  %8 = getelementptr inbounds %"class.simpleandproto::Foo.2", %"class.simpleandproto::Foo.2"* %5, i32 0, i32 2
  call void @"\01??$swap@HX@std@@YAXAAH0@Z"(i32* dereferenceable(4) %8, i32* dereferenceable(4) %7) #10
  %9 = load %"class.simpleandproto::Foo.2"*, %"class.simpleandproto::Foo.2"** %3, align 4
  %10 = getelementptr inbounds %"class.simpleandproto::Foo.2", %"class.simpleandproto::Foo.2"* %9, i32 0, i32 3
  %11 = getelementptr inbounds %"class.simpleandproto::Foo.2", %"class.simpleandproto::Foo.2"* %5, i32 0, i32 3
  call void @"\01??$swap@MX@std@@YAXAAM0@Z"(float* dereferenceable(4) %11, float* dereferenceable(4) %10) #10
  %12 = getelementptr inbounds %"class.simpleandproto::Foo.2", %"class.simpleandproto::Foo.2"* %5, i32 0, i32 1
  %13 = bitcast %"class.google::protobuf::internal::InternalMetadataWithArena"* %12 to %struct._iobuf*
  %14 = load %"class.simpleandproto::Foo.2"*, %"class.simpleandproto::Foo.2"** %3, align 4
  %15 = getelementptr inbounds %"class.simpleandproto::Foo.2", %"class.simpleandproto::Foo.2"* %14, i32 0, i32 1
  ...
  %16 = load %"class.simpleandproto::Foo.2"*, %"class.simpleandproto::Foo.2"** %3, align 4
  %17 = getelementptr inbounds %"class.simpleandproto::Foo.2", %"class.simpleandproto::Foo.2"* %16, i32 0, i32 4
  %18 = getelementptr inbounds %"class.simpleandproto::Foo.2", %"class.simpleandproto::Foo.2"* %5, i32 0, i32 4
