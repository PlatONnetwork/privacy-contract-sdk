...
$"\01??$down_cast@PBVFoo@sample@@$$CBVMessageLite@protobuf@google@@@internal@protobuf@google@@YAPBVFoo@sample@@PBVMessageLite@12@@Z" = comdat any
...
$"\01??$OwnInternal@VFoo@sample@@@Arena@protobuf@google@@AAEXPAVFoo@sample@@U?$integral_constant@_N$0A@@internal@12@@Z" = comdat any

$"\01??$arena_delete_object@VFoo@sample@@@internal@protobuf@google@@YAXPAX@Z" = comdat any
...
$"\01??$down_cast@PBVBar@sample@@$$CBVMessageLite@protobuf@google@@@internal@protobuf@google@@YAPBVBar@sample@@PBVMessageLite@12@@Z" = comdat any

$"\01?set_f@Bar@sample@@QAEXM@Z" = comdat any

$"\01??$Own@VBar@sample@@@Arena@protobuf@google@@QAEXPAVBar@sample@@@Z" = comdat any

$"\01??$OwnInternal@VBar@sample@@@Arena@protobuf@google@@AAEXPAVBar@sample@@U?$integral_constant@_N$0A@@internal@12@@Z" = comdat any

$"\01??$arena_delete_object@VBar@sample@@@internal@protobuf@google@@YAXPAX@Z" = comdat any
...
$"\01??$down_cast@PBVPoint@sample@@$$CBVMessageLite@protobuf@google@@@internal@protobuf@google@@YAPBVPoint@sample@@PBVMessageLite@12@@Z" = comdat any

$"\01??$Own@VPoint@sample@@@Arena@protobuf@google@@QAEXPAVPoint@sample@@@Z" = comdat any

$"\01??$OwnInternal@VPoint@sample@@@Arena@protobuf@google@@AAEXPAVPoint@sample@@U?$integral_constant@_N$0A@@internal@12@@Z" = comdat any

$"\01??$arena_delete_object@VPoint@sample@@@internal@protobuf@google@@YAXPAX@Z" = comdat any
...
$"\01??$down_cast@PBVPoints@sample@@$$CBVMessageLite@protobuf@google@@@internal@protobuf@google@@YAPBVPoints@sample@@PBVMessageLite@12@@Z" = comdat any
...
$"\01??$OwnInternal@VPoints@sample@@@Arena@protobuf@google@@AAEXPAVPoints@sample@@U?$integral_constant@_N$0A@@internal@12@@Z" = comdat any

$"\01??$arena_delete_object@VPoints@sample@@@internal@protobuf@google@@YAXPAX@Z" = comdat any
...
@"\01?once@?1??InitDefaultsFoo@protobuf_SamplesLite_2eproto@@YAXXZ@4HA" = internal global i32 0, align 4
...
@2 = private unnamed_addr constant { [18 x i8*] } { [18 x i8*] [i8* bitcast (%rtti.CompleteObjectLocator* @"\01??_R4Foo@sample@@6B@" to i8*), i8* bitcast (i8* (%"class.sample::Foo.13"*, i32)* @"\01??_GFoo@sample@@UAEPAXI@Z" to i8*), i8* bitcast (void (%"class.sample::Foo.13"*, %"class.std::basic_string"*)* @"\01?GetTypeName@Foo@sample@@UBE?AV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@XZ" to i8*), i8* bitcast (%"class.sample::Foo.13"* (%"class.sample::Foo.13"*, %"class.google::protobuf::Arena"*)* @"\01?New@Foo@sample@@UBEPAV12@PAVArena@protobuf@google@@@Z" to i8*), i8* bitcast (%"class.sample::Foo.13"* (%"class.sample::Foo.13"*)* @"\01?New@Foo@sample@@UBEPAV12@XZ" to i8*), i8* bitcast (%"class.google::protobuf::Arena"* (%"class.google::protobuf::MessageLite"*)* @"\01?GetArena@MessageLite@protobuf@google@@UBEPAVArena@23@XZ" to i8*), i8* bitcast (i8* (%"class.google::protobuf::MessageLite"*)* @"\01?GetMaybeArenaPointer@MessageLite@protobuf@google@@UBEPAXXZ" to i8*), i8* bitcast (void (%"class.sample::Foo.13"*)* @"\01?Clear@Foo@sample@@UAEXXZ" to i8*), i8* bitcast (i1 (%"class.sample::Foo.13"*)* @"\01?IsInitialized@Foo@sample@@UBE_NXZ" to i8*), i8* bitcast (void (%"class.google::protobuf::MessageLite"*, %"class.std::basic_string"*)* @"\01?InitializationErrorString@MessageLite@protobuf@google@@UBE?AV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@XZ" to i8*), i8* bitcast (void (%"class.sample::Foo.13"*, %"class.google::protobuf::MessageLite"*)* @"\01?CheckTypeAndMergeFrom@Foo@sample@@UAEXABVMessageLite@protobuf@google@@@Z" to i8*), i8* bitcast (i1 (%"class.sample::Foo.13"*, %"class.google::protobuf::io::CodedInputStream"*)* @"\01?MergePartialFromCodedStream@Foo@sample@@UAE_NPAVCodedInputStream@io@protobuf@google@@@Z" to i8*), i8* bitcast (i32 (%"class.sample::Foo.13"*)* @"\01?ByteSizeLong@Foo@sample@@UBEIXZ" to i8*), i8* bitcast (void (%"class.sample::Foo.13"*, %"class.google::protobuf::io::CodedOutputStream"*)* @"\01?SerializeWithCachedSizes@Foo@sample@@UBEXPAVCodedOutputStream@io@protobuf@google@@@Z" to i8*), i8* bitcast (i8* (%"class.google::protobuf::MessageLite"*, i8*)* @"\01?SerializeWithCachedSizesToArray@MessageLite@protobuf@google@@UBEPAEPAE@Z" to i8*), i8* bitcast (i32 (%"class.sample::Foo.13"*)* @"\01?GetCachedSize@Foo@sample@@UBEHXZ" to i8*), i8* bitcast (i8* (%"class.google::protobuf::MessageLite"*, i1, i8*)* @"\01?InternalSerializeWithCachedSizesToArray@MessageLite@protobuf@google@@UBEPAE_NPAE@Z" to i8*), i8* bitcast (i8* (%"class.google::protobuf::MessageLite"*)* @"\01?InternalGetTable@MessageLite@protobuf@google@@EBEPBXXZ" to i8*)] }, comdat($"\01??_7Foo@sample@@6B@")
...
@"\01??_R3Foo@sample@@8" = linkonce_odr constant %rtti.ClassHierarchyDescriptor { i32 0, i32 0, i32 2, %rtti.BaseClassDescriptor** getelementptr inbounds ([3 x %rtti.BaseClassDescriptor*], [3 x %rtti.BaseClassDescriptor*]* @"\01??_R2Foo@sample@@8", i32 0, i32 0) }, comdat
@"\01??_R2Foo@sample@@8" = linkonce_odr constant [3 x %rtti.BaseClassDescriptor*] [%rtti.BaseClassDescriptor* @"\01??_R1A@?0A@EA@Foo@sample@@8", %rtti.BaseClassDescriptor* @"\01??_R1A@?0A@EA@MessageLite@protobuf@google@@8", %rtti.BaseClassDescriptor* null], comdat
@"\01??_R1A@?0A@EA@Foo@sample@@8" = linkonce_odr constant %rtti.BaseClassDescriptor { i8* bitcast (%rtti.TypeDescriptor16* @"\01??_R0?AVFoo@sample@@@8" to i8*), i32 1, i32 0, i32 -1, i32 0, i32 64, %rtti.ClassHierarchyDescriptor* @"\01??_R3Foo@sample@@8" }, comdat
...
@"\01?once@?1??InitDefaultsBar@protobuf_SamplesLite_2eproto@@YAXXZ@4HA" = internal global i32 0, align 4
@4 = private unnamed_addr constant { [18 x i8*] } { [18 x i8*] [i8* bitcast (%rtti.CompleteObjectLocator* @"\01??_R4Bar@sample@@6B@" to i8*), i8* bitcast (i8* (%"class.sample::Bar.23"*, i32)* @"\01??_GBar@sample@@UAEPAXI@Z" to i8*), i8* bitcast (void (%"class.sample::Bar.23"*, %"class.std::basic_string"*)* @"\01?GetTypeName@Bar@sample@@UBE?AV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@XZ" to i8*), i8* bitcast (%"class.sample::Bar.23"* (%"class.sample::Bar.23"*, %"class.google::protobuf::Arena"*)* @"\01?New@Bar@sample@@UBEPAV12@PAVArena@protobuf@google@@@Z" to i8*), i8* bitcast (%"class.sample::Bar.23"* (%"class.sample::Bar.23"*)* @"\01?New@Bar@sample@@UBEPAV12@XZ" to i8*), i8* bitcast (%"class.google::protobuf::Arena"* (%"class.google::protobuf::MessageLite"*)* @"\01?GetArena@MessageLite@protobuf@google@@UBEPAVArena@23@XZ" to i8*), i8* bitcast (i8* (%"class.google::protobuf::MessageLite"*)* @"\01?GetMaybeArenaPointer@MessageLite@protobuf@google@@UBEPAXXZ" to i8*), i8* bitcast (void (%"class.sample::Bar.23"*)* @"\01?Clear@Bar@sample@@UAEXXZ" to i8*), i8* bitcast (i1 (%"class.sample::Bar.23"*)* @"\01?IsInitialized@Bar@sample@@UBE_NXZ" to i8*), i8* bitcast (void (%"class.google::protobuf::MessageLite"*, %"class.std::basic_string"*)* @"\01?InitializationErrorString@MessageLite@protobuf@google@@UBE?AV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@XZ" to i8*), i8* bitcast (void (%"class.sample::Bar.23"*, %"class.google::protobuf::MessageLite"*)* @"\01?CheckTypeAndMergeFrom@Bar@sample@@UAEXABVMessageLite@protobuf@google@@@Z" to i8*), i8* bitcast (i1 (%"class.sample::Bar.23"*, %"class.google::protobuf::io::CodedInputStream"*)* @"\01?MergePartialFromCodedStream@Bar@sample@@UAE_NPAVCodedInputStream@io@protobuf@google@@@Z" to i8*), i8* bitcast (i32 (%"class.sample::Bar.23"*)* @"\01?ByteSizeLong@Bar@sample@@UBEIXZ" to i8*), i8* bitcast (void (%"class.sample::Bar.23"*, %"class.google::protobuf::io::CodedOutputStream"*)* @"\01?SerializeWithCachedSizes@Bar@sample@@UBEXPAVCodedOutputStream@io@protobuf@google@@@Z" to i8*), i8* bitcast (i8* (%"class.google::protobuf::MessageLite"*, i8*)* @"\01?SerializeWithCachedSizesToArray@MessageLite@protobuf@google@@UBEPAEPAE@Z" to i8*), i8* bitcast (i32 (%"class.sample::Bar.23"*)* @"\01?GetCachedSize@Bar@sample@@UBEHXZ" to i8*), i8* bitcast (i8* (%"class.google::protobuf::MessageLite"*, i1, i8*)* @"\01?InternalSerializeWithCachedSizesToArray@MessageLite@protobuf@google@@UBEPAE_NPAE@Z" to i8*), i8* bitcast (i8* (%"class.google::protobuf::MessageLite"*)* @"\01?InternalGetTable@MessageLite@protobuf@google@@EBEPBXXZ" to i8*)] }, comdat($"\01??_7Bar@sample@@6B@")
...
@"\01??_R3Bar@sample@@8" = linkonce_odr constant %rtti.ClassHierarchyDescriptor { i32 0, i32 0, i32 2, %rtti.BaseClassDescriptor** getelementptr inbounds ([3 x %rtti.BaseClassDescriptor*], [3 x %rtti.BaseClassDescriptor*]* @"\01??_R2Bar@sample@@8", i32 0, i32 0) }, comdat
@"\01??_R2Bar@sample@@8" = linkonce_odr constant [3 x %rtti.BaseClassDescriptor*] [%rtti.BaseClassDescriptor* @"\01??_R1A@?0A@EA@Bar@sample@@8", %rtti.BaseClassDescriptor* @"\01??_R1A@?0A@EA@MessageLite@protobuf@google@@8", %rtti.BaseClassDescriptor* null], comdat
@"\01??_R1A@?0A@EA@Bar@sample@@8" = linkonce_odr constant %rtti.BaseClassDescriptor { i8* bitcast (%rtti.TypeDescriptor16* @"\01??_R0?AVBar@sample@@@8" to i8*), i32 1, i32 0, i32 -1, i32 0, i32 64, %rtti.ClassHierarchyDescriptor* @"\01??_R3Bar@sample@@8" }, comdat
@"\01?once@?1??InitDefaultsPoint@protobuf_SamplesLite_2eproto@@YAXXZ@4HA" = internal global i32 0, align 4
@5 = private unnamed_addr constant { [18 x i8*] } { [18 x i8*] [i8* bitcast (%rtti.CompleteObjectLocator* @"\01??_R4Point@sample@@6B@" to i8*), i8* bitcast (i8* (%"class.sample::Point.24"*, i32)* @"\01??_GPoint@sample@@UAEPAXI@Z" to i8*), i8* bitcast (void (%"class.sample::Point.24"*, %"class.std::basic_string"*)* @"\01?GetTypeName@Point@sample@@UBE?AV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@XZ" to i8*), i8* bitcast (%"class.sample::Point.24"* (%"class.sample::Point.24"*, %"class.google::protobuf::Arena"*)* @"\01?New@Point@sample@@UBEPAV12@PAVArena@protobuf@google@@@Z" to i8*), i8* bitcast (%"class.sample::Point.24"* (%"class.sample::Point.24"*)* @"\01?New@Point@sample@@UBEPAV12@XZ" to i8*), i8* bitcast (%"class.google::protobuf::Arena"* (%"class.google::protobuf::MessageLite"*)* @"\01?GetArena@MessageLite@protobuf@google@@UBEPAVArena@23@XZ" to i8*), i8* bitcast (i8* (%"class.google::protobuf::MessageLite"*)* @"\01?GetMaybeArenaPointer@MessageLite@protobuf@google@@UBEPAXXZ" to i8*), i8* bitcast (void (%"class.sample::Point.24"*)* @"\01?Clear@Point@sample@@UAEXXZ" to i8*), i8* bitcast (i1 (%"class.sample::Point.24"*)* @"\01?IsInitialized@Point@sample@@UBE_NXZ" to i8*), i8* bitcast (void (%"class.google::protobuf::MessageLite"*, %"class.std::basic_string"*)* @"\01?InitializationErrorString@MessageLite@protobuf@google@@UBE?AV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@XZ" to i8*), i8* bitcast (void (%"class.sample::Point.24"*, %"class.google::protobuf::MessageLite"*)* @"\01?CheckTypeAndMergeFrom@Point@sample@@UAEXABVMessageLite@protobuf@google@@@Z" to i8*), i8* bitcast (i1 (%"class.sample::Point.24"*, %"class.google::protobuf::io::CodedInputStream"*)* @"\01?MergePartialFromCodedStream@Point@sample@@UAE_NPAVCodedInputStream@io@protobuf@google@@@Z" to i8*), i8* bitcast (i32 (%"class.sample::Point.24"*)* @"\01?ByteSizeLong@Point@sample@@UBEIXZ" to i8*), i8* bitcast (void (%"class.sample::Point.24"*, %"class.google::protobuf::io::CodedOutputStream"*)* @"\01?SerializeWithCachedSizes@Point@sample@@UBEXPAVCodedOutputStream@io@protobuf@google@@@Z" to i8*), i8* bitcast (i8* (%"class.google::protobuf::MessageLite"*, i8*)* @"\01?SerializeWithCachedSizesToArray@MessageLite@protobuf@google@@UBEPAEPAE@Z" to i8*), i8* bitcast (i32 (%"class.sample::Point.24"*)* @"\01?GetCachedSize@Point@sample@@UBEHXZ" to i8*), i8* bitcast (i8* (%"class.google::protobuf::MessageLite"*, i1, i8*)* @"\01?InternalSerializeWithCachedSizesToArray@MessageLite@protobuf@google@@UBEPAE_NPAE@Z" to i8*), i8* bitcast (i8* (%"class.google::protobuf::MessageLite"*)* @"\01?InternalGetTable@MessageLite@protobuf@google@@EBEPBXXZ" to i8*)] }, comdat($"\01??_7Point@sample@@6B@")
...
@"\01??_R3Point@sample@@8" = linkonce_odr constant %rtti.ClassHierarchyDescriptor { i32 0, i32 0, i32 2, %rtti.BaseClassDescriptor** getelementptr inbounds ([3 x %rtti.BaseClassDescriptor*], [3 x %rtti.BaseClassDescriptor*]* @"\01??_R2Point@sample@@8", i32 0, i32 0) }, comdat
@"\01??_R2Point@sample@@8" = linkonce_odr constant [3 x %rtti.BaseClassDescriptor*] [%rtti.BaseClassDescriptor* @"\01??_R1A@?0A@EA@Point@sample@@8", %rtti.BaseClassDescriptor* @"\01??_R1A@?0A@EA@MessageLite@protobuf@google@@8", %rtti.BaseClassDescriptor* null], comdat
@"\01??_R1A@?0A@EA@Point@sample@@8" = linkonce_odr constant %rtti.BaseClassDescriptor { i8* bitcast (%rtti.TypeDescriptor18* @"\01??_R0?AVPoint@sample@@@8" to i8*), i32 1, i32 0, i32 -1, i32 0, i32 64, %rtti.ClassHierarchyDescriptor* @"\01??_R3Point@sample@@8" }, comdat
@"\01?once@?1??InitDefaultsPoints@protobuf_SamplesLite_2eproto@@YAXXZ@4HA" = internal global i32 0, align 4
@6 = private unnamed_addr constant { [18 x i8*] } { [18 x i8*] [i8* bitcast (%rtti.CompleteObjectLocator* @"\01??_R4Points@sample@@6B@" to i8*), i8* bitcast (i8* (%"class.sample::Points.25"*, i32)* @"\01??_GPoints@sample@@UAEPAXI@Z" to i8*), i8* bitcast (void (%"class.sample::Points.25"*, %"class.std::basic_string"*)* @"\01?GetTypeName@Points@sample@@UBE?AV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@XZ" to i8*), i8* bitcast (%"class.sample::Points.25"* (%"class.sample::Points.25"*, %"class.google::protobuf::Arena"*)* @"\01?New@Points@sample@@UBEPAV12@PAVArena@protobuf@google@@@Z" to i8*), i8* bitcast (%"class.sample::Points.25"* (%"class.sample::Points.25"*)* @"\01?New@Points@sample@@UBEPAV12@XZ" to i8*), i8* bitcast (%"class.google::protobuf::Arena"* (%"class.google::protobuf::MessageLite"*)* @"\01?GetArena@MessageLite@protobuf@google@@UBEPAVArena@23@XZ" to i8*), i8* bitcast (i8* (%"class.google::protobuf::MessageLite"*)* @"\01?GetMaybeArenaPointer@MessageLite@protobuf@google@@UBEPAXXZ" to i8*), i8* bitcast (void (%"class.sample::Points.25"*)* @"\01?Clear@Points@sample@@UAEXXZ" to i8*), i8* bitcast (i1 (%"class.sample::Points.25"*)* @"\01?IsInitialized@Points@sample@@UBE_NXZ" to i8*), i8* bitcast (void (%"class.google::protobuf::MessageLite"*, %"class.std::basic_string"*)* @"\01?InitializationErrorString@MessageLite@protobuf@google@@UBE?AV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@XZ" to i8*), i8* bitcast (void (%"class.sample::Points.25"*, %"class.google::protobuf::MessageLite"*)* @"\01?CheckTypeAndMergeFrom@Points@sample@@UAEXABVMessageLite@protobuf@google@@@Z" to i8*), i8* bitcast (i1 (%"class.sample::Points.25"*, %"class.google::protobuf::io::CodedInputStream"*)* @"\01?MergePartialFromCodedStream@Points@sample@@UAE_NPAVCodedInputStream@io@protobuf@google@@@Z" to i8*), i8* bitcast (i32 (%"class.sample::Points.25"*)* @"\01?ByteSizeLong@Points@sample@@UBEIXZ" to i8*), i8* bitcast (void (%"class.sample::Points.25"*, %"class.google::protobuf::io::CodedOutputStream"*)* @"\01?SerializeWithCachedSizes@Points@sample@@UBEXPAVCodedOutputStream@io@protobuf@google@@@Z" to i8*), i8* bitcast (i8* (%"class.google::protobuf::MessageLite"*, i8*)* @"\01?SerializeWithCachedSizesToArray@MessageLite@protobuf@google@@UBEPAEPAE@Z" to i8*), i8* bitcast (i32 (%"class.sample::Points.25"*)* @"\01?GetCachedSize@Points@sample@@UBEHXZ" to i8*), i8* bitcast (i8* (%"class.google::protobuf::MessageLite"*, i1, i8*)* @"\01?InternalSerializeWithCachedSizesToArray@MessageLite@protobuf@google@@UBEPAE_NPAE@Z" to i8*), i8* bitcast (i8* (%"class.google::protobuf::MessageLite"*)* @"\01?InternalGetTable@MessageLite@protobuf@google@@EBEPBXXZ" to i8*)] }, comdat($"\01??_7Points@sample@@6B@")
...
@"\01??_R3Points@sample@@8" = linkonce_odr constant %rtti.ClassHierarchyDescriptor { i32 0, i32 0, i32 2, %rtti.BaseClassDescriptor** getelementptr inbounds ([3 x %rtti.BaseClassDescriptor*], [3 x %rtti.BaseClassDescriptor*]* @"\01??_R2Points@sample@@8", i32 0, i32 0) }, comdat
@"\01??_R2Points@sample@@8" = linkonce_odr constant [3 x %rtti.BaseClassDescriptor*] [%rtti.BaseClassDescriptor* @"\01??_R1A@?0A@EA@Points@sample@@8", %rtti.BaseClassDescriptor* @"\01??_R1A@?0A@EA@MessageLite@protobuf@google@@8", %rtti.BaseClassDescriptor* null], comdat
@"\01??_R1A@?0A@EA@Points@sample@@8" = linkonce_odr constant %rtti.BaseClassDescriptor { i8* bitcast (%rtti.TypeDescriptor19* @"\01??_R0?AVPoints@sample@@@8" to i8*), i32 1, i32 0, i32 -1, i32 0, i32 64, %rtti.ClassHierarchyDescriptor* @"\01??_R3Points@sample@@8" }, comdat
...
; <label>:40:                                     ; preds = %36
  ...
  %41 = invoke x86_thiscallcc %"class.sample::Foo"* bitcast (%"class.sample::Foo.13"* (%"class.sample::Foo.13"*)* @"\01??0Foo@sample@@QAE@XZ" to %"class.sample::Foo"* (%"class.sample::Foo"*)*)(%"class.sample::Foo"* %0)
...
; <label>:81:                                     ; preds = %61
  call x86_thiscallcc void bitcast (void (%"class.sample::Foo.13"*)* @"\01??1Foo@sample@@UAE@XZ" to void (%"class.sample::Foo"*)*)(%"class.sample::Foo"* %0) #9
  br label %82
...
; <label>:83:                                     ; preds = %79, %45, %44, %42
  %84 = cleanuppad within none []
  call x86_thiscallcc void bitcast (void (%"class.sample::Foo.13"*)* @"\01??1Foo@sample@@UAE@XZ" to void (%"class.sample::Foo"*)*)(%"class.sample::Foo"* %0) #9 [ "funclet"(token %84) ]
  cleanupret from %84 unwind label %85
...
; <label>:35:                                     ; preds = %31
  ...
  %36 = invoke x86_thiscallcc %"class.sample::Foo"* bitcast (%"class.sample::Foo.13"* (%"class.sample::Foo.13"*)* @"\01??0Foo@sample@@QAE@XZ" to %"class.sample::Foo"* (%"class.sample::Foo"*)*)(%"class.sample::Foo"* %0)
...
; <label>:76:                                     ; preds = %72, %40, %39, %37
  ...
  call x86_thiscallcc void bitcast (void (%"class.sample::Foo.13"*)* @"\01??1Foo@sample@@UAE@XZ" to void (%"class.sample::Foo"*)*)(%"class.sample::Foo"* %0) #9 [ "funclet"(token %77) ]
...
; <label>:31:                                     ; preds = %27
  ...
  %32 = invoke x86_thiscallcc %"class.sample::Foo"* bitcast (%"class.sample::Foo.13"* (%"class.sample::Foo.13"*)* @"\01??0Foo@sample@@QAE@XZ" to %"class.sample::Foo"* (%"class.sample::Foo"*)*)(%"class.sample::Foo"* %0)
...
; <label>:70:                                     ; preds = %66, %36, %35, %33
  %71 = cleanuppad within none []
  call x86_thiscallcc void bitcast (void (%"class.sample::Foo.13"*)* @"\01??1Foo@sample@@UAE@XZ" to void (%"class.sample::Foo"*)*)(%"class.sample::Foo"* %0) #9 [ "funclet"(token %71) ]
  cleanupret from %71 unwind label %72
...
; <label>:77:                                     ; preds = %75
  ...
  %79 = invoke x86_thiscallcc %"class.sample::Foo"* bitcast (%"class.sample::Foo.13"* (%"class.sample::Foo.13"*)* @"\01??0Foo@sample@@QAE@XZ" to %"class.sample::Foo"* (%"class.sample::Foo"*)*)(%"class.sample::Foo"* %78)
...
; <label>:102:                                    ; preds = %101
  ...
  %103 = invoke x86_thiscallcc %"class.sample::Bar"* bitcast (%"class.sample::Bar.23"* (%"class.sample::Bar.23"*)* @"\01??0Bar@sample@@QAE@XZ" to %"class.sample::Bar"* (%"class.sample::Bar"*)*)(%"class.sample::Bar"* %0)
...
; <label>:132:                                    ; preds = %108
  call x86_thiscallcc void bitcast (void (%"class.sample::Bar.23"*)* @"\01??1Bar@sample@@UAE@XZ" to void (%"class.sample::Bar"*)*)(%"class.sample::Bar"* %0) #9
  br label %133
...
; <label>:134:                                    ; preds = %106, %104
  ...
  call x86_thiscallcc void bitcast (void (%"class.sample::Bar.23"*)* @"\01??1Bar@sample@@UAE@XZ" to void (%"class.sample::Bar"*)*)(%"class.sample::Bar"* %0) #9 [ "funclet"(token %135) ]
...
; <label>:43:                                     ; preds = %41
  ...
  %45 = invoke x86_thiscallcc %"class.sample::Foo"* bitcast (%"class.sample::Foo.13"* (%"class.sample::Foo.13"*)* @"\01??0Foo@sample@@QAE@XZ" to %"class.sample::Foo"* (%"class.sample::Foo"*)*)(%"class.sample::Foo"* %44)
...
; <label>:68:                                     ; preds = %67
  ...
  %69 = invoke x86_thiscallcc %"class.sample::Bar"* bitcast (%"class.sample::Bar.23"* (%"class.sample::Bar.23"*)* @"\01??0Bar@sample@@QAE@XZ" to %"class.sample::Bar"* (%"class.sample::Bar"*)*)(%"class.sample::Bar"* %0)
...
; <label>:98:                                     ; preds = %72, %70
  ...
  call x86_thiscallcc void bitcast (void (%"class.sample::Bar.23"*)* @"\01??1Bar@sample@@UAE@XZ" to void (%"class.sample::Bar"*)*)(%"class.sample::Bar"* %0) #9 [ "funclet"(token %99) ]
...
define void @"\01?ReturnPoints@@YA?AVPoints@sample@@HH@Z"(%"class.sample::Points"* noalias sret, i32, i32) #0 personality i8* bitcast (i32 (...)* @__CxxFrameHandler3 to i8*) {
  ...
  %21 = call x86_thiscallcc %"class.sample::Points"* bitcast (%"class.sample::Points.25"* (%"class.sample::Points.25"*)* @"\01??0Points@sample@@QAE@XZ" to %"class.sample::Points"* (%"class.sample::Points"*)*)(%"class.sample::Points"* %0)
...
; <label>:83:                                     ; preds = %77
  call x86_thiscallcc void bitcast (void (%"class.sample::Points.25"*)* @"\01??1Points@sample@@UAE@XZ" to void (%"class.sample::Points"*)*)(%"class.sample::Points"* %0) #9
  br label %84
...
; <label>:85:                                     ; preds = %81, %29, %26, %23, %3
  %86 = cleanuppad within none []
  call x86_thiscallcc void bitcast (void (%"class.sample::Points.25"*)* @"\01??1Points@sample@@UAE@XZ" to void (%"class.sample::Points"*)*)(%"class.sample::Points"* %0) #9 [ "funclet"(token %86) ]
  cleanupret from %86 unwind to caller
}
...
; <label>:6:                                      ; preds = %1
  ...
  %9 = invoke x86_thiscallcc %"class.sample::Point"* bitcast (%"class.sample::Point.24"* (%"class.sample::Point.24"*)* @"\01??0Point@sample@@QAE@XZ" to %"class.sample::Point"* (%"class.sample::Point"*)*)(%"class.sample::Point"* %8)
...
define linkonce_odr x86_thiscallcc %"class.sample::Point"* @"\01??$CreateInternal@VPoint@sample@@$$V@Arena@protobuf@google@@AAEPAVPoint@sample@@_N@Z"(%"class.google::protobuf::Arena"*, i1 zeroext) #0 comdat align 2 {
  ...
  %11 = call x86_thiscallcc %"class.sample::Point"* bitcast (%"class.sample::Point.24"* (%"class.sample::Point.24"*)* @"\01??0Point@sample@@QAE@XZ" to %"class.sample::Point"* (%"class.sample::Point"*)*)(%"class.sample::Point"* %10)
...
define i32 @PlatON_entry_EuclideanDistance(i8**, i8**, i32*) {
  ...
  call void bitcast (%"class.sample::Point.24"* (%"class.sample::Point.24"*)* @"\01??0Point@sample@@QAE@XZ" to void (%"class.sample::Point"*)*)(%"class.sample::Point"* %4)
  ...
  call void bitcast (%"class.sample::Point.24"* (%"class.sample::Point.24"*)* @"\01??0Point@sample@@QAE@XZ" to void (%"class.sample::Point"*)*)(%"class.sample::Point"* %11)
  ...
  call void bitcast (void (%"class.sample::Point.24"*)* @"\01??1Point@sample@@UAE@XZ" to void (%"class.sample::Point"*)*)(%"class.sample::Point"* %4)
  call void bitcast (void (%"class.sample::Point.24"*)* @"\01??1Point@sample@@UAE@XZ" to void (%"class.sample::Point"*)*)(%"class.sample::Point"* %11)
  ret i32 32
}
...
define i32 @PlatON_entry_TestFooAdd01(i8**, i8**, i32*) {
  ...
  call void bitcast (%"class.sample::Foo.13"* (%"class.sample::Foo.13"*)* @"\01??0Foo@sample@@QAE@XZ" to void (%"class.sample::Foo"*)*)(%"class.sample::Foo"* %5)
  ...
  call void bitcast (%"class.sample::Foo.13"* (%"class.sample::Foo.13"*)* @"\01??0Foo@sample@@QAE@XZ" to void (%"class.sample::Foo"*)*)(%"class.sample::Foo"* %12)
  ...
  %20 = call i64 bitcast (i32 (%"class.sample::Foo.13"*)* @"\01?ByteSizeLong@Foo@sample@@UBEIXZ" to i64 (%"class.sample::Foo"*)*)(%"class.sample::Foo"* %4)
  ...
  call void bitcast (void (%"class.sample::Foo.13"*)* @"\01??1Foo@sample@@UAE@XZ" to void (%"class.sample::Foo"*)*)(%"class.sample::Foo"* %4)
  call void bitcast (void (%"class.sample::Foo.13"*)* @"\01??1Foo@sample@@UAE@XZ" to void (%"class.sample::Foo"*)*)(%"class.sample::Foo"* %5)
  call void bitcast (void (%"class.sample::Foo.13"*)* @"\01??1Foo@sample@@UAE@XZ" to void (%"class.sample::Foo"*)*)(%"class.sample::Foo"* %12)
  ret i32 %21
}
...
define i32 @PlatON_entry_TestBarAdd01(i8**, i8**, i32*) {
  ...
  call void bitcast (%"class.sample::Bar.23"* (%"class.sample::Bar.23"*)* @"\01??0Bar@sample@@QAE@XZ" to void (%"class.sample::Bar"*)*)(%"class.sample::Bar"* %5)
  ...
  call void bitcast (%"class.sample::Bar.23"* (%"class.sample::Bar.23"*)* @"\01??0Bar@sample@@QAE@XZ" to void (%"class.sample::Bar"*)*)(%"class.sample::Bar"* %12)
  ...
  %20 = call i64 bitcast (i32 (%"class.sample::Bar.23"*)* @"\01?ByteSizeLong@Bar@sample@@UBEIXZ" to i64 (%"class.sample::Bar"*)*)(%"class.sample::Bar"* %4)
  %21 = trunc i64 %20 to i32
  %22 = call i8* @malloc(i64 %20)
  store i8* %22, i8** %0
  %23 = call i1 @"\01?SerializeToArray@MessageLite@protobuf@google@@QBE_NPAXH@Z"(%"class.google::protobuf::MessageLite"* %19, i8* %22, i32 %21)
  call void bitcast (void (%"class.sample::Bar.23"*)* @"\01??1Bar@sample@@UAE@XZ" to void (%"class.sample::Bar"*)*)(%"class.sample::Bar"* %4)
  call void bitcast (void (%"class.sample::Bar.23"*)* @"\01??1Bar@sample@@UAE@XZ" to void (%"class.sample::Bar"*)*)(%"class.sample::Bar"* %5)
  call void bitcast (void (%"class.sample::Bar.23"*)* @"\01??1Bar@sample@@UAE@XZ" to void (%"class.sample::Bar"*)*)(%"class.sample::Bar"* %12)
  ret i32 %21
}
...
define i32 @PlatON_entry_ReturnPoints(i8**, i8**, i32*) {
  ...
  %20 = call i64 bitcast (i32 (%"class.sample::Points.25"*)* @"\01?ByteSizeLong@Points@sample@@UBEIXZ" to i64 (%"class.sample::Points"*)*)(%"class.sample::Points"* %4)
  %21 = trunc i64 %20 to i32
  %22 = call i8* @malloc(i64 %20)
  store i8* %22, i8** %0
  %23 = call i1 @"\01?SerializeToArray@MessageLite@protobuf@google@@QBE_NPAXH@Z"(%"class.google::protobuf::MessageLite"* %19, i8* %22, i32 %21)
  call void bitcast (void (%"class.sample::Points.25"*)* @"\01??1Points@sample@@UAE@XZ" to void (%"class.sample::Points"*)*)(%"class.sample::Points"* %4)
  ret i32 %21
}
...
define void @"\01?InitDefaultsFooImpl@protobuf_SamplesLite_2eproto@@YAXXZ"() #0 {
  %1 = alloca i8*, align 4
  call void @"\01?VerifyVersion@internal@protobuf@google@@YAXHHPBD@Z"(i32 3005001, i32 3005000, i8* getelementptr inbounds ([73 x i8], [73 x i8]* @"\01??_C@_0EJ@KDOHDODM@E?3?2work?2local?2private?9contract?9s@", i32 0, i32 0))
  ...
  %4 = call x86_thiscallcc %"class.sample::Foo.13"* @"\01??0Foo@sample@@QAE@XZ"(%"class.sample::Foo.13"* %3)
...
; Function Attrs: noinline optnone
define x86_thiscallcc %"class.sample::Foo.13"* @"\01??0Foo@sample@@QAE@XZ"(%"class.sample::Foo.13"* returned) unnamed_addr #0 align 2 personality i8* bitcast (i32 (...)* @__CxxFrameHandler3 to i8*) {
  %2 = alloca %"class.sample::Foo.13"*, align 4
  %3 = alloca %"class.sample::Foo.13"*, align 4
  store %"class.sample::Foo.13"* %0, %"class.sample::Foo.13"** %3, align 4
  %4 = load %"class.sample::Foo.13"*, %"class.sample::Foo.13"** %3, align 4
  store %"class.sample::Foo.13"* %4, %"class.sample::Foo.13"** %2, align 4
...
; <label>:10:                                     ; preds = %1
  ...
  %12 = invoke %"class.sample::Foo.13"* @"\01?internal_default_instance@Foo@sample@@SAPBV12@XZ"()
...
; <label>:17:                                     ; preds = %16, %13
  invoke x86_thiscallcc void @"\01?SharedCtor@Foo@sample@@AAEXXZ"(%"class.sample::Foo.13"* %4)
          to label %18 unwind label %20

; <label>:18:                                     ; preds = %17
  %19 = load %"class.sample::Foo.13"*, %"class.sample::Foo.13"** %2, align 4
  ret %"class.sample::Foo.13"* %19

; <label>:20:                                     ; preds = %17, %15, %10
  %21 = cleanuppad within none []
  call x86_thiscallcc void @"\01??1InternalMetadataWithArenaLite@internal@protobuf@google@@QAE@XZ"(%"class.google::protobuf::internal::InternalMetadataWithArena"* %8) #9 [ "funclet"(token %21) ]
...
; <label>:22:                                     ; preds = %20, %1
  ...
  call x86_thiscallcc void @"\01??1MessageLite@protobuf@google@@UAE@XZ"(%"class.google::protobuf::MessageLite"* %24) #9 [ "funclet"(token %23) ]
...
define linkonce_odr x86_thiscallcc %"class.google::protobuf::internal::InternalMetadataWithArena"* @"\01??0InternalMetadataWithArenaLite@internal@protobuf@google@@QAE@PAVArena@23@@Z"(%"class.google::protobuf::internal::InternalMetadataWithArena"* returned, %"class.google::protobuf::Arena"*) unnamed_addr #0 comdat align 2 {
  ...
  %8 = call x86_thiscallcc %struct._iobuf* @"\01??0?$InternalMetadataWithArenaBase@V?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@VInternalMetadataWithArenaLite@internal@protobuf@google@@@internal@protobuf@google@@QAE@PAVArena@23@@Z"(%struct._iobuf* %6, %"class.google::protobuf::Arena"* %7)
  ret %"class.google::protobuf::internal::InternalMetadataWithArena"* %5
}

; Function Attrs: noinline nounwind optnone
define linkonce_odr %"class.sample::Foo.13"* @"\01?internal_default_instance@Foo@sample@@SAPBV12@XZ"() #3 comdat align 2 {
...
define void @"\01?InitDefaultsFoo@protobuf_SamplesLite_2eproto@@YAXXZ"() #0 {
  call void @"\01?GoogleOnceInit@protobuf@google@@YAXPAHP6AXXZ@Z"(i32* @"\01?once@?1??InitDefaultsFoo@protobuf_SamplesLite_2eproto@@YAXXZ@4HA", void ()* @"\01?InitDefaultsFooImpl@protobuf_SamplesLite_2eproto@@YAXXZ")
  ret void
}

; Function Attrs: noinline optnone
define x86_thiscallcc void @"\01?SharedCtor@Foo@sample@@AAEXXZ"(%"class.sample::Foo.13"*) #0 align 2 {
  %2 = alloca %"class.sample::Foo.13"*, align 4
  store %"class.sample::Foo.13"* %0, %"class.sample::Foo.13"** %2, align 4
  %3 = load %"class.sample::Foo.13"*, %"class.sample::Foo.13"** %2, align 4
...
; Function Attrs: noinline nounwind optnone
define linkonce_odr x86_thiscallcc void @"\01??1InternalMetadataWithArenaLite@internal@protobuf@google@@QAE@XZ"(%"class.google::protobuf::internal::InternalMetadataWithArena"*) unnamed_addr #3 comdat align 2 {
  ...
  call x86_thiscallcc void @"\01??1?$InternalMetadataWithArenaBase@V?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@VInternalMetadataWithArenaLite@internal@protobuf@google@@@internal@protobuf@google@@QAE@XZ"(%struct._iobuf* %4) #9
  ret void
}
...
; Function Attrs: noinline nounwind optnone
define linkonce_odr x86_thiscallcc void @"\01??1?$InternalMetadataWithArenaBase@V?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@VInternalMetadataWithArenaLite@internal@protobuf@google@@@internal@protobuf@google@@QAE@XZ"(%struct._iobuf*) unnamed_addr #3 comdat align 2 personality i8* bitcast (i32 (...)* @__CxxFrameHandler3 to i8*) {
  %2 = alloca %struct._iobuf*, align 4
  store %struct._iobuf* %0, %struct._iobuf** %2, align 4
  %3 = load %struct._iobuf*, %struct._iobuf** %2, align 4
  %4 = invoke x86_thiscallcc zeroext i1 @"\01?have_unknown_fields@?$InternalMetadataWithArenaBase@V?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@VInternalMetadataWithArenaLite@internal@protobuf@google@@@internal@protobuf@google@@QBE_NXZ"(%struct._iobuf* %3)
...
; <label>:6:                                      ; preds = %5
  %7 = invoke x86_thiscallcc %"class.google::protobuf::Arena"* @"\01?arena@?$InternalMetadataWithArenaBase@V?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@VInternalMetadataWithArenaLite@internal@protobuf@google@@@internal@protobuf@google@@QBEPAVArena@34@XZ"(%struct._iobuf* %3)
...
; <label>:14:                                     ; preds = %12
  call x86_thiscallcc void @"\01??1Container@?$InternalMetadataWithArenaBase@V?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@VInternalMetadataWithArenaLite@internal@protobuf@google@@@internal@protobuf@google@@QAE@XZ"(%"struct.google::protobuf::internal::InternalMetadataWithArenaBase<std::basic_string<char, std::char_traits<char>, std::allocator<char> >, google::protobuf::internal::InternalMetadataWithArenaLite>::Container"* %11) #9
...
; Function Attrs: noinline optnone
define linkonce_odr x86_thiscallcc zeroext i1 @"\01?have_unknown_fields@?$InternalMetadataWithArenaBase@V?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@VInternalMetadataWithArenaLite@internal@protobuf@google@@@internal@protobuf@google@@QBE_NXZ"(%struct._iobuf*) #0 comdat align 2 {
  %2 = alloca %struct._iobuf*, align 4
  store %struct._iobuf* %0, %struct._iobuf** %2, align 4
  %3 = load %struct._iobuf*, %struct._iobuf** %2, align 4
  %4 = call x86_thiscallcc i32 @"\01?PtrTag@?$InternalMetadataWithArenaBase@V?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@VInternalMetadataWithArenaLite@internal@protobuf@google@@@internal@protobuf@google@@ABEHXZ"(%struct._iobuf* %3)
  %5 = icmp eq i32 %4, 1
  ret i1 %5
}

; Function Attrs: noinline optnone
define linkonce_odr x86_thiscallcc %"class.google::protobuf::Arena"* @"\01?arena@?$InternalMetadataWithArenaBase@V?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@VInternalMetadataWithArenaLite@internal@protobuf@google@@@internal@protobuf@google@@QBEPAVArena@34@XZ"(%struct._iobuf*) #0 comdat align 2 {
  %2 = alloca %"class.google::protobuf::Arena"*, align 4
  %3 = alloca %struct._iobuf*, align 4
  store %struct._iobuf* %0, %struct._iobuf** %3, align 4
  %4 = load %struct._iobuf*, %struct._iobuf** %3, align 4
  %5 = call x86_thiscallcc zeroext i1 @"\01?have_unknown_fields@?$InternalMetadataWithArenaBase@V?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@VInternalMetadataWithArenaLite@internal@protobuf@google@@@internal@protobuf@google@@QBE_NXZ"(%struct._iobuf* %4)
  br i1 %5, label %6, label %10

; <label>:6:                                      ; preds = %1
  %7 = call x86_thiscallcc %"struct.google::protobuf::internal::InternalMetadataWithArenaBase<std::basic_string<char, std::char_traits<char>, std::allocator<char> >, google::protobuf::internal::InternalMetadataWithArenaLite>::Container"* @"\01??$PtrValue@UContainer@?$InternalMetadataWithArenaBase@V?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@VInternalMetadataWithArenaLite@internal@protobuf@google@@@internal@protobuf@google@@@?$InternalMetadataWithArenaBase@V?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@VInternalMetadataWithArenaLite@internal@protobuf@google@@@internal@protobuf@google@@ABEPAUContainer@0123@XZ"(%struct._iobuf* %4)
...
; <label>:10:                                     ; preds = %1
  %11 = call x86_thiscallcc %"class.google::protobuf::Arena"* @"\01??$PtrValue@VArena@protobuf@google@@@?$InternalMetadataWithArenaBase@V?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@VInternalMetadataWithArenaLite@internal@protobuf@google@@@internal@protobuf@google@@ABEPAVArena@23@XZ"(%struct._iobuf* %4)
...
; Function Attrs: noinline nounwind optnone
define linkonce_odr x86_thiscallcc void @"\01??1Container@?$InternalMetadataWithArenaBase@V?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@VInternalMetadataWithArenaLite@internal@protobuf@google@@@internal@protobuf@google@@QAE@XZ"(%"struct.google::protobuf::internal::InternalMetadataWithArenaBase<std::basic_string<char, std::char_traits<char>, std::allocator<char> >, google::protobuf::internal::InternalMetadataWithArenaLite>::Container"*) unnamed_addr #3 comdat align 2 {
  ...
  call x86_thiscallcc void @"\01??1?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@XZ"(%"class.std::basic_string"* %4) #9
  ret void
}

; Function Attrs: noinline nounwind optnone
define linkonce_odr x86_thiscallcc %"class.google::protobuf::Arena"* @"\01??$PtrValue@VArena@protobuf@google@@@?$InternalMetadataWithArenaBase@V?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@VInternalMetadataWithArenaLite@internal@protobuf@google@@@internal@protobuf@google@@ABEPAVArena@23@XZ"(%struct._iobuf*) #3 comdat align 2 {
  %2 = alloca %struct._iobuf*, align 4
  store %struct._iobuf* %0, %struct._iobuf** %2, align 4
  %3 = load %struct._iobuf*, %struct._iobuf** %2, align 4
  %4 = getelementptr inbounds %struct._iobuf, %struct._iobuf* %3, i32 0, i32 0
...
; Function Attrs: noinline nounwind optnone
define linkonce_odr x86_thiscallcc i32 @"\01?PtrTag@?$InternalMetadataWithArenaBase@V?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@VInternalMetadataWithArenaLite@internal@protobuf@google@@@internal@protobuf@google@@ABEHXZ"(%struct._iobuf*) #3 comdat align 2 {
  %2 = alloca %struct._iobuf*, align 4
  store %struct._iobuf* %0, %struct._iobuf** %2, align 4
  %3 = load %struct._iobuf*, %struct._iobuf** %2, align 4
  %4 = getelementptr inbounds %struct._iobuf, %struct._iobuf* %3, i32 0, i32 0
...
; Function Attrs: noinline nounwind optnone
define linkonce_odr x86_thiscallcc %struct._iobuf* @"\01??0?$InternalMetadataWithArenaBase@V?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@VInternalMetadataWithArenaLite@internal@protobuf@google@@@internal@protobuf@google@@QAE@PAVArena@23@@Z"(%struct._iobuf* returned, %"class.google::protobuf::Arena"*) unnamed_addr #3 comdat align 2 {
  %3 = alloca %"class.google::protobuf::Arena"*, align 4
...
; Function Attrs: noinline nounwind optnone
define linkonce_odr x86_thiscallcc i8* @"\01??_GFoo@sample@@UAEPAXI@Z"(%"class.sample::Foo.13"*, i32) unnamed_addr #3 comdat align 2 {
  %3 = alloca i8*, align 4
  %4 = alloca i32, align 4
  %5 = alloca %"class.sample::Foo.13"*, align 4
  store i32 %1, i32* %4, align 4
  store %"class.sample::Foo.13"* %0, %"class.sample::Foo.13"** %5, align 4
  %6 = load %"class.sample::Foo.13"*, %"class.sample::Foo.13"** %5, align 4
  %7 = bitcast %"class.sample::Foo.13"* %6 to i8*
  store i8* %7, i8** %3, align 4
  %8 = load i32, i32* %4, align 4
  call x86_thiscallcc void @"\01??1Foo@sample@@UAE@XZ"(%"class.sample::Foo.13"* %6) #9
  %9 = icmp eq i32 %8, 0
  br i1 %9, label %12, label %10
...
; Function Attrs: noinline optnone
define x86_thiscallcc void @"\01?GetTypeName@Foo@sample@@UBE?AV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@XZ"(%"class.sample::Foo.13"*, %"class.std::basic_string"* noalias sret) unnamed_addr #0 align 2 {
  %3 = alloca %"class.sample::Foo.13"*, align 4
  store %"class.sample::Foo.13"* %0, %"class.sample::Foo.13"** %3, align 4
  %4 = load %"class.sample::Foo.13"*, %"class.sample::Foo.13"** %3, align 4
  %5 = call x86_thiscallcc %"class.std::basic_string"* @"\01??0?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@QBD@Z"(%"class.std::basic_string"* %1, i8* getelementptr inbounds ([11 x i8], [11 x i8]* @"\01??_C@_0L@LJKODHEF@sample?4Foo?$AA@", i32 0, i32 0))
  ret void
}

; Function Attrs: noinline optnone
define x86_thiscallcc %"class.sample::Foo.13"* @"\01?New@Foo@sample@@UBEPAV12@PAVArena@protobuf@google@@@Z"(%"class.sample::Foo.13"*, %"class.google::protobuf::Arena"*) unnamed_addr #0 align 2 personality i8* bitcast (i32 (...)* @__CxxFrameHandler3 to i8*) {
  %3 = alloca %"class.google::protobuf::Arena"*, align 4
  %4 = alloca %"class.sample::Foo.13"*, align 4
  %5 = alloca %"class.sample::Foo.13"*, align 4
  store %"class.google::protobuf::Arena"* %1, %"class.google::protobuf::Arena"** %3, align 4
  store %"class.sample::Foo.13"* %0, %"class.sample::Foo.13"** %4, align 4
  %6 = load %"class.sample::Foo.13"*, %"class.sample::Foo.13"** %4, align 4
  %7 = call i8* @"\01??2@YAPAXI@Z"(i32 24) #12
  %8 = bitcast i8* %7 to %"class.sample::Foo.13"*
  %9 = invoke x86_thiscallcc %"class.sample::Foo.13"* @"\01??0Foo@sample@@QAE@XZ"(%"class.sample::Foo.13"* %8)
          to label %10 unwind label %16

; <label>:10:                                     ; preds = %2
  store %"class.sample::Foo.13"* %8, %"class.sample::Foo.13"** %5, align 4
...
; <label>:13:                                     ; preds = %10
  %14 = load %"class.google::protobuf::Arena"*, %"class.google::protobuf::Arena"** %3, align 4
  %15 = load %"class.sample::Foo.13"*, %"class.sample::Foo.13"** %5, align 4
  call x86_thiscallcc void @"\01??$Own@VFoo@sample@@@Arena@protobuf@google@@QAEXPAVFoo@sample@@@Z"(%"class.google::protobuf::Arena"* %14, %"class.sample::Foo.13"* %15)
  br label %18
...
; <label>:18:                                     ; preds = %13, %10
  %19 = load %"class.sample::Foo.13"*, %"class.sample::Foo.13"** %5, align 4
  ret %"class.sample::Foo.13"* %19
}

; Function Attrs: noinline optnone
define linkonce_odr x86_thiscallcc %"class.sample::Foo.13"* @"\01?New@Foo@sample@@UBEPAV12@XZ"(%"class.sample::Foo.13"*) unnamed_addr #0 comdat align 2 {
  %2 = alloca %"class.sample::Foo.13"*, align 4
  store %"class.sample::Foo.13"* %0, %"class.sample::Foo.13"** %2, align 4
  %3 = load %"class.sample::Foo.13"*, %"class.sample::Foo.13"** %2, align 4
  %4 = call x86_thiscallcc %"class.sample::Foo.13"* @"\01?New@Foo@sample@@UBEPAV12@PAVArena@protobuf@google@@@Z"(%"class.sample::Foo.13"* %3, %"class.google::protobuf::Arena"* null)
...
; Function Attrs: noinline optnone
define x86_thiscallcc void @"\01?Clear@Foo@sample@@UAEXXZ"(%"class.sample::Foo.13"*) unnamed_addr #0 align 2 {
  %2 = alloca %"class.sample::Foo.13"*, align 4
  %3 = alloca i32, align 4
  store %"class.sample::Foo.13"* %0, %"class.sample::Foo.13"** %2, align 4
  %4 = load %"class.sample::Foo.13"*, %"class.sample::Foo.13"** %2, align 4
  store i32 0, i32* %3, align 4
  ...
  call x86_thiscallcc void @"\01?Clear@?$InternalMetadataWithArenaBase@V?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@VInternalMetadataWithArenaLite@internal@protobuf@google@@@internal@protobuf@google@@QAEXXZ"(%struct._iobuf* %18)
  ret void
}

; Function Attrs: noinline nounwind optnone
define x86_thiscallcc zeroext i1 @"\01?IsInitialized@Foo@sample@@UBE_NXZ"(%"class.sample::Foo.13"*) unnamed_addr #3 align 2 {
  %2 = alloca %"class.sample::Foo.13"*, align 4
  store %"class.sample::Foo.13"* %0, %"class.sample::Foo.13"** %2, align 4
  %3 = load %"class.sample::Foo.13"*, %"class.sample::Foo.13"** %2, align 4
  ret i1 true
...
; Function Attrs: noinline optnone
define x86_thiscallcc void @"\01?CheckTypeAndMergeFrom@Foo@sample@@UAEXABVMessageLite@protobuf@google@@@Z"(%"class.sample::Foo.13"*, %"class.google::protobuf::MessageLite"* dereferenceable(4)) unnamed_addr #0 align 2 {
  ...
  store %"class.sample::Foo.13"* %0, %"class.sample::Foo.13"** %4, align 4
  %5 = load %"class.sample::Foo.13"*, %"class.sample::Foo.13"** %4, align 4
  %6 = load %"class.google::protobuf::MessageLite"*, %"class.google::protobuf::MessageLite"** %3, align 4
  %7 = call %"class.sample::Foo.13"* @"\01??$down_cast@PBVFoo@sample@@$$CBVMessageLite@protobuf@google@@@internal@protobuf@google@@YAPBVFoo@sample@@PBVMessageLite@12@@Z"(%"class.google::protobuf::MessageLite"* %6)
  call x86_thiscallcc void @"\01?MergeFrom@Foo@sample@@QAEXABV12@@Z"(%"class.sample::Foo.13"* %5, %"class.sample::Foo.13"* dereferenceable(24) %7)
  ret void
}

; Function Attrs: noinline optnone
define x86_thiscallcc zeroext i1 @"\01?MergePartialFromCodedStream@Foo@sample@@UAE_NPAVCodedInputStream@io@protobuf@google@@@Z"(%"class.sample::Foo.13"*, %"class.google::protobuf::io::CodedInputStream"*) unnamed_addr #0 align 2 personality i8* bitcast (i32 (...)* @__CxxFrameHandler3 to i8*) {
  %3 = alloca i1, align 1
  ...
  store %"class.sample::Foo.13"* %0, %"class.sample::Foo.13"** %5, align 4
  %12 = load %"class.sample::Foo.13"*, %"class.sample::Foo.13"** %5, align 4
...
; <label>:54:                                     ; preds = %49
  ...
  %57 = invoke zeroext i1 @"\01??$ReadPrimitive@M$01@WireFormatLite@internal@protobuf@google@@SA_NPAVCodedInputStream@io@23@PAM@Z"(%"class.google::protobuf::io::CodedInputStream"* %56, float* %55)
...
; <label>:68:                                     ; preds = %63
  %69 = invoke x86_thiscallcc %"class.std::basic_string"* @"\01?mutable_s@Foo@sample@@QAEPAV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@XZ"(%"class.sample::Foo.13"* %12)
          to label %70 unwind label %105

; <label>:70:                                     ; preds = %68
  %71 = load %"class.google::protobuf::io::CodedInputStream"*, %"class.google::protobuf::io::CodedInputStream"** %4, align 4
  %72 = invoke zeroext i1 @"\01?ReadString@WireFormatLite@internal@protobuf@google@@SA_NPAVCodedInputStream@io@34@PAV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@@Z"(%"class.google::protobuf::io::CodedInputStream"* %71, %"class.std::basic_string"* %69)
...
; <label>:75:                                     ; preds = %73
  %76 = invoke x86_thiscallcc dereferenceable(24) %"class.std::basic_string"* @"\01?s@Foo@sample@@QBEABV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@XZ"(%"class.sample::Foo.13"* %12)
          to label %77 unwind label %105

; <label>:77:                                     ; preds = %75
  %78 = call x86_thiscallcc i32 @"\01?length@?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QBEIXZ"(%"class.std::basic_string"* %76) #9
  %79 = invoke x86_thiscallcc dereferenceable(24) %"class.std::basic_string"* @"\01?s@Foo@sample@@QBEABV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@XZ"(%"class.sample::Foo.13"* %12)
          to label %80 unwind label %105

; <label>:80:                                     ; preds = %77
  %81 = call x86_thiscallcc i8* @"\01?data@?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QBEPBDXZ"(%"class.std::basic_string"* %79) #9
  %82 = invoke zeroext i1 @"\01?VerifyUtf8String@WireFormatLite@internal@protobuf@google@@SA_NPBDHW4Operation@1234@0@Z"(i8* %81, i32 %78, i32 0, i8* getelementptr inbounds ([13 x i8], [13 x i8]* @"\01??_C@_0N@DHCOGDO@sample?4Foo?4s?$AA@", i32 0, i32 0))
...
; <label>:93:                                     ; preds = %89
  %94 = load i32, i32* %6, align 4
  %95 = load %"class.google::protobuf::io::CodedInputStream"*, %"class.google::protobuf::io::CodedInputStream"** %4, align 4
  %96 = invoke zeroext i1 @"\01?SkipField@WireFormatLite@internal@protobuf@google@@SA_NPAVCodedInputStream@io@34@IPAVCodedOutputStream@634@@Z"(%"class.google::protobuf::io::CodedInputStream"* %95, i32 %94, %"class.google::protobuf::io::CodedOutputStream"* %9)
...
; <label>:102:                                    ; preds = %98, %84, %74, %59, %45
  store i1 false, i1* %3, align 1
  store i32 1, i32* %11, align 4
  br label %103

; <label>:103:                                    ; preds = %102, %101
  call x86_thiscallcc void @"\01??1CodedOutputStream@io@protobuf@google@@QAE@XZ"(%"class.google::protobuf::io::CodedOutputStream"* %9) #9
  call x86_thiscallcc void @"\01??1StringOutputStream@io@protobuf@google@@UAE@XZ"(%"class.google::protobuf::io::StringOutputStream"* %8) #9
  call x86_thiscallcc void @"\01??1LiteUnknownFieldSetter@internal@protobuf@google@@QAE@XZ"(%"class.google::protobuf::internal::LiteUnknownFieldSetter"* %7) #9
  %104 = load i1, i1* %3, align 1
  ret i1 %104

; <label>:105:                                    ; preds = %93, %80, %77, %75, %70, %68, %54, %40, %31, %22
  %106 = cleanuppad within none []
  call x86_thiscallcc void @"\01??1CodedOutputStream@io@protobuf@google@@QAE@XZ"(%"class.google::protobuf::io::CodedOutputStream"* %9) #9 [ "funclet"(token %106) ]
  cleanupret from %106 unwind label %107

; <label>:107:                                    ; preds = %105, %18
  %108 = cleanuppad within none []
  call x86_thiscallcc void @"\01??1StringOutputStream@io@protobuf@google@@UAE@XZ"(%"class.google::protobuf::io::StringOutputStream"* %8) #9 [ "funclet"(token %108) ]
  cleanupret from %108 unwind label %109

; <label>:109:                                    ; preds = %107, %16, %2
  %110 = cleanuppad within none []
  call x86_thiscallcc void @"\01??1LiteUnknownFieldSetter@internal@protobuf@google@@QAE@XZ"(%"class.google::protobuf::internal::LiteUnknownFieldSetter"* %7) #9 [ "funclet"(token %110) ]
  cleanupret from %110 unwind to caller
}

; Function Attrs: noinline optnone
define x86_thiscallcc i32 @"\01?ByteSizeLong@Foo@sample@@UBEIXZ"(%"class.sample::Foo.13"*) #0 align 2 {
  %2 = alloca %"class.sample::Foo.13"*, align 4
  %3 = alloca i32, align 4
  %4 = alloca i32, align 4
  store %"class.sample::Foo.13"* %0, %"class.sample::Foo.13"** %2, align 4
  %5 = load %"class.sample::Foo.13"*, %"class.sample::Foo.13"** %2, align 4
  store i32 0, i32* %3, align 4
...
; <label>:14:                                     ; preds = %11, %7
  ...
  %16 = call x86_thiscallcc i32 @"\01?size@?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QBEIXZ"(%"class.std::basic_string"* %15) #9
  %17 = load i32, i32* %3, align 4
  %18 = add i32 %17, %16
  store i32 %18, i32* %3, align 4
  %19 = call x86_thiscallcc dereferenceable(24) %"class.std::basic_string"* @"\01?s@Foo@sample@@QBEABV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@XZ"(%"class.sample::Foo.13"* %5)
...
; <label>:22:                                     ; preds = %14
  %23 = call x86_thiscallcc dereferenceable(24) %"class.std::basic_string"* @"\01?s@Foo@sample@@QBEABV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@XZ"(%"class.sample::Foo.13"* %5)
  %24 = call i32 @"\01?StringSize@WireFormatLite@internal@protobuf@google@@SAIABV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@@Z"(%"class.std::basic_string"* dereferenceable(24) %23)
  %25 = add i32 1, %24
...
; <label>:28:                                     ; preds = %22, %14
  %29 = call x86_thiscallcc i32 bitcast (i32 (%"class.sample::Foo"*)* @"\01?i32@Foo@sample@@QBEHXZ" to i32 (%"class.sample::Foo.13"*)*)(%"class.sample::Foo.13"* %5)
  %30 = icmp ne i32 %29, 0
  br i1 %30, label %31, label %37

; <label>:31:                                     ; preds = %28
  %32 = call x86_thiscallcc i32 bitcast (i32 (%"class.sample::Foo"*)* @"\01?i32@Foo@sample@@QBEHXZ" to i32 (%"class.sample::Foo.13"*)*)(%"class.sample::Foo.13"* %5)
  %33 = call i32 @"\01?Int32Size@WireFormatLite@internal@protobuf@google@@SAIH@Z"(i32 %32)
  %34 = add i32 1, %33
...
; <label>:37:                                     ; preds = %31, %28
  %38 = call x86_thiscallcc float @"\01?f@Foo@sample@@QBEMXZ"(%"class.sample::Foo.13"* %5)
...
; Function Attrs: noinline optnone
define x86_thiscallcc void @"\01?SerializeWithCachedSizes@Foo@sample@@UBEXPAVCodedOutputStream@io@protobuf@google@@@Z"(%"class.sample::Foo.13"*, %"class.google::protobuf::io::CodedOutputStream"*) unnamed_addr #0 align 2 {
  ...
  %7 = call x86_thiscallcc i32 bitcast (i32 (%"class.sample::Foo"*)* @"\01?i32@Foo@sample@@QBEHXZ" to i32 (%"class.sample::Foo.13"*)*)(%"class.sample::Foo.13"* %6)
  %8 = icmp ne i32 %7, 0
  br i1 %8, label %9, label %12

; <label>:9:                                      ; preds = %2
  %10 = load %"class.google::protobuf::io::CodedOutputStream"*, %"class.google::protobuf::io::CodedOutputStream"** %3, align 4
  %11 = call x86_thiscallcc i32 bitcast (i32 (%"class.sample::Foo"*)* @"\01?i32@Foo@sample@@QBEHXZ" to i32 (%"class.sample::Foo.13"*)*)(%"class.sample::Foo.13"* %6)
...
; <label>:12:                                     ; preds = %9, %2
  %13 = call x86_thiscallcc float @"\01?f@Foo@sample@@QBEMXZ"(%"class.sample::Foo.13"* %6)
...
; <label>:15:                                     ; preds = %12
  ...
  %17 = call x86_thiscallcc float @"\01?f@Foo@sample@@QBEMXZ"(%"class.sample::Foo.13"* %6)
...
; <label>:18:                                     ; preds = %15, %12
  %19 = call x86_thiscallcc dereferenceable(24) %"class.std::basic_string"* @"\01?s@Foo@sample@@QBEABV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@XZ"(%"class.sample::Foo.13"* %6)
  %20 = call x86_thiscallcc i32 @"\01?size@?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QBEIXZ"(%"class.std::basic_string"* %19) #9
  %21 = icmp ugt i32 %20, 0
  br i1 %21, label %22, label %30

; <label>:22:                                     ; preds = %18
  %23 = call x86_thiscallcc dereferenceable(24) %"class.std::basic_string"* @"\01?s@Foo@sample@@QBEABV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@XZ"(%"class.sample::Foo.13"* %6)
  ...
  %25 = call x86_thiscallcc dereferenceable(24) %"class.std::basic_string"* @"\01?s@Foo@sample@@QBEABV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@XZ"(%"class.sample::Foo.13"* %6)
  ...
  %29 = call x86_thiscallcc dereferenceable(24) %"class.std::basic_string"* @"\01?s@Foo@sample@@QBEABV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@XZ"(%"class.sample::Foo.13"* %6)
...
; <label>:30:                                     ; preds = %22, %18
  %31 = load %"class.google::protobuf::io::CodedOutputStream"*, %"class.google::protobuf::io::CodedOutputStream"** %3, align 4
  %32 = call zeroext i1 @"\01?GetProto3PreserveUnknownsDefault@internal@protobuf@google@@YA_NXZ"()
  br i1 %32, label %33, label %37

; <label>:33:                                     ; preds = %30
  %34 = getelementptr inbounds %"class.sample::Foo.13", %"class.sample::Foo.13"* %6, i32 0, i32 1
  %35 = bitcast %"class.google::protobuf::internal::InternalMetadataWithArena"* %34 to %struct._iobuf*
  %36 = call x86_thiscallcc dereferenceable(24) %"class.std::basic_string"* @"\01?unknown_fields@?$InternalMetadataWithArenaBase@V?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@VInternalMetadataWithArenaLite@internal@protobuf@google@@@internal@protobuf@google@@QBEABV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@XZ"(%struct._iobuf* %35)
  br label %40

; <label>:37:                                     ; preds = %30
  %38 = getelementptr inbounds %"class.sample::Foo.13", %"class.sample::Foo.13"* %6, i32 0, i32 1
  %39 = call dereferenceable(24) %"class.std::basic_string"* @"\01?default_instance@InternalMetadataWithArenaLite@internal@protobuf@google@@SAABV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@XZ"()
  br label %40

; <label>:40:                                     ; preds = %37, %33
  %41 = phi %"class.std::basic_string"* [ %36, %33 ], [ %39, %37 ]
  %42 = call x86_thiscallcc i32 @"\01?size@?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QBEIXZ"(%"class.std::basic_string"* %41) #9
  %43 = call zeroext i1 @"\01?GetProto3PreserveUnknownsDefault@internal@protobuf@google@@YA_NXZ"()
  br i1 %43, label %44, label %48

; <label>:44:                                     ; preds = %40
  %45 = getelementptr inbounds %"class.sample::Foo.13", %"class.sample::Foo.13"* %6, i32 0, i32 1
  %46 = bitcast %"class.google::protobuf::internal::InternalMetadataWithArena"* %45 to %struct._iobuf*
  %47 = call x86_thiscallcc dereferenceable(24) %"class.std::basic_string"* @"\01?unknown_fields@?$InternalMetadataWithArenaBase@V?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@VInternalMetadataWithArenaLite@internal@protobuf@google@@@internal@protobuf@google@@QBEABV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@XZ"(%struct._iobuf* %46)
  br label %51

; <label>:48:                                     ; preds = %40
  %49 = getelementptr inbounds %"class.sample::Foo.13", %"class.sample::Foo.13"* %6, i32 0, i32 1
  %50 = call dereferenceable(24) %"class.std::basic_string"* @"\01?default_instance@InternalMetadataWithArenaLite@internal@protobuf@google@@SAABV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@XZ"()
  br label %51

; <label>:51:                                     ; preds = %48, %44
  %52 = phi %"class.std::basic_string"* [ %47, %44 ], [ %50, %48 ]
  %53 = call x86_thiscallcc i8* @"\01?data@?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QBEPBDXZ"(%"class.std::basic_string"* %52) #9
  call x86_thiscallcc void @"\01?WriteRaw@CodedOutputStream@io@protobuf@google@@QAEXPBXH@Z"(%"class.google::protobuf::io::CodedOutputStream"* %31, i8* %53, i32 %42)
  ret void
}
...
; Function Attrs: noinline nounwind optnone
define linkonce_odr x86_thiscallcc i32 @"\01?GetCachedSize@Foo@sample@@UBEHXZ"(%"class.sample::Foo.13"*) unnamed_addr #3 comdat align 2 {
  %2 = alloca %"class.sample::Foo.13"*, align 4
  store %"class.sample::Foo.13"* %0, %"class.sample::Foo.13"** %2, align 4
  %3 = load %"class.sample::Foo.13"*, %"class.sample::Foo.13"** %2, align 4
...
; Function Attrs: noinline nounwind optnone
define linkonce_odr x86_thiscallcc float @"\01?f@Foo@sample@@QBEMXZ"(%"class.sample::Foo.13"*) #3 comdat align 2 {
  %2 = alloca %"class.sample::Foo.13"*, align 4
  store %"class.sample::Foo.13"* %0, %"class.sample::Foo.13"** %2, align 4
  %3 = load %"class.sample::Foo.13"*, %"class.sample::Foo.13"** %2, align 4
...
; Function Attrs: noinline optnone
define linkonce_odr x86_thiscallcc dereferenceable(24) %"class.std::basic_string"* @"\01?s@Foo@sample@@QBEABV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@XZ"(%"class.sample::Foo.13"*) #0 comdat align 2 {
  %2 = alloca %"class.sample::Foo.13"*, align 4
  store %"class.sample::Foo.13"* %0, %"class.sample::Foo.13"** %2, align 4
  %3 = load %"class.sample::Foo.13"*, %"class.sample::Foo.13"** %2, align 4
  %4 = getelementptr inbounds %"class.sample::Foo.13", %"class.sample::Foo.13"* %3, i32 0, i32 2
...
declare x86_thiscallcc void @"\01?WriteRaw@CodedOutputStream@io@protobuf@google@@QAEXPBXH@Z"(%"class.google::protobuf::io::CodedOutputStream"*, i8*, i32) #1
...
define linkonce_odr x86_thiscallcc %"class.google::protobuf::internal::LiteUnknownFieldSetter"* @"\01??0LiteUnknownFieldSetter@internal@protobuf@google@@QAE@PAVInternalMetadataWithArenaLite@123@@Z"(%"class.google::protobuf::internal::LiteUnknownFieldSetter"* returned, %"class.google::protobuf::internal::InternalMetadataWithArena"*) unnamed_addr #0 comdat align 2 personality i8* bitcast (i32 (...)* @__CxxFrameHandler3 to i8*) {
  ...
  %10 = call x86_thiscallcc %"class.std::basic_string"* @"\01??0?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@XZ"(%"class.std::basic_string"* %9) #9
  ...
  %13 = invoke x86_thiscallcc zeroext i1 @"\01?have_unknown_fields@?$InternalMetadataWithArenaBase@V?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@VInternalMetadataWithArenaLite@internal@protobuf@google@@@internal@protobuf@google@@QBE_NXZ"(%struct._iobuf* %12)
          to label %14 unwind label %23
...
; <label>:20:                                     ; preds = %15
  call x86_thiscallcc void @"\01?swap@?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAEXAAV12@@Z"(%"class.std::basic_string"* %16, %"class.std::basic_string"* dereferenceable(24) %19) #9
  br label %21
...
; <label>:23:                                     ; preds = %15, %2
  %24 = cleanuppad within none []
  call x86_thiscallcc void @"\01??1?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@XZ"(%"class.std::basic_string"* %9) #9 [ "funclet"(token %24) ]
  cleanupret from %24 unwind to caller
}

; Function Attrs: noinline nounwind optnone
define linkonce_odr x86_thiscallcc %"class.std::basic_string"* @"\01?buffer@LiteUnknownFieldSetter@internal@protobuf@google@@QAEPAV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@XZ"(%"class.google::protobuf::internal::LiteUnknownFieldSetter"*) #3 comdat align 2 {
...
declare x86_thiscallcc %"class.google::protobuf::io::StringOutputStream"* @"\01??0StringOutputStream@io@protobuf@google@@QAE@PAV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@@Z"(%"class.google::protobuf::io::StringOutputStream"* returned, %"class.std::basic_string"*) unnamed_addr #1

declare x86_thiscallcc %"class.google::protobuf::io::CodedOutputStream"* @"\01??0CodedOutputStream@io@protobuf@google@@QAE@PAVZeroCopyOutputStream@123@_N@Z"(%"class.google::protobuf::io::CodedOutputStream"* returned, %"class.google::protobuf::MessageLite"*, i1 zeroext) unnamed_addr #1
...
; Function Attrs: noinline optnone
define linkonce_odr x86_thiscallcc %"class.std::basic_string"* @"\01?mutable_s@Foo@sample@@QAEPAV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@XZ"(%"class.sample::Foo.13"*) #0 comdat align 2 {
  %2 = alloca %"class.sample::Foo.13"*, align 4
  store %"class.sample::Foo.13"* %0, %"class.sample::Foo.13"** %2, align 4
  %3 = load %"class.sample::Foo.13"*, %"class.sample::Foo.13"** %2, align 4
  %4 = getelementptr inbounds %"class.sample::Foo.13", %"class.sample::Foo.13"* %3, i32 0, i32 2
...
declare zeroext i1 @"\01?SkipField@WireFormatLite@internal@protobuf@google@@SA_NPAVCodedInputStream@io@34@IPAVCodedOutputStream@634@@Z"(%"class.google::protobuf::io::CodedInputStream"*, i32, %"class.google::protobuf::io::CodedOutputStream"*) #1

; Function Attrs: nounwind
declare x86_thiscallcc void @"\01??1CodedOutputStream@io@protobuf@google@@QAE@XZ"(%"class.google::protobuf::io::CodedOutputStream"*) unnamed_addr #2

; Function Attrs: noinline nounwind optnone
define linkonce_odr x86_thiscallcc void @"\01??1StringOutputStream@io@protobuf@google@@UAE@XZ"(%"class.google::protobuf::io::StringOutputStream"*) unnamed_addr #3 comdat align 2 {
  ...
  call x86_thiscallcc void @"\01??1ZeroCopyOutputStream@io@protobuf@google@@UAE@XZ"(%"class.google::protobuf::MessageLite"* %4) #9
  ret void
}

; Function Attrs: noinline nounwind optnone
define linkonce_odr x86_thiscallcc void @"\01??1LiteUnknownFieldSetter@internal@protobuf@google@@QAE@XZ"(%"class.google::protobuf::internal::LiteUnknownFieldSetter"*) unnamed_addr #3 comdat align 2 personality i8* bitcast (i32 (...)* @__CxxFrameHandler3 to i8*) {
  %2 = alloca %"class.google::protobuf::internal::LiteUnknownFieldSetter"*, align 4
  store %"class.google::protobuf::internal::LiteUnknownFieldSetter"* %0, %"class.google::protobuf::internal::LiteUnknownFieldSetter"** %2, align 4
  %3 = load %"class.google::protobuf::internal::LiteUnknownFieldSetter"*, %"class.google::protobuf::internal::LiteUnknownFieldSetter"** %2, align 4
  %4 = getelementptr inbounds %"class.google::protobuf::internal::LiteUnknownFieldSetter", %"class.google::protobuf::internal::LiteUnknownFieldSetter"* %3, i32 0, i32 1
  %5 = call x86_thiscallcc zeroext i1 @"\01?empty@?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QBE_NXZ"(%"class.std::basic_string"* %4) #9
...
; <label>:11:                                     ; preds = %6
  ...
  call x86_thiscallcc void @"\01?swap@?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAEXAAV12@@Z"(%"class.std::basic_string"* %10, %"class.std::basic_string"* dereferenceable(24) %12) #9
  br label %13
...
; <label>:15:                                     ; preds = %6
  ...
  call x86_thiscallcc void @"\01??1?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@XZ"(%"class.std::basic_string"* %17) #9 [ "funclet"(token %16) ]
...
; Function Attrs: noinline nounwind optnone
define linkonce_odr x86_thiscallcc zeroext i1 @"\01?empty@?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QBE_NXZ"(%"class.std::basic_string"*) #3 comdat align 2 {
  %2 = alloca %"class.std::basic_string"*, align 4
  store %"class.std::basic_string"* %0, %"class.std::basic_string"** %2, align 4
  %3 = load %"class.std::basic_string"*, %"class.std::basic_string"** %2, align 4
  %4 = call x86_thiscallcc i32 @"\01?size@?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QBEIXZ"(%"class.std::basic_string"* %3) #9
...
; Function Attrs: noinline nounwind optnone
define linkonce_odr x86_thiscallcc void @"\01?swap@?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAEXAAV12@@Z"(%"class.std::basic_string"*, %"class.std::basic_string"* dereferenceable(24)) #3 comdat align 2 personality i8* bitcast (i32 (...)* @__CxxFrameHandler3 to i8*) {
  %3 = alloca %"class.std::basic_string"*, align 4
  %4 = alloca %"class.std::basic_string"*, align 4
  %5 = alloca %struct.__vcrt_assert_va_start_is_not_reference, align 4
  store %"class.std::basic_string"* %1, %"class.std::basic_string"** %3, align 4
...
; <label>:10:                                     ; preds = %2
  ...
  %13 = call x86_thiscallcc dereferenceable(1) %struct.__vcrt_assert_va_start_is_not_reference* @"\01?_Getal@?$_String_alloc@U?$_String_base_types@DV?$allocator@D@std@@@std@@@std@@QAEAAV?$allocator@D@2@XZ"(%"class.std::_String_alloc"* %12) #9
  %14 = bitcast %"class.std::basic_string"* %6 to %"class.std::_String_alloc"*
  %15 = call x86_thiscallcc dereferenceable(1) %struct.__vcrt_assert_va_start_is_not_reference* @"\01?_Getal@?$_String_alloc@U?$_String_base_types@DV?$allocator@D@std@@@std@@@std@@QAEAAV?$allocator@D@2@XZ"(%"class.std::_String_alloc"* %14) #9
  call void @"\01??$_Pocs@V?$allocator@D@std@@@std@@YAXAAV?$allocator@D@0@0@Z"(%struct.__vcrt_assert_va_start_is_not_reference* dereferenceable(1) %15, %struct.__vcrt_assert_va_start_is_not_reference* dereferenceable(1) %13) #9
  br label %16
...
; Function Attrs: noinline nounwind optnone
define linkonce_odr void @"\01??$_Pocs@V?$allocator@D@std@@@std@@YAXAAV?$allocator@D@0@0@Z"(%struct.__vcrt_assert_va_start_is_not_reference* dereferenceable(1), %struct.__vcrt_assert_va_start_is_not_reference* dereferenceable(1)) #3 comdat {
  %3 = alloca %struct.__vcrt_assert_va_start_is_not_reference*, align 4
  %4 = alloca %struct.__vcrt_assert_va_start_is_not_reference*, align 4
  %5 = alloca %struct.__vcrt_assert_va_start_is_not_reference, align 1
  %6 = alloca %struct.__vcrt_assert_va_start_is_not_reference, align 4
  ...
  %7 = load %struct.__vcrt_assert_va_start_is_not_reference*, %struct.__vcrt_assert_va_start_is_not_reference** %3, align 4
  %8 = load %struct.__vcrt_assert_va_start_is_not_reference*, %struct.__vcrt_assert_va_start_is_not_reference** %4, align 4
  call void @"\01??$_Pocs@V?$allocator@D@std@@@std@@YAXAAV?$allocator@D@0@0U?$integral_constant@_N$0A@@0@@Z"(%struct.__vcrt_assert_va_start_is_not_reference* dereferenceable(1) %8, %struct.__vcrt_assert_va_start_is_not_reference* dereferenceable(1) %7, %struct.__vcrt_assert_va_start_is_not_reference* byval align 4 %6) #9
  ret void
}

; Function Attrs: noinline nounwind optnone
define linkonce_odr x86_thiscallcc void @"\01?_Swap_data@?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAEXAAV12@U?$integral_constant@_N$00@2@@Z"(%"class.std::basic_string"*, %"class.std::basic_string"* dereferenceable(24), %struct.__vcrt_assert_va_start_is_not_reference* byval align 4) #3 comdat align 2 {
  %4 = alloca %"class.std::basic_string"*, align 4
  %5 = alloca %"class.std::basic_string"*, align 4
  %6 = alloca i8*, align 4
  %7 = alloca i8*, align 4
  ...
  %9 = load %"class.std::basic_string"*, %"class.std::basic_string"** %5, align 4
  %10 = bitcast %"class.std::basic_string"* %9 to %"class.std::_String_alloc"*
  %11 = call x86_thiscallcc dereferenceable(24) %"class.std::_String_val"* @"\01?_Get_data@?$_String_alloc@U?$_String_base_types@DV?$allocator@D@std@@@std@@@std@@QAEAAV?$_String_val@U?$_Simple_types@D@std@@@2@XZ"(%"class.std::_String_alloc"* %10) #9
  %12 = call %"class.std::_String_val"* @"\01??$addressof@V?$_String_val@U?$_Simple_types@D@std@@@std@@@std@@YAPAV?$_String_val@U?$_Simple_types@D@std@@@0@AAV10@@Z"(%"class.std::_String_val"* dereferenceable(24) %11) #9
  ...
  %17 = call x86_thiscallcc dereferenceable(24) %"class.std::_String_val"* @"\01?_Get_data@?$_String_alloc@U?$_String_base_types@DV?$allocator@D@std@@@std@@@std@@QAEAAV?$_String_val@U?$_Simple_types@D@std@@@2@XZ"(%"class.std::_String_alloc"* %16) #9
  %18 = call %"class.std::_String_val"* @"\01??$addressof@V?$_String_val@U?$_Simple_types@D@std@@@std@@@std@@YAPAV?$_String_val@U?$_Simple_types@D@std@@@0@AAV10@@Z"(%"class.std::_String_val"* dereferenceable(24) %17) #9
...
; Function Attrs: noinline nounwind optnone
define linkonce_odr void @"\01??$_Pocs@V?$allocator@D@std@@@std@@YAXAAV?$allocator@D@0@0U?$integral_constant@_N$0A@@0@@Z"(%struct.__vcrt_assert_va_start_is_not_reference* dereferenceable(1), %struct.__vcrt_assert_va_start_is_not_reference* dereferenceable(1), %struct.__vcrt_assert_va_start_is_not_reference* byval align 4) #3 comdat {
  %4 = alloca %struct.__vcrt_assert_va_start_is_not_reference*, align 4
  %5 = alloca %struct.__vcrt_assert_va_start_is_not_reference*, align 4
  store %struct.__vcrt_assert_va_start_is_not_reference* %1, %struct.__vcrt_assert_va_start_is_not_reference** %4, align 4
  store %struct.__vcrt_assert_va_start_is_not_reference* %0, %struct.__vcrt_assert_va_start_is_not_reference** %5, align 4
...
define linkonce_odr x86_thiscallcc %"class.std::basic_string"* @"\01?mutable_unknown_fields_slow@?$InternalMetadataWithArenaBase@V?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@VInternalMetadataWithArenaLite@internal@protobuf@google@@@internal@protobuf@google@@AAEPAV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@XZ"(%struct._iobuf*) #0 comdat align 2 {
  ...
  %6 = call x86_thiscallcc %"class.google::protobuf::Arena"* @"\01?arena@?$InternalMetadataWithArenaBase@V?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@VInternalMetadataWithArenaLite@internal@protobuf@google@@@internal@protobuf@google@@QBEPAVArena@34@XZ"(%struct._iobuf* %5)
...
; <label>:6:                                      ; preds = %1
  %7 = call i8* @"\01??2@YAPAXI@Z"(i32 28) #12
...
define linkonce_odr x86_thiscallcc %"struct.google::protobuf::internal::InternalMetadataWithArenaBase<std::basic_string<char, std::char_traits<char>, std::allocator<char> >, google::protobuf::internal::InternalMetadataWithArenaLite>::Container"* @"\01??0Container@?$InternalMetadataWithArenaBase@V?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@VInternalMetadataWithArenaLite@internal@protobuf@google@@@internal@protobuf@google@@QAE@XZ"(%"struct.google::protobuf::internal::InternalMetadataWithArenaBase<std::basic_string<char, std::char_traits<char>, std::allocator<char> >, google::protobuf::internal::InternalMetadataWithArenaLite>::Container"* returned) unnamed_addr #3 comdat align 2 {
  ...
  %3 = load %"struct.google::protobuf::internal::InternalMetadataWithArenaBase<std::basic_string<char, std::char_traits<char>, std::allocator<char> >, google::protobuf::internal::InternalMetadataWithArenaLite>::Container"*, %"struct.google::protobuf::internal::InternalMetadataWithArenaBase<std::basic_string<char, std::char_traits<char>, std::allocator<char> >, google::protobuf::internal::InternalMetadataWithArenaLite>::Container"** %2, align 4
  %4 = getelementptr inbounds %"struct.google::protobuf::internal::InternalMetadataWithArenaBase<std::basic_string<char, std::char_traits<char>, std::allocator<char> >, google::protobuf::internal::InternalMetadataWithArenaLite>::Container", %"struct.google::protobuf::internal::InternalMetadataWithArenaBase<std::basic_string<char, std::char_traits<char>, std::allocator<char> >, google::protobuf::internal::InternalMetadataWithArenaLite>::Container"* %3, i32 0, i32 0
  %5 = call x86_thiscallcc %"class.std::basic_string"* @"\01??0?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@XZ"(%"class.std::basic_string"* %4) #9
...
; Function Attrs: noinline nounwind optnone
define linkonce_odr void @"\01??$arena_destruct_object@UContainer@?$InternalMetadataWithArenaBase@V?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@VInternalMetadataWithArenaLite@internal@protobuf@google@@@internal@protobuf@google@@@internal@protobuf@google@@YAXPAX@Z"(i8*) #3 comdat {
  %2 = alloca i8*, align 4
  store i8* %0, i8** %2, align 4
  %3 = load i8*, i8** %2, align 4
  ...
  call x86_thiscallcc void @"\01??1Container@?$InternalMetadataWithArenaBase@V?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@VInternalMetadataWithArenaLite@internal@protobuf@google@@@internal@protobuf@google@@QAE@XZ"(%"struct.google::protobuf::internal::InternalMetadataWithArenaBase<std::basic_string<char, std::char_traits<char>, std::allocator<char> >, google::protobuf::internal::InternalMetadataWithArenaLite>::Container"* %4) #9
  ret void
}
...
; <label>:8:                                      ; preds = %6
  ...
  call x86_thiscallcc void @"\01??1?$_String_alloc@U?$_String_base_types@DV?$allocator@D@std@@@std@@@std@@QAE@XZ"(%"class.std::_String_alloc"* %10) #9 [ "funclet"(token %9) ]
...
; Function Attrs: noinline nounwind optnone
define linkonce_odr x86_thiscallcc void @"\01??1ZeroCopyOutputStream@io@protobuf@google@@UAE@XZ"(%"class.google::protobuf::MessageLite"*) unnamed_addr #3 comdat align 2 {
  %2 = alloca %"class.google::protobuf::MessageLite"*, align 4
  store %"class.google::protobuf::MessageLite"* %0, %"class.google::protobuf::MessageLite"** %2, align 4
  %3 = load %"class.google::protobuf::MessageLite"*, %"class.google::protobuf::MessageLite"** %2, align 4
  ret void
...
; Function Attrs: noinline optnone
define linkonce_odr %"class.sample::Foo.13"* @"\01??$down_cast@PBVFoo@sample@@$$CBVMessageLite@protobuf@google@@@internal@protobuf@google@@YAPBVFoo@sample@@PBVMessageLite@12@@Z"(%"class.google::protobuf::MessageLite"*) #0 comdat {
  %2 = alloca %"class.google::protobuf::MessageLite"*, align 4
  store %"class.google::protobuf::MessageLite"* %0, %"class.google::protobuf::MessageLite"** %2, align 4
  %3 = load %"class.google::protobuf::MessageLite"*, %"class.google::protobuf::MessageLite"** %2, align 4
...
; Function Attrs: noinline optnone
define x86_thiscallcc void @"\01?MergeFrom@Foo@sample@@QAEXABV12@@Z"(%"class.sample::Foo.13"*, %"class.sample::Foo.13"* dereferenceable(24)) #0 align 2 personality i8* bitcast (i32 (...)* @__CxxFrameHandler3 to i8*) {
  %3 = alloca %"class.sample::Foo.13"*, align 4
  %4 = alloca %"class.sample::Foo.13"*, align 4
  %5 = alloca %"class.google::protobuf::internal::LogMessage", align 4
  %6 = alloca i1, align 1
  ...
  store %"class.sample::Foo.13"* %1, %"class.sample::Foo.13"** %3, align 4
  store %"class.sample::Foo.13"* %0, %"class.sample::Foo.13"** %4, align 4
  %10 = load %"class.sample::Foo.13"*, %"class.sample::Foo.13"** %4, align 4
  %11 = load %"class.sample::Foo.13"*, %"class.sample::Foo.13"** %3, align 4
...
; <label>:14:                                     ; preds = %2
  %15 = call x86_thiscallcc %"class.google::protobuf::internal::LogMessage"* @"\01??0LogMessage@internal@protobuf@google@@QAE@W4LogLevel@23@PBDH@Z"(%"class.google::protobuf::internal::LogMessage"* %5, i32 3, i8* getelementptr inbounds ([73 x i8], [73 x i8]* @"\01??_C@_0EJ@KDOHDODM@E?3?2work?2local?2private?9contract?9s@", i32 0, i32 0), i32 362)
  store i1 true, i1* %6, align 1
...
; <label>:22:                                     ; preds = %21, %19
  ...
  %25 = load %"class.sample::Foo.13"*, %"class.sample::Foo.13"** %3, align 4
  %26 = getelementptr inbounds %"class.sample::Foo.13", %"class.sample::Foo.13"* %25, i32 0, i32 1
  call x86_thiscallcc void @"\01?MergeFrom@?$InternalMetadataWithArenaBase@V?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@VInternalMetadataWithArenaLite@internal@protobuf@google@@@internal@protobuf@google@@QAEXABVInternalMetadataWithArenaLite@234@@Z"(%struct._iobuf* %24, %"class.google::protobuf::internal::InternalMetadataWithArena"* dereferenceable(4) %26)
  store i32 0, i32* %8, align 4
  %27 = load %"class.sample::Foo.13"*, %"class.sample::Foo.13"** %3, align 4
  %28 = call x86_thiscallcc dereferenceable(24) %"class.std::basic_string"* @"\01?s@Foo@sample@@QBEABV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@XZ"(%"class.sample::Foo.13"* %27)
...
; <label>:31:                                     ; preds = %22
  ...
  %33 = load %"class.sample::Foo.13"*, %"class.sample::Foo.13"** %3, align 4
...
; <label>:45:                                     ; preds = %31, %22
  %46 = load %"class.sample::Foo.13"*, %"class.sample::Foo.13"** %3, align 4
  %47 = call x86_thiscallcc i32 bitcast (i32 (%"class.sample::Foo"*)* @"\01?i32@Foo@sample@@QBEHXZ" to i32 (%"class.sample::Foo.13"*)*)(%"class.sample::Foo.13"* %46)
  %48 = icmp ne i32 %47, 0
  br i1 %48, label %49, label %52

; <label>:49:                                     ; preds = %45
  %50 = load %"class.sample::Foo.13"*, %"class.sample::Foo.13"** %3, align 4
  %51 = call x86_thiscallcc i32 bitcast (i32 (%"class.sample::Foo"*)* @"\01?i32@Foo@sample@@QBEHXZ" to i32 (%"class.sample::Foo.13"*)*)(%"class.sample::Foo.13"* %50)
  call x86_thiscallcc void bitcast (void (%"class.sample::Foo"*, i32)* @"\01?set_i32@Foo@sample@@QAEXH@Z" to void (%"class.sample::Foo.13"*, i32)*)(%"class.sample::Foo.13"* %10, i32 %51)
  br label %52

; <label>:52:                                     ; preds = %49, %45
  %53 = load %"class.sample::Foo.13"*, %"class.sample::Foo.13"** %3, align 4
  %54 = call x86_thiscallcc float @"\01?f@Foo@sample@@QBEMXZ"(%"class.sample::Foo.13"* %53)
  %55 = fcmp une float %54, 0.000000e+00
  br i1 %55, label %56, label %59

; <label>:56:                                     ; preds = %52
  %57 = load %"class.sample::Foo.13"*, %"class.sample::Foo.13"** %3, align 4
  %58 = call x86_thiscallcc float @"\01?f@Foo@sample@@QBEMXZ"(%"class.sample::Foo.13"* %57)
  call x86_thiscallcc void bitcast (void (%"class.sample::Foo"*, float)* @"\01?set_f@Foo@sample@@QAEXM@Z" to void (%"class.sample::Foo.13"*, float)*)(%"class.sample::Foo.13"* %10, float %58)
  br label %59
...
; Function Attrs: noinline optnone
define linkonce_odr x86_thiscallcc void @"\01?MergeFrom@?$InternalMetadataWithArenaBase@V?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@VInternalMetadataWithArenaLite@internal@protobuf@google@@@internal@protobuf@google@@QAEXABVInternalMetadataWithArenaLite@234@@Z"(%struct._iobuf*, %"class.google::protobuf::internal::InternalMetadataWithArena"* dereferenceable(4)) #0 comdat align 2 {
  ...
  %8 = call x86_thiscallcc zeroext i1 @"\01?have_unknown_fields@?$InternalMetadataWithArenaBase@V?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@VInternalMetadataWithArenaLite@internal@protobuf@google@@@internal@protobuf@google@@QBE_NXZ"(%struct._iobuf* %7)
  br i1 %8, label %9, label %14
...
; Function Attrs: noinline optnone
define linkonce_odr x86_thiscallcc void @"\01?Clear@?$InternalMetadataWithArenaBase@V?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@VInternalMetadataWithArenaLite@internal@protobuf@google@@@internal@protobuf@google@@QAEXXZ"(%struct._iobuf*) #0 comdat align 2 {
  %2 = alloca %struct._iobuf*, align 4
  store %struct._iobuf* %0, %struct._iobuf** %2, align 4
  %3 = load %struct._iobuf*, %struct._iobuf** %2, align 4
  %4 = call x86_thiscallcc zeroext i1 @"\01?have_unknown_fields@?$InternalMetadataWithArenaBase@V?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@VInternalMetadataWithArenaLite@internal@protobuf@google@@@internal@protobuf@google@@QBE_NXZ"(%struct._iobuf* %3)
...
define linkonce_odr x86_thiscallcc void @"\01?DoClear@InternalMetadataWithArenaLite@internal@protobuf@google@@QAEXXZ"(%"class.google::protobuf::internal::InternalMetadataWithArena"*) #0 comdat align 2 {
  ...
  call x86_thiscallcc void @"\01?clear@?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAEXXZ"(%"class.std::basic_string"* %5) #9
  ret void
}
...
; Function Attrs: noinline optnone
define linkonce_odr x86_thiscallcc void @"\01??$Own@VFoo@sample@@@Arena@protobuf@google@@QAEXPAVFoo@sample@@@Z"(%"class.google::protobuf::Arena"*, %"class.sample::Foo.13"*) #0 comdat align 2 {
  %3 = alloca %"class.sample::Foo.13"*, align 4
  %4 = alloca %"class.google::protobuf::Arena"*, align 4
  %5 = alloca %struct.__vcrt_assert_va_start_is_not_reference, align 4
  ...
  %9 = load %"class.sample::Foo.13"*, %"class.sample::Foo.13"** %3, align 4
  call x86_thiscallcc void @"\01??$OwnInternal@VFoo@sample@@@Arena@protobuf@google@@AAEXPAVFoo@sample@@U?$integral_constant@_N$0A@@internal@12@@Z"(%"class.google::protobuf::Arena"* %7, %"class.sample::Foo.13"* %9, %struct.__vcrt_assert_va_start_is_not_reference* byval align 4 %5)
  ret void
}

; Function Attrs: noinline optnone
define linkonce_odr x86_thiscallcc void @"\01??$OwnInternal@VFoo@sample@@@Arena@protobuf@google@@AAEXPAVFoo@sample@@U?$integral_constant@_N$0A@@internal@12@@Z"(%"class.google::protobuf::Arena"*, %"class.sample::Foo.13"*, %struct.__vcrt_assert_va_start_is_not_reference* byval align 4) #0 comdat align 2 {
  %4 = alloca %"class.sample::Foo.13"*, align 4
  %5 = alloca %"class.google::protobuf::Arena"*, align 4
  store %"class.sample::Foo.13"* %1, %"class.sample::Foo.13"** %4, align 4
  store %"class.google::protobuf::Arena"* %0, %"class.google::protobuf::Arena"** %5, align 4
  %6 = load %"class.google::protobuf::Arena"*, %"class.google::protobuf::Arena"** %5, align 4
  %7 = load %"class.sample::Foo.13"*, %"class.sample::Foo.13"** %4, align 4
  %8 = icmp ne %"class.sample::Foo.13"* %7, null
  br i1 %8, label %9, label %13

; <label>:9:                                      ; preds = %3
  %10 = getelementptr inbounds %"class.google::protobuf::Arena", %"class.google::protobuf::Arena"* %6, i32 0, i32 0
  %11 = load %"class.sample::Foo.13"*, %"class.sample::Foo.13"** %4, align 4
  %12 = bitcast %"class.sample::Foo.13"* %11 to i8*
  call x86_thiscallcc void @"\01?AddCleanup@ArenaImpl@internal@protobuf@google@@QAEXPAXP6AX0@Z@Z"(%"class.google::protobuf::internal::ArenaImpl"* %10, i8* %12, void (i8*)* @"\01??$arena_delete_object@VFoo@sample@@@internal@protobuf@google@@YAXPAX@Z")
  br label %13
...
; Function Attrs: noinline nounwind optnone
define linkonce_odr void @"\01??$arena_delete_object@VFoo@sample@@@internal@protobuf@google@@YAXPAX@Z"(i8*) #3 comdat {
  %2 = alloca i8*, align 4
  store i8* %0, i8** %2, align 4
  %3 = load i8*, i8** %2, align 4
...
; <label>:6:                                      ; preds = %1
  ...
  %8 = load i8* (%"class.sample::Foo.13"*, i32)**, i8* (%"class.sample::Foo.13"*, i32)*** %7, align 4
  %9 = getelementptr inbounds i8* (%"class.sample::Foo.13"*, i32)*, i8* (%"class.sample::Foo.13"*, i32)** %8, i64 0
  %10 = load i8* (%"class.sample::Foo.13"*, i32)*, i8* (%"class.sample::Foo.13"*, i32)** %9, align 4
  %11 = call x86_thiscallcc i8* %10(%"class.sample::Foo.13"* %4, i32 1) #9
  br label %12
...
; Function Attrs: noinline nounwind optnone
define x86_thiscallcc void @"\01??1Foo@sample@@UAE@XZ"(%"class.sample::Foo.13"*) unnamed_addr #3 align 2 personality i8* bitcast (i32 (...)* @__CxxFrameHandler3 to i8*) {
  %2 = alloca %"class.sample::Foo.13"*, align 4
  store %"class.sample::Foo.13"* %0, %"class.sample::Foo.13"** %2, align 4
  %3 = load %"class.sample::Foo.13"*, %"class.sample::Foo.13"** %2, align 4
  %4 = bitcast %"class.sample::Foo.13"* %3 to i32 (...)***
  store i32 (...)** bitcast (i8** @"\01??_7Foo@sample@@6B@" to i32 (...)**), i32 (...)*** %4, align 4
  invoke x86_thiscallcc void @"\01?SharedDtor@Foo@sample@@AAEXXZ"(%"class.sample::Foo.13"* %3)
          to label %5 unwind label %8

; <label>:5:                                      ; preds = %1
  %6 = getelementptr inbounds %"class.sample::Foo.13", %"class.sample::Foo.13"* %3, i32 0, i32 1
  call x86_thiscallcc void @"\01??1InternalMetadataWithArenaLite@internal@protobuf@google@@QAE@XZ"(%"class.google::protobuf::internal::InternalMetadataWithArena"* %6) #9
  %7 = bitcast %"class.sample::Foo.13"* %3 to %"class.google::protobuf::MessageLite"*
  call x86_thiscallcc void @"\01??1MessageLite@protobuf@google@@UAE@XZ"(%"class.google::protobuf::MessageLite"* %7) #9
  ret void

; <label>:8:                                      ; preds = %1
  %9 = cleanuppad within none []
  %10 = getelementptr inbounds %"class.sample::Foo.13", %"class.sample::Foo.13"* %3, i32 0, i32 1
  call x86_thiscallcc void @"\01??1InternalMetadataWithArenaLite@internal@protobuf@google@@QAE@XZ"(%"class.google::protobuf::internal::InternalMetadataWithArena"* %10) #9 [ "funclet"(token %9) ]
  cleanupret from %9 unwind label %11

; <label>:11:                                     ; preds = %8
  %12 = cleanuppad within none []
  %13 = bitcast %"class.sample::Foo.13"* %3 to %"class.google::protobuf::MessageLite"*
  call x86_thiscallcc void @"\01??1MessageLite@protobuf@google@@UAE@XZ"(%"class.google::protobuf::MessageLite"* %13) #9 [ "funclet"(token %12) ]
...
; Function Attrs: noinline optnone
define x86_thiscallcc void @"\01?SharedDtor@Foo@sample@@AAEXXZ"(%"class.sample::Foo.13"*) #0 align 2 {
  %2 = alloca %"class.sample::Foo.13"*, align 4
  store %"class.sample::Foo.13"* %0, %"class.sample::Foo.13"** %2, align 4
  %3 = load %"class.sample::Foo.13"*, %"class.sample::Foo.13"** %2, align 4
  %4 = getelementptr inbounds %"class.sample::Foo.13", %"class.sample::Foo.13"* %3, i32 0, i32 2
...
define void @"\01?InitDefaultsBarImpl@protobuf_SamplesLite_2eproto@@YAXXZ"() #0 {
  ...
  %4 = call x86_thiscallcc %"class.sample::Bar.23"* @"\01??0Bar@sample@@QAE@XZ"(%"class.sample::Bar.23"* %3)
  %5 = load i8*, i8** %1, align 4
  call void @"\01?OnShutdownDestroyMessage@internal@protobuf@google@@YAXPBX@Z"(i8* %5)
...
; Function Attrs: noinline optnone
define x86_thiscallcc %"class.sample::Bar.23"* @"\01??0Bar@sample@@QAE@XZ"(%"class.sample::Bar.23"* returned) unnamed_addr #0 align 2 personality i8* bitcast (i32 (...)* @__CxxFrameHandler3 to i8*) {
  %2 = alloca %"class.sample::Bar.23"*, align 4
  %3 = alloca %"class.sample::Bar.23"*, align 4
  store %"class.sample::Bar.23"* %0, %"class.sample::Bar.23"** %3, align 4
  %4 = load %"class.sample::Bar.23"*, %"class.sample::Bar.23"** %3, align 4
  store %"class.sample::Bar.23"* %4, %"class.sample::Bar.23"** %2, align 4
...
; <label>:10:                                     ; preds = %1
  %11 = invoke %"class.sample::Bar.23"* @"\01?internal_default_instance@Bar@sample@@SAPBV12@XZ"()
          to label %12 unwind label %19
...
; <label>:16:                                     ; preds = %15, %12
  invoke x86_thiscallcc void @"\01?SharedCtor@Bar@sample@@AAEXXZ"(%"class.sample::Bar.23"* %4)
          to label %17 unwind label %19

; <label>:17:                                     ; preds = %16
  %18 = load %"class.sample::Bar.23"*, %"class.sample::Bar.23"** %2, align 4
  ret %"class.sample::Bar.23"* %18

; <label>:19:                                     ; preds = %16, %14, %10
  %20 = cleanuppad within none []
  call x86_thiscallcc void @"\01??1InternalMetadataWithArenaLite@internal@protobuf@google@@QAE@XZ"(%"class.google::protobuf::internal::InternalMetadataWithArena"* %8) #9 [ "funclet"(token %20) ]
...
; <label>:21:                                     ; preds = %19, %1
  ...
  call x86_thiscallcc void @"\01??1MessageLite@protobuf@google@@UAE@XZ"(%"class.google::protobuf::MessageLite"* %23) #9 [ "funclet"(token %22) ]
  cleanupret from %22 unwind to caller
}

; Function Attrs: noinline optnone
define void @"\01?InitAsDefaultInstance@Bar@sample@@SAXXZ"() #0 align 2 {
  %1 = call %"class.sample::Foo.13"* @"\01?internal_default_instance@Foo@sample@@SAPBV12@XZ"()
  %2 = call x86_thiscallcc %"class.sample::Bar.23"* @"\01?get_mutable@?$ExplicitlyConstructed@VBar@sample@@@internal@protobuf@google@@QAEPAVBar@sample@@XZ"(%"class.google::protobuf::internal::ExplicitlyConstructed"* getelementptr inbounds (%"class.sample::FooDefaultTypeInternal", %"class.sample::FooDefaultTypeInternal"* @"\01?_Bar_default_instance_@sample@@3VBarDefaultTypeInternal@1@A", i32 0, i32 0))
...
; Function Attrs: noinline nounwind optnone
define linkonce_odr x86_thiscallcc %"class.sample::Bar.23"* @"\01?get_mutable@?$ExplicitlyConstructed@VBar@sample@@@internal@protobuf@google@@QAEPAVBar@sample@@XZ"(%"class.google::protobuf::internal::ExplicitlyConstructed"*) #3 comdat align 2 {
  %2 = alloca %"class.google::protobuf::internal::ExplicitlyConstructed"*, align 4
  store %"class.google::protobuf::internal::ExplicitlyConstructed"* %0, %"class.google::protobuf::internal::ExplicitlyConstructed"** %2, align 4
  %3 = load %"class.google::protobuf::internal::ExplicitlyConstructed"*, %"class.google::protobuf::internal::ExplicitlyConstructed"** %2, align 4
  %4 = getelementptr inbounds %"class.google::protobuf::internal::ExplicitlyConstructed", %"class.google::protobuf::internal::ExplicitlyConstructed"* %3, i32 0, i32 0
  %5 = bitcast %"union.google::protobuf::internal::ExplicitlyConstructed<std::basic_string<char, std::char_traits<char>, std::allocator<char> > >::AlignedUnion"* %4 to %"class.sample::Bar.23"*
  ret %"class.sample::Bar.23"* %5
}

; Function Attrs: noinline nounwind optnone
define linkonce_odr %"class.sample::Bar.23"* @"\01?internal_default_instance@Bar@sample@@SAPBV12@XZ"() #3 comdat align 2 {
...
define void @"\01?InitDefaultsBar@protobuf_SamplesLite_2eproto@@YAXXZ"() #0 {
  call void @"\01?GoogleOnceInit@protobuf@google@@YAXPAHP6AXXZ@Z"(i32* @"\01?once@?1??InitDefaultsBar@protobuf_SamplesLite_2eproto@@YAXXZ@4HA", void ()* @"\01?InitDefaultsBarImpl@protobuf_SamplesLite_2eproto@@YAXXZ")
  ret void
}

; Function Attrs: noinline nounwind optnone
define x86_thiscallcc void @"\01?SharedCtor@Bar@sample@@AAEXXZ"(%"class.sample::Bar.23"*) #3 align 2 {
  %2 = alloca %"class.sample::Bar.23"*, align 4
  store %"class.sample::Bar.23"* %0, %"class.sample::Bar.23"** %2, align 4
  %3 = load %"class.sample::Bar.23"*, %"class.sample::Bar.23"** %2, align 4
...
; Function Attrs: noinline nounwind optnone
define linkonce_odr x86_thiscallcc i8* @"\01??_GBar@sample@@UAEPAXI@Z"(%"class.sample::Bar.23"*, i32) unnamed_addr #3 comdat align 2 {
  %3 = alloca i8*, align 4
  %4 = alloca i32, align 4
  %5 = alloca %"class.sample::Bar.23"*, align 4
  store i32 %1, i32* %4, align 4
  store %"class.sample::Bar.23"* %0, %"class.sample::Bar.23"** %5, align 4
  %6 = load %"class.sample::Bar.23"*, %"class.sample::Bar.23"** %5, align 4
  %7 = bitcast %"class.sample::Bar.23"* %6 to i8*
  store i8* %7, i8** %3, align 4
  %8 = load i32, i32* %4, align 4
  call x86_thiscallcc void @"\01??1Bar@sample@@UAE@XZ"(%"class.sample::Bar.23"* %6) #9
  %9 = icmp eq i32 %8, 0
  br i1 %9, label %12, label %10
...
; Function Attrs: noinline optnone
define x86_thiscallcc void @"\01?GetTypeName@Bar@sample@@UBE?AV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@XZ"(%"class.sample::Bar.23"*, %"class.std::basic_string"* noalias sret) unnamed_addr #0 align 2 {
  %3 = alloca %"class.sample::Bar.23"*, align 4
  store %"class.sample::Bar.23"* %0, %"class.sample::Bar.23"** %3, align 4
  %4 = load %"class.sample::Bar.23"*, %"class.sample::Bar.23"** %3, align 4
  %5 = call x86_thiscallcc %"class.std::basic_string"* @"\01??0?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@QBD@Z"(%"class.std::basic_string"* %1, i8* getelementptr inbounds ([11 x i8], [11 x i8]* @"\01??_C@_0L@MDDOOBAE@sample?4Bar?$AA@", i32 0, i32 0))
  ret void
}

; Function Attrs: noinline optnone
define x86_thiscallcc %"class.sample::Bar.23"* @"\01?New@Bar@sample@@UBEPAV12@PAVArena@protobuf@google@@@Z"(%"class.sample::Bar.23"*, %"class.google::protobuf::Arena"*) unnamed_addr #0 align 2 personality i8* bitcast (i32 (...)* @__CxxFrameHandler3 to i8*) {
  %3 = alloca %"class.google::protobuf::Arena"*, align 4
  %4 = alloca %"class.sample::Bar.23"*, align 4
  %5 = alloca %"class.sample::Bar.23"*, align 4
  store %"class.google::protobuf::Arena"* %1, %"class.google::protobuf::Arena"** %3, align 4
  store %"class.sample::Bar.23"* %0, %"class.sample::Bar.23"** %4, align 4
  %6 = load %"class.sample::Bar.23"*, %"class.sample::Bar.23"** %4, align 4
  %7 = call i8* @"\01??2@YAPAXI@Z"(i32 24) #12
  %8 = bitcast i8* %7 to %"class.sample::Bar.23"*
  %9 = invoke x86_thiscallcc %"class.sample::Bar.23"* @"\01??0Bar@sample@@QAE@XZ"(%"class.sample::Bar.23"* %8)
          to label %10 unwind label %16

; <label>:10:                                     ; preds = %2
  store %"class.sample::Bar.23"* %8, %"class.sample::Bar.23"** %5, align 4
  %11 = load %"class.google::protobuf::Arena"*, %"class.google::protobuf::Arena"** %3, align 4
  %12 = icmp ne %"class.google::protobuf::Arena"* %11, null
  br i1 %12, label %13, label %18
...
; <label>:13:                                     ; preds = %10
  %14 = load %"class.google::protobuf::Arena"*, %"class.google::protobuf::Arena"** %3, align 4
  %15 = load %"class.sample::Bar.23"*, %"class.sample::Bar.23"** %5, align 4
  call x86_thiscallcc void @"\01??$Own@VBar@sample@@@Arena@protobuf@google@@QAEXPAVBar@sample@@@Z"(%"class.google::protobuf::Arena"* %14, %"class.sample::Bar.23"* %15)
  br label %18
...
; <label>:18:                                     ; preds = %13, %10
  %19 = load %"class.sample::Bar.23"*, %"class.sample::Bar.23"** %5, align 4
  ret %"class.sample::Bar.23"* %19
}

; Function Attrs: noinline optnone
define linkonce_odr x86_thiscallcc %"class.sample::Bar.23"* @"\01?New@Bar@sample@@UBEPAV12@XZ"(%"class.sample::Bar.23"*) unnamed_addr #0 comdat align 2 {
  %2 = alloca %"class.sample::Bar.23"*, align 4
  store %"class.sample::Bar.23"* %0, %"class.sample::Bar.23"** %2, align 4
  %3 = load %"class.sample::Bar.23"*, %"class.sample::Bar.23"** %2, align 4
  %4 = call x86_thiscallcc %"class.sample::Bar.23"* @"\01?New@Bar@sample@@UBEPAV12@PAVArena@protobuf@google@@@Z"(%"class.sample::Bar.23"* %3, %"class.google::protobuf::Arena"* null)
  ret %"class.sample::Bar.23"* %4
}

; Function Attrs: noinline optnone
define x86_thiscallcc void @"\01?Clear@Bar@sample@@UAEXXZ"(%"class.sample::Bar.23"*) unnamed_addr #0 align 2 {
  %2 = alloca %"class.sample::Bar.23"*, align 4
  %3 = alloca i32, align 4
  store %"class.sample::Bar.23"* %0, %"class.sample::Bar.23"** %2, align 4
  %4 = load %"class.sample::Bar.23"*, %"class.sample::Bar.23"** %2, align 4
  store i32 0, i32* %3, align 4
  %5 = call x86_thiscallcc %"class.google::protobuf::Arena"* bitcast (%"class.google::protobuf::Arena"* (%"class.sample::Bar"*)* @"\01?GetArenaNoVirtual@Bar@sample@@ABEPAVArena@protobuf@google@@XZ" to %"class.google::protobuf::Arena"* (%"class.sample::Bar.23"*)*)(%"class.sample::Bar.23"* %4)
...
; <label>:7:                                      ; preds = %1
  ...
  %9 = load %"class.sample::Foo.13"*, %"class.sample::Foo.13"** %8, align 4
  %10 = icmp ne %"class.sample::Foo.13"* %9, null
  br i1 %10, label %11, label %22

; <label>:11:                                     ; preds = %7
  %12 = getelementptr inbounds %"class.sample::Bar.23", %"class.sample::Bar.23"* %4, i32 0, i32 2
  %13 = load %"class.sample::Foo.13"*, %"class.sample::Foo.13"** %12, align 4
  %14 = icmp eq %"class.sample::Foo.13"* %13, null
  br i1 %14, label %21, label %15

; <label>:15:                                     ; preds = %11
  %16 = bitcast %"class.sample::Foo.13"* %13 to i8* (%"class.sample::Foo.13"*, i32)***
  %17 = load i8* (%"class.sample::Foo.13"*, i32)**, i8* (%"class.sample::Foo.13"*, i32)*** %16, align 4
  %18 = getelementptr inbounds i8* (%"class.sample::Foo.13"*, i32)*, i8* (%"class.sample::Foo.13"*, i32)** %17, i64 0
  %19 = load i8* (%"class.sample::Foo.13"*, i32)*, i8* (%"class.sample::Foo.13"*, i32)** %18, align 4
  %20 = call x86_thiscallcc i8* %19(%"class.sample::Foo.13"* %13, i32 1) #9
  br label %21
...
; <label>:22:                                     ; preds = %21, %7, %1
  ...
  store %"class.sample::Foo.13"* null, %"class.sample::Foo.13"** %23, align 4
  ...
  %35 = bitcast %"class.google::protobuf::internal::InternalMetadataWithArena"* %34 to %struct._iobuf*
  call x86_thiscallcc void @"\01?Clear@?$InternalMetadataWithArenaBase@V?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@VInternalMetadataWithArenaLite@internal@protobuf@google@@@internal@protobuf@google@@QAEXXZ"(%struct._iobuf* %35)
  ret void
}

; Function Attrs: noinline nounwind optnone
define x86_thiscallcc zeroext i1 @"\01?IsInitialized@Bar@sample@@UBE_NXZ"(%"class.sample::Bar.23"*) unnamed_addr #3 align 2 {
  %2 = alloca %"class.sample::Bar.23"*, align 4
  store %"class.sample::Bar.23"* %0, %"class.sample::Bar.23"** %2, align 4
  %3 = load %"class.sample::Bar.23"*, %"class.sample::Bar.23"** %2, align 4
  ret i1 true
...
; Function Attrs: noinline optnone
define x86_thiscallcc void @"\01?CheckTypeAndMergeFrom@Bar@sample@@UAEXABVMessageLite@protobuf@google@@@Z"(%"class.sample::Bar.23"*, %"class.google::protobuf::MessageLite"* dereferenceable(4)) unnamed_addr #0 align 2 {
  %3 = alloca %"class.google::protobuf::MessageLite"*, align 4
  %4 = alloca %"class.sample::Bar.23"*, align 4
  store %"class.google::protobuf::MessageLite"* %1, %"class.google::protobuf::MessageLite"** %3, align 4
  store %"class.sample::Bar.23"* %0, %"class.sample::Bar.23"** %4, align 4
  %5 = load %"class.sample::Bar.23"*, %"class.sample::Bar.23"** %4, align 4
  %6 = load %"class.google::protobuf::MessageLite"*, %"class.google::protobuf::MessageLite"** %3, align 4
  %7 = call %"class.sample::Bar.23"* @"\01??$down_cast@PBVBar@sample@@$$CBVMessageLite@protobuf@google@@@internal@protobuf@google@@YAPBVBar@sample@@PBVMessageLite@12@@Z"(%"class.google::protobuf::MessageLite"* %6)
  call x86_thiscallcc void @"\01?MergeFrom@Bar@sample@@QAEXABV12@@Z"(%"class.sample::Bar.23"* %5, %"class.sample::Bar.23"* dereferenceable(24) %7)
  ret void
}

; Function Attrs: noinline optnone
define x86_thiscallcc zeroext i1 @"\01?MergePartialFromCodedStream@Bar@sample@@UAE_NPAVCodedInputStream@io@protobuf@google@@@Z"(%"class.sample::Bar.23"*, %"class.google::protobuf::io::CodedInputStream"*) unnamed_addr #0 align 2 personality i8* bitcast (i32 (...)* @__CxxFrameHandler3 to i8*) {
  %3 = alloca i1, align 1
  %4 = alloca %"class.google::protobuf::io::CodedInputStream"*, align 4
  %5 = alloca %"class.sample::Bar.23"*, align 4
  %6 = alloca i32, align 4
  ...
  store %"class.google::protobuf::io::CodedInputStream"* %1, %"class.google::protobuf::io::CodedInputStream"** %4, align 4
  store %"class.sample::Bar.23"* %0, %"class.sample::Bar.23"** %5, align 4
  %12 = load %"class.sample::Bar.23"*, %"class.sample::Bar.23"** %5, align 4
...
; <label>:40:                                     ; preds = %35
  %41 = invoke x86_thiscallcc %"class.sample::Foo.13"* @"\01?mutable_foo@Bar@sample@@QAEPAVFoo@2@XZ"(%"class.sample::Bar.23"* %12)
...
; <label>:42:                                     ; preds = %40
  ...
  %45 = invoke zeroext i1 @"\01?ReadMessage@WireFormatLite@internal@protobuf@google@@SA_NPAVCodedInputStream@io@34@PAVMessageLite@34@@Z"(%"class.google::protobuf::io::CodedInputStream"* %44, %"class.google::protobuf::MessageLite"* %43)
...
; <label>:56:                                     ; preds = %51
  ...
  %58 = load %"class.google::protobuf::io::CodedInputStream"*, %"class.google::protobuf::io::CodedInputStream"** %4, align 4
  %59 = invoke zeroext i1 @"\01??$ReadPrimitive@H$04@WireFormatLite@internal@protobuf@google@@SA_NPAVCodedInputStream@io@23@PAH@Z"(%"class.google::protobuf::io::CodedInputStream"* %58, i32* %57)
...
; <label>:70:                                     ; preds = %65
  ...
  %72 = load %"class.google::protobuf::io::CodedInputStream"*, %"class.google::protobuf::io::CodedInputStream"** %4, align 4
  %73 = invoke zeroext i1 @"\01??$ReadPrimitive@M$01@WireFormatLite@internal@protobuf@google@@SA_NPAVCodedInputStream@io@23@PAM@Z"(%"class.google::protobuf::io::CodedInputStream"* %72, float* %71)
...
; <label>:84:                                     ; preds = %80
  %85 = load i32, i32* %6, align 4
  %86 = load %"class.google::protobuf::io::CodedInputStream"*, %"class.google::protobuf::io::CodedInputStream"** %4, align 4
  %87 = invoke zeroext i1 @"\01?SkipField@WireFormatLite@internal@protobuf@google@@SA_NPAVCodedInputStream@io@34@IPAVCodedOutputStream@634@@Z"(%"class.google::protobuf::io::CodedInputStream"* %86, i32 %85, %"class.google::protobuf::io::CodedOutputStream"* %9)
...
; <label>:96:                                     ; preds = %84, %70, %56, %42, %40, %31, %22
  ...
  call x86_thiscallcc void @"\01??1CodedOutputStream@io@protobuf@google@@QAE@XZ"(%"class.google::protobuf::io::CodedOutputStream"* %9) #9 [ "funclet"(token %97) ]
  cleanupret from %97 unwind label %98

; <label>:98:                                     ; preds = %96, %18
  %99 = cleanuppad within none []
  call x86_thiscallcc void @"\01??1StringOutputStream@io@protobuf@google@@UAE@XZ"(%"class.google::protobuf::io::StringOutputStream"* %8) #9 [ "funclet"(token %99) ]
  cleanupret from %99 unwind label %100

; <label>:100:                                    ; preds = %98, %16, %2
  %101 = cleanuppad within none []
  call x86_thiscallcc void @"\01??1LiteUnknownFieldSetter@internal@protobuf@google@@QAE@XZ"(%"class.google::protobuf::internal::LiteUnknownFieldSetter"* %7) #9 [ "funclet"(token %101) ]
  cleanupret from %101 unwind to caller
}

; Function Attrs: noinline optnone
define x86_thiscallcc i32 @"\01?ByteSizeLong@Bar@sample@@UBEIXZ"(%"class.sample::Bar.23"*) #0 align 2 {
  %2 = alloca %"class.sample::Bar.23"*, align 4
  %3 = alloca i32, align 4
  %4 = alloca i32, align 4
  store %"class.sample::Bar.23"* %0, %"class.sample::Bar.23"** %2, align 4
  %5 = load %"class.sample::Bar.23"*, %"class.sample::Bar.23"** %2, align 4
  store i32 0, i32* %3, align 4
  %6 = call zeroext i1 @"\01?GetProto3PreserveUnknownsDefault@internal@protobuf@google@@YA_NXZ"()
  br i1 %6, label %7, label %11
...
; <label>:14:                                     ; preds = %11, %7
  ...
  %18 = add i32 %17, %16
  store i32 %18, i32* %3, align 4
  %19 = call x86_thiscallcc zeroext i1 @"\01?has_foo@Bar@sample@@QBE_NXZ"(%"class.sample::Bar.23"* %5)
  br i1 %19, label %20, label %28

; <label>:20:                                     ; preds = %14
  %21 = getelementptr inbounds %"class.sample::Bar.23", %"class.sample::Bar.23"* %5, i32 0, i32 2
  %22 = load %"class.sample::Foo.13"*, %"class.sample::Foo.13"** %21, align 4
  %23 = bitcast %"class.sample::Foo.13"* %22 to %"class.google::protobuf::MessageLite"*
  %24 = call i32 @"\01?MessageSize@WireFormatLite@internal@protobuf@google@@SAIABVMessageLite@34@@Z"(%"class.google::protobuf::MessageLite"* dereferenceable(4) %23)
  %25 = add i32 1, %24
  %26 = load i32, i32* %3, align 4
  %27 = add i32 %26, %25
  store i32 %27, i32* %3, align 4
...
; <label>:28:                                     ; preds = %20, %14
  %29 = call x86_thiscallcc i32 bitcast (i32 (%"class.sample::Bar"*)* @"\01?i32@Bar@sample@@QBEHXZ" to i32 (%"class.sample::Bar.23"*)*)(%"class.sample::Bar.23"* %5)
  %30 = icmp ne i32 %29, 0
  br i1 %30, label %31, label %37

; <label>:31:                                     ; preds = %28
  %32 = call x86_thiscallcc i32 bitcast (i32 (%"class.sample::Bar"*)* @"\01?i32@Bar@sample@@QBEHXZ" to i32 (%"class.sample::Bar.23"*)*)(%"class.sample::Bar.23"* %5)
  %33 = call i32 @"\01?Int32Size@WireFormatLite@internal@protobuf@google@@SAIH@Z"(i32 %32)
  %34 = add i32 1, %33
  %35 = load i32, i32* %3, align 4
  %36 = add i32 %35, %34
...
; <label>:37:                                     ; preds = %31, %28
  %38 = call x86_thiscallcc float @"\01?f@Bar@sample@@QBEMXZ"(%"class.sample::Bar.23"* %5)
  %39 = fcmp une float %38, 0.000000e+00
  br i1 %39, label %40, label %43
...
; Function Attrs: noinline optnone
define x86_thiscallcc void @"\01?SerializeWithCachedSizes@Bar@sample@@UBEXPAVCodedOutputStream@io@protobuf@google@@@Z"(%"class.sample::Bar.23"*, %"class.google::protobuf::io::CodedOutputStream"*) unnamed_addr #0 align 2 {
  %3 = alloca %"class.google::protobuf::io::CodedOutputStream"*, align 4
  %4 = alloca %"class.sample::Bar.23"*, align 4
  %5 = alloca i32, align 4
  store %"class.google::protobuf::io::CodedOutputStream"* %1, %"class.google::protobuf::io::CodedOutputStream"** %3, align 4
  ...
  %6 = load %"class.sample::Bar.23"*, %"class.sample::Bar.23"** %4, align 4
  store i32 0, i32* %5, align 4
  %7 = call x86_thiscallcc zeroext i1 @"\01?has_foo@Bar@sample@@QBE_NXZ"(%"class.sample::Bar.23"* %6)
...
; <label>:8:                                      ; preds = %2
  ...
  %11 = load %"class.sample::Foo.13"*, %"class.sample::Foo.13"** %10, align 4
  %12 = bitcast %"class.sample::Foo.13"* %11 to %"class.google::protobuf::MessageLite"*
  call void @"\01?WriteMessage@WireFormatLite@internal@protobuf@google@@SAXHABVMessageLite@34@PAVCodedOutputStream@io@34@@Z"(i32 1, %"class.google::protobuf::MessageLite"* dereferenceable(4) %12, %"class.google::protobuf::io::CodedOutputStream"* %9)
  br label %13

; <label>:13:                                     ; preds = %8, %2
  %14 = call x86_thiscallcc i32 bitcast (i32 (%"class.sample::Bar"*)* @"\01?i32@Bar@sample@@QBEHXZ" to i32 (%"class.sample::Bar.23"*)*)(%"class.sample::Bar.23"* %6)
  %15 = icmp ne i32 %14, 0
  br i1 %15, label %16, label %19

; <label>:16:                                     ; preds = %13
  %17 = load %"class.google::protobuf::io::CodedOutputStream"*, %"class.google::protobuf::io::CodedOutputStream"** %3, align 4
  %18 = call x86_thiscallcc i32 bitcast (i32 (%"class.sample::Bar"*)* @"\01?i32@Bar@sample@@QBEHXZ" to i32 (%"class.sample::Bar.23"*)*)(%"class.sample::Bar.23"* %6)
...
; <label>:19:                                     ; preds = %16, %13
  %20 = call x86_thiscallcc float @"\01?f@Bar@sample@@QBEMXZ"(%"class.sample::Bar.23"* %6)
...
; <label>:22:                                     ; preds = %19
  ...
  %24 = call x86_thiscallcc float @"\01?f@Bar@sample@@QBEMXZ"(%"class.sample::Bar.23"* %6)
...
; <label>:25:                                     ; preds = %22, %19
  %26 = load %"class.google::protobuf::io::CodedOutputStream"*, %"class.google::protobuf::io::CodedOutputStream"** %3, align 4
...
; <label>:28:                                     ; preds = %25
  ...
  %31 = call x86_thiscallcc dereferenceable(24) %"class.std::basic_string"* @"\01?unknown_fields@?$InternalMetadataWithArenaBase@V?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@VInternalMetadataWithArenaLite@internal@protobuf@google@@@internal@protobuf@google@@QBEABV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@XZ"(%struct._iobuf* %30)
  br label %35

; <label>:32:                                     ; preds = %25
  %33 = getelementptr inbounds %"class.sample::Bar.23", %"class.sample::Bar.23"* %6, i32 0, i32 1
  %34 = call dereferenceable(24) %"class.std::basic_string"* @"\01?default_instance@InternalMetadataWithArenaLite@internal@protobuf@google@@SAABV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@XZ"()
  br label %35

; <label>:35:                                     ; preds = %32, %28
  %36 = phi %"class.std::basic_string"* [ %31, %28 ], [ %34, %32 ]
  %37 = call x86_thiscallcc i32 @"\01?size@?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QBEIXZ"(%"class.std::basic_string"* %36) #9
  %38 = call zeroext i1 @"\01?GetProto3PreserveUnknownsDefault@internal@protobuf@google@@YA_NXZ"()
  br i1 %38, label %39, label %43

; <label>:39:                                     ; preds = %35
  %40 = getelementptr inbounds %"class.sample::Bar.23", %"class.sample::Bar.23"* %6, i32 0, i32 1
  %41 = bitcast %"class.google::protobuf::internal::InternalMetadataWithArena"* %40 to %struct._iobuf*
  %42 = call x86_thiscallcc dereferenceable(24) %"class.std::basic_string"* @"\01?unknown_fields@?$InternalMetadataWithArenaBase@V?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@VInternalMetadataWithArenaLite@internal@protobuf@google@@@internal@protobuf@google@@QBEABV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@XZ"(%struct._iobuf* %41)
  br label %46

; <label>:43:                                     ; preds = %35
  %44 = getelementptr inbounds %"class.sample::Bar.23", %"class.sample::Bar.23"* %6, i32 0, i32 1
  %45 = call dereferenceable(24) %"class.std::basic_string"* @"\01?default_instance@InternalMetadataWithArenaLite@internal@protobuf@google@@SAABV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@XZ"()
  br label %46

; <label>:46:                                     ; preds = %43, %39
  %47 = phi %"class.std::basic_string"* [ %42, %39 ], [ %45, %43 ]
  %48 = call x86_thiscallcc i8* @"\01?data@?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QBEPBDXZ"(%"class.std::basic_string"* %47) #9
  call x86_thiscallcc void @"\01?WriteRaw@CodedOutputStream@io@protobuf@google@@QAEXPBXH@Z"(%"class.google::protobuf::io::CodedOutputStream"* %26, i8* %48, i32 %37)
  ret void
}

; Function Attrs: noinline nounwind optnone
define linkonce_odr x86_thiscallcc i32 @"\01?GetCachedSize@Bar@sample@@UBEHXZ"(%"class.sample::Bar.23"*) unnamed_addr #3 comdat align 2 {
  %2 = alloca %"class.sample::Bar.23"*, align 4
  store %"class.sample::Bar.23"* %0, %"class.sample::Bar.23"** %2, align 4
  %3 = load %"class.sample::Bar.23"*, %"class.sample::Bar.23"** %2, align 4
...
; Function Attrs: noinline nounwind optnone
define linkonce_odr x86_thiscallcc zeroext i1 @"\01?has_foo@Bar@sample@@QBE_NXZ"(%"class.sample::Bar.23"*) #3 comdat align 2 {
  %2 = alloca %"class.sample::Bar.23"*, align 4
  store %"class.sample::Bar.23"* %0, %"class.sample::Bar.23"** %2, align 4
  %3 = load %"class.sample::Bar.23"*, %"class.sample::Bar.23"** %2, align 4
  %4 = call %"class.sample::Bar.23"* @"\01?internal_default_instance@Bar@sample@@SAPBV12@XZ"()
  %5 = icmp ne %"class.sample::Bar.23"* %3, %4
  br i1 %5, label %6, label %10

; <label>:6:                                      ; preds = %1
  %7 = getelementptr inbounds %"class.sample::Bar.23", %"class.sample::Bar.23"* %3, i32 0, i32 2
  %8 = load %"class.sample::Foo.13"*, %"class.sample::Foo.13"** %7, align 4
...
declare void @"\01?WriteMessage@WireFormatLite@internal@protobuf@google@@SAXHABVMessageLite@34@PAVCodedOutputStream@io@34@@Z"(i32, %"class.google::protobuf::MessageLite"* dereferenceable(4), %"class.google::protobuf::io::CodedOutputStream"*) #1

; Function Attrs: noinline nounwind optnone
define linkonce_odr x86_thiscallcc float @"\01?f@Bar@sample@@QBEMXZ"(%"class.sample::Bar.23"*) #3 comdat align 2 {
  %2 = alloca %"class.sample::Bar.23"*, align 4
  store %"class.sample::Bar.23"* %0, %"class.sample::Bar.23"** %2, align 4
  %3 = load %"class.sample::Bar.23"*, %"class.sample::Bar.23"** %2, align 4
...
; Function Attrs: noinline optnone
define linkonce_odr x86_thiscallcc %"class.sample::Foo.13"* @"\01?mutable_foo@Bar@sample@@QAEPAVFoo@2@XZ"(%"class.sample::Bar.23"*) #0 comdat align 2 personality i8* bitcast (i32 (...)* @__CxxFrameHandler3 to i8*) {
  %2 = alloca %"class.sample::Bar.23"*, align 4
  store %"class.sample::Bar.23"* %0, %"class.sample::Bar.23"** %2, align 4
  %3 = load %"class.sample::Bar.23"*, %"class.sample::Bar.23"** %2, align 4
  %4 = getelementptr inbounds %"class.sample::Bar.23", %"class.sample::Bar.23"* %3, i32 0, i32 2
...
; <label>:7:                                      ; preds = %1
  ...
  %9 = bitcast i8* %8 to %"class.sample::Foo.13"*
  %10 = invoke x86_thiscallcc %"class.sample::Foo.13"* @"\01??0Foo@sample@@QAE@XZ"(%"class.sample::Foo.13"* %9)
          to label %11 unwind label %13

; <label>:11:                                     ; preds = %7
  %12 = getelementptr inbounds %"class.sample::Bar.23", %"class.sample::Bar.23"* %3, i32 0, i32 2
  store %"class.sample::Foo.13"* %9, %"class.sample::Foo.13"** %12, align 4
  br label %15
...
; <label>:15:                                     ; preds = %11, %1
  ...
  %17 = load %"class.sample::Foo.13"*, %"class.sample::Foo.13"** %16, align 4
...
; <label>:11:                                     ; preds = %2
  ...
  call x86_thiscallcc void @"\01?IncrementRecursionDepthAndPushLimit@CodedInputStream@io@protobuf@google@@QAE?AU?$pair@HH@std@@H@Z"(%"class.google::protobuf::io::CodedInputStream"* %12, %"struct.std::pair.51"* sret %7, i32 %13)
...
declare x86_thiscallcc void @"\01?IncrementRecursionDepthAndPushLimit@CodedInputStream@io@protobuf@google@@QAE?AU?$pair@HH@std@@H@Z"(%"class.google::protobuf::io::CodedInputStream"*, %"struct.std::pair.51"* sret, i32) #1
...
; Function Attrs: noinline optnone
define linkonce_odr %"class.sample::Bar.23"* @"\01??$down_cast@PBVBar@sample@@$$CBVMessageLite@protobuf@google@@@internal@protobuf@google@@YAPBVBar@sample@@PBVMessageLite@12@@Z"(%"class.google::protobuf::MessageLite"*) #0 comdat {
  %2 = alloca %"class.google::protobuf::MessageLite"*, align 4
  store %"class.google::protobuf::MessageLite"* %0, %"class.google::protobuf::MessageLite"** %2, align 4
  %3 = load %"class.google::protobuf::MessageLite"*, %"class.google::protobuf::MessageLite"** %2, align 4
  %4 = icmp eq %"class.google::protobuf::MessageLite"* %3, null
...
; Function Attrs: noinline optnone
define x86_thiscallcc void @"\01?MergeFrom@Bar@sample@@QAEXABV12@@Z"(%"class.sample::Bar.23"*, %"class.sample::Bar.23"* dereferenceable(24)) #0 align 2 personality i8* bitcast (i32 (...)* @__CxxFrameHandler3 to i8*) {
  %3 = alloca %"class.sample::Bar.23"*, align 4
  %4 = alloca %"class.sample::Bar.23"*, align 4
  %5 = alloca %"class.google::protobuf::internal::LogMessage", align 4
  %6 = alloca i1, align 1
  %7 = alloca %struct.__vcrt_assert_va_start_is_not_reference, align 1
  %8 = alloca i32, align 4
  store %"class.sample::Bar.23"* %1, %"class.sample::Bar.23"** %3, align 4
  store %"class.sample::Bar.23"* %0, %"class.sample::Bar.23"** %4, align 4
  %9 = load %"class.sample::Bar.23"*, %"class.sample::Bar.23"** %4, align 4
  %10 = load %"class.sample::Bar.23"*, %"class.sample::Bar.23"** %3, align 4
...
; <label>:13:                                     ; preds = %2
  %14 = call x86_thiscallcc %"class.google::protobuf::internal::LogMessage"* @"\01??0LogMessage@internal@protobuf@google@@QAE@W4LogLevel@23@PBDH@Z"(%"class.google::protobuf::internal::LogMessage"* %5, i32 3, i8* getelementptr inbounds ([73 x i8], [73 x i8]* @"\01??_C@_0EJ@KDOHDODM@E?3?2work?2local?2private?9contract?9s@", i32 0, i32 0), i32 636)
  store i1 true, i1* %6, align 1
...
; <label>:21:                                     ; preds = %20, %18
  ...
  %24 = load %"class.sample::Bar.23"*, %"class.sample::Bar.23"** %3, align 4
  %25 = getelementptr inbounds %"class.sample::Bar.23", %"class.sample::Bar.23"* %24, i32 0, i32 1
  call x86_thiscallcc void @"\01?MergeFrom@?$InternalMetadataWithArenaBase@V?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@VInternalMetadataWithArenaLite@internal@protobuf@google@@@internal@protobuf@google@@QAEXABVInternalMetadataWithArenaLite@234@@Z"(%struct._iobuf* %23, %"class.google::protobuf::internal::InternalMetadataWithArena"* dereferenceable(4) %25)
  store i32 0, i32* %8, align 4
  %26 = load %"class.sample::Bar.23"*, %"class.sample::Bar.23"** %3, align 4
  %27 = call x86_thiscallcc zeroext i1 @"\01?has_foo@Bar@sample@@QBE_NXZ"(%"class.sample::Bar.23"* %26)
  br i1 %27, label %28, label %37

; <label>:28:                                     ; preds = %21
  %29 = call x86_thiscallcc %"class.sample::Foo.13"* @"\01?mutable_foo@Bar@sample@@QAEPAVFoo@2@XZ"(%"class.sample::Bar.23"* %9)
  %30 = load %"class.sample::Bar.23"*, %"class.sample::Bar.23"** %3, align 4
  %31 = call x86_thiscallcc dereferenceable(24) %"class.sample::Foo.13"* bitcast (%"class.sample::Foo"* (%"class.sample::Bar"*)* @"\01?foo@Bar@sample@@QBEABVFoo@2@XZ" to %"class.sample::Foo.13"* (%"class.sample::Bar.23"*)*)(%"class.sample::Bar.23"* %30)
  call x86_thiscallcc void @"\01?MergeFrom@Foo@sample@@QAEXABV12@@Z"(%"class.sample::Foo.13"* %29, %"class.sample::Foo.13"* dereferenceable(24) %31)
  br label %37
...
; <label>:37:                                     ; preds = %28, %21
  %38 = load %"class.sample::Bar.23"*, %"class.sample::Bar.23"** %3, align 4
  %39 = call x86_thiscallcc i32 bitcast (i32 (%"class.sample::Bar"*)* @"\01?i32@Bar@sample@@QBEHXZ" to i32 (%"class.sample::Bar.23"*)*)(%"class.sample::Bar.23"* %38)
  %40 = icmp ne i32 %39, 0
  br i1 %40, label %41, label %44

; <label>:41:                                     ; preds = %37
  %42 = load %"class.sample::Bar.23"*, %"class.sample::Bar.23"** %3, align 4
  %43 = call x86_thiscallcc i32 bitcast (i32 (%"class.sample::Bar"*)* @"\01?i32@Bar@sample@@QBEHXZ" to i32 (%"class.sample::Bar.23"*)*)(%"class.sample::Bar.23"* %42)
  call x86_thiscallcc void bitcast (void (%"class.sample::Bar"*, i32)* @"\01?set_i32@Bar@sample@@QAEXH@Z" to void (%"class.sample::Bar.23"*, i32)*)(%"class.sample::Bar.23"* %9, i32 %43)
  br label %44

; <label>:44:                                     ; preds = %41, %37
  %45 = load %"class.sample::Bar.23"*, %"class.sample::Bar.23"** %3, align 4
  %46 = call x86_thiscallcc float @"\01?f@Bar@sample@@QBEMXZ"(%"class.sample::Bar.23"* %45)
  %47 = fcmp une float %46, 0.000000e+00
  br i1 %47, label %48, label %51

; <label>:48:                                     ; preds = %44
  %49 = load %"class.sample::Bar.23"*, %"class.sample::Bar.23"** %3, align 4
  %50 = call x86_thiscallcc float @"\01?f@Bar@sample@@QBEMXZ"(%"class.sample::Bar.23"* %49)
  call x86_thiscallcc void @"\01?set_f@Bar@sample@@QAEXM@Z"(%"class.sample::Bar.23"* %9, float %50)
  br label %51
...
; Function Attrs: noinline nounwind optnone
define linkonce_odr x86_thiscallcc void @"\01?set_f@Bar@sample@@QAEXM@Z"(%"class.sample::Bar.23"*, float) #3 comdat align 2 {
  %3 = alloca float, align 4
  %4 = alloca %"class.sample::Bar.23"*, align 4
  store float %1, float* %3, align 4
  store %"class.sample::Bar.23"* %0, %"class.sample::Bar.23"** %4, align 4
...
; Function Attrs: noinline optnone
define linkonce_odr x86_thiscallcc void @"\01??$Own@VBar@sample@@@Arena@protobuf@google@@QAEXPAVBar@sample@@@Z"(%"class.google::protobuf::Arena"*, %"class.sample::Bar.23"*) #0 comdat align 2 {
  %3 = alloca %"class.sample::Bar.23"*, align 4
  %4 = alloca %"class.google::protobuf::Arena"*, align 4
  %5 = alloca %struct.__vcrt_assert_va_start_is_not_reference, align 4
  %6 = alloca %struct.__vcrt_assert_va_start_is_not_reference, align 1
  ...
  %7 = load %"class.google::protobuf::Arena"*, %"class.google::protobuf::Arena"** %4, align 4
  %8 = bitcast %struct.__vcrt_assert_va_start_is_not_reference* %6 to %struct.__vcrt_assert_va_start_is_not_reference*
  %9 = load %"class.sample::Bar.23"*, %"class.sample::Bar.23"** %3, align 4
  call x86_thiscallcc void @"\01??$OwnInternal@VBar@sample@@@Arena@protobuf@google@@AAEXPAVBar@sample@@U?$integral_constant@_N$0A@@internal@12@@Z"(%"class.google::protobuf::Arena"* %7, %"class.sample::Bar.23"* %9, %struct.__vcrt_assert_va_start_is_not_reference* byval align 4 %5)
  ret void
}

; Function Attrs: noinline optnone
define linkonce_odr x86_thiscallcc void @"\01??$OwnInternal@VBar@sample@@@Arena@protobuf@google@@AAEXPAVBar@sample@@U?$integral_constant@_N$0A@@internal@12@@Z"(%"class.google::protobuf::Arena"*, %"class.sample::Bar.23"*, %struct.__vcrt_assert_va_start_is_not_reference* byval align 4) #0 comdat align 2 {
  %4 = alloca %"class.sample::Bar.23"*, align 4
  %5 = alloca %"class.google::protobuf::Arena"*, align 4
  store %"class.sample::Bar.23"* %1, %"class.sample::Bar.23"** %4, align 4
  store %"class.google::protobuf::Arena"* %0, %"class.google::protobuf::Arena"** %5, align 4
  %6 = load %"class.google::protobuf::Arena"*, %"class.google::protobuf::Arena"** %5, align 4
  %7 = load %"class.sample::Bar.23"*, %"class.sample::Bar.23"** %4, align 4
  %8 = icmp ne %"class.sample::Bar.23"* %7, null
  br i1 %8, label %9, label %13

; <label>:9:                                      ; preds = %3
  %10 = getelementptr inbounds %"class.google::protobuf::Arena", %"class.google::protobuf::Arena"* %6, i32 0, i32 0
  %11 = load %"class.sample::Bar.23"*, %"class.sample::Bar.23"** %4, align 4
  %12 = bitcast %"class.sample::Bar.23"* %11 to i8*
  call x86_thiscallcc void @"\01?AddCleanup@ArenaImpl@internal@protobuf@google@@QAEXPAXP6AX0@Z@Z"(%"class.google::protobuf::internal::ArenaImpl"* %10, i8* %12, void (i8*)* @"\01??$arena_delete_object@VBar@sample@@@internal@protobuf@google@@YAXPAX@Z")
  br label %13
...
; Function Attrs: noinline nounwind optnone
define linkonce_odr void @"\01??$arena_delete_object@VBar@sample@@@internal@protobuf@google@@YAXPAX@Z"(i8*) #3 comdat {
  %2 = alloca i8*, align 4
  store i8* %0, i8** %2, align 4
  %3 = load i8*, i8** %2, align 4
...
; <label>:6:                                      ; preds = %1
  ...
  %8 = load i8* (%"class.sample::Bar.23"*, i32)**, i8* (%"class.sample::Bar.23"*, i32)*** %7, align 4
  %9 = getelementptr inbounds i8* (%"class.sample::Bar.23"*, i32)*, i8* (%"class.sample::Bar.23"*, i32)** %8, i64 0
  %10 = load i8* (%"class.sample::Bar.23"*, i32)*, i8* (%"class.sample::Bar.23"*, i32)** %9, align 4
  %11 = call x86_thiscallcc i8* %10(%"class.sample::Bar.23"* %4, i32 1) #9
  br label %12
...
; Function Attrs: noinline nounwind optnone
define x86_thiscallcc void @"\01??1Bar@sample@@UAE@XZ"(%"class.sample::Bar.23"*) unnamed_addr #3 align 2 personality i8* bitcast (i32 (...)* @__CxxFrameHandler3 to i8*) {
  %2 = alloca %"class.sample::Bar.23"*, align 4
  store %"class.sample::Bar.23"* %0, %"class.sample::Bar.23"** %2, align 4
  %3 = load %"class.sample::Bar.23"*, %"class.sample::Bar.23"** %2, align 4
  %4 = bitcast %"class.sample::Bar.23"* %3 to i32 (...)***
  store i32 (...)** bitcast (i8** @"\01??_7Bar@sample@@6B@" to i32 (...)**), i32 (...)*** %4, align 4
  invoke x86_thiscallcc void @"\01?SharedDtor@Bar@sample@@AAEXXZ"(%"class.sample::Bar.23"* %3)
          to label %5 unwind label %8
...
; Function Attrs: noinline optnone
define x86_thiscallcc void @"\01?SharedDtor@Bar@sample@@AAEXXZ"(%"class.sample::Bar.23"*) #0 align 2 {
  %2 = alloca %"class.sample::Bar.23"*, align 4
  store %"class.sample::Bar.23"* %0, %"class.sample::Bar.23"** %2, align 4
  %3 = load %"class.sample::Bar.23"*, %"class.sample::Bar.23"** %2, align 4
  %4 = call %"class.sample::Bar.23"* @"\01?internal_default_instance@Bar@sample@@SAPBV12@XZ"()
...
; <label>:10:                                     ; preds = %6
  ...
  %12 = load i8* (%"class.sample::Foo.13"*, i32)**, i8* (%"class.sample::Foo.13"*, i32)*** %11, align 4
  %13 = getelementptr inbounds i8* (%"class.sample::Foo.13"*, i32)*, i8* (%"class.sample::Foo.13"*, i32)** %12, i64 0
  %14 = load i8* (%"class.sample::Foo.13"*, i32)*, i8* (%"class.sample::Foo.13"*, i32)** %13, align 4
  %15 = call x86_thiscallcc i8* %14(%"class.sample::Foo.13"* %8, i32 1) #9
  br label %16
...
define void @"\01?InitDefaultsPointImpl@protobuf_SamplesLite_2eproto@@YAXXZ"() #0 {
  ...
  %4 = call x86_thiscallcc %"class.sample::Point.24"* @"\01??0Point@sample@@QAE@XZ"(%"class.sample::Point.24"* %3)
  %5 = load i8*, i8** %1, align 4
  call void @"\01?OnShutdownDestroyMessage@internal@protobuf@google@@YAXPBX@Z"(i8* %5)
...
; Function Attrs: noinline optnone
define x86_thiscallcc %"class.sample::Point.24"* @"\01??0Point@sample@@QAE@XZ"(%"class.sample::Point.24"* returned) unnamed_addr #0 align 2 personality i8* bitcast (i32 (...)* @__CxxFrameHandler3 to i8*) {
  %2 = alloca %"class.sample::Point.24"*, align 4
  %3 = alloca %"class.sample::Point.24"*, align 4
  store %"class.sample::Point.24"* %0, %"class.sample::Point.24"** %3, align 4
  %4 = load %"class.sample::Point.24"*, %"class.sample::Point.24"** %3, align 4
  store %"class.sample::Point.24"* %4, %"class.sample::Point.24"** %2, align 4
...
; <label>:10:                                     ; preds = %1
  %11 = invoke %"class.sample::Point.24"* @"\01?internal_default_instance@Point@sample@@SAPBV12@XZ"()
          to label %12 unwind label %19
...
; <label>:16:                                     ; preds = %15, %12
  invoke x86_thiscallcc void @"\01?SharedCtor@Point@sample@@AAEXXZ"(%"class.sample::Point.24"* %4)
          to label %17 unwind label %19

; <label>:17:                                     ; preds = %16
  %18 = load %"class.sample::Point.24"*, %"class.sample::Point.24"** %2, align 4
...
; Function Attrs: noinline nounwind optnone
define linkonce_odr %"class.sample::Point.24"* @"\01?internal_default_instance@Point@sample@@SAPBV12@XZ"() #3 comdat align 2 {
  ret %"class.sample::Point.24"* bitcast (%"class.sample::FooDefaultTypeInternal"* @"\01?_Point_default_instance_@sample@@3VPointDefaultTypeInternal@1@A" to %"class.sample::Point.24"*)
}

; Function Attrs: noinline optnone
define void @"\01?InitDefaultsPoint@protobuf_SamplesLite_2eproto@@YAXXZ"() #0 {
  call void @"\01?GoogleOnceInit@protobuf@google@@YAXPAHP6AXXZ@Z"(i32* @"\01?once@?1??InitDefaultsPoint@protobuf_SamplesLite_2eproto@@YAXXZ@4HA", void ()* @"\01?InitDefaultsPointImpl@protobuf_SamplesLite_2eproto@@YAXXZ")
  ret void
}

; Function Attrs: noinline nounwind optnone
define x86_thiscallcc void @"\01?SharedCtor@Point@sample@@AAEXXZ"(%"class.sample::Point.24"*) #3 align 2 {
  %2 = alloca %"class.sample::Point.24"*, align 4
  store %"class.sample::Point.24"* %0, %"class.sample::Point.24"** %2, align 4
  %3 = load %"class.sample::Point.24"*, %"class.sample::Point.24"** %2, align 4
...
; Function Attrs: noinline nounwind optnone
define linkonce_odr x86_thiscallcc i8* @"\01??_GPoint@sample@@UAEPAXI@Z"(%"class.sample::Point.24"*, i32) unnamed_addr #3 comdat align 2 {
  %3 = alloca i8*, align 4
  %4 = alloca i32, align 4
  %5 = alloca %"class.sample::Point.24"*, align 4
  store i32 %1, i32* %4, align 4
  store %"class.sample::Point.24"* %0, %"class.sample::Point.24"** %5, align 4
  %6 = load %"class.sample::Point.24"*, %"class.sample::Point.24"** %5, align 4
  %7 = bitcast %"class.sample::Point.24"* %6 to i8*
  store i8* %7, i8** %3, align 4
  %8 = load i32, i32* %4, align 4
  call x86_thiscallcc void @"\01??1Point@sample@@UAE@XZ"(%"class.sample::Point.24"* %6) #9
  %9 = icmp eq i32 %8, 0
  br i1 %9, label %12, label %10
...
; Function Attrs: noinline optnone
define x86_thiscallcc void @"\01?GetTypeName@Point@sample@@UBE?AV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@XZ"(%"class.sample::Point.24"*, %"class.std::basic_string"* noalias sret) unnamed_addr #0 align 2 {
  %3 = alloca %"class.sample::Point.24"*, align 4
  store %"class.sample::Point.24"* %0, %"class.sample::Point.24"** %3, align 4
  %4 = load %"class.sample::Point.24"*, %"class.sample::Point.24"** %3, align 4
  %5 = call x86_thiscallcc %"class.std::basic_string"* @"\01??0?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@QBD@Z"(%"class.std::basic_string"* %1, i8* getelementptr inbounds ([13 x i8], [13 x i8]* @"\01??_C@_0N@MMENEDGD@sample?4Point?$AA@", i32 0, i32 0))
  ret void
}

; Function Attrs: noinline optnone
define x86_thiscallcc %"class.sample::Point.24"* @"\01?New@Point@sample@@UBEPAV12@PAVArena@protobuf@google@@@Z"(%"class.sample::Point.24"*, %"class.google::protobuf::Arena"*) unnamed_addr #0 align 2 personality i8* bitcast (i32 (...)* @__CxxFrameHandler3 to i8*) {
  %3 = alloca %"class.google::protobuf::Arena"*, align 4
  %4 = alloca %"class.sample::Point.24"*, align 4
  %5 = alloca %"class.sample::Point.24"*, align 4
  store %"class.google::protobuf::Arena"* %1, %"class.google::protobuf::Arena"** %3, align 4
  store %"class.sample::Point.24"* %0, %"class.sample::Point.24"** %4, align 4
  %6 = load %"class.sample::Point.24"*, %"class.sample::Point.24"** %4, align 4
  %7 = call i8* @"\01??2@YAPAXI@Z"(i32 20) #12
  %8 = bitcast i8* %7 to %"class.sample::Point.24"*
  %9 = invoke x86_thiscallcc %"class.sample::Point.24"* @"\01??0Point@sample@@QAE@XZ"(%"class.sample::Point.24"* %8)
          to label %10 unwind label %16

; <label>:10:                                     ; preds = %2
  store %"class.sample::Point.24"* %8, %"class.sample::Point.24"** %5, align 4
  %11 = load %"class.google::protobuf::Arena"*, %"class.google::protobuf::Arena"** %3, align 4
  %12 = icmp ne %"class.google::protobuf::Arena"* %11, null
  br i1 %12, label %13, label %18
...
; <label>:13:                                     ; preds = %10
  %14 = load %"class.google::protobuf::Arena"*, %"class.google::protobuf::Arena"** %3, align 4
  %15 = load %"class.sample::Point.24"*, %"class.sample::Point.24"** %5, align 4
  call x86_thiscallcc void @"\01??$Own@VPoint@sample@@@Arena@protobuf@google@@QAEXPAVPoint@sample@@@Z"(%"class.google::protobuf::Arena"* %14, %"class.sample::Point.24"* %15)
  br label %18
...
; <label>:18:                                     ; preds = %13, %10
  %19 = load %"class.sample::Point.24"*, %"class.sample::Point.24"** %5, align 4
  ret %"class.sample::Point.24"* %19
}

; Function Attrs: noinline optnone
define linkonce_odr x86_thiscallcc %"class.sample::Point.24"* @"\01?New@Point@sample@@UBEPAV12@XZ"(%"class.sample::Point.24"*) unnamed_addr #0 comdat align 2 {
  %2 = alloca %"class.sample::Point.24"*, align 4
  store %"class.sample::Point.24"* %0, %"class.sample::Point.24"** %2, align 4
  %3 = load %"class.sample::Point.24"*, %"class.sample::Point.24"** %2, align 4
  %4 = call x86_thiscallcc %"class.sample::Point.24"* @"\01?New@Point@sample@@UBEPAV12@PAVArena@protobuf@google@@@Z"(%"class.sample::Point.24"* %3, %"class.google::protobuf::Arena"* null)
  ret %"class.sample::Point.24"* %4
}

; Function Attrs: noinline optnone
define x86_thiscallcc void @"\01?Clear@Point@sample@@UAEXXZ"(%"class.sample::Point.24"*) unnamed_addr #0 align 2 {
  %2 = alloca %"class.sample::Point.24"*, align 4
  %3 = alloca i32, align 4
  store %"class.sample::Point.24"* %0, %"class.sample::Point.24"** %2, align 4
  %4 = load %"class.sample::Point.24"*, %"class.sample::Point.24"** %2, align 4
  store i32 0, i32* %3, align 4
  ...
  call x86_thiscallcc void @"\01?Clear@?$InternalMetadataWithArenaBase@V?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@VInternalMetadataWithArenaLite@internal@protobuf@google@@@internal@protobuf@google@@QAEXXZ"(%struct._iobuf* %16)
  ret void
}

; Function Attrs: noinline nounwind optnone
define x86_thiscallcc zeroext i1 @"\01?IsInitialized@Point@sample@@UBE_NXZ"(%"class.sample::Point.24"*) unnamed_addr #3 align 2 {
  %2 = alloca %"class.sample::Point.24"*, align 4
  store %"class.sample::Point.24"* %0, %"class.sample::Point.24"** %2, align 4
  %3 = load %"class.sample::Point.24"*, %"class.sample::Point.24"** %2, align 4
  ret i1 true
...
; Function Attrs: noinline optnone
define x86_thiscallcc void @"\01?CheckTypeAndMergeFrom@Point@sample@@UAEXABVMessageLite@protobuf@google@@@Z"(%"class.sample::Point.24"*, %"class.google::protobuf::MessageLite"* dereferenceable(4)) unnamed_addr #0 align 2 {
  %3 = alloca %"class.google::protobuf::MessageLite"*, align 4
  %4 = alloca %"class.sample::Point.24"*, align 4
  store %"class.google::protobuf::MessageLite"* %1, %"class.google::protobuf::MessageLite"** %3, align 4
  store %"class.sample::Point.24"* %0, %"class.sample::Point.24"** %4, align 4
  %5 = load %"class.sample::Point.24"*, %"class.sample::Point.24"** %4, align 4
  %6 = load %"class.google::protobuf::MessageLite"*, %"class.google::protobuf::MessageLite"** %3, align 4
  %7 = call %"class.sample::Point.24"* @"\01??$down_cast@PBVPoint@sample@@$$CBVMessageLite@protobuf@google@@@internal@protobuf@google@@YAPBVPoint@sample@@PBVMessageLite@12@@Z"(%"class.google::protobuf::MessageLite"* %6)
  call x86_thiscallcc void @"\01?MergeFrom@Point@sample@@QAEXABV12@@Z"(%"class.sample::Point.24"* %5, %"class.sample::Point.24"* dereferenceable(20) %7)
  ret void
}

; Function Attrs: noinline optnone
define x86_thiscallcc zeroext i1 @"\01?MergePartialFromCodedStream@Point@sample@@UAE_NPAVCodedInputStream@io@protobuf@google@@@Z"(%"class.sample::Point.24"*, %"class.google::protobuf::io::CodedInputStream"*) unnamed_addr #0 align 2 personality i8* bitcast (i32 (...)* @__CxxFrameHandler3 to i8*) {
  %3 = alloca i1, align 1
  %4 = alloca %"class.google::protobuf::io::CodedInputStream"*, align 4
  %5 = alloca %"class.sample::Point.24"*, align 4
  %6 = alloca i32, align 4
  ...
  store %"class.google::protobuf::io::CodedInputStream"* %1, %"class.google::protobuf::io::CodedInputStream"** %4, align 4
  store %"class.sample::Point.24"* %0, %"class.sample::Point.24"** %5, align 4
  %12 = load %"class.sample::Point.24"*, %"class.sample::Point.24"** %5, align 4
...
; <label>:80:                                     ; preds = %68, %54, %40, %31, %22
  %81 = cleanuppad within none []
  call x86_thiscallcc void @"\01??1CodedOutputStream@io@protobuf@google@@QAE@XZ"(%"class.google::protobuf::io::CodedOutputStream"* %9) #9 [ "funclet"(token %81) ]
  cleanupret from %81 unwind label %82

; <label>:82:                                     ; preds = %80, %18
  %83 = cleanuppad within none []
  call x86_thiscallcc void @"\01??1StringOutputStream@io@protobuf@google@@UAE@XZ"(%"class.google::protobuf::io::StringOutputStream"* %8) #9 [ "funclet"(token %83) ]
  cleanupret from %83 unwind label %84

; <label>:84:                                     ; preds = %82, %16, %2
  %85 = cleanuppad within none []
  call x86_thiscallcc void @"\01??1LiteUnknownFieldSetter@internal@protobuf@google@@QAE@XZ"(%"class.google::protobuf::internal::LiteUnknownFieldSetter"* %7) #9 [ "funclet"(token %85) ]
  cleanupret from %85 unwind to caller
}

; Function Attrs: noinline optnone
define x86_thiscallcc i32 @"\01?ByteSizeLong@Point@sample@@UBEIXZ"(%"class.sample::Point.24"*) #0 align 2 {
  %2 = alloca %"class.sample::Point.24"*, align 4
  %3 = alloca i32, align 4
  %4 = alloca i32, align 4
  store %"class.sample::Point.24"* %0, %"class.sample::Point.24"** %2, align 4
  %5 = load %"class.sample::Point.24"*, %"class.sample::Point.24"** %2, align 4
  store i32 0, i32* %3, align 4
  %6 = call zeroext i1 @"\01?GetProto3PreserveUnknownsDefault@internal@protobuf@google@@YA_NXZ"()
  br i1 %6, label %7, label %11
...
; <label>:14:                                     ; preds = %11, %7
  ...
  %18 = add i32 %17, %16
  store i32 %18, i32* %3, align 4
  %19 = call x86_thiscallcc i32 bitcast (i32 (%"class.sample::Point"*)* @"\01?x@Point@sample@@QBEHXZ" to i32 (%"class.sample::Point.24"*)*)(%"class.sample::Point.24"* %5)
  %20 = icmp ne i32 %19, 0
  br i1 %20, label %21, label %27

; <label>:21:                                     ; preds = %14
  %22 = call x86_thiscallcc i32 bitcast (i32 (%"class.sample::Point"*)* @"\01?x@Point@sample@@QBEHXZ" to i32 (%"class.sample::Point.24"*)*)(%"class.sample::Point.24"* %5)
...
; <label>:27:                                     ; preds = %21, %14
  %28 = call x86_thiscallcc i32 bitcast (i32 (%"class.sample::Point"*)* @"\01?y@Point@sample@@QBEHXZ" to i32 (%"class.sample::Point.24"*)*)(%"class.sample::Point.24"* %5)
  %29 = icmp ne i32 %28, 0
  br i1 %29, label %30, label %36

; <label>:30:                                     ; preds = %27
  %31 = call x86_thiscallcc i32 bitcast (i32 (%"class.sample::Point"*)* @"\01?y@Point@sample@@QBEHXZ" to i32 (%"class.sample::Point.24"*)*)(%"class.sample::Point.24"* %5)
...
; Function Attrs: noinline optnone
define x86_thiscallcc void @"\01?SerializeWithCachedSizes@Point@sample@@UBEXPAVCodedOutputStream@io@protobuf@google@@@Z"(%"class.sample::Point.24"*, %"class.google::protobuf::io::CodedOutputStream"*) unnamed_addr #0 align 2 {
  %3 = alloca %"class.google::protobuf::io::CodedOutputStream"*, align 4
  %4 = alloca %"class.sample::Point.24"*, align 4
  %5 = alloca i32, align 4
  store %"class.google::protobuf::io::CodedOutputStream"* %1, %"class.google::protobuf::io::CodedOutputStream"** %3, align 4
  ...
  %6 = load %"class.sample::Point.24"*, %"class.sample::Point.24"** %4, align 4
  store i32 0, i32* %5, align 4
  %7 = call x86_thiscallcc i32 bitcast (i32 (%"class.sample::Point"*)* @"\01?x@Point@sample@@QBEHXZ" to i32 (%"class.sample::Point.24"*)*)(%"class.sample::Point.24"* %6)
  %8 = icmp ne i32 %7, 0
  br i1 %8, label %9, label %12

; <label>:9:                                      ; preds = %2
  %10 = load %"class.google::protobuf::io::CodedOutputStream"*, %"class.google::protobuf::io::CodedOutputStream"** %3, align 4
  %11 = call x86_thiscallcc i32 bitcast (i32 (%"class.sample::Point"*)* @"\01?x@Point@sample@@QBEHXZ" to i32 (%"class.sample::Point.24"*)*)(%"class.sample::Point.24"* %6)
  call void @"\01?WriteInt32@WireFormatLite@internal@protobuf@google@@SAXHHPAVCodedOutputStream@io@34@@Z"(i32 1, i32 %11, %"class.google::protobuf::io::CodedOutputStream"* %10)
  br label %12

; <label>:12:                                     ; preds = %9, %2
  %13 = call x86_thiscallcc i32 bitcast (i32 (%"class.sample::Point"*)* @"\01?y@Point@sample@@QBEHXZ" to i32 (%"class.sample::Point.24"*)*)(%"class.sample::Point.24"* %6)
  %14 = icmp ne i32 %13, 0
  br i1 %14, label %15, label %18

; <label>:15:                                     ; preds = %12
  %16 = load %"class.google::protobuf::io::CodedOutputStream"*, %"class.google::protobuf::io::CodedOutputStream"** %3, align 4
  %17 = call x86_thiscallcc i32 bitcast (i32 (%"class.sample::Point"*)* @"\01?y@Point@sample@@QBEHXZ" to i32 (%"class.sample::Point.24"*)*)(%"class.sample::Point.24"* %6)
...
; <label>:39:                                     ; preds = %36, %32
  ...
  %41 = call x86_thiscallcc i8* @"\01?data@?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QBEPBDXZ"(%"class.std::basic_string"* %40) #9
...
; Function Attrs: noinline nounwind optnone
define linkonce_odr x86_thiscallcc i32 @"\01?GetCachedSize@Point@sample@@UBEHXZ"(%"class.sample::Point.24"*) unnamed_addr #3 comdat align 2 {
  %2 = alloca %"class.sample::Point.24"*, align 4
  store %"class.sample::Point.24"* %0, %"class.sample::Point.24"** %2, align 4
  %3 = load %"class.sample::Point.24"*, %"class.sample::Point.24"** %2, align 4
...
; Function Attrs: noinline optnone
define linkonce_odr %"class.sample::Point.24"* @"\01??$down_cast@PBVPoint@sample@@$$CBVMessageLite@protobuf@google@@@internal@protobuf@google@@YAPBVPoint@sample@@PBVMessageLite@12@@Z"(%"class.google::protobuf::MessageLite"*) #0 comdat {
  %2 = alloca %"class.google::protobuf::MessageLite"*, align 4
  store %"class.google::protobuf::MessageLite"* %0, %"class.google::protobuf::MessageLite"** %2, align 4
  %3 = load %"class.google::protobuf::MessageLite"*, %"class.google::protobuf::MessageLite"** %2, align 4
  %4 = icmp eq %"class.google::protobuf::MessageLite"* %3, null
...
; Function Attrs: noinline optnone
define x86_thiscallcc void @"\01?MergeFrom@Point@sample@@QAEXABV12@@Z"(%"class.sample::Point.24"*, %"class.sample::Point.24"* dereferenceable(20)) #0 align 2 personality i8* bitcast (i32 (...)* @__CxxFrameHandler3 to i8*) {
  %3 = alloca %"class.sample::Point.24"*, align 4
  %4 = alloca %"class.sample::Point.24"*, align 4
  %5 = alloca %"class.google::protobuf::internal::LogMessage", align 4
  %6 = alloca i1, align 1
  %7 = alloca %struct.__vcrt_assert_va_start_is_not_reference, align 1
  %8 = alloca i32, align 4
  store %"class.sample::Point.24"* %1, %"class.sample::Point.24"** %3, align 4
  store %"class.sample::Point.24"* %0, %"class.sample::Point.24"** %4, align 4
  %9 = load %"class.sample::Point.24"*, %"class.sample::Point.24"** %4, align 4
  %10 = load %"class.sample::Point.24"*, %"class.sample::Point.24"** %3, align 4
...
; <label>:13:                                     ; preds = %2
  %14 = call x86_thiscallcc %"class.google::protobuf::internal::LogMessage"* @"\01??0LogMessage@internal@protobuf@google@@QAE@W4LogLevel@23@PBDH@Z"(%"class.google::protobuf::internal::LogMessage"* %5, i32 3, i8* getelementptr inbounds ([73 x i8], [73 x i8]* @"\01??_C@_0EJ@KDOHDODM@E?3?2work?2local?2private?9contract?9s@", i32 0, i32 0), i32 873)
  store i1 true, i1* %6, align 1
  %15 = invoke x86_thiscallcc dereferenceable(36) %"class.google::protobuf::internal::LogMessage"* @"\01??6LogMessage@internal@protobuf@google@@QAEAAV0123@PBD@Z"(%"class.google::protobuf::internal::LogMessage"* %5, i8* getelementptr inbounds ([34 x i8], [34 x i8]* @"\01??_C@_0CC@HENEHLPK@CHECK?5failed?3?5?$CI?$CGfrom?$CJ?5?$CB?$DN?5?$CIthis?$CJ?3@", i32 0, i32 0))
          to label %16 unwind label %32
...
; <label>:21:                                     ; preds = %20, %18
  ...
  %23 = bitcast %"class.google::protobuf::internal::InternalMetadataWithArena"* %22 to %struct._iobuf*
  %24 = load %"class.sample::Point.24"*, %"class.sample::Point.24"** %3, align 4
  %25 = getelementptr inbounds %"class.sample::Point.24", %"class.sample::Point.24"* %24, i32 0, i32 1
  call x86_thiscallcc void @"\01?MergeFrom@?$InternalMetadataWithArenaBase@V?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@VInternalMetadataWithArenaLite@internal@protobuf@google@@@internal@protobuf@google@@QAEXABVInternalMetadataWithArenaLite@234@@Z"(%struct._iobuf* %23, %"class.google::protobuf::internal::InternalMetadataWithArena"* dereferenceable(4) %25)
  store i32 0, i32* %8, align 4
  %26 = load %"class.sample::Point.24"*, %"class.sample::Point.24"** %3, align 4
  %27 = call x86_thiscallcc i32 bitcast (i32 (%"class.sample::Point"*)* @"\01?x@Point@sample@@QBEHXZ" to i32 (%"class.sample::Point.24"*)*)(%"class.sample::Point.24"* %26)
  %28 = icmp ne i32 %27, 0
  br i1 %28, label %29, label %37

; <label>:29:                                     ; preds = %21
  %30 = load %"class.sample::Point.24"*, %"class.sample::Point.24"** %3, align 4
  %31 = call x86_thiscallcc i32 bitcast (i32 (%"class.sample::Point"*)* @"\01?x@Point@sample@@QBEHXZ" to i32 (%"class.sample::Point.24"*)*)(%"class.sample::Point.24"* %30)
  call x86_thiscallcc void bitcast (void (%"class.sample::Point"*, i32)* @"\01?set_x@Point@sample@@QAEXH@Z" to void (%"class.sample::Point.24"*, i32)*)(%"class.sample::Point.24"* %9, i32 %31)
  br label %37
...
; <label>:37:                                     ; preds = %29, %21
  %38 = load %"class.sample::Point.24"*, %"class.sample::Point.24"** %3, align 4
  %39 = call x86_thiscallcc i32 bitcast (i32 (%"class.sample::Point"*)* @"\01?y@Point@sample@@QBEHXZ" to i32 (%"class.sample::Point.24"*)*)(%"class.sample::Point.24"* %38)
  %40 = icmp ne i32 %39, 0
  br i1 %40, label %41, label %44

; <label>:41:                                     ; preds = %37
  %42 = load %"class.sample::Point.24"*, %"class.sample::Point.24"** %3, align 4
  %43 = call x86_thiscallcc i32 bitcast (i32 (%"class.sample::Point"*)* @"\01?y@Point@sample@@QBEHXZ" to i32 (%"class.sample::Point.24"*)*)(%"class.sample::Point.24"* %42)
  call x86_thiscallcc void bitcast (void (%"class.sample::Point"*, i32)* @"\01?set_y@Point@sample@@QAEXH@Z" to void (%"class.sample::Point.24"*, i32)*)(%"class.sample::Point.24"* %9, i32 %43)
  br label %44
...
; Function Attrs: noinline optnone
define linkonce_odr x86_thiscallcc void @"\01??$Own@VPoint@sample@@@Arena@protobuf@google@@QAEXPAVPoint@sample@@@Z"(%"class.google::protobuf::Arena"*, %"class.sample::Point.24"*) #0 comdat align 2 {
  %3 = alloca %"class.sample::Point.24"*, align 4
  %4 = alloca %"class.google::protobuf::Arena"*, align 4
  %5 = alloca %struct.__vcrt_assert_va_start_is_not_reference, align 4
  %6 = alloca %struct.__vcrt_assert_va_start_is_not_reference, align 1
  ...
  %7 = load %"class.google::protobuf::Arena"*, %"class.google::protobuf::Arena"** %4, align 4
  %8 = bitcast %struct.__vcrt_assert_va_start_is_not_reference* %6 to %struct.__vcrt_assert_va_start_is_not_reference*
  %9 = load %"class.sample::Point.24"*, %"class.sample::Point.24"** %3, align 4
  call x86_thiscallcc void @"\01??$OwnInternal@VPoint@sample@@@Arena@protobuf@google@@AAEXPAVPoint@sample@@U?$integral_constant@_N$0A@@internal@12@@Z"(%"class.google::protobuf::Arena"* %7, %"class.sample::Point.24"* %9, %struct.__vcrt_assert_va_start_is_not_reference* byval align 4 %5)
  ret void
}

; Function Attrs: noinline optnone
define linkonce_odr x86_thiscallcc void @"\01??$OwnInternal@VPoint@sample@@@Arena@protobuf@google@@AAEXPAVPoint@sample@@U?$integral_constant@_N$0A@@internal@12@@Z"(%"class.google::protobuf::Arena"*, %"class.sample::Point.24"*, %struct.__vcrt_assert_va_start_is_not_reference* byval align 4) #0 comdat align 2 {
  %4 = alloca %"class.sample::Point.24"*, align 4
  %5 = alloca %"class.google::protobuf::Arena"*, align 4
  store %"class.sample::Point.24"* %1, %"class.sample::Point.24"** %4, align 4
  store %"class.google::protobuf::Arena"* %0, %"class.google::protobuf::Arena"** %5, align 4
  %6 = load %"class.google::protobuf::Arena"*, %"class.google::protobuf::Arena"** %5, align 4
  %7 = load %"class.sample::Point.24"*, %"class.sample::Point.24"** %4, align 4
  %8 = icmp ne %"class.sample::Point.24"* %7, null
  br i1 %8, label %9, label %13

; <label>:9:                                      ; preds = %3
  %10 = getelementptr inbounds %"class.google::protobuf::Arena", %"class.google::protobuf::Arena"* %6, i32 0, i32 0
  %11 = load %"class.sample::Point.24"*, %"class.sample::Point.24"** %4, align 4
  %12 = bitcast %"class.sample::Point.24"* %11 to i8*
  call x86_thiscallcc void @"\01?AddCleanup@ArenaImpl@internal@protobuf@google@@QAEXPAXP6AX0@Z@Z"(%"class.google::protobuf::internal::ArenaImpl"* %10, i8* %12, void (i8*)* @"\01??$arena_delete_object@VPoint@sample@@@internal@protobuf@google@@YAXPAX@Z")
  br label %13
...
; Function Attrs: noinline nounwind optnone
define linkonce_odr void @"\01??$arena_delete_object@VPoint@sample@@@internal@protobuf@google@@YAXPAX@Z"(i8*) #3 comdat {
  %2 = alloca i8*, align 4
  store i8* %0, i8** %2, align 4
  %3 = load i8*, i8** %2, align 4
...
; <label>:6:                                      ; preds = %1
  ...
  %8 = load i8* (%"class.sample::Point.24"*, i32)**, i8* (%"class.sample::Point.24"*, i32)*** %7, align 4
  %9 = getelementptr inbounds i8* (%"class.sample::Point.24"*, i32)*, i8* (%"class.sample::Point.24"*, i32)** %8, i64 0
  %10 = load i8* (%"class.sample::Point.24"*, i32)*, i8* (%"class.sample::Point.24"*, i32)** %9, align 4
  %11 = call x86_thiscallcc i8* %10(%"class.sample::Point.24"* %4, i32 1) #9
  br label %12
...
; Function Attrs: noinline nounwind optnone
define x86_thiscallcc void @"\01??1Point@sample@@UAE@XZ"(%"class.sample::Point.24"*) #3 align 2 personality i8* bitcast (i32 (...)* @__CxxFrameHandler3 to i8*) {
  %2 = alloca %"class.sample::Point.24"*, align 4
  store %"class.sample::Point.24"* %0, %"class.sample::Point.24"** %2, align 4
  %3 = load %"class.sample::Point.24"*, %"class.sample::Point.24"** %2, align 4
  %4 = bitcast %"class.sample::Point.24"* %3 to i32 (...)***
  store i32 (...)** bitcast (i8** @"\01??_7Point@sample@@6B@" to i32 (...)**), i32 (...)*** %4, align 4
  invoke x86_thiscallcc void @"\01?SharedDtor@Point@sample@@AAEXXZ"(%"class.sample::Point.24"* %3)
          to label %5 unwind label %8
...
; Function Attrs: noinline nounwind optnone
define x86_thiscallcc void @"\01?SharedDtor@Point@sample@@AAEXXZ"(%"class.sample::Point.24"*) #3 align 2 {
  %2 = alloca %"class.sample::Point.24"*, align 4
  store %"class.sample::Point.24"* %0, %"class.sample::Point.24"** %2, align 4
  %3 = load %"class.sample::Point.24"*, %"class.sample::Point.24"** %2, align 4
  ret void
...
define void @"\01?InitDefaultsPointsImpl@protobuf_SamplesLite_2eproto@@YAXXZ"() #0 {
  ...
  %4 = call x86_thiscallcc %"class.sample::Points.25"* @"\01??0Points@sample@@QAE@XZ"(%"class.sample::Points.25"* %3)
  %5 = load i8*, i8** %1, align 4
  call void @"\01?OnShutdownDestroyMessage@internal@protobuf@google@@YAXPBX@Z"(i8* %5)
...
; Function Attrs: noinline optnone
define x86_thiscallcc %"class.sample::Points.25"* @"\01??0Points@sample@@QAE@XZ"(%"class.sample::Points.25"* returned) unnamed_addr #0 align 2 personality i8* bitcast (i32 (...)* @__CxxFrameHandler3 to i8*) {
  %2 = alloca %"class.sample::Points.25"*, align 4
  %3 = alloca %"class.sample::Points.25"*, align 4
  store %"class.sample::Points.25"* %0, %"class.sample::Points.25"** %3, align 4
  %4 = load %"class.sample::Points.25"*, %"class.sample::Points.25"** %3, align 4
  store %"class.sample::Points.25"* %4, %"class.sample::Points.25"** %2, align 4
...
; <label>:13:                                     ; preds = %10
  %14 = invoke %"class.sample::Points.25"* @"\01?internal_default_instance@Points@sample@@SAPBV12@XZ"()
...
; <label>:19:                                     ; preds = %18, %15
  invoke x86_thiscallcc void @"\01?SharedCtor@Points@sample@@AAEXXZ"(%"class.sample::Points.25"* %4)
          to label %20 unwind label %22

; <label>:20:                                     ; preds = %19
  %21 = load %"class.sample::Points.25"*, %"class.sample::Points.25"** %2, align 4
...
; <label>:24:                                     ; preds = %22, %10
  %25 = cleanuppad within none []
  call x86_thiscallcc void @"\01??1InternalMetadataWithArenaLite@internal@protobuf@google@@QAE@XZ"(%"class.google::protobuf::internal::InternalMetadataWithArena"* %8) #9 [ "funclet"(token %25) ]
  cleanupret from %25 unwind label %26

; <label>:26:                                     ; preds = %24, %1
  %27 = cleanuppad within none []
  %28 = bitcast %"class.sample::Points.25"* %4 to %"class.google::protobuf::MessageLite"*
  call x86_thiscallcc void @"\01??1MessageLite@protobuf@google@@UAE@XZ"(%"class.google::protobuf::MessageLite"* %28) #9 [ "funclet"(token %27) ]
...
; Function Attrs: noinline nounwind optnone
define linkonce_odr %"class.sample::Points.25"* @"\01?internal_default_instance@Points@sample@@SAPBV12@XZ"() #3 comdat align 2 {
...
define void @"\01?InitDefaultsPoints@protobuf_SamplesLite_2eproto@@YAXXZ"() #0 {
  call void @"\01?GoogleOnceInit@protobuf@google@@YAXPAHP6AXXZ@Z"(i32* @"\01?once@?1??InitDefaultsPoints@protobuf_SamplesLite_2eproto@@YAXXZ@4HA", void ()* @"\01?InitDefaultsPointsImpl@protobuf_SamplesLite_2eproto@@YAXXZ")
  ret void
}

; Function Attrs: noinline nounwind optnone
define x86_thiscallcc void @"\01?SharedCtor@Points@sample@@AAEXXZ"(%"class.sample::Points.25"*) #3 align 2 {
  %2 = alloca %"class.sample::Points.25"*, align 4
  store %"class.sample::Points.25"* %0, %"class.sample::Points.25"** %2, align 4
  %3 = load %"class.sample::Points.25"*, %"class.sample::Points.25"** %2, align 4
...
; <label>:27:                                     ; preds = %23
  ...
  %32 = call %"class.sample::Point.24"* bitcast (%"class.sample::Point"* (i8*)* @"\01??$cast@VTypeHandler@?$RepeatedPtrField@VPoint@sample@@@protobuf@google@@@RepeatedPtrFieldBase@internal@protobuf@google@@CAPAVPoint@sample@@PAX@Z" to %"class.sample::Point.24"* (i8*)*)(i8* %31)
  call void @"\01?Delete@?$GenericTypeHandler@VPoint@sample@@@internal@protobuf@google@@SAXPAVPoint@sample@@PAVArena@34@@Z"(%"class.sample::Point.24"* %32, %"class.google::protobuf::Arena"* null)
  br label %33
...
; Function Attrs: noinline nounwind optnone
define linkonce_odr void @"\01?Delete@?$GenericTypeHandler@VPoint@sample@@@internal@protobuf@google@@SAXPAVPoint@sample@@PAVArena@34@@Z"(%"class.sample::Point.24"*, %"class.google::protobuf::Arena"*) #3 comdat align 2 {
  %3 = alloca %"class.google::protobuf::Arena"*, align 4
  %4 = alloca %"class.sample::Point.24"*, align 4
  store %"class.google::protobuf::Arena"* %1, %"class.google::protobuf::Arena"** %3, align 4
  store %"class.sample::Point.24"* %0, %"class.sample::Point.24"** %4, align 4
...
; <label>:7:                                      ; preds = %2
  %8 = load %"class.sample::Point.24"*, %"class.sample::Point.24"** %4, align 4
  %9 = icmp eq %"class.sample::Point.24"* %8, null
  br i1 %9, label %16, label %10

; <label>:10:                                     ; preds = %7
  %11 = bitcast %"class.sample::Point.24"* %8 to i8* (%"class.sample::Point.24"*, i32)***
  %12 = load i8* (%"class.sample::Point.24"*, i32)**, i8* (%"class.sample::Point.24"*, i32)*** %11, align 4
  %13 = getelementptr inbounds i8* (%"class.sample::Point.24"*, i32)*, i8* (%"class.sample::Point.24"*, i32)** %12, i64 0
  %14 = load i8* (%"class.sample::Point.24"*, i32)*, i8* (%"class.sample::Point.24"*, i32)** %13, align 4
  %15 = call x86_thiscallcc i8* %14(%"class.sample::Point.24"* %8, i32 1) #9
  br label %16
...
; Function Attrs: noinline nounwind optnone
define linkonce_odr x86_thiscallcc i8* @"\01??_GPoints@sample@@UAEPAXI@Z"(%"class.sample::Points.25"*, i32) unnamed_addr #3 comdat align 2 {
  %3 = alloca i8*, align 4
  %4 = alloca i32, align 4
  %5 = alloca %"class.sample::Points.25"*, align 4
  store i32 %1, i32* %4, align 4
  store %"class.sample::Points.25"* %0, %"class.sample::Points.25"** %5, align 4
  %6 = load %"class.sample::Points.25"*, %"class.sample::Points.25"** %5, align 4
  %7 = bitcast %"class.sample::Points.25"* %6 to i8*
  store i8* %7, i8** %3, align 4
  %8 = load i32, i32* %4, align 4
  call x86_thiscallcc void @"\01??1Points@sample@@UAE@XZ"(%"class.sample::Points.25"* %6) #9
  %9 = icmp eq i32 %8, 0
  br i1 %9, label %12, label %10
...
; Function Attrs: noinline optnone
define x86_thiscallcc void @"\01?GetTypeName@Points@sample@@UBE?AV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@XZ"(%"class.sample::Points.25"*, %"class.std::basic_string"* noalias sret) unnamed_addr #0 align 2 {
  %3 = alloca %"class.sample::Points.25"*, align 4
  store %"class.sample::Points.25"* %0, %"class.sample::Points.25"** %3, align 4
  %4 = load %"class.sample::Points.25"*, %"class.sample::Points.25"** %3, align 4
  %5 = call x86_thiscallcc %"class.std::basic_string"* @"\01??0?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@QBD@Z"(%"class.std::basic_string"* %1, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @"\01??_C@_0O@NAGFFHJE@sample?4Points?$AA@", i32 0, i32 0))
  ret void
}

; Function Attrs: noinline optnone
define x86_thiscallcc %"class.sample::Points.25"* @"\01?New@Points@sample@@UBEPAV12@PAVArena@protobuf@google@@@Z"(%"class.sample::Points.25"*, %"class.google::protobuf::Arena"*) unnamed_addr #0 align 2 personality i8* bitcast (i32 (...)* @__CxxFrameHandler3 to i8*) {
  %3 = alloca %"class.google::protobuf::Arena"*, align 4
  %4 = alloca %"class.sample::Points.25"*, align 4
  %5 = alloca %"class.sample::Points.25"*, align 4
  store %"class.google::protobuf::Arena"* %1, %"class.google::protobuf::Arena"** %3, align 4
  store %"class.sample::Points.25"* %0, %"class.sample::Points.25"** %4, align 4
  %6 = load %"class.sample::Points.25"*, %"class.sample::Points.25"** %4, align 4
  %7 = call i8* @"\01??2@YAPAXI@Z"(i32 28) #12
  %8 = bitcast i8* %7 to %"class.sample::Points.25"*
  %9 = invoke x86_thiscallcc %"class.sample::Points.25"* @"\01??0Points@sample@@QAE@XZ"(%"class.sample::Points.25"* %8)
          to label %10 unwind label %16

; <label>:10:                                     ; preds = %2
  store %"class.sample::Points.25"* %8, %"class.sample::Points.25"** %5, align 4
  %11 = load %"class.google::protobuf::Arena"*, %"class.google::protobuf::Arena"** %3, align 4
  %12 = icmp ne %"class.google::protobuf::Arena"* %11, null
  br i1 %12, label %13, label %18
...
; <label>:13:                                     ; preds = %10
  %14 = load %"class.google::protobuf::Arena"*, %"class.google::protobuf::Arena"** %3, align 4
  %15 = load %"class.sample::Points.25"*, %"class.sample::Points.25"** %5, align 4
  call x86_thiscallcc void @"\01??$Own@VPoints@sample@@@Arena@protobuf@google@@QAEXPAVPoints@sample@@@Z"(%"class.google::protobuf::Arena"* %14, %"class.sample::Points.25"* %15)
  br label %18
...
; <label>:18:                                     ; preds = %13, %10
  %19 = load %"class.sample::Points.25"*, %"class.sample::Points.25"** %5, align 4
  ret %"class.sample::Points.25"* %19
}

; Function Attrs: noinline optnone
define linkonce_odr x86_thiscallcc %"class.sample::Points.25"* @"\01?New@Points@sample@@UBEPAV12@XZ"(%"class.sample::Points.25"*) unnamed_addr #0 comdat align 2 {
  %2 = alloca %"class.sample::Points.25"*, align 4
  store %"class.sample::Points.25"* %0, %"class.sample::Points.25"** %2, align 4
  %3 = load %"class.sample::Points.25"*, %"class.sample::Points.25"** %2, align 4
  %4 = call x86_thiscallcc %"class.sample::Points.25"* @"\01?New@Points@sample@@UBEPAV12@PAVArena@protobuf@google@@@Z"(%"class.sample::Points.25"* %3, %"class.google::protobuf::Arena"* null)
  ret %"class.sample::Points.25"* %4
}

; Function Attrs: noinline optnone
define x86_thiscallcc void @"\01?Clear@Points@sample@@UAEXXZ"(%"class.sample::Points.25"*) unnamed_addr #0 align 2 {
  %2 = alloca %"class.sample::Points.25"*, align 4
  %3 = alloca i32, align 4
  store %"class.sample::Points.25"* %0, %"class.sample::Points.25"** %2, align 4
  %4 = load %"class.sample::Points.25"*, %"class.sample::Points.25"** %2, align 4
  store i32 0, i32* %3, align 4
  ...
  %7 = bitcast %"class.google::protobuf::internal::InternalMetadataWithArena"* %6 to %struct._iobuf*
  call x86_thiscallcc void @"\01?Clear@?$InternalMetadataWithArenaBase@V?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@VInternalMetadataWithArenaLite@internal@protobuf@google@@@internal@protobuf@google@@QAEXXZ"(%struct._iobuf* %7)
  ret void
}

; Function Attrs: noinline nounwind optnone
define x86_thiscallcc zeroext i1 @"\01?IsInitialized@Points@sample@@UBE_NXZ"(%"class.sample::Points.25"*) unnamed_addr #3 align 2 {
  %2 = alloca %"class.sample::Points.25"*, align 4
  store %"class.sample::Points.25"* %0, %"class.sample::Points.25"** %2, align 4
  %3 = load %"class.sample::Points.25"*, %"class.sample::Points.25"** %2, align 4
  ret i1 true
...
; Function Attrs: noinline optnone
define x86_thiscallcc void @"\01?CheckTypeAndMergeFrom@Points@sample@@UAEXABVMessageLite@protobuf@google@@@Z"(%"class.sample::Points.25"*, %"class.google::protobuf::MessageLite"* dereferenceable(4)) unnamed_addr #0 align 2 {
  %3 = alloca %"class.google::protobuf::MessageLite"*, align 4
  %4 = alloca %"class.sample::Points.25"*, align 4
  store %"class.google::protobuf::MessageLite"* %1, %"class.google::protobuf::MessageLite"** %3, align 4
  store %"class.sample::Points.25"* %0, %"class.sample::Points.25"** %4, align 4
  %5 = load %"class.sample::Points.25"*, %"class.sample::Points.25"** %4, align 4
  %6 = load %"class.google::protobuf::MessageLite"*, %"class.google::protobuf::MessageLite"** %3, align 4
  %7 = call %"class.sample::Points.25"* @"\01??$down_cast@PBVPoints@sample@@$$CBVMessageLite@protobuf@google@@@internal@protobuf@google@@YAPBVPoints@sample@@PBVMessageLite@12@@Z"(%"class.google::protobuf::MessageLite"* %6)
  call x86_thiscallcc void @"\01?MergeFrom@Points@sample@@QAEXABV12@@Z"(%"class.sample::Points.25"* %5, %"class.sample::Points.25"* dereferenceable(28) %7)
  ret void
}

; Function Attrs: noinline optnone
define x86_thiscallcc zeroext i1 @"\01?MergePartialFromCodedStream@Points@sample@@UAE_NPAVCodedInputStream@io@protobuf@google@@@Z"(%"class.sample::Points.25"*, %"class.google::protobuf::io::CodedInputStream"*) unnamed_addr #0 align 2 personality i8* bitcast (i32 (...)* @__CxxFrameHandler3 to i8*) {
  %3 = alloca i1, align 1
  %4 = alloca %"class.google::protobuf::io::CodedInputStream"*, align 4
  %5 = alloca %"class.sample::Points.25"*, align 4
  %6 = alloca i32, align 4
  ...
  store %"class.google::protobuf::io::CodedInputStream"* %1, %"class.google::protobuf::io::CodedInputStream"** %4, align 4
  store %"class.sample::Points.25"* %0, %"class.sample::Points.25"** %5, align 4
  %12 = load %"class.sample::Points.25"*, %"class.sample::Points.25"** %5, align 4
...
; <label>:40:                                     ; preds = %35
  %41 = invoke x86_thiscallcc %"class.sample::Point.24"* bitcast (%"class.sample::Point"* (%"class.sample::Points"*)* @"\01?add_points@Points@sample@@QAEPAVPoint@2@XZ" to %"class.sample::Point.24"* (%"class.sample::Points.25"*)*)(%"class.sample::Points.25"* %12)
...
; <label>:56:                                     ; preds = %52
  ...
  %58 = load %"class.google::protobuf::io::CodedInputStream"*, %"class.google::protobuf::io::CodedInputStream"** %4, align 4
  %59 = invoke zeroext i1 @"\01?SkipField@WireFormatLite@internal@protobuf@google@@SA_NPAVCodedInputStream@io@34@IPAVCodedOutputStream@634@@Z"(%"class.google::protobuf::io::CodedInputStream"* %58, i32 %57, %"class.google::protobuf::io::CodedOutputStream"* %9)
...
; <label>:68:                                     ; preds = %56, %42, %40, %31, %22
  %69 = cleanuppad within none []
  call x86_thiscallcc void @"\01??1CodedOutputStream@io@protobuf@google@@QAE@XZ"(%"class.google::protobuf::io::CodedOutputStream"* %9) #9 [ "funclet"(token %69) ]
  cleanupret from %69 unwind label %70

; <label>:70:                                     ; preds = %68, %18
  %71 = cleanuppad within none []
  call x86_thiscallcc void @"\01??1StringOutputStream@io@protobuf@google@@UAE@XZ"(%"class.google::protobuf::io::StringOutputStream"* %8) #9 [ "funclet"(token %71) ]
  cleanupret from %71 unwind label %72

; <label>:72:                                     ; preds = %70, %16, %2
  %73 = cleanuppad within none []
  call x86_thiscallcc void @"\01??1LiteUnknownFieldSetter@internal@protobuf@google@@QAE@XZ"(%"class.google::protobuf::internal::LiteUnknownFieldSetter"* %7) #9 [ "funclet"(token %73) ]
  cleanupret from %73 unwind to caller
}

; Function Attrs: noinline optnone
define x86_thiscallcc i32 @"\01?ByteSizeLong@Points@sample@@UBEIXZ"(%"class.sample::Points.25"*) #0 align 2 {
  %2 = alloca %"class.sample::Points.25"*, align 4
  %3 = alloca i32, align 4
  %4 = alloca i32, align 4
  %5 = alloca i32, align 4
  %6 = alloca i32, align 4
  store %"class.sample::Points.25"* %0, %"class.sample::Points.25"** %2, align 4
  %7 = load %"class.sample::Points.25"*, %"class.sample::Points.25"** %2, align 4
  store i32 0, i32* %3, align 4
...
; <label>:9:                                      ; preds = %1
  ...
  %12 = call x86_thiscallcc dereferenceable(24) %"class.std::basic_string"* @"\01?unknown_fields@?$InternalMetadataWithArenaBase@V?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@VInternalMetadataWithArenaLite@internal@protobuf@google@@@internal@protobuf@google@@QBEABV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@XZ"(%struct._iobuf* %11)
  br label %16

; <label>:13:                                     ; preds = %1
  %14 = getelementptr inbounds %"class.sample::Points.25", %"class.sample::Points.25"* %7, i32 0, i32 1
  %15 = call dereferenceable(24) %"class.std::basic_string"* @"\01?default_instance@InternalMetadataWithArenaLite@internal@protobuf@google@@SAABV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@XZ"()
  br label %16
...
; <label>:16:                                     ; preds = %13, %9
  ...
  %21 = call x86_thiscallcc i32 @"\01?points_size@Points@sample@@QBEHXZ"(%"class.sample::Points.25"* %7)
...
; <label>:30:                                     ; preds = %26
  %31 = load i32, i32* %5, align 4
  %32 = call x86_thiscallcc dereferenceable(20) %"class.sample::Point.24"* @"\01?points@Points@sample@@QBEABVPoint@2@H@Z"(%"class.sample::Points.25"* %7, i32 %31)
  %33 = bitcast %"class.sample::Point.24"* %32 to %"class.google::protobuf::MessageLite"*
  %34 = call i32 @"\01?MessageSize@WireFormatLite@internal@protobuf@google@@SAIABVMessageLite@34@@Z"(%"class.google::protobuf::MessageLite"* dereferenceable(4) %33)
  %35 = load i32, i32* %3, align 4
  %36 = add i32 %35, %34
  store i32 %36, i32* %3, align 4
  br label %37
...
; <label>:40:                                     ; preds = %26
  ...
  %43 = load i32, i32* %6, align 4
  %44 = getelementptr inbounds %"class.sample::Points.25", %"class.sample::Points.25"* %7, i32 0, i32 3
...
; Function Attrs: noinline optnone
define x86_thiscallcc void @"\01?SerializeWithCachedSizes@Points@sample@@UBEXPAVCodedOutputStream@io@protobuf@google@@@Z"(%"class.sample::Points.25"*, %"class.google::protobuf::io::CodedOutputStream"*) unnamed_addr #0 align 2 {
  %3 = alloca %"class.google::protobuf::io::CodedOutputStream"*, align 4
  %4 = alloca %"class.sample::Points.25"*, align 4
  %5 = alloca i32, align 4
  %6 = alloca i32, align 4
  ...
  store %"class.google::protobuf::io::CodedOutputStream"* %1, %"class.google::protobuf::io::CodedOutputStream"** %3, align 4
  store %"class.sample::Points.25"* %0, %"class.sample::Points.25"** %4, align 4
  %8 = load %"class.sample::Points.25"*, %"class.sample::Points.25"** %4, align 4
  store i32 0, i32* %5, align 4
  store i32 0, i32* %6, align 4
  %9 = call x86_thiscallcc i32 @"\01?points_size@Points@sample@@QBEHXZ"(%"class.sample::Points.25"* %8)
...
; <label>:14:                                     ; preds = %10
  ...
  %16 = load i32, i32* %6, align 4
  %17 = call x86_thiscallcc dereferenceable(20) %"class.sample::Point.24"* @"\01?points@Points@sample@@QBEABVPoint@2@H@Z"(%"class.sample::Points.25"* %8, i32 %16)
  %18 = bitcast %"class.sample::Point.24"* %17 to %"class.google::protobuf::MessageLite"*
  call void @"\01?WriteMessage@WireFormatLite@internal@protobuf@google@@SAXHABVMessageLite@34@PAVCodedOutputStream@io@34@@Z"(i32 1, %"class.google::protobuf::MessageLite"* dereferenceable(4) %18, %"class.google::protobuf::io::CodedOutputStream"* %15)
  br label %19
...
; <label>:25:                                     ; preds = %22
  ...
  %28 = call x86_thiscallcc dereferenceable(24) %"class.std::basic_string"* @"\01?unknown_fields@?$InternalMetadataWithArenaBase@V?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@VInternalMetadataWithArenaLite@internal@protobuf@google@@@internal@protobuf@google@@QBEABV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@XZ"(%struct._iobuf* %27)
  br label %32

; <label>:29:                                     ; preds = %22
  %30 = getelementptr inbounds %"class.sample::Points.25", %"class.sample::Points.25"* %8, i32 0, i32 1
  %31 = call dereferenceable(24) %"class.std::basic_string"* @"\01?default_instance@InternalMetadataWithArenaLite@internal@protobuf@google@@SAABV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@XZ"()
  br label %32

; <label>:32:                                     ; preds = %29, %25
  %33 = phi %"class.std::basic_string"* [ %28, %25 ], [ %31, %29 ]
  %34 = call x86_thiscallcc i32 @"\01?size@?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QBEIXZ"(%"class.std::basic_string"* %33) #9
  %35 = call zeroext i1 @"\01?GetProto3PreserveUnknownsDefault@internal@protobuf@google@@YA_NXZ"()
  br i1 %35, label %36, label %40

; <label>:36:                                     ; preds = %32
  %37 = getelementptr inbounds %"class.sample::Points.25", %"class.sample::Points.25"* %8, i32 0, i32 1
  %38 = bitcast %"class.google::protobuf::internal::InternalMetadataWithArena"* %37 to %struct._iobuf*
  %39 = call x86_thiscallcc dereferenceable(24) %"class.std::basic_string"* @"\01?unknown_fields@?$InternalMetadataWithArenaBase@V?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@VInternalMetadataWithArenaLite@internal@protobuf@google@@@internal@protobuf@google@@QBEABV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@XZ"(%struct._iobuf* %38)
  br label %43

; <label>:40:                                     ; preds = %32
  %41 = getelementptr inbounds %"class.sample::Points.25", %"class.sample::Points.25"* %8, i32 0, i32 1
  %42 = call dereferenceable(24) %"class.std::basic_string"* @"\01?default_instance@InternalMetadataWithArenaLite@internal@protobuf@google@@SAABV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@XZ"()
  br label %43

; <label>:43:                                     ; preds = %40, %36
  %44 = phi %"class.std::basic_string"* [ %39, %36 ], [ %42, %40 ]
  %45 = call x86_thiscallcc i8* @"\01?data@?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QBEPBDXZ"(%"class.std::basic_string"* %44) #9
  call x86_thiscallcc void @"\01?WriteRaw@CodedOutputStream@io@protobuf@google@@QAEXPBXH@Z"(%"class.google::protobuf::io::CodedOutputStream"* %23, i8* %45, i32 %34)
  ret void
}

; Function Attrs: noinline nounwind optnone
define linkonce_odr x86_thiscallcc i32 @"\01?GetCachedSize@Points@sample@@UBEHXZ"(%"class.sample::Points.25"*) unnamed_addr #3 comdat align 2 {
  %2 = alloca %"class.sample::Points.25"*, align 4
  store %"class.sample::Points.25"* %0, %"class.sample::Points.25"** %2, align 4
  %3 = load %"class.sample::Points.25"*, %"class.sample::Points.25"** %2, align 4
  %4 = getelementptr inbounds %"class.sample::Points.25", %"class.sample::Points.25"* %3, i32 0, i32 3
...
; Function Attrs: noinline optnone
define linkonce_odr x86_thiscallcc i32 @"\01?points_size@Points@sample@@QBEHXZ"(%"class.sample::Points.25"*) #0 comdat align 2 {
  %2 = alloca %"class.sample::Points.25"*, align 4
  store %"class.sample::Points.25"* %0, %"class.sample::Points.25"** %2, align 4
  %3 = load %"class.sample::Points.25"*, %"class.sample::Points.25"** %2, align 4
...
; Function Attrs: noinline optnone
define linkonce_odr x86_thiscallcc dereferenceable(20) %"class.sample::Point.24"* @"\01?points@Points@sample@@QBEABVPoint@2@H@Z"(%"class.sample::Points.25"*, i32) #0 comdat align 2 {
  %3 = alloca i32, align 4
  %4 = alloca %"class.sample::Points.25"*, align 4
  store i32 %1, i32* %3, align 4
  store %"class.sample::Points.25"* %0, %"class.sample::Points.25"** %4, align 4
  ...
  %7 = load i32, i32* %3, align 4
  %8 = call x86_thiscallcc dereferenceable(20) %"class.sample::Point.24"* @"\01?Get@?$RepeatedPtrField@VPoint@sample@@@protobuf@google@@QBEABVPoint@sample@@H@Z"(%"class.google::protobuf::RepeatedPtrField"* %6, i32 %7)
  ret %"class.sample::Point.24"* %8
}

; Function Attrs: noinline optnone
define linkonce_odr x86_thiscallcc dereferenceable(20) %"class.sample::Point.24"* @"\01?Get@?$RepeatedPtrField@VPoint@sample@@@protobuf@google@@QBEABVPoint@sample@@H@Z"(%"class.google::protobuf::RepeatedPtrField"*, i32) #0 comdat align 2 {
  %3 = alloca i32, align 4
  ...
  %7 = load i32, i32* %3, align 4
  %8 = call x86_thiscallcc dereferenceable(20) %"class.sample::Point.24"* @"\01??$Get@VTypeHandler@?$RepeatedPtrField@VPoint@sample@@@protobuf@google@@@RepeatedPtrFieldBase@internal@protobuf@google@@IBEABVPoint@sample@@H@Z"(%"class.google::protobuf::internal::RepeatedPtrFieldBase"* %6, i32 %7)
  ret %"class.sample::Point.24"* %8
}

; Function Attrs: noinline optnone
define linkonce_odr x86_thiscallcc dereferenceable(20) %"class.sample::Point.24"* @"\01??$Get@VTypeHandler@?$RepeatedPtrField@VPoint@sample@@@protobuf@google@@@RepeatedPtrFieldBase@internal@protobuf@google@@IBEABVPoint@sample@@H@Z"(%"class.google::protobuf::internal::RepeatedPtrFieldBase"*, i32) #0 comdat align 2 personality i8* bitcast (i32 (...)* @__CxxFrameHandler3 to i8*) {
  %3 = alloca i32, align 4
...
; <label>:37:                                     ; preds = %36, %34
  ...
  %44 = call %"class.sample::Point.24"* bitcast (%"class.sample::Point"* (i8*)* @"\01??$cast@VTypeHandler@?$RepeatedPtrField@VPoint@sample@@@protobuf@google@@@RepeatedPtrFieldBase@internal@protobuf@google@@CAPAVPoint@sample@@PAX@Z" to %"class.sample::Point.24"* (i8*)*)(i8* %43)
  ret %"class.sample::Point.24"* %44
...
; Function Attrs: noinline optnone
define linkonce_odr %"class.sample::Points.25"* @"\01??$down_cast@PBVPoints@sample@@$$CBVMessageLite@protobuf@google@@@internal@protobuf@google@@YAPBVPoints@sample@@PBVMessageLite@12@@Z"(%"class.google::protobuf::MessageLite"*) #0 comdat {
  %2 = alloca %"class.google::protobuf::MessageLite"*, align 4
  store %"class.google::protobuf::MessageLite"* %0, %"class.google::protobuf::MessageLite"** %2, align 4
  %3 = load %"class.google::protobuf::MessageLite"*, %"class.google::protobuf::MessageLite"** %2, align 4
  %4 = icmp eq %"class.google::protobuf::MessageLite"* %3, null
...
; Function Attrs: noinline optnone
define x86_thiscallcc void @"\01?MergeFrom@Points@sample@@QAEXABV12@@Z"(%"class.sample::Points.25"*, %"class.sample::Points.25"* dereferenceable(28)) #0 align 2 personality i8* bitcast (i32 (...)* @__CxxFrameHandler3 to i8*) {
  %3 = alloca %"class.sample::Points.25"*, align 4
  %4 = alloca %"class.sample::Points.25"*, align 4
  %5 = alloca %"class.google::protobuf::internal::LogMessage", align 4
  %6 = alloca i1, align 1
  %7 = alloca %struct.__vcrt_assert_va_start_is_not_reference, align 1
  %8 = alloca i32, align 4
  store %"class.sample::Points.25"* %1, %"class.sample::Points.25"** %3, align 4
  store %"class.sample::Points.25"* %0, %"class.sample::Points.25"** %4, align 4
  %9 = load %"class.sample::Points.25"*, %"class.sample::Points.25"** %4, align 4
  %10 = load %"class.sample::Points.25"*, %"class.sample::Points.25"** %3, align 4
...
; <label>:13:                                     ; preds = %2
  %14 = call x86_thiscallcc %"class.google::protobuf::internal::LogMessage"* @"\01??0LogMessage@internal@protobuf@google@@QAE@W4LogLevel@23@PBDH@Z"(%"class.google::protobuf::internal::LogMessage"* %5, i32 3, i8* getelementptr inbounds ([73 x i8], [73 x i8]* @"\01??_C@_0EJ@KDOHDODM@E?3?2work?2local?2private?9contract?9s@", i32 0, i32 0), i32 1075)
  store i1 true, i1* %6, align 1
  %15 = invoke x86_thiscallcc dereferenceable(36) %"class.google::protobuf::internal::LogMessage"* @"\01??6LogMessage@internal@protobuf@google@@QAEAAV0123@PBD@Z"(%"class.google::protobuf::internal::LogMessage"* %5, i8* getelementptr inbounds ([34 x i8], [34 x i8]* @"\01??_C@_0CC@HENEHLPK@CHECK?5failed?3?5?$CI?$CGfrom?$CJ?5?$CB?$DN?5?$CIthis?$CJ?3@", i32 0, i32 0))
...
; <label>:21:                                     ; preds = %20, %18
  ...
  %23 = bitcast %"class.google::protobuf::internal::InternalMetadataWithArena"* %22 to %struct._iobuf*
  %24 = load %"class.sample::Points.25"*, %"class.sample::Points.25"** %3, align 4
  ...
  %27 = load %"class.sample::Points.25"*, %"class.sample::Points.25"** %3, align 4
...
define linkonce_odr x86_thiscallcc void @"\01??$MergeFromInnerLoop@VTypeHandler@?$RepeatedPtrField@VPoint@sample@@@protobuf@google@@@RepeatedPtrFieldBase@internal@protobuf@google@@AAEXPAPAX0HH@Z"(%"class.google::protobuf::internal::RepeatedPtrFieldBase"*, i8**, i8**, i32, i32) #0 comdat align 2 {
  ...
  %11 = alloca i32, align 4
  %12 = alloca %"class.sample::Point.24"*, align 4
  %13 = alloca %"class.sample::Point.24"*, align 4
  %14 = alloca %"class.google::protobuf::Arena"*, align 4
  %15 = alloca i32, align 4
  %16 = alloca %"class.sample::Point.24"*, align 4
  %17 = alloca %"class.sample::Point.24"*, align 4
  store i32 %4, i32* %6, align 4
...
; <label>:29:                                     ; preds = %27
  ...
  %34 = bitcast i8* %33 to %"class.sample::Point.24"*
  store %"class.sample::Point.24"* %34, %"class.sample::Point.24"** %12, align 4
  %35 = load i8**, i8*** %9, align 4
  %36 = load i32, i32* %11, align 4
  %37 = getelementptr inbounds i8*, i8** %35, i32 %36
  %38 = load i8*, i8** %37, align 4
  %39 = bitcast i8* %38 to %"class.sample::Point.24"*
  store %"class.sample::Point.24"* %39, %"class.sample::Point.24"** %13, align 4
  %40 = load %"class.sample::Point.24"*, %"class.sample::Point.24"** %13, align 4
  %41 = load %"class.sample::Point.24"*, %"class.sample::Point.24"** %12, align 4
  call void @"\01?Merge@?$GenericTypeHandler@VPoint@sample@@@internal@protobuf@google@@SAXABVPoint@sample@@PAV56@@Z"(%"class.sample::Point.24"* dereferenceable(20) %41, %"class.sample::Point.24"* %40)
  br label %42
...
; <label>:52:                                     ; preds = %48
  ...
  %56 = load i8*, i8** %55, align 4
  %57 = bitcast i8* %56 to %"class.sample::Point.24"*
  store %"class.sample::Point.24"* %57, %"class.sample::Point.24"** %16, align 4
  %58 = load %"class.google::protobuf::Arena"*, %"class.google::protobuf::Arena"** %14, align 4
  %59 = load %"class.sample::Point.24"*, %"class.sample::Point.24"** %16, align 4
  %60 = call %"class.sample::Point.24"* bitcast (%"class.sample::Point"* (%"class.sample::Point"*, %"class.google::protobuf::Arena"*)* @"\01?NewFromPrototype@?$GenericTypeHandler@VPoint@sample@@@internal@protobuf@google@@SAPAVPoint@sample@@PBV56@PAVArena@34@@Z" to %"class.sample::Point.24"* (%"class.sample::Point.24"*, %"class.google::protobuf::Arena"*)*)(%"class.sample::Point.24"* %59, %"class.google::protobuf::Arena"* %58)
  store %"class.sample::Point.24"* %60, %"class.sample::Point.24"** %17, align 4
  %61 = load %"class.sample::Point.24"*, %"class.sample::Point.24"** %17, align 4
  %62 = load %"class.sample::Point.24"*, %"class.sample::Point.24"** %16, align 4
  call void @"\01?Merge@?$GenericTypeHandler@VPoint@sample@@@internal@protobuf@google@@SAXABVPoint@sample@@PAV56@@Z"(%"class.sample::Point.24"* dereferenceable(20) %62, %"class.sample::Point.24"* %61)
  %63 = load %"class.sample::Point.24"*, %"class.sample::Point.24"** %17, align 4
  %64 = bitcast %"class.sample::Point.24"* %63 to i8*
...
; Function Attrs: noinline optnone
define linkonce_odr void @"\01?Merge@?$GenericTypeHandler@VPoint@sample@@@internal@protobuf@google@@SAXABVPoint@sample@@PAV56@@Z"(%"class.sample::Point.24"* dereferenceable(20), %"class.sample::Point.24"*) #0 comdat align 2 {
  %3 = alloca %"class.sample::Point.24"*, align 4
  %4 = alloca %"class.sample::Point.24"*, align 4
  store %"class.sample::Point.24"* %1, %"class.sample::Point.24"** %3, align 4
  store %"class.sample::Point.24"* %0, %"class.sample::Point.24"** %4, align 4
  %5 = load %"class.sample::Point.24"*, %"class.sample::Point.24"** %3, align 4
  %6 = load %"class.sample::Point.24"*, %"class.sample::Point.24"** %4, align 4
  call x86_thiscallcc void @"\01?MergeFrom@Point@sample@@QAEXABV12@@Z"(%"class.sample::Point.24"* %5, %"class.sample::Point.24"* dereferenceable(20) %6)
  ret void
}
...
; <label>:31:                                     ; preds = %38, %26
  ...
  %37 = call %"class.sample::Point.24"* bitcast (%"class.sample::Point"* (i8*)* @"\01??$cast@VTypeHandler@?$RepeatedPtrField@VPoint@sample@@@protobuf@google@@@RepeatedPtrFieldBase@internal@protobuf@google@@CAPAVPoint@sample@@PAX@Z" to %"class.sample::Point.24"* (i8*)*)(i8* %36)
  call void @"\01?Clear@?$GenericTypeHandler@VPoint@sample@@@internal@protobuf@google@@SAXPAVPoint@sample@@@Z"(%"class.sample::Point.24"* %37)
  br label %38
...
; Function Attrs: noinline optnone
define linkonce_odr void @"\01?Clear@?$GenericTypeHandler@VPoint@sample@@@internal@protobuf@google@@SAXPAVPoint@sample@@@Z"(%"class.sample::Point.24"*) #0 comdat align 2 {
  %2 = alloca %"class.sample::Point.24"*, align 4
  store %"class.sample::Point.24"* %0, %"class.sample::Point.24"** %2, align 4
  %3 = load %"class.sample::Point.24"*, %"class.sample::Point.24"** %2, align 4
  call x86_thiscallcc void @"\01?Clear@Point@sample@@UAEXXZ"(%"class.sample::Point.24"* %3)
  ret void
}

; Function Attrs: noinline optnone
define linkonce_odr x86_thiscallcc void @"\01??$Own@VPoints@sample@@@Arena@protobuf@google@@QAEXPAVPoints@sample@@@Z"(%"class.google::protobuf::Arena"*, %"class.sample::Points.25"*) #0 comdat align 2 {
  %3 = alloca %"class.sample::Points.25"*, align 4
  %4 = alloca %"class.google::protobuf::Arena"*, align 4
  %5 = alloca %struct.__vcrt_assert_va_start_is_not_reference, align 4
  %6 = alloca %struct.__vcrt_assert_va_start_is_not_reference, align 1
  ...
  %7 = load %"class.google::protobuf::Arena"*, %"class.google::protobuf::Arena"** %4, align 4
  %8 = bitcast %struct.__vcrt_assert_va_start_is_not_reference* %6 to %struct.__vcrt_assert_va_start_is_not_reference*
  %9 = load %"class.sample::Points.25"*, %"class.sample::Points.25"** %3, align 4
  call x86_thiscallcc void @"\01??$OwnInternal@VPoints@sample@@@Arena@protobuf@google@@AAEXPAVPoints@sample@@U?$integral_constant@_N$0A@@internal@12@@Z"(%"class.google::protobuf::Arena"* %7, %"class.sample::Points.25"* %9, %struct.__vcrt_assert_va_start_is_not_reference* byval align 4 %5)
  ret void
}

; Function Attrs: noinline optnone
define linkonce_odr x86_thiscallcc void @"\01??$OwnInternal@VPoints@sample@@@Arena@protobuf@google@@AAEXPAVPoints@sample@@U?$integral_constant@_N$0A@@internal@12@@Z"(%"class.google::protobuf::Arena"*, %"class.sample::Points.25"*, %struct.__vcrt_assert_va_start_is_not_reference* byval align 4) #0 comdat align 2 {
  %4 = alloca %"class.sample::Points.25"*, align 4
  %5 = alloca %"class.google::protobuf::Arena"*, align 4
  store %"class.sample::Points.25"* %1, %"class.sample::Points.25"** %4, align 4
  store %"class.google::protobuf::Arena"* %0, %"class.google::protobuf::Arena"** %5, align 4
  %6 = load %"class.google::protobuf::Arena"*, %"class.google::protobuf::Arena"** %5, align 4
  %7 = load %"class.sample::Points.25"*, %"class.sample::Points.25"** %4, align 4
  %8 = icmp ne %"class.sample::Points.25"* %7, null
  br i1 %8, label %9, label %13

; <label>:9:                                      ; preds = %3
  %10 = getelementptr inbounds %"class.google::protobuf::Arena", %"class.google::protobuf::Arena"* %6, i32 0, i32 0
  %11 = load %"class.sample::Points.25"*, %"class.sample::Points.25"** %4, align 4
  %12 = bitcast %"class.sample::Points.25"* %11 to i8*
  call x86_thiscallcc void @"\01?AddCleanup@ArenaImpl@internal@protobuf@google@@QAEXPAXP6AX0@Z@Z"(%"class.google::protobuf::internal::ArenaImpl"* %10, i8* %12, void (i8*)* @"\01??$arena_delete_object@VPoints@sample@@@internal@protobuf@google@@YAXPAX@Z")
  br label %13
...
; Function Attrs: noinline nounwind optnone
define linkonce_odr void @"\01??$arena_delete_object@VPoints@sample@@@internal@protobuf@google@@YAXPAX@Z"(i8*) #3 comdat {
  %2 = alloca i8*, align 4
  store i8* %0, i8** %2, align 4
  %3 = load i8*, i8** %2, align 4
...
; <label>:6:                                      ; preds = %1
  ...
  %8 = load i8* (%"class.sample::Points.25"*, i32)**, i8* (%"class.sample::Points.25"*, i32)*** %7, align 4
  %9 = getelementptr inbounds i8* (%"class.sample::Points.25"*, i32)*, i8* (%"class.sample::Points.25"*, i32)** %8, i64 0
  %10 = load i8* (%"class.sample::Points.25"*, i32)*, i8* (%"class.sample::Points.25"*, i32)** %9, align 4
  %11 = call x86_thiscallcc i8* %10(%"class.sample::Points.25"* %4, i32 1) #9
  br label %12
...
; Function Attrs: noinline nounwind optnone
define x86_thiscallcc void @"\01??1Points@sample@@UAE@XZ"(%"class.sample::Points.25"*) unnamed_addr #3 align 2 personality i8* bitcast (i32 (...)* @__CxxFrameHandler3 to i8*) {
  %2 = alloca %"class.sample::Points.25"*, align 4
  store %"class.sample::Points.25"* %0, %"class.sample::Points.25"** %2, align 4
  %3 = load %"class.sample::Points.25"*, %"class.sample::Points.25"** %2, align 4
  %4 = bitcast %"class.sample::Points.25"* %3 to i32 (...)***
  store i32 (...)** bitcast (i8** @"\01??_7Points@sample@@6B@" to i32 (...)**), i32 (...)*** %4, align 4
  invoke x86_thiscallcc void @"\01?SharedDtor@Points@sample@@AAEXXZ"(%"class.sample::Points.25"* %3)
...
; <label>:5:                                      ; preds = %1
  ...
  call x86_thiscallcc void @"\01??1InternalMetadataWithArenaLite@internal@protobuf@google@@QAE@XZ"(%"class.google::protobuf::internal::InternalMetadataWithArena"* %7) #9
  %8 = bitcast %"class.sample::Points.25"* %3 to %"class.google::protobuf::MessageLite"*
  call x86_thiscallcc void @"\01??1MessageLite@protobuf@google@@UAE@XZ"(%"class.google::protobuf::MessageLite"* %8) #9
  ret void
...
; <label>:12:                                     ; preds = %9
  ...
  call x86_thiscallcc void @"\01??1InternalMetadataWithArenaLite@internal@protobuf@google@@QAE@XZ"(%"class.google::protobuf::internal::InternalMetadataWithArena"* %14) #9 [ "funclet"(token %13) ]
  cleanupret from %13 unwind label %15

; <label>:15:                                     ; preds = %12
  %16 = cleanuppad within none []
  %17 = bitcast %"class.sample::Points.25"* %3 to %"class.google::protobuf::MessageLite"*
  call x86_thiscallcc void @"\01??1MessageLite@protobuf@google@@UAE@XZ"(%"class.google::protobuf::MessageLite"* %17) #9 [ "funclet"(token %16) ]
  cleanupret from %16 unwind label %18
...
; Function Attrs: noinline nounwind optnone
define x86_thiscallcc void @"\01?SharedDtor@Points@sample@@AAEXXZ"(%"class.sample::Points.25"*) #3 align 2 {
  %2 = alloca %"class.sample::Points.25"*, align 4
  store %"class.sample::Points.25"* %0, %"class.sample::Points.25"** %2, align 4
  %3 = load %"class.sample::Points.25"*, %"class.sample::Points.25"** %2, align 4
  ret void
...
; Function Attrs: noinline optnone
define x86_thiscallcc %"class.sample::Foo.13"* @"\01??0Foo@sample@@QAE@ABV01@@Z"(%"class.sample::Foo.13"* returned, %"class.sample::Foo.13"* dereferenceable(24)) unnamed_addr #0 align 2 personality i8* bitcast (i32 (...)* @__CxxFrameHandler3 to i8*) {
  %3 = alloca %"class.sample::Foo.13"*, align 4
  %4 = alloca %"class.sample::Foo.13"*, align 4
  %5 = alloca %"class.sample::Foo.13"*, align 4
  %6 = alloca %"struct.google::protobuf::internal::ArenaStringPtr", align 4
  store %"class.sample::Foo.13"* %1, %"class.sample::Foo.13"** %4, align 4
  store %"class.sample::Foo.13"* %0, %"class.sample::Foo.13"** %5, align 4
  %7 = load %"class.sample::Foo.13"*, %"class.sample::Foo.13"** %5, align 4
  store %"class.sample::Foo.13"* %7, %"class.sample::Foo.13"** %3, align 4
  %8 = bitcast %"class.sample::Foo.13"* %7 to %"class.google::protobuf::MessageLite"*
  %9 = call x86_thiscallcc %"class.google::protobuf::MessageLite"* @"\01??0MessageLite@protobuf@google@@QAE@XZ"(%"class.google::protobuf::MessageLite"* %8)
  ...
  %12 = invoke x86_thiscallcc %"class.google::protobuf::internal::InternalMetadataWithArena"* @"\01??0InternalMetadataWithArenaLite@internal@protobuf@google@@QAE@PAVArena@23@@Z"(%"class.google::protobuf::internal::InternalMetadataWithArena"* %11, %"class.google::protobuf::Arena"* null)
...
; <label>:13:                                     ; preds = %2
  ...
  %18 = load %"class.sample::Foo.13"*, %"class.sample::Foo.13"** %4, align 4
  %19 = getelementptr inbounds %"class.sample::Foo.13", %"class.sample::Foo.13"* %18, i32 0, i32 1
  invoke x86_thiscallcc void @"\01?MergeFrom@?$InternalMetadataWithArenaBase@V?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@VInternalMetadataWithArenaLite@internal@protobuf@google@@@internal@protobuf@google@@QAEXABVInternalMetadataWithArenaLite@234@@Z"(%struct._iobuf* %17, %"class.google::protobuf::internal::InternalMetadataWithArena"* dereferenceable(4) %19)
...
; <label>:24:                                     ; preds = %23
  %25 = load %"class.sample::Foo.13"*, %"class.sample::Foo.13"** %4, align 4
  %26 = invoke x86_thiscallcc dereferenceable(24) %"class.std::basic_string"* @"\01?s@Foo@sample@@QBEABV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@XZ"(%"class.sample::Foo.13"* %25)
...
; <label>:30:                                     ; preds = %27
  ...
  %32 = load %"class.sample::Foo.13"*, %"class.sample::Foo.13"** %4, align 4
...
; <label>:41:                                     ; preds = %40, %27
  %42 = getelementptr inbounds %"class.sample::Foo.13", %"class.sample::Foo.13"* %7, i32 0, i32 3
  %43 = bitcast i32* %42 to i8*
  %44 = load %"class.sample::Foo.13"*, %"class.sample::Foo.13"** %4, align 4
  %45 = getelementptr inbounds %"class.sample::Foo.13", %"class.sample::Foo.13"* %44, i32 0, i32 3
  %46 = bitcast i32* %45 to i8*
  %47 = getelementptr inbounds %"class.sample::Foo.13", %"class.sample::Foo.13"* %7, i32 0, i32 4
  %48 = bitcast float* %47 to i8*
  %49 = getelementptr inbounds %"class.sample::Foo.13", %"class.sample::Foo.13"* %7, i32 0, i32 3
  ...
  %55 = load %"class.sample::Foo.13"*, %"class.sample::Foo.13"** %3, align 4
  ret %"class.sample::Foo.13"* %55

; <label>:56:                                     ; preds = %37, %30, %24, %23, %20, %13
  %57 = cleanuppad within none []
  call x86_thiscallcc void @"\01??1InternalMetadataWithArenaLite@internal@protobuf@google@@QAE@XZ"(%"class.google::protobuf::internal::InternalMetadataWithArena"* %11) #9 [ "funclet"(token %57) ]
  cleanupret from %57 unwind label %58

; <label>:58:                                     ; preds = %56, %2
  %59 = cleanuppad within none []
  %60 = bitcast %"class.sample::Foo.13"* %7 to %"class.google::protobuf::MessageLite"*
  call x86_thiscallcc void @"\01??1MessageLite@protobuf@google@@UAE@XZ"(%"class.google::protobuf::MessageLite"* %60) #9 [ "funclet"(token %59) ]
  cleanupret from %59 unwind to caller
}

; Function Attrs: noinline nounwind optnone
define x86_thiscallcc void @"\01?SetCachedSize@Foo@sample@@ABEXH@Z"(%"class.sample::Foo.13"*, i32) #3 align 2 {
  %3 = alloca i32, align 4
  %4 = alloca %"class.sample::Foo.13"*, align 4
  store i32 %1, i32* %3, align 4
  store %"class.sample::Foo.13"* %0, %"class.sample::Foo.13"** %4, align 4
...
; Function Attrs: noinline optnone
define dereferenceable(24) %"class.sample::Foo.13"* @"\01?default_instance@Foo@sample@@SAABV12@XZ"() #0 align 2 {
  call void @"\01?InitDefaultsFoo@protobuf_SamplesLite_2eproto@@YAXXZ"()
  %1 = call %"class.sample::Foo.13"* @"\01?internal_default_instance@Foo@sample@@SAPBV12@XZ"()
...
; Function Attrs: noinline optnone
define x86_thiscallcc void @"\01?CopyFrom@Foo@sample@@QAEXABV12@@Z"(%"class.sample::Foo.13"*, %"class.sample::Foo.13"* dereferenceable(24)) #0 align 2 {
  %3 = alloca %"class.sample::Foo.13"*, align 4
  %4 = alloca %"class.sample::Foo.13"*, align 4
  store %"class.sample::Foo.13"* %1, %"class.sample::Foo.13"** %3, align 4
  store %"class.sample::Foo.13"* %0, %"class.sample::Foo.13"** %4, align 4
  %5 = load %"class.sample::Foo.13"*, %"class.sample::Foo.13"** %4, align 4
  %6 = load %"class.sample::Foo.13"*, %"class.sample::Foo.13"** %3, align 4
...
; <label>:9:                                      ; preds = %2
  call x86_thiscallcc void @"\01?Clear@Foo@sample@@UAEXXZ"(%"class.sample::Foo.13"* %5)
  %10 = load %"class.sample::Foo.13"*, %"class.sample::Foo.13"** %3, align 4
  call x86_thiscallcc void @"\01?MergeFrom@Foo@sample@@QAEXABV12@@Z"(%"class.sample::Foo.13"* %5, %"class.sample::Foo.13"* dereferenceable(24) %10)
  br label %11
...
; Function Attrs: noinline optnone
define x86_thiscallcc void @"\01?Swap@Foo@sample@@QAEXPAV12@@Z"(%"class.sample::Foo.13"*, %"class.sample::Foo.13"*) #0 align 2 {
  %3 = alloca %"class.sample::Foo.13"*, align 4
  %4 = alloca %"class.sample::Foo.13"*, align 4
  store %"class.sample::Foo.13"* %1, %"class.sample::Foo.13"** %3, align 4
  store %"class.sample::Foo.13"* %0, %"class.sample::Foo.13"** %4, align 4
...
; <label>:9:                                      ; preds = %2
  %10 = load %"class.sample::Foo.13"*, %"class.sample::Foo.13"** %3, align 4
  call x86_thiscallcc void @"\01?InternalSwap@Foo@sample@@AAEXPAV12@@Z"(%"class.sample::Foo.13"* %5, %"class.sample::Foo.13"* %10)
  br label %11
...
; Function Attrs: noinline optnone
define x86_thiscallcc void @"\01?InternalSwap@Foo@sample@@AAEXPAV12@@Z"(%"class.sample::Foo.13"*, %"class.sample::Foo.13"*) #0 align 2 {
  %3 = alloca %"class.sample::Foo.13"*, align 4
  %4 = alloca %"class.sample::Foo.13"*, align 4
  store %"class.sample::Foo.13"* %1, %"class.sample::Foo.13"** %3, align 4
  store %"class.sample::Foo.13"* %0, %"class.sample::Foo.13"** %4, align 4
  ...
  %7 = load %"class.sample::Foo.13"*, %"class.sample::Foo.13"** %3, align 4
  ...
  %12 = load %"class.sample::Foo.13"*, %"class.sample::Foo.13"** %3, align 4
  ...
  %16 = bitcast %"class.google::protobuf::internal::InternalMetadataWithArena"* %15 to %struct._iobuf*
  %17 = load %"class.sample::Foo.13"*, %"class.sample::Foo.13"** %3, align 4
  %18 = getelementptr inbounds %"class.sample::Foo.13", %"class.sample::Foo.13"* %17, i32 0, i32 1
  call x86_thiscallcc void @"\01?Swap@?$InternalMetadataWithArenaBase@V?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@VInternalMetadataWithArenaLite@internal@protobuf@google@@@internal@protobuf@google@@QAEXPAVInternalMetadataWithArenaLite@234@@Z"(%struct._iobuf* %16, %"class.google::protobuf::internal::InternalMetadataWithArena"* %18)
  %19 = load %"class.sample::Foo.13"*, %"class.sample::Foo.13"** %3, align 4
...
; Function Attrs: noinline optnone
define linkonce_odr x86_thiscallcc void @"\01?Swap@?$InternalMetadataWithArenaBase@V?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@VInternalMetadataWithArenaLite@internal@protobuf@google@@@internal@protobuf@google@@QAEXPAVInternalMetadataWithArenaLite@234@@Z"(%struct._iobuf*, %"class.google::protobuf::internal::InternalMetadataWithArena"*) #0 comdat align 2 {
  %3 = alloca %"class.google::protobuf::internal::InternalMetadataWithArena"*, align 4
  %4 = alloca %struct._iobuf*, align 4
  store %"class.google::protobuf::internal::InternalMetadataWithArena"* %1, %"class.google::protobuf::internal::InternalMetadataWithArena"** %3, align 4
  store %struct._iobuf* %0, %struct._iobuf** %4, align 4
  %5 = load %struct._iobuf*, %struct._iobuf** %4, align 4
  %6 = call x86_thiscallcc zeroext i1 @"\01?have_unknown_fields@?$InternalMetadataWithArenaBase@V?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@VInternalMetadataWithArenaLite@internal@protobuf@google@@@internal@protobuf@google@@QBE_NXZ"(%struct._iobuf* %5)
...
; <label>:7:                                      ; preds = %2
  ...
  %9 = bitcast %"class.google::protobuf::internal::InternalMetadataWithArena"* %8 to %struct._iobuf*
  %10 = call x86_thiscallcc zeroext i1 @"\01?have_unknown_fields@?$InternalMetadataWithArenaBase@V?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@VInternalMetadataWithArenaLite@internal@protobuf@google@@@internal@protobuf@google@@QBE_NXZ"(%struct._iobuf* %9)
...
define linkonce_odr x86_thiscallcc void @"\01?DoSwap@InternalMetadataWithArenaLite@internal@protobuf@google@@QAEXPAV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@@Z"(%"class.google::protobuf::internal::InternalMetadataWithArena"*, %"class.std::basic_string"*) #0 comdat align 2 {
  ...
  %7 = call x86_thiscallcc %"class.std::basic_string"* @"\01?mutable_unknown_fields@?$InternalMetadataWithArenaBase@V?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@VInternalMetadataWithArenaLite@internal@protobuf@google@@@internal@protobuf@google@@QAEPAV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@XZ"(%struct._iobuf* %6)
  %8 = load %"class.std::basic_string"*, %"class.std::basic_string"** %3, align 4
  call x86_thiscallcc void @"\01?swap@?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAEXAAV12@@Z"(%"class.std::basic_string"* %7, %"class.std::basic_string"* dereferenceable(24) %8) #9
  ret void
}
...
; Function Attrs: noinline optnone
define x86_thiscallcc %"class.sample::Bar.23"* @"\01??0Bar@sample@@QAE@ABV01@@Z"(%"class.sample::Bar.23"* returned, %"class.sample::Bar.23"* dereferenceable(24)) unnamed_addr #0 align 2 personality i8* bitcast (i32 (...)* @__CxxFrameHandler3 to i8*) {
  %3 = alloca %"class.sample::Bar.23"*, align 4
  %4 = alloca %"class.sample::Bar.23"*, align 4
  %5 = alloca %"class.sample::Bar.23"*, align 4
  store %"class.sample::Bar.23"* %1, %"class.sample::Bar.23"** %4, align 4
  store %"class.sample::Bar.23"* %0, %"class.sample::Bar.23"** %5, align 4
  %6 = load %"class.sample::Bar.23"*, %"class.sample::Bar.23"** %5, align 4
  store %"class.sample::Bar.23"* %6, %"class.sample::Bar.23"** %3, align 4
  %7 = bitcast %"class.sample::Bar.23"* %6 to %"class.google::protobuf::MessageLite"*
  %8 = call x86_thiscallcc %"class.google::protobuf::MessageLite"* @"\01??0MessageLite@protobuf@google@@QAE@XZ"(%"class.google::protobuf::MessageLite"* %7)
  ...
  %11 = invoke x86_thiscallcc %"class.google::protobuf::internal::InternalMetadataWithArena"* @"\01??0InternalMetadataWithArenaLite@internal@protobuf@google@@QAE@PAVArena@23@@Z"(%"class.google::protobuf::internal::InternalMetadataWithArena"* %10, %"class.google::protobuf::Arena"* null)
...
; <label>:12:                                     ; preds = %2
  ...
  %16 = load %"class.sample::Bar.23"*, %"class.sample::Bar.23"** %4, align 4
  %17 = getelementptr inbounds %"class.sample::Bar.23", %"class.sample::Bar.23"* %16, i32 0, i32 1
  invoke x86_thiscallcc void @"\01?MergeFrom@?$InternalMetadataWithArenaBase@V?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@VInternalMetadataWithArenaLite@internal@protobuf@google@@@internal@protobuf@google@@QAEXABVInternalMetadataWithArenaLite@234@@Z"(%struct._iobuf* %15, %"class.google::protobuf::internal::InternalMetadataWithArena"* dereferenceable(4) %17)
          to label %18 unwind label %51

; <label>:18:                                     ; preds = %12
  %19 = load %"class.sample::Bar.23"*, %"class.sample::Bar.23"** %4, align 4
  %20 = invoke x86_thiscallcc zeroext i1 @"\01?has_foo@Bar@sample@@QBE_NXZ"(%"class.sample::Bar.23"* %19)
...
; <label>:24:                                     ; preds = %22
  ...
  %26 = load %"class.sample::Bar.23"*, %"class.sample::Bar.23"** %4, align 4
  %27 = getelementptr inbounds %"class.sample::Bar.23", %"class.sample::Bar.23"* %26, i32 0, i32 2
  %28 = load %"class.sample::Foo.13"*, %"class.sample::Foo.13"** %27, align 4
  %29 = invoke x86_thiscallcc %"class.sample::Foo.13"* @"\01??0Foo@sample@@QAE@ABV01@@Z"(%"class.sample::Foo.13"* %25, %"class.sample::Foo.13"* dereferenceable(24) %28)
          to label %30 unwind label %32

; <label>:30:                                     ; preds = %24
  %31 = getelementptr inbounds %"class.sample::Bar.23", %"class.sample::Bar.23"* %6, i32 0, i32 2
  store %"class.sample::Foo.13"* %25, %"class.sample::Foo.13"** %31, align 4
  br label %36
...
; <label>:34:                                     ; preds = %21
  ...
  store %"class.sample::Foo.13"* null, %"class.sample::Foo.13"** %35, align 4
  br label %36

; <label>:36:                                     ; preds = %34, %30
  %37 = getelementptr inbounds %"class.sample::Bar.23", %"class.sample::Bar.23"* %6, i32 0, i32 3
  %38 = bitcast i32* %37 to i8*
  %39 = load %"class.sample::Bar.23"*, %"class.sample::Bar.23"** %4, align 4
  ...
  %50 = load %"class.sample::Bar.23"*, %"class.sample::Bar.23"** %3, align 4
  ret %"class.sample::Bar.23"* %50

; <label>:51:                                     ; preds = %32, %22, %18, %12
  %52 = cleanuppad within none []
  call x86_thiscallcc void @"\01??1InternalMetadataWithArenaLite@internal@protobuf@google@@QAE@XZ"(%"class.google::protobuf::internal::InternalMetadataWithArena"* %10) #9 [ "funclet"(token %52) ]
  cleanupret from %52 unwind label %53

; <label>:53:                                     ; preds = %51, %2
  %54 = cleanuppad within none []
  %55 = bitcast %"class.sample::Bar.23"* %6 to %"class.google::protobuf::MessageLite"*
  call x86_thiscallcc void @"\01??1MessageLite@protobuf@google@@UAE@XZ"(%"class.google::protobuf::MessageLite"* %55) #9 [ "funclet"(token %54) ]
  cleanupret from %54 unwind to caller
}

; Function Attrs: noinline nounwind optnone
define x86_thiscallcc void @"\01?SetCachedSize@Bar@sample@@ABEXH@Z"(%"class.sample::Bar.23"*, i32) #3 align 2 {
  %3 = alloca i32, align 4
  %4 = alloca %"class.sample::Bar.23"*, align 4
  store i32 %1, i32* %3, align 4
  store %"class.sample::Bar.23"* %0, %"class.sample::Bar.23"** %4, align 4
...
; Function Attrs: noinline optnone
define dereferenceable(24) %"class.sample::Bar.23"* @"\01?default_instance@Bar@sample@@SAABV12@XZ"() #0 align 2 {
  call void @"\01?InitDefaultsBar@protobuf_SamplesLite_2eproto@@YAXXZ"()
  %1 = call %"class.sample::Bar.23"* @"\01?internal_default_instance@Bar@sample@@SAPBV12@XZ"()
  ret %"class.sample::Bar.23"* %1
}

; Function Attrs: noinline optnone
define x86_thiscallcc void @"\01?CopyFrom@Bar@sample@@QAEXABV12@@Z"(%"class.sample::Bar.23"*, %"class.sample::Bar.23"* dereferenceable(24)) #0 align 2 {
  %3 = alloca %"class.sample::Bar.23"*, align 4
  %4 = alloca %"class.sample::Bar.23"*, align 4
  store %"class.sample::Bar.23"* %1, %"class.sample::Bar.23"** %3, align 4
  store %"class.sample::Bar.23"* %0, %"class.sample::Bar.23"** %4, align 4
  %5 = load %"class.sample::Bar.23"*, %"class.sample::Bar.23"** %4, align 4
  %6 = load %"class.sample::Bar.23"*, %"class.sample::Bar.23"** %3, align 4
...
; <label>:9:                                      ; preds = %2
  call x86_thiscallcc void @"\01?Clear@Bar@sample@@UAEXXZ"(%"class.sample::Bar.23"* %5)
  %10 = load %"class.sample::Bar.23"*, %"class.sample::Bar.23"** %3, align 4
  call x86_thiscallcc void @"\01?MergeFrom@Bar@sample@@QAEXABV12@@Z"(%"class.sample::Bar.23"* %5, %"class.sample::Bar.23"* dereferenceable(24) %10)
  br label %11
...
; Function Attrs: noinline optnone
define x86_thiscallcc void @"\01?Swap@Bar@sample@@QAEXPAV12@@Z"(%"class.sample::Bar.23"*, %"class.sample::Bar.23"*) #0 align 2 {
  %3 = alloca %"class.sample::Bar.23"*, align 4
  %4 = alloca %"class.sample::Bar.23"*, align 4
  store %"class.sample::Bar.23"* %1, %"class.sample::Bar.23"** %3, align 4
  store %"class.sample::Bar.23"* %0, %"class.sample::Bar.23"** %4, align 4
...
; <label>:9:                                      ; preds = %2
  %10 = load %"class.sample::Bar.23"*, %"class.sample::Bar.23"** %3, align 4
  call x86_thiscallcc void @"\01?InternalSwap@Bar@sample@@AAEXPAV12@@Z"(%"class.sample::Bar.23"* %5, %"class.sample::Bar.23"* %10)
  br label %11
...
; Function Attrs: noinline optnone
define x86_thiscallcc void @"\01?InternalSwap@Bar@sample@@AAEXPAV12@@Z"(%"class.sample::Bar.23"*, %"class.sample::Bar.23"*) #0 align 2 {
  %3 = alloca %"class.sample::Bar.23"*, align 4
  %4 = alloca %"class.sample::Bar.23"*, align 4
  store %"class.sample::Bar.23"* %1, %"class.sample::Bar.23"** %3, align 4
  store %"class.sample::Bar.23"* %0, %"class.sample::Bar.23"** %4, align 4
  ...
  call void @"\01??$swap@PAVFoo@sample@@X@std@@YAXAAPAVFoo@sample@@0@Z"(%"class.sample::Foo.13"** dereferenceable(4) %8, %"class.sample::Foo.13"** dereferenceable(4) %7) #9
  %9 = load %"class.sample::Bar.23"*, %"class.sample::Bar.23"** %3, align 4
  ...
  call void @"\01??$swap@HX@std@@YAXAAH0@Z"(i32* dereferenceable(4) %11, i32* dereferenceable(4) %10) #9
  %12 = load %"class.sample::Bar.23"*, %"class.sample::Bar.23"** %3, align 4
  ...
  %16 = bitcast %"class.google::protobuf::internal::InternalMetadataWithArena"* %15 to %struct._iobuf*
  %17 = load %"class.sample::Bar.23"*, %"class.sample::Bar.23"** %3, align 4
  %18 = getelementptr inbounds %"class.sample::Bar.23", %"class.sample::Bar.23"* %17, i32 0, i32 1
  call x86_thiscallcc void @"\01?Swap@?$InternalMetadataWithArenaBase@V?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@VInternalMetadataWithArenaLite@internal@protobuf@google@@@internal@protobuf@google@@QAEXPAVInternalMetadataWithArenaLite@234@@Z"(%struct._iobuf* %16, %"class.google::protobuf::internal::InternalMetadataWithArena"* %18)
  %19 = load %"class.sample::Bar.23"*, %"class.sample::Bar.23"** %3, align 4
...
; Function Attrs: noinline nounwind optnone
define linkonce_odr void @"\01??$swap@PAVFoo@sample@@X@std@@YAXAAPAVFoo@sample@@0@Z"(%"class.sample::Foo.13"** dereferenceable(4), %"class.sample::Foo.13"** dereferenceable(4)) #3 comdat {
  %3 = alloca %"class.sample::Foo.13"**, align 4
  %4 = alloca %"class.sample::Foo.13"**, align 4
  %5 = alloca %"class.sample::Foo.13"*, align 4
  store %"class.sample::Foo.13"** %1, %"class.sample::Foo.13"*** %3, align 4
  store %"class.sample::Foo.13"** %0, %"class.sample::Foo.13"*** %4, align 4
  %6 = load %"class.sample::Foo.13"**, %"class.sample::Foo.13"*** %4, align 4
  %7 = call dereferenceable(4) %"class.sample::Foo.13"** @"\01??$move@AAPAVFoo@sample@@@std@@YA$$QAPAVFoo@sample@@AAPAV12@@Z"(%"class.sample::Foo.13"** dereferenceable(4) %6) #9
  %8 = load %"class.sample::Foo.13"*, %"class.sample::Foo.13"** %7, align 4
  store %"class.sample::Foo.13"* %8, %"class.sample::Foo.13"** %5, align 4
  %9 = load %"class.sample::Foo.13"**, %"class.sample::Foo.13"*** %3, align 4
  %10 = call dereferenceable(4) %"class.sample::Foo.13"** @"\01??$move@AAPAVFoo@sample@@@std@@YA$$QAPAVFoo@sample@@AAPAV12@@Z"(%"class.sample::Foo.13"** dereferenceable(4) %9) #9
  %11 = load %"class.sample::Foo.13"*, %"class.sample::Foo.13"** %10, align 4
  %12 = load %"class.sample::Foo.13"**, %"class.sample::Foo.13"*** %4, align 4
  store %"class.sample::Foo.13"* %11, %"class.sample::Foo.13"** %12, align 4
  %13 = call dereferenceable(4) %"class.sample::Foo.13"** @"\01??$move@AAPAVFoo@sample@@@std@@YA$$QAPAVFoo@sample@@AAPAV12@@Z"(%"class.sample::Foo.13"** dereferenceable(4) %5) #9
  %14 = load %"class.sample::Foo.13"*, %"class.sample::Foo.13"** %13, align 4
  %15 = load %"class.sample::Foo.13"**, %"class.sample::Foo.13"*** %3, align 4
  store %"class.sample::Foo.13"* %14, %"class.sample::Foo.13"** %15, align 4
  ret void
}

; Function Attrs: noinline nounwind optnone
define linkonce_odr dereferenceable(4) %"class.sample::Foo.13"** @"\01??$move@AAPAVFoo@sample@@@std@@YA$$QAPAVFoo@sample@@AAPAV12@@Z"(%"class.sample::Foo.13"** dereferenceable(4)) #3 comdat {
  %2 = alloca %"class.sample::Foo.13"**, align 4
  store %"class.sample::Foo.13"** %0, %"class.sample::Foo.13"*** %2, align 4
  %3 = load %"class.sample::Foo.13"**, %"class.sample::Foo.13"*** %2, align 4
...
; Function Attrs: noinline optnone
define x86_thiscallcc %"class.sample::Point.24"* @"\01??0Point@sample@@QAE@ABV01@@Z"(%"class.sample::Point.24"* returned, %"class.sample::Point.24"* dereferenceable(20)) unnamed_addr #0 align 2 personality i8* bitcast (i32 (...)* @__CxxFrameHandler3 to i8*) {
  %3 = alloca %"class.sample::Point.24"*, align 4
  %4 = alloca %"class.sample::Point.24"*, align 4
  store %"class.sample::Point.24"* %1, %"class.sample::Point.24"** %3, align 4
  store %"class.sample::Point.24"* %0, %"class.sample::Point.24"** %4, align 4
...
; <label>:11:                                     ; preds = %2
  ...
  %14 = bitcast %"class.google::protobuf::internal::InternalMetadataWithArena"* %13 to %struct._iobuf*
  %15 = load %"class.sample::Point.24"*, %"class.sample::Point.24"** %3, align 4
  %16 = getelementptr inbounds %"class.sample::Point.24", %"class.sample::Point.24"* %15, i32 0, i32 1
  invoke x86_thiscallcc void @"\01?MergeFrom@?$InternalMetadataWithArenaBase@V?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@VInternalMetadataWithArenaLite@internal@protobuf@google@@@internal@protobuf@google@@QAEXABVInternalMetadataWithArenaLite@234@@Z"(%struct._iobuf* %14, %"class.google::protobuf::internal::InternalMetadataWithArena"* dereferenceable(4) %16)
          to label %17 unwind label %31

; <label>:17:                                     ; preds = %11
  %18 = getelementptr inbounds %"class.sample::Point.24", %"class.sample::Point.24"* %5, i32 0, i32 2
  %19 = bitcast i32* %18 to i8*
  %20 = load %"class.sample::Point.24"*, %"class.sample::Point.24"** %3, align 4
...
; <label>:31:                                     ; preds = %11
  ...
  call x86_thiscallcc void @"\01??1InternalMetadataWithArenaLite@internal@protobuf@google@@QAE@XZ"(%"class.google::protobuf::internal::InternalMetadataWithArena"* %9) #9 [ "funclet"(token %32) ]
...
; <label>:33:                                     ; preds = %31, %2
  ...
  call x86_thiscallcc void @"\01??1MessageLite@protobuf@google@@UAE@XZ"(%"class.google::protobuf::MessageLite"* %35) #9 [ "funclet"(token %34) ]
  cleanupret from %34 unwind to caller
}

; Function Attrs: noinline nounwind optnone
define x86_thiscallcc void @"\01?SetCachedSize@Point@sample@@ABEXH@Z"(%"class.sample::Point.24"*, i32) #3 align 2 {
  %3 = alloca i32, align 4
  %4 = alloca %"class.sample::Point.24"*, align 4
  store i32 %1, i32* %3, align 4
  store %"class.sample::Point.24"* %0, %"class.sample::Point.24"** %4, align 4
...
; Function Attrs: noinline optnone
define dereferenceable(20) %"class.sample::Point.24"* @"\01?default_instance@Point@sample@@SAABV12@XZ"() #0 align 2 {
  call void @"\01?InitDefaultsPoint@protobuf_SamplesLite_2eproto@@YAXXZ"()
  %1 = call %"class.sample::Point.24"* @"\01?internal_default_instance@Point@sample@@SAPBV12@XZ"()
  ret %"class.sample::Point.24"* %1
}

; Function Attrs: noinline optnone
define x86_thiscallcc void @"\01?CopyFrom@Point@sample@@QAEXABV12@@Z"(%"class.sample::Point.24"*, %"class.sample::Point.24"* dereferenceable(20)) #0 align 2 {
  %3 = alloca %"class.sample::Point.24"*, align 4
  %4 = alloca %"class.sample::Point.24"*, align 4
  store %"class.sample::Point.24"* %1, %"class.sample::Point.24"** %3, align 4
  store %"class.sample::Point.24"* %0, %"class.sample::Point.24"** %4, align 4
  %5 = load %"class.sample::Point.24"*, %"class.sample::Point.24"** %4, align 4
  %6 = load %"class.sample::Point.24"*, %"class.sample::Point.24"** %3, align 4
...
; <label>:9:                                      ; preds = %2
  call x86_thiscallcc void @"\01?Clear@Point@sample@@UAEXXZ"(%"class.sample::Point.24"* %5)
  %10 = load %"class.sample::Point.24"*, %"class.sample::Point.24"** %3, align 4
  call x86_thiscallcc void @"\01?MergeFrom@Point@sample@@QAEXABV12@@Z"(%"class.sample::Point.24"* %5, %"class.sample::Point.24"* dereferenceable(20) %10)
  br label %11
...
; Function Attrs: noinline optnone
define x86_thiscallcc void @"\01?Swap@Point@sample@@QAEXPAV12@@Z"(%"class.sample::Point.24"*, %"class.sample::Point.24"*) #0 align 2 {
  %3 = alloca %"class.sample::Point.24"*, align 4
  %4 = alloca %"class.sample::Point.24"*, align 4
  store %"class.sample::Point.24"* %1, %"class.sample::Point.24"** %3, align 4
  store %"class.sample::Point.24"* %0, %"class.sample::Point.24"** %4, align 4
...
; <label>:9:                                      ; preds = %2
  %10 = load %"class.sample::Point.24"*, %"class.sample::Point.24"** %3, align 4
  call x86_thiscallcc void @"\01?InternalSwap@Point@sample@@AAEXPAV12@@Z"(%"class.sample::Point.24"* %5, %"class.sample::Point.24"* %10)
  br label %11
...
; Function Attrs: noinline optnone
define x86_thiscallcc void @"\01?InternalSwap@Point@sample@@AAEXPAV12@@Z"(%"class.sample::Point.24"*, %"class.sample::Point.24"*) #0 align 2 {
  %3 = alloca %"class.sample::Point.24"*, align 4
  %4 = alloca %"class.sample::Point.24"*, align 4
  store %"class.sample::Point.24"* %1, %"class.sample::Point.24"** %3, align 4
  store %"class.sample::Point.24"* %0, %"class.sample::Point.24"** %4, align 4
  ...
  %14 = load %"class.sample::Point.24"*, %"class.sample::Point.24"** %3, align 4
  %15 = getelementptr inbounds %"class.sample::Point.24", %"class.sample::Point.24"* %14, i32 0, i32 1
  call x86_thiscallcc void @"\01?Swap@?$InternalMetadataWithArenaBase@V?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@VInternalMetadataWithArenaLite@internal@protobuf@google@@@internal@protobuf@google@@QAEXPAVInternalMetadataWithArenaLite@234@@Z"(%struct._iobuf* %13, %"class.google::protobuf::internal::InternalMetadataWithArena"* %15)
  %16 = load %"class.sample::Point.24"*, %"class.sample::Point.24"** %3, align 4
...
; Function Attrs: noinline optnone
define x86_thiscallcc %"class.sample::Points.25"* @"\01??0Points@sample@@QAE@ABV01@@Z"(%"class.sample::Points.25"* returned, %"class.sample::Points.25"* dereferenceable(28)) unnamed_addr #0 align 2 personality i8* bitcast (i32 (...)* @__CxxFrameHandler3 to i8*) {
  %3 = alloca %"class.sample::Points.25"*, align 4
  %4 = alloca %"class.sample::Points.25"*, align 4
  store %"class.sample::Points.25"* %1, %"class.sample::Points.25"** %3, align 4
  store %"class.sample::Points.25"* %0, %"class.sample::Points.25"** %4, align 4
...
; <label>:11:                                     ; preds = %2
  ...
  %13 = load %"class.sample::Points.25"*, %"class.sample::Points.25"** %3, align 4
...
; <label>:16:                                     ; preds = %11
  ...
  %20 = load %"class.sample::Points.25"*, %"class.sample::Points.25"** %3, align 4
  %21 = getelementptr inbounds %"class.sample::Points.25", %"class.sample::Points.25"* %20, i32 0, i32 1
  invoke x86_thiscallcc void @"\01?MergeFrom@?$InternalMetadataWithArenaBase@V?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@VInternalMetadataWithArenaLite@internal@protobuf@google@@@internal@protobuf@google@@QAEXABVInternalMetadataWithArenaLite@234@@Z"(%struct._iobuf* %19, %"class.google::protobuf::internal::InternalMetadataWithArena"* dereferenceable(4) %21)
          to label %22 unwind label %23
...
; <label>:25:                                     ; preds = %23, %11
  %26 = cleanuppad within none []
  call x86_thiscallcc void @"\01??1InternalMetadataWithArenaLite@internal@protobuf@google@@QAE@XZ"(%"class.google::protobuf::internal::InternalMetadataWithArena"* %9) #9 [ "funclet"(token %26) ]
  cleanupret from %26 unwind label %27

; <label>:27:                                     ; preds = %25, %2
  %28 = cleanuppad within none []
  %29 = bitcast %"class.sample::Points.25"* %5 to %"class.google::protobuf::MessageLite"*
  call x86_thiscallcc void @"\01??1MessageLite@protobuf@google@@UAE@XZ"(%"class.google::protobuf::MessageLite"* %29) #9 [ "funclet"(token %28) ]
  cleanupret from %28 unwind to caller
}
...
; Function Attrs: noinline nounwind optnone
define x86_thiscallcc void @"\01?SetCachedSize@Points@sample@@ABEXH@Z"(%"class.sample::Points.25"*, i32) #3 align 2 {
  %3 = alloca i32, align 4
  %4 = alloca %"class.sample::Points.25"*, align 4
  store i32 %1, i32* %3, align 4
  store %"class.sample::Points.25"* %0, %"class.sample::Points.25"** %4, align 4
...
; Function Attrs: noinline optnone
define dereferenceable(28) %"class.sample::Points.25"* @"\01?default_instance@Points@sample@@SAABV12@XZ"() #0 align 2 {
  call void @"\01?InitDefaultsPoints@protobuf_SamplesLite_2eproto@@YAXXZ"()
  %1 = call %"class.sample::Points.25"* @"\01?internal_default_instance@Points@sample@@SAPBV12@XZ"()
  ret %"class.sample::Points.25"* %1
}

; Function Attrs: noinline optnone
define x86_thiscallcc void @"\01?CopyFrom@Points@sample@@QAEXABV12@@Z"(%"class.sample::Points.25"*, %"class.sample::Points.25"* dereferenceable(28)) #0 align 2 {
  %3 = alloca %"class.sample::Points.25"*, align 4
  %4 = alloca %"class.sample::Points.25"*, align 4
  store %"class.sample::Points.25"* %1, %"class.sample::Points.25"** %3, align 4
  store %"class.sample::Points.25"* %0, %"class.sample::Points.25"** %4, align 4
  %5 = load %"class.sample::Points.25"*, %"class.sample::Points.25"** %4, align 4
  %6 = load %"class.sample::Points.25"*, %"class.sample::Points.25"** %3, align 4
...
; <label>:9:                                      ; preds = %2
  call x86_thiscallcc void @"\01?Clear@Points@sample@@UAEXXZ"(%"class.sample::Points.25"* %5)
  %10 = load %"class.sample::Points.25"*, %"class.sample::Points.25"** %3, align 4
  call x86_thiscallcc void @"\01?MergeFrom@Points@sample@@QAEXABV12@@Z"(%"class.sample::Points.25"* %5, %"class.sample::Points.25"* dereferenceable(28) %10)
  br label %11
...
; Function Attrs: noinline optnone
define x86_thiscallcc void @"\01?Swap@Points@sample@@QAEXPAV12@@Z"(%"class.sample::Points.25"*, %"class.sample::Points.25"*) #0 align 2 {
  %3 = alloca %"class.sample::Points.25"*, align 4
  %4 = alloca %"class.sample::Points.25"*, align 4
  store %"class.sample::Points.25"* %1, %"class.sample::Points.25"** %3, align 4
  store %"class.sample::Points.25"* %0, %"class.sample::Points.25"** %4, align 4
...
; <label>:9:                                      ; preds = %2
  %10 = load %"class.sample::Points.25"*, %"class.sample::Points.25"** %3, align 4
  call x86_thiscallcc void @"\01?InternalSwap@Points@sample@@AAEXPAV12@@Z"(%"class.sample::Points.25"* %5, %"class.sample::Points.25"* %10)
  br label %11
...
; Function Attrs: noinline optnone
define x86_thiscallcc void @"\01?InternalSwap@Points@sample@@AAEXPAV12@@Z"(%"class.sample::Points.25"*, %"class.sample::Points.25"*) #0 align 2 {
  %3 = alloca %"class.sample::Points.25"*, align 4
  %4 = alloca %"class.sample::Points.25"*, align 4
  store %"class.sample::Points.25"* %1, %"class.sample::Points.25"** %3, align 4
  store %"class.sample::Points.25"* %0, %"class.sample::Points.25"** %4, align 4
  ...
  %8 = load %"class.sample::Points.25"*, %"class.sample::Points.25"** %3, align 4
  ...
  call x86_thiscallcc void @"\01?Swap@?$InternalMetadataWithArenaBase@V?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@VInternalMetadataWithArenaLite@internal@protobuf@google@@@internal@protobuf@google@@QAEXPAVInternalMetadataWithArenaLite@234@@Z"(%struct._iobuf* %12, %"class.google::protobuf::internal::InternalMetadataWithArena"* %14)
  %15 = load %"class.sample::Points.25"*, %"class.sample::Points.25"** %3, align 4
