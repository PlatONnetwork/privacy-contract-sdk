...
$"\01??$down_cast@PBVFoo@simpleproto2@@$$CBVMessageLite@protobuf@google@@@internal@protobuf@google@@YAPBVFoo@simpleproto2@@PBVMessageLite@12@@Z" = comdat any
...
$"\01??$OwnInternal@VFoo@simpleproto2@@@Arena@protobuf@google@@AAEXPAVFoo@simpleproto2@@U?$integral_constant@_N$0A@@internal@12@@Z" = comdat any

$"\01??$arena_delete_object@VFoo@simpleproto2@@@internal@protobuf@google@@YAXPAX@Z" = comdat any
...
$"\01??$down_cast@PBVBar@simpleproto2@@$$CBVMessageLite@protobuf@google@@@internal@protobuf@google@@YAPBVBar@simpleproto2@@PBVMessageLite@12@@Z" = comdat any
...
$"\01??$OwnInternal@VBar@simpleproto2@@@Arena@protobuf@google@@AAEXPAVBar@simpleproto2@@U?$integral_constant@_N$0A@@internal@12@@Z" = comdat any

$"\01??$arena_delete_object@VBar@simpleproto2@@@internal@protobuf@google@@YAXPAX@Z" = comdat any
...
@"\01?once@?1??InitDefaultsFoo@protobuf_SimpleProtoLite2_2eproto@@YAXXZ@4HA" = internal global i32 0, align 4
...
@2 = private unnamed_addr constant { [18 x i8*] } { [18 x i8*] [i8* bitcast (%rtti.CompleteObjectLocator* @"\01??_R4Foo@simpleproto2@@6B@" to i8*), i8* bitcast (i8* (%"class.simpleproto2::Foo.11"*, i32)* @"\01??_GFoo@simpleproto2@@UAEPAXI@Z" to i8*), i8* bitcast (void (%"class.simpleproto2::Foo.11"*, %"class.std::basic_string"*)* @"\01?GetTypeName@Foo@simpleproto2@@UBE?AV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@XZ" to i8*), i8* bitcast (%"class.simpleproto2::Foo.11"* (%"class.simpleproto2::Foo.11"*, %"class.google::protobuf::Arena"*)* @"\01?New@Foo@simpleproto2@@UBEPAV12@PAVArena@protobuf@google@@@Z" to i8*), i8* bitcast (%"class.simpleproto2::Foo.11"* (%"class.simpleproto2::Foo.11"*)* @"\01?New@Foo@simpleproto2@@UBEPAV12@XZ" to i8*), i8* bitcast (%"class.google::protobuf::Arena"* (%"class.google::protobuf::MessageLite"*)* @"\01?GetArena@MessageLite@protobuf@google@@UBEPAVArena@23@XZ" to i8*), i8* bitcast (i8* (%"class.google::protobuf::MessageLite"*)* @"\01?GetMaybeArenaPointer@MessageLite@protobuf@google@@UBEPAXXZ" to i8*), i8* bitcast (void (%"class.simpleproto2::Foo.11"*)* @"\01?Clear@Foo@simpleproto2@@UAEXXZ" to i8*), i8* bitcast (i1 (%"class.simpleproto2::Foo.11"*)* @"\01?IsInitialized@Foo@simpleproto2@@UBE_NXZ" to i8*), i8* bitcast (void (%"class.google::protobuf::MessageLite"*, %"class.std::basic_string"*)* @"\01?InitializationErrorString@MessageLite@protobuf@google@@UBE?AV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@XZ" to i8*), i8* bitcast (void (%"class.simpleproto2::Foo.11"*, %"class.google::protobuf::MessageLite"*)* @"\01?CheckTypeAndMergeFrom@Foo@simpleproto2@@UAEXABVMessageLite@protobuf@google@@@Z" to i8*), i8* bitcast (i1 (%"class.simpleproto2::Foo.11"*, %"class.google::protobuf::io::CodedInputStream"*)* @"\01?MergePartialFromCodedStream@Foo@simpleproto2@@UAE_NPAVCodedInputStream@io@protobuf@google@@@Z" to i8*), i8* bitcast (i32 (%"class.simpleproto2::Foo.11"*)* @"\01?ByteSizeLong@Foo@simpleproto2@@UBEIXZ" to i8*), i8* bitcast (void (%"class.simpleproto2::Foo.11"*, %"class.google::protobuf::io::CodedOutputStream"*)* @"\01?SerializeWithCachedSizes@Foo@simpleproto2@@UBEXPAVCodedOutputStream@io@protobuf@google@@@Z" to i8*), i8* bitcast (i8* (%"class.google::protobuf::MessageLite"*, i8*)* @"\01?SerializeWithCachedSizesToArray@MessageLite@protobuf@google@@UBEPAEPAE@Z" to i8*), i8* bitcast (i32 (%"class.simpleproto2::Foo.11"*)* @"\01?GetCachedSize@Foo@simpleproto2@@UBEHXZ" to i8*), i8* bitcast (i8* (%"class.google::protobuf::MessageLite"*, i1, i8*)* @"\01?InternalSerializeWithCachedSizesToArray@MessageLite@protobuf@google@@UBEPAE_NPAE@Z" to i8*), i8* bitcast (i8* (%"class.google::protobuf::MessageLite"*)* @"\01?InternalGetTable@MessageLite@protobuf@google@@EBEPBXXZ" to i8*)] }, comdat($"\01??_7Foo@simpleproto2@@6B@")
...
@"\01??_R3Foo@simpleproto2@@8" = linkonce_odr constant %rtti.ClassHierarchyDescriptor { i32 0, i32 0, i32 2, %rtti.BaseClassDescriptor** getelementptr inbounds ([3 x %rtti.BaseClassDescriptor*], [3 x %rtti.BaseClassDescriptor*]* @"\01??_R2Foo@simpleproto2@@8", i32 0, i32 0) }, comdat
@"\01??_R2Foo@simpleproto2@@8" = linkonce_odr constant [3 x %rtti.BaseClassDescriptor*] [%rtti.BaseClassDescriptor* @"\01??_R1A@?0A@EA@Foo@simpleproto2@@8", %rtti.BaseClassDescriptor* @"\01??_R1A@?0A@EA@MessageLite@protobuf@google@@8", %rtti.BaseClassDescriptor* null], comdat
@"\01??_R1A@?0A@EA@Foo@simpleproto2@@8" = linkonce_odr constant %rtti.BaseClassDescriptor { i8* bitcast (%rtti.TypeDescriptor22* @"\01??_R0?AVFoo@simpleproto2@@@8" to i8*), i32 1, i32 0, i32 -1, i32 0, i32 64, %rtti.ClassHierarchyDescriptor* @"\01??_R3Foo@simpleproto2@@8" }, comdat
...
@"\01?once@?1??InitDefaultsBar@protobuf_SimpleProtoLite2_2eproto@@YAXXZ@4HA" = internal global i32 0, align 4
@4 = private unnamed_addr constant { [18 x i8*] } { [18 x i8*] [i8* bitcast (%rtti.CompleteObjectLocator* @"\01??_R4Bar@simpleproto2@@6B@" to i8*), i8* bitcast (i8* (%"class.simpleproto2::Bar.23"*, i32)* @"\01??_GBar@simpleproto2@@UAEPAXI@Z" to i8*), i8* bitcast (void (%"class.simpleproto2::Bar.23"*, %"class.std::basic_string"*)* @"\01?GetTypeName@Bar@simpleproto2@@UBE?AV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@XZ" to i8*), i8* bitcast (%"class.simpleproto2::Bar.23"* (%"class.simpleproto2::Bar.23"*, %"class.google::protobuf::Arena"*)* @"\01?New@Bar@simpleproto2@@UBEPAV12@PAVArena@protobuf@google@@@Z" to i8*), i8* bitcast (%"class.simpleproto2::Bar.23"* (%"class.simpleproto2::Bar.23"*)* @"\01?New@Bar@simpleproto2@@UBEPAV12@XZ" to i8*), i8* bitcast (%"class.google::protobuf::Arena"* (%"class.google::protobuf::MessageLite"*)* @"\01?GetArena@MessageLite@protobuf@google@@UBEPAVArena@23@XZ" to i8*), i8* bitcast (i8* (%"class.google::protobuf::MessageLite"*)* @"\01?GetMaybeArenaPointer@MessageLite@protobuf@google@@UBEPAXXZ" to i8*), i8* bitcast (void (%"class.simpleproto2::Bar.23"*)* @"\01?Clear@Bar@simpleproto2@@UAEXXZ" to i8*), i8* bitcast (i1 (%"class.simpleproto2::Bar.23"*)* @"\01?IsInitialized@Bar@simpleproto2@@UBE_NXZ" to i8*), i8* bitcast (void (%"class.google::protobuf::MessageLite"*, %"class.std::basic_string"*)* @"\01?InitializationErrorString@MessageLite@protobuf@google@@UBE?AV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@XZ" to i8*), i8* bitcast (void (%"class.simpleproto2::Bar.23"*, %"class.google::protobuf::MessageLite"*)* @"\01?CheckTypeAndMergeFrom@Bar@simpleproto2@@UAEXABVMessageLite@protobuf@google@@@Z" to i8*), i8* bitcast (i1 (%"class.simpleproto2::Bar.23"*, %"class.google::protobuf::io::CodedInputStream"*)* @"\01?MergePartialFromCodedStream@Bar@simpleproto2@@UAE_NPAVCodedInputStream@io@protobuf@google@@@Z" to i8*), i8* bitcast (i32 (%"class.simpleproto2::Bar.23"*)* @"\01?ByteSizeLong@Bar@simpleproto2@@UBEIXZ" to i8*), i8* bitcast (void (%"class.simpleproto2::Bar.23"*, %"class.google::protobuf::io::CodedOutputStream"*)* @"\01?SerializeWithCachedSizes@Bar@simpleproto2@@UBEXPAVCodedOutputStream@io@protobuf@google@@@Z" to i8*), i8* bitcast (i8* (%"class.google::protobuf::MessageLite"*, i8*)* @"\01?SerializeWithCachedSizesToArray@MessageLite@protobuf@google@@UBEPAEPAE@Z" to i8*), i8* bitcast (i32 (%"class.simpleproto2::Bar.23"*)* @"\01?GetCachedSize@Bar@simpleproto2@@UBEHXZ" to i8*), i8* bitcast (i8* (%"class.google::protobuf::MessageLite"*, i1, i8*)* @"\01?InternalSerializeWithCachedSizesToArray@MessageLite@protobuf@google@@UBEPAE_NPAE@Z" to i8*), i8* bitcast (i8* (%"class.google::protobuf::MessageLite"*)* @"\01?InternalGetTable@MessageLite@protobuf@google@@EBEPBXXZ" to i8*)] }, comdat($"\01??_7Bar@simpleproto2@@6B@")
...
@"\01??_R3Bar@simpleproto2@@8" = linkonce_odr constant %rtti.ClassHierarchyDescriptor { i32 0, i32 0, i32 2, %rtti.BaseClassDescriptor** getelementptr inbounds ([3 x %rtti.BaseClassDescriptor*], [3 x %rtti.BaseClassDescriptor*]* @"\01??_R2Bar@simpleproto2@@8", i32 0, i32 0) }, comdat
@"\01??_R2Bar@simpleproto2@@8" = linkonce_odr constant [3 x %rtti.BaseClassDescriptor*] [%rtti.BaseClassDescriptor* @"\01??_R1A@?0A@EA@Bar@simpleproto2@@8", %rtti.BaseClassDescriptor* @"\01??_R1A@?0A@EA@MessageLite@protobuf@google@@8", %rtti.BaseClassDescriptor* null], comdat
@"\01??_R1A@?0A@EA@Bar@simpleproto2@@8" = linkonce_odr constant %rtti.BaseClassDescriptor { i8* bitcast (%rtti.TypeDescriptor22* @"\01??_R0?AVBar@simpleproto2@@@8" to i8*), i32 1, i32 0, i32 -1, i32 0, i32 64, %rtti.ClassHierarchyDescriptor* @"\01??_R3Bar@simpleproto2@@8" }, comdat
...
; <label>:75:                                     ; preds = %71
  %76 = invoke i8* @"\01??2@YAPAXI@Z"(i32 24) #11
          to label %77 unwind label %136

; <label>:77:                                     ; preds = %75
  %78 = bitcast i8* %76 to %"class.simpleproto2::Foo"*
  %79 = invoke x86_thiscallcc %"class.simpleproto2::Foo"* bitcast (%"class.simpleproto2::Foo.11"* (%"class.simpleproto2::Foo.11"*)* @"\01??0Foo@simpleproto2@@QAE@XZ" to %"class.simpleproto2::Foo"* (%"class.simpleproto2::Foo"*)*)(%"class.simpleproto2::Foo"* %78)
...
; <label>:102:                                    ; preds = %101
  call x86_thiscallcc void @"\01??1?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@XZ"(%"class.std::basic_string"* %19) #10
  call x86_thiscallcc void @"\01??1?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@XZ"(%"class.std::basic_string"* %21) #10
  call x86_thiscallcc void @"\01??1?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@XZ"(%"class.std::basic_string"* %22) #10
  call x86_thiscallcc void @"\01??1?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@XZ"(%"class.std::basic_string"* %24) #10
  call x86_thiscallcc void @"\01??1?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@XZ"(%"class.std::basic_string"* %25) #10
  call x86_thiscallcc void @"\01??1?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@XZ"(%"class.std::basic_string"* %26) #10
  call x86_thiscallcc void @"\01??1?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@XZ"(%"class.std::basic_string"* %23) #10
  call x86_thiscallcc void @"\01??1?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@XZ"(%"class.std::basic_string"* %20) #10
  store i1 false, i1* %27, align 1
  %103 = invoke x86_thiscallcc %"class.simpleproto2::Bar"* bitcast (%"class.simpleproto2::Bar.23"* (%"class.simpleproto2::Bar.23"*)* @"\01??0Bar@simpleproto2@@QAE@XZ" to %"class.simpleproto2::Bar"* (%"class.simpleproto2::Bar"*)*)(%"class.simpleproto2::Bar"* %0)
...
; <label>:110:                                    ; preds = %48
  ...
  call x86_thiscallcc void @"\01??1Integer@emp@@QAE@XZ"(%"class.emp::Integer"* %11) #10 [ "funclet"(token %111) ]
  cleanupret from %111 unwind label %140

; <label>:112:                                    ; preds = %69
  %113 = cleanuppad within none []
  call x86_thiscallcc void @"\01??1Integer@emp@@QAE@XZ"(%"class.emp::Integer"* %17) #10 [ "funclet"(token %113) ]
  cleanupret from %113 unwind label %136

; <label>:114:                                    ; preds = %77
  %115 = cleanuppad within none []
  call void @"\01??3@YAXPAX@Z"(i8* %76) #12 [ "funclet"(token %115) ]
  cleanupret from %115 unwind label %136

; <label>:116:                                    ; preds = %101
  %117 = cleanuppad within none []
  call x86_thiscallcc void @"\01??1?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@XZ"(%"class.std::basic_string"* %19) #10 [ "funclet"(token %117) ]
  cleanupret from %117 unwind label %118

; <label>:118:                                    ; preds = %116, %100
  %119 = cleanuppad within none []
  call x86_thiscallcc void @"\01??1?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@XZ"(%"class.std::basic_string"* %21) #10 [ "funclet"(token %119) ]
  cleanupret from %119 unwind label %120

; <label>:120:                                    ; preds = %118, %99
  %121 = cleanuppad within none []
  call x86_thiscallcc void @"\01??1?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@XZ"(%"class.std::basic_string"* %22) #10 [ "funclet"(token %121) ]
  cleanupret from %121 unwind label %122

; <label>:122:                                    ; preds = %120, %98
  %123 = cleanuppad within none []
  call x86_thiscallcc void @"\01??1?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@XZ"(%"class.std::basic_string"* %24) #10 [ "funclet"(token %123) ]
  cleanupret from %123 unwind label %124

; <label>:124:                                    ; preds = %122, %97
  %125 = cleanuppad within none []
  call x86_thiscallcc void @"\01??1?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@XZ"(%"class.std::basic_string"* %25) #10 [ "funclet"(token %125) ]
  cleanupret from %125 unwind label %126

; <label>:126:                                    ; preds = %124, %96
  %127 = cleanuppad within none []
  call x86_thiscallcc void @"\01??1?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@XZ"(%"class.std::basic_string"* %26) #10 [ "funclet"(token %127) ]
  cleanupret from %127 unwind label %128

; <label>:128:                                    ; preds = %126, %95, %92
  %129 = cleanuppad within none []
  call x86_thiscallcc void @"\01??1?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@XZ"(%"class.std::basic_string"* %23) #10 [ "funclet"(token %129) ]
  cleanupret from %129 unwind label %130

; <label>:130:                                    ; preds = %128, %91, %88
  %131 = cleanuppad within none []
  call x86_thiscallcc void @"\01??1?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@XZ"(%"class.std::basic_string"* %20) #10 [ "funclet"(token %131) ]
  cleanupret from %131 unwind label %136

; <label>:132:                                    ; preds = %108
  call x86_thiscallcc void bitcast (void (%"class.simpleproto2::Bar.23"*)* @"\01??1Bar@simpleproto2@@UAE@XZ" to void (%"class.simpleproto2::Bar"*)*)(%"class.simpleproto2::Bar"* %0) #10
  br label %133

; <label>:133:                                    ; preds = %132, %108
  call x86_thiscallcc void @"\01??1Integer@emp@@QAE@XZ"(%"class.emp::Integer"* %14) #10
  call x86_thiscallcc void @"\01??1Integer@emp@@QAE@XZ"(%"class.emp::Integer"* %12) #10
  call x86_thiscallcc void @"\01??1Integer@emp@@QAE@XZ"(%"class.emp::Integer"* %8) #10
  call x86_thiscallcc void @"\01??1Integer@emp@@QAE@XZ"(%"class.emp::Integer"* %6) #10
  ret void

; <label>:134:                                    ; preds = %106, %104
  %135 = cleanuppad within none []
  call x86_thiscallcc void bitcast (void (%"class.simpleproto2::Bar.23"*)* @"\01??1Bar@simpleproto2@@UAE@XZ" to void (%"class.simpleproto2::Bar"*)*)(%"class.simpleproto2::Bar"* %0) #10 [ "funclet"(token %135) ]
  cleanupret from %135 unwind label %136

; <label>:136:                                    ; preds = %134, %102, %130, %85, %83, %80, %114, %75, %71, %112, %68
  %137 = cleanuppad within none []
  call x86_thiscallcc void @"\01??1Integer@emp@@QAE@XZ"(%"class.emp::Integer"* %14) #10 [ "funclet"(token %137) ]
  cleanupret from %137 unwind label %138

; <label>:138:                                    ; preds = %136, %66, %64, %61
  %139 = cleanuppad within none []
  call x86_thiscallcc void @"\01??1Integer@emp@@QAE@XZ"(%"class.emp::Integer"* %12) #10 [ "funclet"(token %139) ]
  cleanupret from %139 unwind label %140

; <label>:140:                                    ; preds = %138, %59, %57, %54, %50, %110, %47
  %141 = cleanuppad within none []
  call x86_thiscallcc void @"\01??1Integer@emp@@QAE@XZ"(%"class.emp::Integer"* %8) #10 [ "funclet"(token %141) ]
  cleanupret from %141 unwind label %142

; <label>:142:                                    ; preds = %140, %45, %3
  %143 = cleanuppad within none []
  call x86_thiscallcc void @"\01??1Integer@emp@@QAE@XZ"(%"class.emp::Integer"* %6) #10 [ "funclet"(token %143) ]
...
define linkonce_odr void @"\01??$?HDU?$char_traits@D@std@@V?$allocator@D@1@@std@@YA?AV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@0@QBD$$QAV10@@Z"(%"class.std::basic_string"* noalias sret, i8*, %"class.std::basic_string"* dereferenceable(24)) #0 comdat {
  ...
  %9 = call dereferenceable(24) %"class.std::basic_string"* @"\01??$move@AAV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@@std@@YA$$QAV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@0@AAV10@@Z"(%"class.std::basic_string"* dereferenceable(24) %8) #10
  %10 = call x86_thiscallcc %"class.std::basic_string"* @"\01??0?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@$$QAV01@@Z"(%"class.std::basic_string"* %0, %"class.std::basic_string"* dereferenceable(24) %9) #10
  ret void
}
...
define linkonce_odr void @"\01??$?HDU?$char_traits@D@std@@V?$allocator@D@1@@std@@YA?AV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@0@$$QAV10@0@Z"(%"class.std::basic_string"* noalias sret, %"class.std::basic_string"* dereferenceable(24), %"class.std::basic_string"* dereferenceable(24)) #0 comdat {
  ...
  store %"class.std::basic_string"* %1, %"class.std::basic_string"** %5, align 4
  %6 = load %"class.std::basic_string"*, %"class.std::basic_string"** %4, align 4
  %7 = call x86_thiscallcc i32 @"\01?size@?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QBEIXZ"(%"class.std::basic_string"* %6) #10
  %8 = load %"class.std::basic_string"*, %"class.std::basic_string"** %5, align 4
  %9 = call x86_thiscallcc i32 @"\01?capacity@?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QBEIXZ"(%"class.std::basic_string"* %8) #10
  %10 = load %"class.std::basic_string"*, %"class.std::basic_string"** %5, align 4
  %11 = call x86_thiscallcc i32 @"\01?size@?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QBEIXZ"(%"class.std::basic_string"* %10) #10
  %12 = sub i32 %9, %11
...
; <label>:14:                                     ; preds = %3
  ...
  %16 = call x86_thiscallcc i32 @"\01?capacity@?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QBEIXZ"(%"class.std::basic_string"* %15) #10
  %17 = load %"class.std::basic_string"*, %"class.std::basic_string"** %4, align 4
  %18 = call x86_thiscallcc i32 @"\01?size@?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QBEIXZ"(%"class.std::basic_string"* %17) #10
  %19 = sub i32 %16, %18
  %20 = load %"class.std::basic_string"*, %"class.std::basic_string"** %5, align 4
  %21 = call x86_thiscallcc i32 @"\01?size@?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QBEIXZ"(%"class.std::basic_string"* %20) #10
...
; <label>:23:                                     ; preds = %14, %3
  ...
  %27 = call dereferenceable(24) %"class.std::basic_string"* @"\01??$move@AAV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@@std@@YA$$QAV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@0@AAV10@@Z"(%"class.std::basic_string"* dereferenceable(24) %26) #10
  %28 = call x86_thiscallcc %"class.std::basic_string"* @"\01??0?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@$$QAV01@@Z"(%"class.std::basic_string"* %0, %"class.std::basic_string"* dereferenceable(24) %27) #10
  br label %35
...
; <label>:29:                                     ; preds = %14
  ...
  %33 = call dereferenceable(24) %"class.std::basic_string"* @"\01??$move@AAV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@@std@@YA$$QAV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@0@AAV10@@Z"(%"class.std::basic_string"* dereferenceable(24) %32) #10
  %34 = call x86_thiscallcc %"class.std::basic_string"* @"\01??0?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@$$QAV01@@Z"(%"class.std::basic_string"* %0, %"class.std::basic_string"* dereferenceable(24) %33) #10
  br label %35
...
define linkonce_odr x86_thiscallcc void @"\01?set_s@Foo@simpleproto2@@QAEX$$QAV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@@Z"(%"class.simpleproto2::Foo"*, %"class.std::basic_string"* dereferenceable(24)) #0 comdat align 2 {
  ...
  %8 = call dereferenceable(24) %"class.std::basic_string"* @"\01??$move@AAV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@@std@@YA$$QAV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@0@AAV10@@Z"(%"class.std::basic_string"* dereferenceable(24) %7) #10
...
; <label>:15:                                     ; preds = %11
  ...
  %20 = call x86_thiscallcc i8* %19(%"class.simpleproto2::Foo"* %13, i32 1) #10
  br label %21
...
; <label>:13:                                     ; preds = %1
  ...
  %19 = call x86_thiscallcc dereferenceable(1) %"class.std::allocator"* @"\01?_Getal@?$_String_alloc@U?$_String_base_types@DV?$allocator@D@std@@@std@@@std@@QAEAAV?$allocator@D@2@XZ"(%"class.std::_String_alloc"* %18) #10
...
define linkonce_odr x86_thiscallcc void @"\01?_Orphan_all@?$_String_alloc@U?$_String_base_types@DV?$allocator@D@std@@@std@@@std@@QAEXXZ"(%"class.std::_String_alloc"*) #1 comdat align 2 {
  ...
  call x86_thiscallcc void @"\01?_Orphan_all@_Container_base0@std@@QAEXXZ"(%"class.std::allocator"* %5) #10
  ret void
}
...
define linkonce_odr x86_thiscallcc dereferenceable(1) %"class.std::allocator"* @"\01?_Getal@?$_String_alloc@U?$_String_base_types@DV?$allocator@D@std@@@std@@@std@@QAEAAV?$allocator@D@2@XZ"(%"class.std::_String_alloc"*) #1 comdat align 2 {
  ...
  %3 = load %"class.std::_String_alloc"*, %"class.std::_String_alloc"** %2, align 4
  %4 = getelementptr inbounds %"class.std::_String_alloc", %"class.std::_String_alloc"* %3, i32 0, i32 0
  %5 = call x86_thiscallcc dereferenceable(1) %"class.std::allocator"* @"\01?_Get_first@?$_Compressed_pair@V?$allocator@D@std@@V?$_String_val@U?$_Simple_types@D@std@@@2@$00@std@@QAEAAV?$allocator@D@2@XZ"(%"class.std::_Compressed_pair"* %4) #10
...
; <label>:10:                                     ; preds = %3
  %11 = call i8* @"\01??2@YAPAXI@Z"(i32 24) #11
  %12 = bitcast i8* %11 to %"class.std::basic_string"*
  %13 = load %"class.std::basic_string"*, %"class.std::basic_string"** %4, align 4
  %14 = call dereferenceable(24) %"class.std::basic_string"* @"\01??$move@AAV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@@std@@YA$$QAV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@0@AAV10@@Z"(%"class.std::basic_string"* dereferenceable(24) %13) #10
  %15 = call x86_thiscallcc %"class.std::basic_string"* @"\01??0?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@$$QAV01@@Z"(%"class.std::basic_string"* %12, %"class.std::basic_string"* dereferenceable(24) %14) #10
...
; <label>:17:                                     ; preds = %3
  ...
  %19 = call dereferenceable(24) %"class.std::basic_string"* @"\01??$move@AAV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@@std@@YA$$QAV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@0@AAV10@@Z"(%"class.std::basic_string"* dereferenceable(24) %18) #10
  ...
  %22 = call x86_thiscallcc dereferenceable(24) %"class.std::basic_string"* @"\01??4?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAEAAV01@$$QAV01@@Z"(%"class.std::basic_string"* %21, %"class.std::basic_string"* dereferenceable(24) %19) #10
  br label %23
...
define linkonce_odr x86_thiscallcc %"class.std::basic_string"* @"\01??0?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@$$QAV01@@Z"(%"class.std::basic_string"* returned, %"class.std::basic_string"* dereferenceable(24)) unnamed_addr #1 comdat align 2 personality i8* bitcast (i32 (...)* @__CxxFrameHandler3 to i8*) {
  ...
  %10 = call x86_thiscallcc dereferenceable(1) %"class.std::allocator"* @"\01?_Getal@?$_String_alloc@U?$_String_base_types@DV?$allocator@D@std@@@std@@@std@@QAEAAV?$allocator@D@2@XZ"(%"class.std::_String_alloc"* %9) #10
  %11 = call dereferenceable(1) %"class.std::allocator"* @"\01??$move@AAV?$allocator@D@std@@@std@@YA$$QAV?$allocator@D@0@AAV10@@Z"(%"class.std::allocator"* dereferenceable(1) %10) #10
...
; <label>:13:                                     ; preds = %2
  ...
  %15 = call dereferenceable(24) %"class.std::basic_string"* @"\01??$move@AAV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@@std@@YA$$QAV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@0@AAV10@@Z"(%"class.std::basic_string"* dereferenceable(24) %14) #10
  call x86_thiscallcc void @"\01?_Assign_rv_contents_with_alloc_always_equal@?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAEX$$QAV12@U?$integral_constant@_N$00@2@@Z"(%"class.std::basic_string"* %6, %"class.std::basic_string"* dereferenceable(24) %15, %"class.std::allocator"* byval align 4 %5) #10
...
; <label>:11:                                     ; preds = %10
  ...
  %15 = call x86_thiscallcc dereferenceable(1) %"class.std::allocator"* @"\01?_Getal@?$_String_alloc@U?$_String_base_types@DV?$allocator@D@std@@@std@@@std@@QAEAAV?$allocator@D@2@XZ"(%"class.std::_String_alloc"* %14) #10
...
; <label>:16:                                     ; preds = %11
  ...
  %18 = call dereferenceable(24) %"class.std::basic_string"* @"\01??$move@AAV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@@std@@YA$$QAV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@0@AAV10@@Z"(%"class.std::basic_string"* dereferenceable(24) %17) #10
  call x86_thiscallcc void @"\01?_Assign_rv_contents@?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAEX$$QAV12@U?$integral_constant@_N$00@2@@Z"(%"class.std::basic_string"* %6, %"class.std::basic_string"* dereferenceable(24) %18, %"class.std::allocator"* byval align 4 %5) #10
  br label %19
...
define linkonce_odr x86_thiscallcc void @"\01?_Move_alloc@?$_String_alloc@U?$_String_base_types@DV?$allocator@D@std@@@std@@@std@@QAEXAAV?$allocator@D@2@@Z"(%"class.std::_String_alloc"*, %"class.std::allocator"* dereferenceable(1)) #1 comdat align 2 {
  ...
  %7 = call x86_thiscallcc dereferenceable(1) %"class.std::allocator"* @"\01?_Getal@?$_String_alloc@U?$_String_base_types@DV?$allocator@D@std@@@std@@@std@@QAEAAV?$allocator@D@2@XZ"(%"class.std::_String_alloc"* %5) #10
  call void @"\01??$_Pocma@V?$allocator@D@std@@@std@@YAXAAV?$allocator@D@0@0@Z"(%"class.std::allocator"* dereferenceable(1) %7, %"class.std::allocator"* dereferenceable(1) %6) #10
  ret void
}
...
define linkonce_odr x86_thiscallcc void @"\01?_Assign_rv_contents@?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAEX$$QAV12@U?$integral_constant@_N$00@2@@Z"(%"class.std::basic_string"*, %"class.std::basic_string"* dereferenceable(24), %"class.std::allocator"* byval align 4) #1 comdat align 2 {
  ...
  %9 = call dereferenceable(24) %"class.std::basic_string"* @"\01??$move@AAV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@@std@@YA$$QAV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@0@AAV10@@Z"(%"class.std::basic_string"* dereferenceable(24) %8) #10
  call x86_thiscallcc void @"\01?_Assign_rv_contents_with_alloc_always_equal@?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAEX$$QAV12@U?$integral_constant@_N$00@2@@Z"(%"class.std::basic_string"* %7, %"class.std::basic_string"* dereferenceable(24) %9, %"class.std::allocator"* byval align 4 %6) #10
  ret void
}
...
define linkonce_odr x86_thiscallcc void @"\01?_Assign_rv_contents_with_alloc_always_equal@?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAEX$$QAV12@U?$integral_constant@_N$00@2@@Z"(%"class.std::basic_string"*, %"class.std::basic_string"* dereferenceable(24), %"class.std::allocator"* byval align 4) #1 comdat align 2 personality i8* bitcast (i32 (...)* @__CxxFrameHandler3 to i8*) {
  ...
  %12 = call x86_thiscallcc dereferenceable(24) %"class.std::_String_val"* @"\01?_Get_data@?$_String_alloc@U?$_String_base_types@DV?$allocator@D@std@@@std@@@std@@QAEAAV?$_String_val@U?$_Simple_types@D@std@@@2@XZ"(%"class.std::_String_alloc"* %11) #10
  ...
  %15 = call %"class.std::_String_val"* @"\01??$addressof@V?$_String_val@U?$_Simple_types@D@std@@@std@@@std@@YAPAV?$_String_val@U?$_Simple_types@D@std@@@0@AAV10@@Z"(%"class.std::_String_val"* dereferenceable(24) %14) #10
  ...
  %19 = call %"class.std::_String_val"* @"\01??$addressof@V?$_String_val@U?$_Simple_types@D@std@@@std@@@std@@YAPAV?$_String_val@U?$_Simple_types@D@std@@@0@AAV10@@Z"(%"class.std::_String_val"* dereferenceable(24) %18) #10
...
define linkonce_odr void @"\01??$_Pocma@V?$allocator@D@std@@@std@@YAXAAV?$allocator@D@0@0@Z"(%"class.std::allocator"* dereferenceable(1), %"class.std::allocator"* dereferenceable(1)) #1 comdat {
  ...
  call void @"\01??$_Pocma@V?$allocator@D@std@@@std@@YAXAAV?$allocator@D@0@0U?$integral_constant@_N$00@0@@Z"(%"class.std::allocator"* dereferenceable(1) %8, %"class.std::allocator"* dereferenceable(1) %7, %"class.std::allocator"* byval align 4 %6) #10
  ret void
}
...
define linkonce_odr void @"\01??$_Pocma@V?$allocator@D@std@@@std@@YAXAAV?$allocator@D@0@0U?$integral_constant@_N$00@0@@Z"(%"class.std::allocator"* dereferenceable(1), %"class.std::allocator"* dereferenceable(1), %"class.std::allocator"* byval align 4) #1 comdat {
  ...
  %7 = call dereferenceable(1) %"class.std::allocator"* @"\01??$move@AAV?$allocator@D@std@@@std@@YA$$QAV?$allocator@D@0@AAV10@@Z"(%"class.std::allocator"* dereferenceable(1) %6) #10
...
define linkonce_odr x86_thiscallcc %"class.std::_String_alloc"* @"\01??$?0V?$allocator@D@std@@X@?$_String_alloc@U?$_String_base_types@DV?$allocator@D@std@@@std@@@std@@QAE@$$QAV?$allocator@D@1@@Z"(%"class.std::_String_alloc"* returned, %"class.std::allocator"* dereferenceable(1)) unnamed_addr #0 comdat align 2 {
  ...
  %9 = call dereferenceable(1) %"class.std::allocator"* @"\01??$forward@V?$allocator@D@std@@@std@@YA$$QAV?$allocator@D@0@AAV10@@Z"(%"class.std::allocator"* dereferenceable(1) %8) #10
...
define linkonce_odr x86_thiscallcc dereferenceable(24) %"class.std::basic_string"* @"\01?insert@?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAEAAV12@IABV12@@Z"(%"class.std::basic_string"*, i32, %"class.std::basic_string"* dereferenceable(24)) #0 comdat align 2 {
  ...
  %11 = call x86_thiscallcc dereferenceable(24) %"class.std::_String_val"* @"\01?_Get_data@?$_String_alloc@U?$_String_base_types@DV?$allocator@D@std@@@std@@@std@@QBEABV?$_String_val@U?$_Simple_types@D@std@@@2@XZ"(%"class.std::_String_alloc"* %10) #10
...
define linkonce_odr x86_thiscallcc dereferenceable(24) %"class.std::basic_string"* @"\01?insert@?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAEAAV12@IQBDI@Z"(%"class.std::basic_string"*, i32, i8*, i32) #0 comdat align 2 {
  ...
  %18 = call x86_thiscallcc dereferenceable(24) %"class.std::_String_val"* @"\01?_Get_data@?$_String_alloc@U?$_String_base_types@DV?$allocator@D@std@@@std@@@std@@QAEAAV?$_String_val@U?$_Simple_types@D@std@@@2@XZ"(%"class.std::_String_alloc"* %17) #10
...
; <label>:67:                                     ; preds = %66, %53
  ...
  %76 = call i8* @"\01?move@?$char_traits@D@std@@SAPADQADQBDI@Z"(i8* %75, i8* %72, i32 %71) #10
  %77 = load i32, i32* %14, align 4
  %78 = load i8*, i8** %7, align 4
  %79 = load i8*, i8** %13, align 4
  %80 = call i8* @"\01?copy@?$char_traits@D@std@@SAPADQADQBDI@Z"(i8* %79, i8* %78, i32 %77) #10
  ...
  %92 = call i8* @"\01?copy@?$char_traits@D@std@@SAPADQADQBDI@Z"(i8* %91, i8* %88, i32 %83) #10
...
define linkonce_odr x86_thiscallcc dereferenceable(24) %"class.std::basic_string"* @"\01??$_Reallocate_grow_by@V<lambda_1>@?0??insert@?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAEAAV34@IQBDI@Z@IPBDI@?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAEAAV01@IV<lambda_1>@?0??insert@01@QAEAAV01@IQBDI@Z@IPBDI@Z"(%"class.std::basic_string"*, i32, %"class.std::allocator"* byval align 4, i32, i8*, i32) #0 comdat align 2 {
  ...
  %23 = call x86_thiscallcc dereferenceable(24) %"class.std::_String_val"* @"\01?_Get_data@?$_String_alloc@U?$_String_base_types@DV?$allocator@D@std@@@std@@@std@@QAEAAV?$_String_val@U?$_Simple_types@D@std@@@2@XZ"(%"class.std::_String_alloc"* %22) #10
  ...
  %27 = call x86_thiscallcc i32 @"\01?max_size@?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QBEIXZ"(%"class.std::basic_string"* %21) #10
...
; <label>:33:                                     ; preds = %6
  ...
  %43 = call x86_thiscallcc dereferenceable(1) %"class.std::allocator"* @"\01?_Getal@?$_String_alloc@U?$_String_base_types@DV?$allocator@D@std@@@std@@@std@@QAEAAV?$allocator@D@2@XZ"(%"class.std::_String_alloc"* %42) #10
  ...
  call x86_thiscallcc void @"\01?_Orphan_all@_Container_base0@std@@QAEXXZ"(%"class.std::allocator"* %49) #10
...
; <label>:80:                                     ; preds = %33
  ...
  %93 = call i8** @"\01??$addressof@PAD@std@@YAPAPADAAPAD@Z"(i8** dereferenceable(4) %92) #10
...
define linkonce_odr x86_thiscallcc i32 @"\01?max_size@?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QBEIXZ"(%"class.std::basic_string"*) #1 comdat align 2 {
  ...
  %9 = bitcast %"class.std::basic_string"* %8 to %"class.std::_String_alloc"*
  %10 = call x86_thiscallcc dereferenceable(1) %"class.std::allocator"* @"\01?_Getal@?$_String_alloc@U?$_String_base_types@DV?$allocator@D@std@@@std@@@std@@QBEABV?$allocator@D@2@XZ"(%"class.std::_String_alloc"* %9) #10
  %11 = call i32 @"\01?max_size@?$_Default_allocator_traits@V?$allocator@D@std@@@std@@SAIABV?$allocator@D@2@@Z"(%"class.std::allocator"* dereferenceable(1) %10) #10
  store i32 %11, i32* %3, align 4
...
define linkonce_odr x86_thiscallcc void @"\01??R<lambda_1>@?0??insert@?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAEAAV23@IQBDI@Z@QBE?A?<auto>@@QAD0II0I@Z"(%"class.std::allocator"*, i8*, i8*, i32, i32, i8*, i32) #1 comdat align 2 {
  ...
  %19 = call i8* @"\01?copy@?$char_traits@D@std@@SAPADQADQBDI@Z"(i8* %18, i8* %17, i32 %16) #10
  %20 = load i32, i32* %8, align 4
  %21 = load i8*, i8** %9, align 4
  %22 = load i8*, i8** %13, align 4
  %23 = load i32, i32* %10, align 4
  %24 = getelementptr inbounds i8, i8* %22, i32 %23
  %25 = call i8* @"\01?copy@?$char_traits@D@std@@SAPADQADQBDI@Z"(i8* %24, i8* %21, i32 %20) #10
  ...
  %38 = call i8* @"\01?copy@?$char_traits@D@std@@SAPADQADQBDI@Z"(i8* %37, i8* %32, i32 %29) #10
  ret void
}
...
define linkonce_odr x86_thiscallcc dereferenceable(1) %"class.std::allocator"* @"\01?_Getal@?$_String_alloc@U?$_String_base_types@DV?$allocator@D@std@@@std@@@std@@QBEABV?$allocator@D@2@XZ"(%"class.std::_String_alloc"*) #1 comdat align 2 {
  ...
  %3 = load %"class.std::_String_alloc"*, %"class.std::_String_alloc"** %2, align 4
  %4 = getelementptr inbounds %"class.std::_String_alloc", %"class.std::_String_alloc"* %3, i32 0, i32 0
  %5 = call x86_thiscallcc dereferenceable(1) %"class.std::allocator"* @"\01?_Get_first@?$_Compressed_pair@V?$allocator@D@std@@V?$_String_val@U?$_Simple_types@D@std@@@2@$00@std@@QBEABV?$allocator@D@2@XZ"(%"class.std::_Compressed_pair"* %4) #10
  ret %"class.std::allocator"* %5
}
...
; <label>:31:                                     ; preds = %5
  ...
  %41 = call x86_thiscallcc dereferenceable(1) %"class.std::allocator"* @"\01?_Getal@?$_String_alloc@U?$_String_base_types@DV?$allocator@D@std@@@std@@@std@@QAEAAV?$allocator@D@2@XZ"(%"class.std::_String_alloc"* %40) #10
  ...
  call x86_thiscallcc void @"\01?_Orphan_all@_Container_base0@std@@QAEXXZ"(%"class.std::allocator"* %47) #10
...
define linkonce_odr x86_thiscallcc dereferenceable(24) %"class.std::basic_string"* @"\01?insert@?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAEAAV12@IQBD@Z"(%"class.std::basic_string"*, i32, i8*) #0 comdat align 2 {
  ...
  %7 = load %"class.std::basic_string"*, %"class.std::basic_string"** %6, align 4
  %8 = load i8*, i8** %4, align 4
  %9 = call i32 @"\01?length@?$char_traits@D@std@@SAIQBD@Z"(i8* %8) #10
...
define linkonce_odr void @"\01??$_Integral_to_string@DH@std@@YA?AV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@0@H@Z"(%"class.std::basic_string"* noalias sret, i32) #0 comdat {
  ...
  store i32 %1, i32* %3, align 4
  %9 = call i8* @"\01??$end@D$0BF@@std@@YAPADAAY0BF@D@Z"([21 x i8]* dereferenceable(21) %4) #10
...
; <label>:25:                                     ; preds = %21, %14
  %26 = call x86_thiscallcc %"class.std::allocator"* @"\01??0?$allocator@D@std@@QAE@XZ"(%"class.std::allocator"* %8) #10
...
; <label>:23:                                     ; preds = %21, %18, %15, %14, %4
  ...
  call x86_thiscallcc void @"\01??1?$_String_alloc@U?$_String_base_types@DV?$allocator@D@std@@@std@@@std@@QAE@XZ"(%"class.std::_String_alloc"* %25) #10 [ "funclet"(token %24) ]
...
define linkonce_odr x86_thiscallcc %"class.std::_String_alloc"* @"\01??$?0ABV?$allocator@D@std@@X@?$_String_alloc@U?$_String_base_types@DV?$allocator@D@std@@@std@@@std@@QAE@ABV?$allocator@D@1@@Z"(%"class.std::_String_alloc"* returned, %"class.std::allocator"* dereferenceable(1)) unnamed_addr #0 comdat align 2 {
  ...
  %7 = getelementptr inbounds %"class.std::_String_alloc", %"class.std::_String_alloc"* %6, i32 0, i32 0
  %8 = load %"class.std::allocator"*, %"class.std::allocator"** %3, align 4
  %9 = call dereferenceable(1) %"class.std::allocator"* @"\01??$forward@ABV?$allocator@D@std@@@std@@YAABV?$allocator@D@0@ABV10@@Z"(%"class.std::allocator"* dereferenceable(1) %8) #10
...
; <label>:18:                                     ; preds = %4
  ...
  %27 = call x86_thiscallcc dereferenceable(1) %"class.std::allocator"* @"\01?_Getal@?$_String_alloc@U?$_String_base_types@DV?$allocator@D@std@@@std@@@std@@QAEAAV?$allocator@D@2@XZ"(%"class.std::_String_alloc"* %26) #10
  ...
  call x86_thiscallcc void @"\01?_Orphan_all@_Container_base0@std@@QAEXXZ"(%"class.std::allocator"* %33) #10
...
define i32 @PlatON_entry_TestBarAdd01(i8**, i8**, i32*) {
  ...
  call void bitcast (%"class.simpleproto2::Bar.23"* (%"class.simpleproto2::Bar.23"*)* @"\01??0Bar@simpleproto2@@QAE@XZ" to void (%"class.simpleproto2::Bar"*)*)(%"class.simpleproto2::Bar"* %5)
  ...
  call void bitcast (%"class.simpleproto2::Bar.23"* (%"class.simpleproto2::Bar.23"*)* @"\01??0Bar@simpleproto2@@QAE@XZ" to void (%"class.simpleproto2::Bar"*)*)(%"class.simpleproto2::Bar"* %12)
  ...
  %20 = call i64 bitcast (i32 (%"class.simpleproto2::Bar.23"*)* @"\01?ByteSizeLong@Bar@simpleproto2@@UBEIXZ" to i64 (%"class.simpleproto2::Bar"*)*)(%"class.simpleproto2::Bar"* %4)
  ...
  call void bitcast (void (%"class.simpleproto2::Bar.23"*)* @"\01??1Bar@simpleproto2@@UAE@XZ" to void (%"class.simpleproto2::Bar"*)*)(%"class.simpleproto2::Bar"* %4)
  call void bitcast (void (%"class.simpleproto2::Bar.23"*)* @"\01??1Bar@simpleproto2@@UAE@XZ" to void (%"class.simpleproto2::Bar"*)*)(%"class.simpleproto2::Bar"* %5)
  call void bitcast (void (%"class.simpleproto2::Bar.23"*)* @"\01??1Bar@simpleproto2@@UAE@XZ" to void (%"class.simpleproto2::Bar"*)*)(%"class.simpleproto2::Bar"* %12)
  ret i32 %21
}
...
define void @"\01?InitDefaultsFooImpl@protobuf_SimpleProtoLite2_2eproto@@YAXXZ"() #0 {
  %1 = alloca i8*, align 4
  call void @"\01?VerifyVersion@internal@protobuf@google@@YAXHHPBD@Z"(i32 3005001, i32 3005000, i8* getelementptr inbounds ([78 x i8], [78 x i8]* @"\01??_C@_0EO@CHGOICEJ@E?3?2work?2local?2private?9contract?9s@", i32 0, i32 0))
  ...
  %4 = call x86_thiscallcc %"class.simpleproto2::Foo.11"* @"\01??0Foo@simpleproto2@@QAE@XZ"(%"class.simpleproto2::Foo.11"* %3)
...
; Function Attrs: noinline optnone
define x86_thiscallcc %"class.simpleproto2::Foo.11"* @"\01??0Foo@simpleproto2@@QAE@XZ"(%"class.simpleproto2::Foo.11"* returned) unnamed_addr #0 align 2 personality i8* bitcast (i32 (...)* @__CxxFrameHandler3 to i8*) {
  %2 = alloca %"class.simpleproto2::Foo.11"*, align 4
  %3 = alloca %"class.simpleproto2::Foo.11"*, align 4
  store %"class.simpleproto2::Foo.11"* %0, %"class.simpleproto2::Foo.11"** %3, align 4
  %4 = load %"class.simpleproto2::Foo.11"*, %"class.simpleproto2::Foo.11"** %3, align 4
  store %"class.simpleproto2::Foo.11"* %4, %"class.simpleproto2::Foo.11"** %2, align 4
...
; <label>:10:                                     ; preds = %1
  ...
  %12 = invoke %"class.simpleproto2::Foo.11"* @"\01?internal_default_instance@Foo@simpleproto2@@SAPBV12@XZ"()
...
; <label>:17:                                     ; preds = %16, %13
  invoke x86_thiscallcc void @"\01?SharedCtor@Foo@simpleproto2@@AAEXXZ"(%"class.simpleproto2::Foo.11"* %4)
          to label %18 unwind label %20

; <label>:18:                                     ; preds = %17
  %19 = load %"class.simpleproto2::Foo.11"*, %"class.simpleproto2::Foo.11"** %2, align 4
  ret %"class.simpleproto2::Foo.11"* %19

; <label>:20:                                     ; preds = %17, %15, %10
  %21 = cleanuppad within none []
  call x86_thiscallcc void @"\01??1InternalMetadataWithArenaLite@internal@protobuf@google@@QAE@XZ"(%"class.google::protobuf::internal::InternalMetadataWithArena"* %8) #10 [ "funclet"(token %21) ]
...
; <label>:22:                                     ; preds = %20, %1
  ...
  call x86_thiscallcc void @"\01??1MessageLite@protobuf@google@@UAE@XZ"(%"class.google::protobuf::MessageLite"* %24) #10 [ "funclet"(token %23) ]
...
; Function Attrs: noinline nounwind optnone
define linkonce_odr %"class.simpleproto2::Foo.11"* @"\01?internal_default_instance@Foo@simpleproto2@@SAPBV12@XZ"() #1 comdat align 2 {
...
define void @"\01?InitDefaultsFoo@protobuf_SimpleProtoLite2_2eproto@@YAXXZ"() #0 {
  call void @"\01?GoogleOnceInit@protobuf@google@@YAXPAHP6AXXZ@Z"(i32* @"\01?once@?1??InitDefaultsFoo@protobuf_SimpleProtoLite2_2eproto@@YAXXZ@4HA", void ()* @"\01?InitDefaultsFooImpl@protobuf_SimpleProtoLite2_2eproto@@YAXXZ")
  ret void
}

; Function Attrs: noinline optnone
define x86_thiscallcc void @"\01?SharedCtor@Foo@simpleproto2@@AAEXXZ"(%"class.simpleproto2::Foo.11"*) #0 align 2 {
  %2 = alloca %"class.simpleproto2::Foo.11"*, align 4
  store %"class.simpleproto2::Foo.11"* %0, %"class.simpleproto2::Foo.11"** %2, align 4
  %3 = load %"class.simpleproto2::Foo.11"*, %"class.simpleproto2::Foo.11"** %2, align 4
...
; Function Attrs: noinline nounwind optnone
define linkonce_odr x86_thiscallcc i8* @"\01??_GFoo@simpleproto2@@UAEPAXI@Z"(%"class.simpleproto2::Foo.11"*, i32) unnamed_addr #1 comdat align 2 {
  %3 = alloca i8*, align 4
  %4 = alloca i32, align 4
  %5 = alloca %"class.simpleproto2::Foo.11"*, align 4
  store i32 %1, i32* %4, align 4
  store %"class.simpleproto2::Foo.11"* %0, %"class.simpleproto2::Foo.11"** %5, align 4
  %6 = load %"class.simpleproto2::Foo.11"*, %"class.simpleproto2::Foo.11"** %5, align 4
  %7 = bitcast %"class.simpleproto2::Foo.11"* %6 to i8*
  store i8* %7, i8** %3, align 4
  %8 = load i32, i32* %4, align 4
  call x86_thiscallcc void @"\01??1Foo@simpleproto2@@UAE@XZ"(%"class.simpleproto2::Foo.11"* %6) #10
  %9 = icmp eq i32 %8, 0
  br i1 %9, label %12, label %10
...
; Function Attrs: noinline optnone
define x86_thiscallcc void @"\01?GetTypeName@Foo@simpleproto2@@UBE?AV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@XZ"(%"class.simpleproto2::Foo.11"*, %"class.std::basic_string"* noalias sret) unnamed_addr #0 align 2 {
  %3 = alloca %"class.simpleproto2::Foo.11"*, align 4
  store %"class.simpleproto2::Foo.11"* %0, %"class.simpleproto2::Foo.11"** %3, align 4
  %4 = load %"class.simpleproto2::Foo.11"*, %"class.simpleproto2::Foo.11"** %3, align 4
  %5 = call x86_thiscallcc %"class.std::basic_string"* @"\01??0?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@QBD@Z"(%"class.std::basic_string"* %1, i8* getelementptr inbounds ([17 x i8], [17 x i8]* @"\01??_C@_0BB@GHJBMFOJ@simpleproto2?4Foo?$AA@", i32 0, i32 0))
  ret void
}

; Function Attrs: noinline optnone
define x86_thiscallcc %"class.simpleproto2::Foo.11"* @"\01?New@Foo@simpleproto2@@UBEPAV12@PAVArena@protobuf@google@@@Z"(%"class.simpleproto2::Foo.11"*, %"class.google::protobuf::Arena"*) unnamed_addr #0 align 2 personality i8* bitcast (i32 (...)* @__CxxFrameHandler3 to i8*) {
  %3 = alloca %"class.google::protobuf::Arena"*, align 4
  %4 = alloca %"class.simpleproto2::Foo.11"*, align 4
  %5 = alloca %"class.simpleproto2::Foo.11"*, align 4
  store %"class.google::protobuf::Arena"* %1, %"class.google::protobuf::Arena"** %3, align 4
  store %"class.simpleproto2::Foo.11"* %0, %"class.simpleproto2::Foo.11"** %4, align 4
  %6 = load %"class.simpleproto2::Foo.11"*, %"class.simpleproto2::Foo.11"** %4, align 4
  %7 = call i8* @"\01??2@YAPAXI@Z"(i32 24) #11
  %8 = bitcast i8* %7 to %"class.simpleproto2::Foo.11"*
  %9 = invoke x86_thiscallcc %"class.simpleproto2::Foo.11"* @"\01??0Foo@simpleproto2@@QAE@XZ"(%"class.simpleproto2::Foo.11"* %8)
          to label %10 unwind label %16

; <label>:10:                                     ; preds = %2
  store %"class.simpleproto2::Foo.11"* %8, %"class.simpleproto2::Foo.11"** %5, align 4
...
; <label>:13:                                     ; preds = %10
  ...
  %15 = load %"class.simpleproto2::Foo.11"*, %"class.simpleproto2::Foo.11"** %5, align 4
  call x86_thiscallcc void @"\01??$Own@VFoo@simpleproto2@@@Arena@protobuf@google@@QAEXPAVFoo@simpleproto2@@@Z"(%"class.google::protobuf::Arena"* %14, %"class.simpleproto2::Foo.11"* %15)
  br label %18
...
; <label>:18:                                     ; preds = %13, %10
  %19 = load %"class.simpleproto2::Foo.11"*, %"class.simpleproto2::Foo.11"** %5, align 4
  ret %"class.simpleproto2::Foo.11"* %19
}

; Function Attrs: noinline optnone
define linkonce_odr x86_thiscallcc %"class.simpleproto2::Foo.11"* @"\01?New@Foo@simpleproto2@@UBEPAV12@XZ"(%"class.simpleproto2::Foo.11"*) unnamed_addr #0 comdat align 2 {
  %2 = alloca %"class.simpleproto2::Foo.11"*, align 4
  store %"class.simpleproto2::Foo.11"* %0, %"class.simpleproto2::Foo.11"** %2, align 4
  %3 = load %"class.simpleproto2::Foo.11"*, %"class.simpleproto2::Foo.11"** %2, align 4
  %4 = call x86_thiscallcc %"class.simpleproto2::Foo.11"* @"\01?New@Foo@simpleproto2@@UBEPAV12@PAVArena@protobuf@google@@@Z"(%"class.simpleproto2::Foo.11"* %3, %"class.google::protobuf::Arena"* null)
...
; Function Attrs: noinline optnone
define x86_thiscallcc void @"\01?Clear@Foo@simpleproto2@@UAEXXZ"(%"class.simpleproto2::Foo.11"*) unnamed_addr #0 align 2 {
  %2 = alloca %"class.simpleproto2::Foo.11"*, align 4
  %3 = alloca i32, align 4
  store %"class.simpleproto2::Foo.11"* %0, %"class.simpleproto2::Foo.11"** %2, align 4
  %4 = load %"class.simpleproto2::Foo.11"*, %"class.simpleproto2::Foo.11"** %2, align 4
  store i32 0, i32* %3, align 4
...
; Function Attrs: noinline nounwind optnone
define x86_thiscallcc zeroext i1 @"\01?IsInitialized@Foo@simpleproto2@@UBE_NXZ"(%"class.simpleproto2::Foo.11"*) unnamed_addr #1 align 2 {
  %2 = alloca %"class.simpleproto2::Foo.11"*, align 4
  store %"class.simpleproto2::Foo.11"* %0, %"class.simpleproto2::Foo.11"** %2, align 4
  %3 = load %"class.simpleproto2::Foo.11"*, %"class.simpleproto2::Foo.11"** %2, align 4
  ret i1 true
...
; Function Attrs: noinline optnone
define x86_thiscallcc void @"\01?CheckTypeAndMergeFrom@Foo@simpleproto2@@UAEXABVMessageLite@protobuf@google@@@Z"(%"class.simpleproto2::Foo.11"*, %"class.google::protobuf::MessageLite"* dereferenceable(4)) unnamed_addr #0 align 2 {
  ...
  store %"class.simpleproto2::Foo.11"* %0, %"class.simpleproto2::Foo.11"** %4, align 4
  %5 = load %"class.simpleproto2::Foo.11"*, %"class.simpleproto2::Foo.11"** %4, align 4
  %6 = load %"class.google::protobuf::MessageLite"*, %"class.google::protobuf::MessageLite"** %3, align 4
  %7 = call %"class.simpleproto2::Foo.11"* @"\01??$down_cast@PBVFoo@simpleproto2@@$$CBVMessageLite@protobuf@google@@@internal@protobuf@google@@YAPBVFoo@simpleproto2@@PBVMessageLite@12@@Z"(%"class.google::protobuf::MessageLite"* %6)
  call x86_thiscallcc void @"\01?MergeFrom@Foo@simpleproto2@@QAEXABV12@@Z"(%"class.simpleproto2::Foo.11"* %5, %"class.simpleproto2::Foo.11"* dereferenceable(24) %7)
  ret void
}

; Function Attrs: noinline optnone
define x86_thiscallcc zeroext i1 @"\01?MergePartialFromCodedStream@Foo@simpleproto2@@UAE_NPAVCodedInputStream@io@protobuf@google@@@Z"(%"class.simpleproto2::Foo.11"*, %"class.google::protobuf::io::CodedInputStream"*) unnamed_addr #0 align 2 personality i8* bitcast (i32 (...)* @__CxxFrameHandler3 to i8*) {
  %3 = alloca i1, align 1
  ...
  store %"class.simpleproto2::Foo.11"* %0, %"class.simpleproto2::Foo.11"** %5, align 4
  %12 = load %"class.simpleproto2::Foo.11"*, %"class.simpleproto2::Foo.11"** %5, align 4
...
; <label>:68:                                     ; preds = %63
  %69 = invoke x86_thiscallcc %"class.std::basic_string"* @"\01?mutable_s@Foo@simpleproto2@@QAEPAV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@XZ"(%"class.simpleproto2::Foo.11"* %12)
...
; <label>:75:                                     ; preds = %73
  %76 = invoke x86_thiscallcc dereferenceable(24) %"class.std::basic_string"* @"\01?s@Foo@simpleproto2@@QBEABV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@XZ"(%"class.simpleproto2::Foo.11"* %12)
          to label %77 unwind label %105

; <label>:77:                                     ; preds = %75
  %78 = call x86_thiscallcc i32 @"\01?length@?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QBEIXZ"(%"class.std::basic_string"* %76) #10
  %79 = invoke x86_thiscallcc dereferenceable(24) %"class.std::basic_string"* @"\01?s@Foo@simpleproto2@@QBEABV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@XZ"(%"class.simpleproto2::Foo.11"* %12)
          to label %80 unwind label %105

; <label>:80:                                     ; preds = %77
  %81 = call x86_thiscallcc i8* @"\01?data@?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QBEPBDXZ"(%"class.std::basic_string"* %79) #10
  %82 = invoke zeroext i1 @"\01?VerifyUtf8String@WireFormatLite@internal@protobuf@google@@SA_NPBDHW4Operation@1234@0@Z"(i8* %81, i32 %78, i32 0, i8* getelementptr inbounds ([19 x i8], [19 x i8]* @"\01??_C@_0BD@FCHDFINE@simpleproto2?4Foo?4s?$AA@", i32 0, i32 0))
...
; <label>:105:                                    ; preds = %93, %80, %77, %75, %70, %68, %54, %40, %31, %22
  ...
  call x86_thiscallcc void @"\01??1CodedOutputStream@io@protobuf@google@@QAE@XZ"(%"class.google::protobuf::io::CodedOutputStream"* %9) #10 [ "funclet"(token %106) ]
  cleanupret from %106 unwind label %107

; <label>:107:                                    ; preds = %105, %18
  %108 = cleanuppad within none []
  call x86_thiscallcc void @"\01??1StringOutputStream@io@protobuf@google@@UAE@XZ"(%"class.google::protobuf::io::StringOutputStream"* %8) #10 [ "funclet"(token %108) ]
  cleanupret from %108 unwind label %109

; <label>:109:                                    ; preds = %107, %16, %2
  %110 = cleanuppad within none []
  call x86_thiscallcc void @"\01??1LiteUnknownFieldSetter@internal@protobuf@google@@QAE@XZ"(%"class.google::protobuf::internal::LiteUnknownFieldSetter"* %7) #10 [ "funclet"(token %110) ]
  cleanupret from %110 unwind to caller
}

; Function Attrs: noinline optnone
define x86_thiscallcc i32 @"\01?ByteSizeLong@Foo@simpleproto2@@UBEIXZ"(%"class.simpleproto2::Foo.11"*) #0 align 2 {
  %2 = alloca %"class.simpleproto2::Foo.11"*, align 4
  %3 = alloca i32, align 4
  %4 = alloca i32, align 4
  store %"class.simpleproto2::Foo.11"* %0, %"class.simpleproto2::Foo.11"** %2, align 4
  %5 = load %"class.simpleproto2::Foo.11"*, %"class.simpleproto2::Foo.11"** %2, align 4
  store i32 0, i32* %3, align 4
...
; <label>:14:                                     ; preds = %11, %7
  ...
  %19 = call x86_thiscallcc dereferenceable(24) %"class.std::basic_string"* @"\01?s@Foo@simpleproto2@@QBEABV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@XZ"(%"class.simpleproto2::Foo.11"* %5)
  %20 = call x86_thiscallcc i32 @"\01?size@?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QBEIXZ"(%"class.std::basic_string"* %19) #10
  %21 = icmp ugt i32 %20, 0
  br i1 %21, label %22, label %28

; <label>:22:                                     ; preds = %14
  %23 = call x86_thiscallcc dereferenceable(24) %"class.std::basic_string"* @"\01?s@Foo@simpleproto2@@QBEABV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@XZ"(%"class.simpleproto2::Foo.11"* %5)
...
; <label>:28:                                     ; preds = %22, %14
  %29 = call x86_thiscallcc i32 bitcast (i32 (%"class.simpleproto2::Foo"*)* @"\01?i32@Foo@simpleproto2@@QBEHXZ" to i32 (%"class.simpleproto2::Foo.11"*)*)(%"class.simpleproto2::Foo.11"* %5)
  %30 = icmp ne i32 %29, 0
  br i1 %30, label %31, label %37

; <label>:31:                                     ; preds = %28
  %32 = call x86_thiscallcc i32 bitcast (i32 (%"class.simpleproto2::Foo"*)* @"\01?i32@Foo@simpleproto2@@QBEHXZ" to i32 (%"class.simpleproto2::Foo.11"*)*)(%"class.simpleproto2::Foo.11"* %5)
...
; <label>:37:                                     ; preds = %31, %28
  %38 = call x86_thiscallcc float @"\01?f@Foo@simpleproto2@@QBEMXZ"(%"class.simpleproto2::Foo.11"* %5)
...
; Function Attrs: noinline optnone
define x86_thiscallcc void @"\01?SerializeWithCachedSizes@Foo@simpleproto2@@UBEXPAVCodedOutputStream@io@protobuf@google@@@Z"(%"class.simpleproto2::Foo.11"*, %"class.google::protobuf::io::CodedOutputStream"*) unnamed_addr #0 align 2 {
  ...
  %7 = call x86_thiscallcc i32 bitcast (i32 (%"class.simpleproto2::Foo"*)* @"\01?i32@Foo@simpleproto2@@QBEHXZ" to i32 (%"class.simpleproto2::Foo.11"*)*)(%"class.simpleproto2::Foo.11"* %6)
  %8 = icmp ne i32 %7, 0
  br i1 %8, label %9, label %12

; <label>:9:                                      ; preds = %2
  %10 = load %"class.google::protobuf::io::CodedOutputStream"*, %"class.google::protobuf::io::CodedOutputStream"** %3, align 4
  %11 = call x86_thiscallcc i32 bitcast (i32 (%"class.simpleproto2::Foo"*)* @"\01?i32@Foo@simpleproto2@@QBEHXZ" to i32 (%"class.simpleproto2::Foo.11"*)*)(%"class.simpleproto2::Foo.11"* %6)
...
; <label>:12:                                     ; preds = %9, %2
  %13 = call x86_thiscallcc float @"\01?f@Foo@simpleproto2@@QBEMXZ"(%"class.simpleproto2::Foo.11"* %6)
...
; <label>:15:                                     ; preds = %12
  ...
  %17 = call x86_thiscallcc float @"\01?f@Foo@simpleproto2@@QBEMXZ"(%"class.simpleproto2::Foo.11"* %6)
...
; <label>:18:                                     ; preds = %15, %12
  %19 = call x86_thiscallcc dereferenceable(24) %"class.std::basic_string"* @"\01?s@Foo@simpleproto2@@QBEABV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@XZ"(%"class.simpleproto2::Foo.11"* %6)
  %20 = call x86_thiscallcc i32 @"\01?size@?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QBEIXZ"(%"class.std::basic_string"* %19) #10
  %21 = icmp ugt i32 %20, 0
  br i1 %21, label %22, label %30

; <label>:22:                                     ; preds = %18
  %23 = call x86_thiscallcc dereferenceable(24) %"class.std::basic_string"* @"\01?s@Foo@simpleproto2@@QBEABV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@XZ"(%"class.simpleproto2::Foo.11"* %6)
  %24 = call x86_thiscallcc i32 @"\01?length@?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QBEIXZ"(%"class.std::basic_string"* %23) #10
  %25 = call x86_thiscallcc dereferenceable(24) %"class.std::basic_string"* @"\01?s@Foo@simpleproto2@@QBEABV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@XZ"(%"class.simpleproto2::Foo.11"* %6)
  %26 = call x86_thiscallcc i8* @"\01?data@?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QBEPBDXZ"(%"class.std::basic_string"* %25) #10
  ...
  %29 = call x86_thiscallcc dereferenceable(24) %"class.std::basic_string"* @"\01?s@Foo@simpleproto2@@QBEABV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@XZ"(%"class.simpleproto2::Foo.11"* %6)
...
; <label>:33:                                     ; preds = %30
  %34 = getelementptr inbounds %"class.simpleproto2::Foo.11", %"class.simpleproto2::Foo.11"* %6, i32 0, i32 1
...
; <label>:37:                                     ; preds = %30
  %38 = getelementptr inbounds %"class.simpleproto2::Foo.11", %"class.simpleproto2::Foo.11"* %6, i32 0, i32 1
...
; <label>:40:                                     ; preds = %37, %33
  ...
  %42 = call x86_thiscallcc i32 @"\01?size@?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QBEIXZ"(%"class.std::basic_string"* %41) #10
  %43 = call zeroext i1 @"\01?GetProto3PreserveUnknownsDefault@internal@protobuf@google@@YA_NXZ"()
  br i1 %43, label %44, label %48

; <label>:44:                                     ; preds = %40
  %45 = getelementptr inbounds %"class.simpleproto2::Foo.11", %"class.simpleproto2::Foo.11"* %6, i32 0, i32 1
...
; <label>:48:                                     ; preds = %40
  %49 = getelementptr inbounds %"class.simpleproto2::Foo.11", %"class.simpleproto2::Foo.11"* %6, i32 0, i32 1
...
; <label>:51:                                     ; preds = %48, %44
  ...
  %53 = call x86_thiscallcc i8* @"\01?data@?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QBEPBDXZ"(%"class.std::basic_string"* %52) #10
...
; Function Attrs: noinline nounwind optnone
define linkonce_odr x86_thiscallcc i32 @"\01?GetCachedSize@Foo@simpleproto2@@UBEHXZ"(%"class.simpleproto2::Foo.11"*) unnamed_addr #1 comdat align 2 {
  %2 = alloca %"class.simpleproto2::Foo.11"*, align 4
  store %"class.simpleproto2::Foo.11"* %0, %"class.simpleproto2::Foo.11"** %2, align 4
  %3 = load %"class.simpleproto2::Foo.11"*, %"class.simpleproto2::Foo.11"** %2, align 4
...
; Function Attrs: noinline nounwind optnone
define linkonce_odr x86_thiscallcc float @"\01?f@Foo@simpleproto2@@QBEMXZ"(%"class.simpleproto2::Foo.11"*) #1 comdat align 2 {
  %2 = alloca %"class.simpleproto2::Foo.11"*, align 4
  store %"class.simpleproto2::Foo.11"* %0, %"class.simpleproto2::Foo.11"** %2, align 4
  %3 = load %"class.simpleproto2::Foo.11"*, %"class.simpleproto2::Foo.11"** %2, align 4
...
; Function Attrs: noinline optnone
define linkonce_odr x86_thiscallcc dereferenceable(24) %"class.std::basic_string"* @"\01?s@Foo@simpleproto2@@QBEABV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@XZ"(%"class.simpleproto2::Foo.11"*) #0 comdat align 2 {
  %2 = alloca %"class.simpleproto2::Foo.11"*, align 4
  store %"class.simpleproto2::Foo.11"* %0, %"class.simpleproto2::Foo.11"** %2, align 4
  %3 = load %"class.simpleproto2::Foo.11"*, %"class.simpleproto2::Foo.11"** %2, align 4
  %4 = getelementptr inbounds %"class.simpleproto2::Foo.11", %"class.simpleproto2::Foo.11"* %3, i32 0, i32 2
...
; Function Attrs: noinline optnone
define linkonce_odr x86_thiscallcc %"class.std::basic_string"* @"\01?mutable_s@Foo@simpleproto2@@QAEPAV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@XZ"(%"class.simpleproto2::Foo.11"*) #0 comdat align 2 {
  %2 = alloca %"class.simpleproto2::Foo.11"*, align 4
  store %"class.simpleproto2::Foo.11"* %0, %"class.simpleproto2::Foo.11"** %2, align 4
  %3 = load %"class.simpleproto2::Foo.11"*, %"class.simpleproto2::Foo.11"** %2, align 4
  %4 = getelementptr inbounds %"class.simpleproto2::Foo.11", %"class.simpleproto2::Foo.11"* %3, i32 0, i32 2
...
; <label>:10:                                     ; preds = %2
  ...
  %13 = call x86_thiscallcc dereferenceable(1) %"class.std::allocator"* @"\01?_Getal@?$_String_alloc@U?$_String_base_types@DV?$allocator@D@std@@@std@@@std@@QAEAAV?$allocator@D@2@XZ"(%"class.std::_String_alloc"* %12) #10
  %14 = bitcast %"class.std::basic_string"* %6 to %"class.std::_String_alloc"*
  %15 = call x86_thiscallcc dereferenceable(1) %"class.std::allocator"* @"\01?_Getal@?$_String_alloc@U?$_String_base_types@DV?$allocator@D@std@@@std@@@std@@QAEAAV?$allocator@D@2@XZ"(%"class.std::_String_alloc"* %14) #10
  call void @"\01??$_Pocs@V?$allocator@D@std@@@std@@YAXAAV?$allocator@D@0@0@Z"(%"class.std::allocator"* dereferenceable(1) %15, %"class.std::allocator"* dereferenceable(1) %13) #10
  br label %16
...
define linkonce_odr void @"\01??$_Pocs@V?$allocator@D@std@@@std@@YAXAAV?$allocator@D@0@0@Z"(%"class.std::allocator"* dereferenceable(1), %"class.std::allocator"* dereferenceable(1)) #1 comdat {
  ...
  %7 = load %"class.std::allocator"*, %"class.std::allocator"** %3, align 4
  %8 = load %"class.std::allocator"*, %"class.std::allocator"** %4, align 4
  call void @"\01??$_Pocs@V?$allocator@D@std@@@std@@YAXAAV?$allocator@D@0@0U?$integral_constant@_N$0A@@0@@Z"(%"class.std::allocator"* dereferenceable(1) %8, %"class.std::allocator"* dereferenceable(1) %7, %"class.std::allocator"* byval align 4 %6) #10
  ret void
}
...
; <label>:6:                                      ; preds = %1
  %7 = call i8* @"\01??2@YAPAXI@Z"(i32 28) #11
...
define linkonce_odr x86_thiscallcc %"class.std::_Compressed_pair"* @"\01??$?0$$V@?$_Compressed_pair@V?$allocator@D@std@@V?$_String_val@U?$_Simple_types@D@std@@@2@$00@std@@QAE@U_Zero_then_variadic_args_t@1@@Z"(%"class.std::_Compressed_pair"* returned, %"class.std::allocator"* byval align 4) unnamed_addr #0 comdat align 2 {
  ...
  %6 = call x86_thiscallcc %"class.std::allocator"* @"\01??0?$allocator@D@std@@QAE@XZ"(%"class.std::allocator"* %5) #10
...
; <label>:20:                                     ; preds = %19, %17
  %21 = call i8* @"\01??2@YAPAXI@Z"(i32 24) #11
...
; <label>:30:                                     ; preds = %27
  call x86_thiscallcc void @"\01??1LogMessage@internal@protobuf@google@@QAE@XZ"(%"class.google::protobuf::internal::LogMessage"* %5) #10 [ "funclet"(token %28) ]
  br label %31
...
; <label>:32:                                     ; preds = %20
  ...
  call void @"\01??3@YAXPAX@Z"(i8* %21) #12 [ "funclet"(token %33) ]
...
; <label>:14:                                     ; preds = %2
  ...
  call x86_thiscallcc void @"\01??1?$_String_alloc@U?$_String_base_types@DV?$allocator@D@std@@@std@@@std@@QAE@XZ"(%"class.std::_String_alloc"* %16) #10 [ "funclet"(token %15) ]
...
define linkonce_odr x86_thiscallcc void @"\01?_Construct_lv_contents@?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAEXABV12@@Z"(%"class.std::basic_string"*, %"class.std::basic_string"* dereferenceable(24)) #0 comdat align 2 {
  ...
  %16 = call x86_thiscallcc dereferenceable(24) %"class.std::_String_val"* @"\01?_Get_data@?$_String_alloc@U?$_String_base_types@DV?$allocator@D@std@@@std@@@std@@QAEAAV?$_String_val@U?$_Simple_types@D@std@@@2@XZ"(%"class.std::_String_alloc"* %15) #10
  ...
  %19 = call x86_thiscallcc dereferenceable(24) %"class.std::_String_val"* @"\01?_Get_data@?$_String_alloc@U?$_String_base_types@DV?$allocator@D@std@@@std@@@std@@QBEABV?$_String_val@U?$_Simple_types@D@std@@@2@XZ"(%"class.std::_String_alloc"* %18) #10
...
; <label>:27:                                     ; preds = %2
  ...
  %33 = call i8* @"\01?copy@?$char_traits@D@std@@SAPADQADQBDI@Z"(i8* %32, i8* %28, i32 16) #10
...
; <label>:39:                                     ; preds = %2
  ...
  %42 = call x86_thiscallcc i32 @"\01?max_size@?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QBEIXZ"(%"class.std::basic_string"* %14) #10
  store i32 %42, i32* %11, align 4
  %43 = load i32, i32* %7, align 4
  %44 = or i32 %43, 15
  store i32 %44, i32* %12, align 4
  %45 = call dereferenceable(4) i32* @"\01??$_Min_value@I@std@@YAABIABI0@Z"(i32* dereferenceable(4) %12, i32* dereferenceable(4) %11) #10
  ...
  %54 = call i8** @"\01??$addressof@PAD@std@@YAPAPADAAPAD@Z"(i8** dereferenceable(4) %53) #10
  ...
  %61 = call i8* @"\01?copy@?$char_traits@D@std@@SAPADQADQBDI@Z"(i8* %60, i8* %58, i32 %57) #10
...
; Function Attrs: noinline optnone
define linkonce_odr %"class.simpleproto2::Foo.11"* @"\01??$down_cast@PBVFoo@simpleproto2@@$$CBVMessageLite@protobuf@google@@@internal@protobuf@google@@YAPBVFoo@simpleproto2@@PBVMessageLite@12@@Z"(%"class.google::protobuf::MessageLite"*) #0 comdat {
  %2 = alloca %"class.google::protobuf::MessageLite"*, align 4
  store %"class.google::protobuf::MessageLite"* %0, %"class.google::protobuf::MessageLite"** %2, align 4
  %3 = load %"class.google::protobuf::MessageLite"*, %"class.google::protobuf::MessageLite"** %2, align 4
...
; Function Attrs: noinline optnone
define x86_thiscallcc void @"\01?MergeFrom@Foo@simpleproto2@@QAEXABV12@@Z"(%"class.simpleproto2::Foo.11"*, %"class.simpleproto2::Foo.11"* dereferenceable(24)) #0 align 2 personality i8* bitcast (i32 (...)* @__CxxFrameHandler3 to i8*) {
  %3 = alloca %"class.simpleproto2::Foo.11"*, align 4
  %4 = alloca %"class.simpleproto2::Foo.11"*, align 4
  %5 = alloca %"class.google::protobuf::internal::LogMessage", align 4
  %6 = alloca i1, align 1
  ...
  store %"class.simpleproto2::Foo.11"* %1, %"class.simpleproto2::Foo.11"** %3, align 4
  store %"class.simpleproto2::Foo.11"* %0, %"class.simpleproto2::Foo.11"** %4, align 4
  %10 = load %"class.simpleproto2::Foo.11"*, %"class.simpleproto2::Foo.11"** %4, align 4
  %11 = load %"class.simpleproto2::Foo.11"*, %"class.simpleproto2::Foo.11"** %3, align 4
...
; <label>:14:                                     ; preds = %2
  %15 = call x86_thiscallcc %"class.google::protobuf::internal::LogMessage"* @"\01??0LogMessage@internal@protobuf@google@@QAE@W4LogLevel@23@PBDH@Z"(%"class.google::protobuf::internal::LogMessage"* %5, i32 3, i8* getelementptr inbounds ([78 x i8], [78 x i8]* @"\01??_C@_0EO@CHGOICEJ@E?3?2work?2local?2private?9contract?9s@", i32 0, i32 0), i32 309)
  store i1 true, i1* %6, align 1
...
; <label>:22:                                     ; preds = %21, %19
  ...
  %25 = load %"class.simpleproto2::Foo.11"*, %"class.simpleproto2::Foo.11"** %3, align 4
  ...
  store i32 0, i32* %8, align 4
  %27 = load %"class.simpleproto2::Foo.11"*, %"class.simpleproto2::Foo.11"** %3, align 4
  %28 = call x86_thiscallcc dereferenceable(24) %"class.std::basic_string"* @"\01?s@Foo@simpleproto2@@QBEABV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@XZ"(%"class.simpleproto2::Foo.11"* %27)
  %29 = call x86_thiscallcc i32 @"\01?size@?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QBEIXZ"(%"class.std::basic_string"* %28) #10
  %30 = icmp ugt i32 %29, 0
  br i1 %30, label %31, label %45

; <label>:31:                                     ; preds = %22
  %32 = getelementptr inbounds %"class.simpleproto2::Foo.11", %"class.simpleproto2::Foo.11"* %10, i32 0, i32 2
  %33 = load %"class.simpleproto2::Foo.11"*, %"class.simpleproto2::Foo.11"** %3, align 4
...
; <label>:43:                                     ; preds = %40
  call x86_thiscallcc void @"\01??1LogMessage@internal@protobuf@google@@QAE@XZ"(%"class.google::protobuf::internal::LogMessage"* %5) #10 [ "funclet"(token %41) ]
  br label %44
...
; <label>:45:                                     ; preds = %31, %22
  %46 = load %"class.simpleproto2::Foo.11"*, %"class.simpleproto2::Foo.11"** %3, align 4
  %47 = call x86_thiscallcc i32 bitcast (i32 (%"class.simpleproto2::Foo"*)* @"\01?i32@Foo@simpleproto2@@QBEHXZ" to i32 (%"class.simpleproto2::Foo.11"*)*)(%"class.simpleproto2::Foo.11"* %46)
  %48 = icmp ne i32 %47, 0
  br i1 %48, label %49, label %52

; <label>:49:                                     ; preds = %45
  %50 = load %"class.simpleproto2::Foo.11"*, %"class.simpleproto2::Foo.11"** %3, align 4
  %51 = call x86_thiscallcc i32 bitcast (i32 (%"class.simpleproto2::Foo"*)* @"\01?i32@Foo@simpleproto2@@QBEHXZ" to i32 (%"class.simpleproto2::Foo.11"*)*)(%"class.simpleproto2::Foo.11"* %50)
  call x86_thiscallcc void bitcast (void (%"class.simpleproto2::Foo"*, i32)* @"\01?set_i32@Foo@simpleproto2@@QAEXH@Z" to void (%"class.simpleproto2::Foo.11"*, i32)*)(%"class.simpleproto2::Foo.11"* %10, i32 %51)
  br label %52

; <label>:52:                                     ; preds = %49, %45
  %53 = load %"class.simpleproto2::Foo.11"*, %"class.simpleproto2::Foo.11"** %3, align 4
  %54 = call x86_thiscallcc float @"\01?f@Foo@simpleproto2@@QBEMXZ"(%"class.simpleproto2::Foo.11"* %53)
  %55 = fcmp une float %54, 0.000000e+00
  br i1 %55, label %56, label %59

; <label>:56:                                     ; preds = %52
  %57 = load %"class.simpleproto2::Foo.11"*, %"class.simpleproto2::Foo.11"** %3, align 4
  %58 = call x86_thiscallcc float @"\01?f@Foo@simpleproto2@@QBEMXZ"(%"class.simpleproto2::Foo.11"* %57)
  call x86_thiscallcc void bitcast (void (%"class.simpleproto2::Foo"*, float)* @"\01?set_f@Foo@simpleproto2@@QAEXM@Z" to void (%"class.simpleproto2::Foo.11"*, float)*)(%"class.simpleproto2::Foo.11"* %10, float %58)
  br label %59
...
define linkonce_odr x86_thiscallcc dereferenceable(24) %"class.std::basic_string"* @"\01??4?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAEAAV01@ABV01@@Z"(%"class.std::basic_string"*, %"class.std::basic_string"* dereferenceable(24)) #0 comdat align 2 {
  ...
  %6 = load %"class.std::basic_string"*, %"class.std::basic_string"** %4, align 4
  %7 = load %"class.std::basic_string"*, %"class.std::basic_string"** %3, align 4
  %8 = call %"class.std::basic_string"* @"\01??$addressof@$$CBV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@@std@@YAPBV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@0@ABV10@@Z"(%"class.std::basic_string"* dereferenceable(24) %7) #10
  %9 = icmp ne %"class.std::basic_string"* %6, %8
...
; <label>:10:                                     ; preds = %2
  ...
  %12 = load %"class.std::basic_string"*, %"class.std::basic_string"** %3, align 4
  %13 = bitcast %"class.std::basic_string"* %12 to %"class.std::_String_alloc"*
  %14 = call x86_thiscallcc dereferenceable(1) %"class.std::allocator"* @"\01?_Getal@?$_String_alloc@U?$_String_base_types@DV?$allocator@D@std@@@std@@@std@@QBEABV?$allocator@D@2@XZ"(%"class.std::_String_alloc"* %13) #10
  ...
  %16 = bitcast %"class.std::basic_string"* %15 to %"class.std::_String_alloc"*
  %17 = call x86_thiscallcc dereferenceable(24) %"class.std::_String_val"* @"\01?_Get_data@?$_String_alloc@U?$_String_base_types@DV?$allocator@D@std@@@std@@@std@@QBEABV?$_String_val@U?$_Simple_types@D@std@@@2@XZ"(%"class.std::_String_alloc"* %16) #10
...
define linkonce_odr x86_thiscallcc void @"\01?_Copy_alloc@?$_String_alloc@U?$_String_base_types@DV?$allocator@D@std@@@std@@@std@@QAEXABV?$allocator@D@2@@Z"(%"class.std::_String_alloc"*, %"class.std::allocator"* dereferenceable(1)) #1 comdat align 2 {
  ...
  %6 = load %"class.std::allocator"*, %"class.std::allocator"** %3, align 4
  %7 = call x86_thiscallcc dereferenceable(1) %"class.std::allocator"* @"\01?_Getal@?$_String_alloc@U?$_String_base_types@DV?$allocator@D@std@@@std@@@std@@QAEAAV?$allocator@D@2@XZ"(%"class.std::_String_alloc"* %5) #10
  call void @"\01??$_Pocca@V?$allocator@D@std@@@std@@YAXAAV?$allocator@D@0@ABV10@@Z"(%"class.std::allocator"* dereferenceable(1) %7, %"class.std::allocator"* dereferenceable(1) %6) #10
  ret void
}
...
define linkonce_odr void @"\01??$_Pocca@V?$allocator@D@std@@@std@@YAXAAV?$allocator@D@0@ABV10@@Z"(%"class.std::allocator"* dereferenceable(1), %"class.std::allocator"* dereferenceable(1)) #1 comdat {
  ...
  %7 = load %"class.std::allocator"*, %"class.std::allocator"** %3, align 4
  %8 = load %"class.std::allocator"*, %"class.std::allocator"** %4, align 4
  call void @"\01??$_Pocca@V?$allocator@D@std@@@std@@YAXAAV?$allocator@D@0@ABV10@U?$integral_constant@_N$0A@@0@@Z"(%"class.std::allocator"* dereferenceable(1) %8, %"class.std::allocator"* dereferenceable(1) %7, %"class.std::allocator"* byval align 4 %6) #10
  ret void
}
...
; <label>:11:                                     ; preds = %2
  ...
  call x86_thiscallcc void @"\01?clear@?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAEXXZ"(%"class.std::basic_string"* %13) #10
  br label %14
...
; Function Attrs: noinline optnone
define linkonce_odr x86_thiscallcc void @"\01??$Own@VFoo@simpleproto2@@@Arena@protobuf@google@@QAEXPAVFoo@simpleproto2@@@Z"(%"class.google::protobuf::Arena"*, %"class.simpleproto2::Foo.11"*) #0 comdat align 2 {
  %3 = alloca %"class.simpleproto2::Foo.11"*, align 4
  %4 = alloca %"class.google::protobuf::Arena"*, align 4
  %5 = alloca %"class.std::allocator", align 4
  ...
  %9 = load %"class.simpleproto2::Foo.11"*, %"class.simpleproto2::Foo.11"** %3, align 4
  call x86_thiscallcc void @"\01??$OwnInternal@VFoo@simpleproto2@@@Arena@protobuf@google@@AAEXPAVFoo@simpleproto2@@U?$integral_constant@_N$0A@@internal@12@@Z"(%"class.google::protobuf::Arena"* %7, %"class.simpleproto2::Foo.11"* %9, %"class.std::allocator"* byval align 4 %5)
  ret void
}

; Function Attrs: noinline optnone
define linkonce_odr x86_thiscallcc void @"\01??$OwnInternal@VFoo@simpleproto2@@@Arena@protobuf@google@@AAEXPAVFoo@simpleproto2@@U?$integral_constant@_N$0A@@internal@12@@Z"(%"class.google::protobuf::Arena"*, %"class.simpleproto2::Foo.11"*, %"class.std::allocator"* byval align 4) #0 comdat align 2 {
  %4 = alloca %"class.simpleproto2::Foo.11"*, align 4
  %5 = alloca %"class.google::protobuf::Arena"*, align 4
  store %"class.simpleproto2::Foo.11"* %1, %"class.simpleproto2::Foo.11"** %4, align 4
  store %"class.google::protobuf::Arena"* %0, %"class.google::protobuf::Arena"** %5, align 4
  %6 = load %"class.google::protobuf::Arena"*, %"class.google::protobuf::Arena"** %5, align 4
  %7 = load %"class.simpleproto2::Foo.11"*, %"class.simpleproto2::Foo.11"** %4, align 4
  %8 = icmp ne %"class.simpleproto2::Foo.11"* %7, null
  br i1 %8, label %9, label %13

; <label>:9:                                      ; preds = %3
  %10 = getelementptr inbounds %"class.google::protobuf::Arena", %"class.google::protobuf::Arena"* %6, i32 0, i32 0
  %11 = load %"class.simpleproto2::Foo.11"*, %"class.simpleproto2::Foo.11"** %4, align 4
  %12 = bitcast %"class.simpleproto2::Foo.11"* %11 to i8*
  call x86_thiscallcc void @"\01?AddCleanup@ArenaImpl@internal@protobuf@google@@QAEXPAXP6AX0@Z@Z"(%"class.google::protobuf::internal::ArenaImpl"* %10, i8* %12, void (i8*)* @"\01??$arena_delete_object@VFoo@simpleproto2@@@internal@protobuf@google@@YAXPAX@Z")
  br label %13
...
; Function Attrs: noinline nounwind optnone
define linkonce_odr void @"\01??$arena_delete_object@VFoo@simpleproto2@@@internal@protobuf@google@@YAXPAX@Z"(i8*) #1 comdat {
  %2 = alloca i8*, align 4
  store i8* %0, i8** %2, align 4
  %3 = load i8*, i8** %2, align 4
...
; <label>:6:                                      ; preds = %1
  ...
  %8 = load i8* (%"class.simpleproto2::Foo.11"*, i32)**, i8* (%"class.simpleproto2::Foo.11"*, i32)*** %7, align 4
  %9 = getelementptr inbounds i8* (%"class.simpleproto2::Foo.11"*, i32)*, i8* (%"class.simpleproto2::Foo.11"*, i32)** %8, i64 0
  %10 = load i8* (%"class.simpleproto2::Foo.11"*, i32)*, i8* (%"class.simpleproto2::Foo.11"*, i32)** %9, align 4
  %11 = call x86_thiscallcc i8* %10(%"class.simpleproto2::Foo.11"* %4, i32 1) #10
  br label %12
...
; Function Attrs: noinline nounwind optnone
define x86_thiscallcc void @"\01??1Foo@simpleproto2@@UAE@XZ"(%"class.simpleproto2::Foo.11"*) #1 align 2 personality i8* bitcast (i32 (...)* @__CxxFrameHandler3 to i8*) {
  %2 = alloca %"class.simpleproto2::Foo.11"*, align 4
  store %"class.simpleproto2::Foo.11"* %0, %"class.simpleproto2::Foo.11"** %2, align 4
  %3 = load %"class.simpleproto2::Foo.11"*, %"class.simpleproto2::Foo.11"** %2, align 4
  %4 = bitcast %"class.simpleproto2::Foo.11"* %3 to i32 (...)***
  store i32 (...)** bitcast (i8** @"\01??_7Foo@simpleproto2@@6B@" to i32 (...)**), i32 (...)*** %4, align 4
  invoke x86_thiscallcc void @"\01?SharedDtor@Foo@simpleproto2@@AAEXXZ"(%"class.simpleproto2::Foo.11"* %3)
...
; Function Attrs: noinline optnone
define x86_thiscallcc void @"\01?SharedDtor@Foo@simpleproto2@@AAEXXZ"(%"class.simpleproto2::Foo.11"*) #0 align 2 {
  %2 = alloca %"class.simpleproto2::Foo.11"*, align 4
  store %"class.simpleproto2::Foo.11"* %0, %"class.simpleproto2::Foo.11"** %2, align 4
  %3 = load %"class.simpleproto2::Foo.11"*, %"class.simpleproto2::Foo.11"** %2, align 4
  %4 = getelementptr inbounds %"class.simpleproto2::Foo.11", %"class.simpleproto2::Foo.11"* %3, i32 0, i32 2
...
; <label>:14:                                     ; preds = %10
  call x86_thiscallcc void @"\01??1?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@XZ"(%"class.std::basic_string"* %12) #10
...
define void @"\01?InitDefaultsBarImpl@protobuf_SimpleProtoLite2_2eproto@@YAXXZ"() #0 {
  ...
  %4 = call x86_thiscallcc %"class.simpleproto2::Bar.23"* @"\01??0Bar@simpleproto2@@QAE@XZ"(%"class.simpleproto2::Bar.23"* %3)
  %5 = load i8*, i8** %1, align 4
  call void @"\01?OnShutdownDestroyMessage@internal@protobuf@google@@YAXPBX@Z"(i8* %5)
...
; Function Attrs: noinline optnone
define x86_thiscallcc %"class.simpleproto2::Bar.23"* @"\01??0Bar@simpleproto2@@QAE@XZ"(%"class.simpleproto2::Bar.23"* returned) unnamed_addr #0 align 2 personality i8* bitcast (i32 (...)* @__CxxFrameHandler3 to i8*) {
  %2 = alloca %"class.simpleproto2::Bar.23"*, align 4
  %3 = alloca %"class.simpleproto2::Bar.23"*, align 4
  store %"class.simpleproto2::Bar.23"* %0, %"class.simpleproto2::Bar.23"** %3, align 4
  %4 = load %"class.simpleproto2::Bar.23"*, %"class.simpleproto2::Bar.23"** %3, align 4
  store %"class.simpleproto2::Bar.23"* %4, %"class.simpleproto2::Bar.23"** %2, align 4
...
; <label>:10:                                     ; preds = %1
  %11 = invoke %"class.simpleproto2::Bar.23"* @"\01?internal_default_instance@Bar@simpleproto2@@SAPBV12@XZ"()
          to label %12 unwind label %19
...
; <label>:16:                                     ; preds = %15, %12
  invoke x86_thiscallcc void @"\01?SharedCtor@Bar@simpleproto2@@AAEXXZ"(%"class.simpleproto2::Bar.23"* %4)
          to label %17 unwind label %19

; <label>:17:                                     ; preds = %16
  %18 = load %"class.simpleproto2::Bar.23"*, %"class.simpleproto2::Bar.23"** %2, align 4
...
define void @"\01?InitAsDefaultInstance@Bar@simpleproto2@@SAXXZ"() #0 align 2 {
  %1 = call %"class.simpleproto2::Foo.11"* @"\01?internal_default_instance@Foo@simpleproto2@@SAPBV12@XZ"()
  %2 = call x86_thiscallcc %"class.simpleproto2::Bar.23"* @"\01?get_mutable@?$ExplicitlyConstructed@VBar@simpleproto2@@@internal@protobuf@google@@QAEPAVBar@simpleproto2@@XZ"(%"class.google::protobuf::internal::ExplicitlyConstructed"* getelementptr inbounds (%"class.simpleproto2::FooDefaultTypeInternal", %"class.simpleproto2::FooDefaultTypeInternal"* @"\01?_Bar_default_instance_@simpleproto2@@3VBarDefaultTypeInternal@1@A", i32 0, i32 0))
...
; Function Attrs: noinline nounwind optnone
define linkonce_odr x86_thiscallcc %"class.simpleproto2::Bar.23"* @"\01?get_mutable@?$ExplicitlyConstructed@VBar@simpleproto2@@@internal@protobuf@google@@QAEPAVBar@simpleproto2@@XZ"(%"class.google::protobuf::internal::ExplicitlyConstructed"*) #1 comdat align 2 {
  %2 = alloca %"class.google::protobuf::internal::ExplicitlyConstructed"*, align 4
  store %"class.google::protobuf::internal::ExplicitlyConstructed"* %0, %"class.google::protobuf::internal::ExplicitlyConstructed"** %2, align 4
  %3 = load %"class.google::protobuf::internal::ExplicitlyConstructed"*, %"class.google::protobuf::internal::ExplicitlyConstructed"** %2, align 4
  %4 = getelementptr inbounds %"class.google::protobuf::internal::ExplicitlyConstructed", %"class.google::protobuf::internal::ExplicitlyConstructed"* %3, i32 0, i32 0
  %5 = bitcast %"union.google::protobuf::internal::ExplicitlyConstructed<std::basic_string<char, std::char_traits<char>, std::allocator<char> > >::AlignedUnion"* %4 to %"class.simpleproto2::Bar.23"*
  ret %"class.simpleproto2::Bar.23"* %5
}

; Function Attrs: noinline nounwind optnone
define linkonce_odr %"class.simpleproto2::Bar.23"* @"\01?internal_default_instance@Bar@simpleproto2@@SAPBV12@XZ"() #1 comdat align 2 {
...
define void @"\01?InitDefaultsBar@protobuf_SimpleProtoLite2_2eproto@@YAXXZ"() #0 {
  call void @"\01?GoogleOnceInit@protobuf@google@@YAXPAHP6AXXZ@Z"(i32* @"\01?once@?1??InitDefaultsBar@protobuf_SimpleProtoLite2_2eproto@@YAXXZ@4HA", void ()* @"\01?InitDefaultsBarImpl@protobuf_SimpleProtoLite2_2eproto@@YAXXZ")
  ret void
}

; Function Attrs: noinline nounwind optnone
define x86_thiscallcc void @"\01?SharedCtor@Bar@simpleproto2@@AAEXXZ"(%"class.simpleproto2::Bar.23"*) #1 align 2 {
  %2 = alloca %"class.simpleproto2::Bar.23"*, align 4
  store %"class.simpleproto2::Bar.23"* %0, %"class.simpleproto2::Bar.23"** %2, align 4
  %3 = load %"class.simpleproto2::Bar.23"*, %"class.simpleproto2::Bar.23"** %2, align 4
...
; Function Attrs: noinline nounwind optnone
define linkonce_odr x86_thiscallcc i8* @"\01??_GBar@simpleproto2@@UAEPAXI@Z"(%"class.simpleproto2::Bar.23"*, i32) unnamed_addr #1 comdat align 2 {
  %3 = alloca i8*, align 4
  %4 = alloca i32, align 4
  %5 = alloca %"class.simpleproto2::Bar.23"*, align 4
  store i32 %1, i32* %4, align 4
  store %"class.simpleproto2::Bar.23"* %0, %"class.simpleproto2::Bar.23"** %5, align 4
  %6 = load %"class.simpleproto2::Bar.23"*, %"class.simpleproto2::Bar.23"** %5, align 4
  %7 = bitcast %"class.simpleproto2::Bar.23"* %6 to i8*
  store i8* %7, i8** %3, align 4
  %8 = load i32, i32* %4, align 4
  call x86_thiscallcc void @"\01??1Bar@simpleproto2@@UAE@XZ"(%"class.simpleproto2::Bar.23"* %6) #10
  %9 = icmp eq i32 %8, 0
  br i1 %9, label %12, label %10
...
; Function Attrs: noinline optnone
define x86_thiscallcc void @"\01?GetTypeName@Bar@simpleproto2@@UBE?AV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@XZ"(%"class.simpleproto2::Bar.23"*, %"class.std::basic_string"* noalias sret) unnamed_addr #0 align 2 {
  %3 = alloca %"class.simpleproto2::Bar.23"*, align 4
  store %"class.simpleproto2::Bar.23"* %0, %"class.simpleproto2::Bar.23"** %3, align 4
  %4 = load %"class.simpleproto2::Bar.23"*, %"class.simpleproto2::Bar.23"** %3, align 4
  %5 = call x86_thiscallcc %"class.std::basic_string"* @"\01??0?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@QBD@Z"(%"class.std::basic_string"* %1, i8* getelementptr inbounds ([17 x i8], [17 x i8]* @"\01??_C@_0BB@BNABBDKI@simpleproto2?4Bar?$AA@", i32 0, i32 0))
  ret void
}

; Function Attrs: noinline optnone
define x86_thiscallcc %"class.simpleproto2::Bar.23"* @"\01?New@Bar@simpleproto2@@UBEPAV12@PAVArena@protobuf@google@@@Z"(%"class.simpleproto2::Bar.23"*, %"class.google::protobuf::Arena"*) unnamed_addr #0 align 2 personality i8* bitcast (i32 (...)* @__CxxFrameHandler3 to i8*) {
  %3 = alloca %"class.google::protobuf::Arena"*, align 4
  %4 = alloca %"class.simpleproto2::Bar.23"*, align 4
  %5 = alloca %"class.simpleproto2::Bar.23"*, align 4
  store %"class.google::protobuf::Arena"* %1, %"class.google::protobuf::Arena"** %3, align 4
  store %"class.simpleproto2::Bar.23"* %0, %"class.simpleproto2::Bar.23"** %4, align 4
  %6 = load %"class.simpleproto2::Bar.23"*, %"class.simpleproto2::Bar.23"** %4, align 4
  %7 = call i8* @"\01??2@YAPAXI@Z"(i32 24) #11
  %8 = bitcast i8* %7 to %"class.simpleproto2::Bar.23"*
  %9 = invoke x86_thiscallcc %"class.simpleproto2::Bar.23"* @"\01??0Bar@simpleproto2@@QAE@XZ"(%"class.simpleproto2::Bar.23"* %8)
          to label %10 unwind label %16

; <label>:10:                                     ; preds = %2
  store %"class.simpleproto2::Bar.23"* %8, %"class.simpleproto2::Bar.23"** %5, align 4
  %11 = load %"class.google::protobuf::Arena"*, %"class.google::protobuf::Arena"** %3, align 4
  %12 = icmp ne %"class.google::protobuf::Arena"* %11, null
  br i1 %12, label %13, label %18
...
; <label>:13:                                     ; preds = %10
  %14 = load %"class.google::protobuf::Arena"*, %"class.google::protobuf::Arena"** %3, align 4
  %15 = load %"class.simpleproto2::Bar.23"*, %"class.simpleproto2::Bar.23"** %5, align 4
  call x86_thiscallcc void @"\01??$Own@VBar@simpleproto2@@@Arena@protobuf@google@@QAEXPAVBar@simpleproto2@@@Z"(%"class.google::protobuf::Arena"* %14, %"class.simpleproto2::Bar.23"* %15)
  br label %18
...
; <label>:18:                                     ; preds = %13, %10
  %19 = load %"class.simpleproto2::Bar.23"*, %"class.simpleproto2::Bar.23"** %5, align 4
  ret %"class.simpleproto2::Bar.23"* %19
}

; Function Attrs: noinline optnone
define linkonce_odr x86_thiscallcc %"class.simpleproto2::Bar.23"* @"\01?New@Bar@simpleproto2@@UBEPAV12@XZ"(%"class.simpleproto2::Bar.23"*) unnamed_addr #0 comdat align 2 {
  %2 = alloca %"class.simpleproto2::Bar.23"*, align 4
  store %"class.simpleproto2::Bar.23"* %0, %"class.simpleproto2::Bar.23"** %2, align 4
  %3 = load %"class.simpleproto2::Bar.23"*, %"class.simpleproto2::Bar.23"** %2, align 4
  %4 = call x86_thiscallcc %"class.simpleproto2::Bar.23"* @"\01?New@Bar@simpleproto2@@UBEPAV12@PAVArena@protobuf@google@@@Z"(%"class.simpleproto2::Bar.23"* %3, %"class.google::protobuf::Arena"* null)
  ret %"class.simpleproto2::Bar.23"* %4
}

; Function Attrs: noinline optnone
define x86_thiscallcc void @"\01?Clear@Bar@simpleproto2@@UAEXXZ"(%"class.simpleproto2::Bar.23"*) unnamed_addr #0 align 2 {
  %2 = alloca %"class.simpleproto2::Bar.23"*, align 4
  %3 = alloca i32, align 4
  store %"class.simpleproto2::Bar.23"* %0, %"class.simpleproto2::Bar.23"** %2, align 4
  %4 = load %"class.simpleproto2::Bar.23"*, %"class.simpleproto2::Bar.23"** %2, align 4
  store i32 0, i32* %3, align 4
  %5 = call x86_thiscallcc %"class.google::protobuf::Arena"* bitcast (%"class.google::protobuf::Arena"* (%"class.simpleproto2::Bar"*)* @"\01?GetArenaNoVirtual@Bar@simpleproto2@@ABEPAVArena@protobuf@google@@XZ" to %"class.google::protobuf::Arena"* (%"class.simpleproto2::Bar.23"*)*)(%"class.simpleproto2::Bar.23"* %4)
...
; <label>:7:                                      ; preds = %1
  ...
  %9 = load %"class.simpleproto2::Foo.11"*, %"class.simpleproto2::Foo.11"** %8, align 4
...
; <label>:11:                                     ; preds = %7
  ...
  %13 = load %"class.simpleproto2::Foo.11"*, %"class.simpleproto2::Foo.11"** %12, align 4
  %14 = icmp eq %"class.simpleproto2::Foo.11"* %13, null
  br i1 %14, label %21, label %15

; <label>:15:                                     ; preds = %11
  %16 = bitcast %"class.simpleproto2::Foo.11"* %13 to i8* (%"class.simpleproto2::Foo.11"*, i32)***
  %17 = load i8* (%"class.simpleproto2::Foo.11"*, i32)**, i8* (%"class.simpleproto2::Foo.11"*, i32)*** %16, align 4
  %18 = getelementptr inbounds i8* (%"class.simpleproto2::Foo.11"*, i32)*, i8* (%"class.simpleproto2::Foo.11"*, i32)** %17, i64 0
  %19 = load i8* (%"class.simpleproto2::Foo.11"*, i32)*, i8* (%"class.simpleproto2::Foo.11"*, i32)** %18, align 4
  %20 = call x86_thiscallcc i8* %19(%"class.simpleproto2::Foo.11"* %13, i32 1) #10
  br label %21
...
; <label>:22:                                     ; preds = %21, %7, %1
  ...
  store %"class.simpleproto2::Foo.11"* null, %"class.simpleproto2::Foo.11"** %23, align 4
  ...
  %35 = bitcast %"class.google::protobuf::internal::InternalMetadataWithArena"* %34 to %"class.google::protobuf::internal::InternalMetadataWithArenaBase"*
  call x86_thiscallcc void @"\01?Clear@?$InternalMetadataWithArenaBase@V?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@VInternalMetadataWithArenaLite@internal@protobuf@google@@@internal@protobuf@google@@QAEXXZ"(%"class.google::protobuf::internal::InternalMetadataWithArenaBase"* %35)
  ret void
}

; Function Attrs: noinline nounwind optnone
define x86_thiscallcc zeroext i1 @"\01?IsInitialized@Bar@simpleproto2@@UBE_NXZ"(%"class.simpleproto2::Bar.23"*) unnamed_addr #1 align 2 {
  %2 = alloca %"class.simpleproto2::Bar.23"*, align 4
  store %"class.simpleproto2::Bar.23"* %0, %"class.simpleproto2::Bar.23"** %2, align 4
  %3 = load %"class.simpleproto2::Bar.23"*, %"class.simpleproto2::Bar.23"** %2, align 4
  ret i1 true
...
; Function Attrs: noinline optnone
define x86_thiscallcc void @"\01?CheckTypeAndMergeFrom@Bar@simpleproto2@@UAEXABVMessageLite@protobuf@google@@@Z"(%"class.simpleproto2::Bar.23"*, %"class.google::protobuf::MessageLite"* dereferenceable(4)) unnamed_addr #0 align 2 {
  %3 = alloca %"class.google::protobuf::MessageLite"*, align 4
  %4 = alloca %"class.simpleproto2::Bar.23"*, align 4
  store %"class.google::protobuf::MessageLite"* %1, %"class.google::protobuf::MessageLite"** %3, align 4
  store %"class.simpleproto2::Bar.23"* %0, %"class.simpleproto2::Bar.23"** %4, align 4
  %5 = load %"class.simpleproto2::Bar.23"*, %"class.simpleproto2::Bar.23"** %4, align 4
  %6 = load %"class.google::protobuf::MessageLite"*, %"class.google::protobuf::MessageLite"** %3, align 4
  %7 = call %"class.simpleproto2::Bar.23"* @"\01??$down_cast@PBVBar@simpleproto2@@$$CBVMessageLite@protobuf@google@@@internal@protobuf@google@@YAPBVBar@simpleproto2@@PBVMessageLite@12@@Z"(%"class.google::protobuf::MessageLite"* %6)
  call x86_thiscallcc void @"\01?MergeFrom@Bar@simpleproto2@@QAEXABV12@@Z"(%"class.simpleproto2::Bar.23"* %5, %"class.simpleproto2::Bar.23"* dereferenceable(24) %7)
  ret void
}

; Function Attrs: noinline optnone
define x86_thiscallcc zeroext i1 @"\01?MergePartialFromCodedStream@Bar@simpleproto2@@UAE_NPAVCodedInputStream@io@protobuf@google@@@Z"(%"class.simpleproto2::Bar.23"*, %"class.google::protobuf::io::CodedInputStream"*) unnamed_addr #0 align 2 personality i8* bitcast (i32 (...)* @__CxxFrameHandler3 to i8*) {
  %3 = alloca i1, align 1
  %4 = alloca %"class.google::protobuf::io::CodedInputStream"*, align 4
  %5 = alloca %"class.simpleproto2::Bar.23"*, align 4
  %6 = alloca i32, align 4
  ...
  store %"class.google::protobuf::io::CodedInputStream"* %1, %"class.google::protobuf::io::CodedInputStream"** %4, align 4
  store %"class.simpleproto2::Bar.23"* %0, %"class.simpleproto2::Bar.23"** %5, align 4
  %12 = load %"class.simpleproto2::Bar.23"*, %"class.simpleproto2::Bar.23"** %5, align 4
...
; <label>:40:                                     ; preds = %35
  %41 = invoke x86_thiscallcc %"class.simpleproto2::Foo.11"* @"\01?mutable_foo@Bar@simpleproto2@@QAEPAVFoo@2@XZ"(%"class.simpleproto2::Bar.23"* %12)
...
; <label>:96:                                     ; preds = %84, %70, %56, %42, %40, %31, %22
  ...
  call x86_thiscallcc void @"\01??1CodedOutputStream@io@protobuf@google@@QAE@XZ"(%"class.google::protobuf::io::CodedOutputStream"* %9) #10 [ "funclet"(token %97) ]
  cleanupret from %97 unwind label %98

; <label>:98:                                     ; preds = %96, %18
  %99 = cleanuppad within none []
  call x86_thiscallcc void @"\01??1StringOutputStream@io@protobuf@google@@UAE@XZ"(%"class.google::protobuf::io::StringOutputStream"* %8) #10 [ "funclet"(token %99) ]
  cleanupret from %99 unwind label %100

; <label>:100:                                    ; preds = %98, %16, %2
  %101 = cleanuppad within none []
  call x86_thiscallcc void @"\01??1LiteUnknownFieldSetter@internal@protobuf@google@@QAE@XZ"(%"class.google::protobuf::internal::LiteUnknownFieldSetter"* %7) #10 [ "funclet"(token %101) ]
  cleanupret from %101 unwind to caller
}

; Function Attrs: noinline optnone
define x86_thiscallcc i32 @"\01?ByteSizeLong@Bar@simpleproto2@@UBEIXZ"(%"class.simpleproto2::Bar.23"*) #0 align 2 {
  %2 = alloca %"class.simpleproto2::Bar.23"*, align 4
  %3 = alloca i32, align 4
  %4 = alloca i32, align 4
  store %"class.simpleproto2::Bar.23"* %0, %"class.simpleproto2::Bar.23"** %2, align 4
  %5 = load %"class.simpleproto2::Bar.23"*, %"class.simpleproto2::Bar.23"** %2, align 4
  store i32 0, i32* %3, align 4
  %6 = call zeroext i1 @"\01?GetProto3PreserveUnknownsDefault@internal@protobuf@google@@YA_NXZ"()
  br i1 %6, label %7, label %11
...
; <label>:14:                                     ; preds = %11, %7
  ...
  %18 = add i32 %17, %16
  store i32 %18, i32* %3, align 4
  %19 = call x86_thiscallcc zeroext i1 @"\01?has_foo@Bar@simpleproto2@@QBE_NXZ"(%"class.simpleproto2::Bar.23"* %5)
  br i1 %19, label %20, label %28

; <label>:20:                                     ; preds = %14
  %21 = getelementptr inbounds %"class.simpleproto2::Bar.23", %"class.simpleproto2::Bar.23"* %5, i32 0, i32 2
  %22 = load %"class.simpleproto2::Foo.11"*, %"class.simpleproto2::Foo.11"** %21, align 4
...
; <label>:28:                                     ; preds = %20, %14
  %29 = call x86_thiscallcc i32 bitcast (i32 (%"class.simpleproto2::Bar"*)* @"\01?i32@Bar@simpleproto2@@QBEHXZ" to i32 (%"class.simpleproto2::Bar.23"*)*)(%"class.simpleproto2::Bar.23"* %5)
  %30 = icmp ne i32 %29, 0
  br i1 %30, label %31, label %37

; <label>:31:                                     ; preds = %28
  %32 = call x86_thiscallcc i32 bitcast (i32 (%"class.simpleproto2::Bar"*)* @"\01?i32@Bar@simpleproto2@@QBEHXZ" to i32 (%"class.simpleproto2::Bar.23"*)*)(%"class.simpleproto2::Bar.23"* %5)
  %33 = call i32 @"\01?Int32Size@WireFormatLite@internal@protobuf@google@@SAIH@Z"(i32 %32)
  %34 = add i32 1, %33
  %35 = load i32, i32* %3, align 4
  %36 = add i32 %35, %34
...
; <label>:37:                                     ; preds = %31, %28
  %38 = call x86_thiscallcc float @"\01?f@Bar@simpleproto2@@QBEMXZ"(%"class.simpleproto2::Bar.23"* %5)
  %39 = fcmp une float %38, 0.000000e+00
  br i1 %39, label %40, label %43
...
; Function Attrs: noinline optnone
define x86_thiscallcc void @"\01?SerializeWithCachedSizes@Bar@simpleproto2@@UBEXPAVCodedOutputStream@io@protobuf@google@@@Z"(%"class.simpleproto2::Bar.23"*, %"class.google::protobuf::io::CodedOutputStream"*) unnamed_addr #0 align 2 {
  %3 = alloca %"class.google::protobuf::io::CodedOutputStream"*, align 4
  %4 = alloca %"class.simpleproto2::Bar.23"*, align 4
  %5 = alloca i32, align 4
  store %"class.google::protobuf::io::CodedOutputStream"* %1, %"class.google::protobuf::io::CodedOutputStream"** %3, align 4
  ...
  %6 = load %"class.simpleproto2::Bar.23"*, %"class.simpleproto2::Bar.23"** %4, align 4
  store i32 0, i32* %5, align 4
  %7 = call x86_thiscallcc zeroext i1 @"\01?has_foo@Bar@simpleproto2@@QBE_NXZ"(%"class.simpleproto2::Bar.23"* %6)
...
; <label>:8:                                      ; preds = %2
  ...
  %11 = load %"class.simpleproto2::Foo.11"*, %"class.simpleproto2::Foo.11"** %10, align 4
...
; <label>:13:                                     ; preds = %8, %2
  %14 = call x86_thiscallcc i32 bitcast (i32 (%"class.simpleproto2::Bar"*)* @"\01?i32@Bar@simpleproto2@@QBEHXZ" to i32 (%"class.simpleproto2::Bar.23"*)*)(%"class.simpleproto2::Bar.23"* %6)
  %15 = icmp ne i32 %14, 0
  br i1 %15, label %16, label %19

; <label>:16:                                     ; preds = %13
  %17 = load %"class.google::protobuf::io::CodedOutputStream"*, %"class.google::protobuf::io::CodedOutputStream"** %3, align 4
  %18 = call x86_thiscallcc i32 bitcast (i32 (%"class.simpleproto2::Bar"*)* @"\01?i32@Bar@simpleproto2@@QBEHXZ" to i32 (%"class.simpleproto2::Bar.23"*)*)(%"class.simpleproto2::Bar.23"* %6)
...
; <label>:19:                                     ; preds = %16, %13
  %20 = call x86_thiscallcc float @"\01?f@Bar@simpleproto2@@QBEMXZ"(%"class.simpleproto2::Bar.23"* %6)
...
; <label>:22:                                     ; preds = %19
  ...
  %24 = call x86_thiscallcc float @"\01?f@Bar@simpleproto2@@QBEMXZ"(%"class.simpleproto2::Bar.23"* %6)
...
; <label>:35:                                     ; preds = %32, %28
  ...
  %37 = call x86_thiscallcc i32 @"\01?size@?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QBEIXZ"(%"class.std::basic_string"* %36) #10
  %38 = call zeroext i1 @"\01?GetProto3PreserveUnknownsDefault@internal@protobuf@google@@YA_NXZ"()
  br i1 %38, label %39, label %43

; <label>:39:                                     ; preds = %35
  %40 = getelementptr inbounds %"class.simpleproto2::Bar.23", %"class.simpleproto2::Bar.23"* %6, i32 0, i32 1
  ...
  %42 = call x86_thiscallcc dereferenceable(24) %"class.std::basic_string"* @"\01?unknown_fields@?$InternalMetadataWithArenaBase@V?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@VInternalMetadataWithArenaLite@internal@protobuf@google@@@internal@protobuf@google@@QBEABV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@XZ"(%"class.google::protobuf::internal::InternalMetadataWithArenaBase"* %41)
  br label %46

; <label>:43:                                     ; preds = %35
  %44 = getelementptr inbounds %"class.simpleproto2::Bar.23", %"class.simpleproto2::Bar.23"* %6, i32 0, i32 1
...
; <label>:46:                                     ; preds = %43, %39
  ...
  %48 = call x86_thiscallcc i8* @"\01?data@?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QBEPBDXZ"(%"class.std::basic_string"* %47) #10
...
; Function Attrs: noinline nounwind optnone
define linkonce_odr x86_thiscallcc i32 @"\01?GetCachedSize@Bar@simpleproto2@@UBEHXZ"(%"class.simpleproto2::Bar.23"*) unnamed_addr #1 comdat align 2 {
  %2 = alloca %"class.simpleproto2::Bar.23"*, align 4
  store %"class.simpleproto2::Bar.23"* %0, %"class.simpleproto2::Bar.23"** %2, align 4
  %3 = load %"class.simpleproto2::Bar.23"*, %"class.simpleproto2::Bar.23"** %2, align 4
...
; Function Attrs: noinline nounwind optnone
define linkonce_odr x86_thiscallcc zeroext i1 @"\01?has_foo@Bar@simpleproto2@@QBE_NXZ"(%"class.simpleproto2::Bar.23"*) #1 comdat align 2 {
  %2 = alloca %"class.simpleproto2::Bar.23"*, align 4
  store %"class.simpleproto2::Bar.23"* %0, %"class.simpleproto2::Bar.23"** %2, align 4
  %3 = load %"class.simpleproto2::Bar.23"*, %"class.simpleproto2::Bar.23"** %2, align 4
  %4 = call %"class.simpleproto2::Bar.23"* @"\01?internal_default_instance@Bar@simpleproto2@@SAPBV12@XZ"()
...
; <label>:6:                                      ; preds = %1
  ...
  %8 = load %"class.simpleproto2::Foo.11"*, %"class.simpleproto2::Foo.11"** %7, align 4
...
declare void @"\01?WriteMessage@WireFormatLite@internal@protobuf@google@@SAXHABVMessageLite@34@PAVCodedOutputStream@io@34@@Z"(i32, %"class.google::protobuf::MessageLite"* dereferenceable(4), %"class.google::protobuf::io::CodedOutputStream"*) #2

; Function Attrs: noinline nounwind optnone
define linkonce_odr x86_thiscallcc float @"\01?f@Bar@simpleproto2@@QBEMXZ"(%"class.simpleproto2::Bar.23"*) #1 comdat align 2 {
  %2 = alloca %"class.simpleproto2::Bar.23"*, align 4
  store %"class.simpleproto2::Bar.23"* %0, %"class.simpleproto2::Bar.23"** %2, align 4
  %3 = load %"class.simpleproto2::Bar.23"*, %"class.simpleproto2::Bar.23"** %2, align 4
...
; Function Attrs: noinline optnone
define linkonce_odr x86_thiscallcc %"class.simpleproto2::Foo.11"* @"\01?mutable_foo@Bar@simpleproto2@@QAEPAVFoo@2@XZ"(%"class.simpleproto2::Bar.23"*) #0 comdat align 2 personality i8* bitcast (i32 (...)* @__CxxFrameHandler3 to i8*) {
  %2 = alloca %"class.simpleproto2::Bar.23"*, align 4
  store %"class.simpleproto2::Bar.23"* %0, %"class.simpleproto2::Bar.23"** %2, align 4
  %3 = load %"class.simpleproto2::Bar.23"*, %"class.simpleproto2::Bar.23"** %2, align 4
  %4 = getelementptr inbounds %"class.simpleproto2::Bar.23", %"class.simpleproto2::Bar.23"* %3, i32 0, i32 2
...
; <label>:7:                                      ; preds = %1
  %8 = call i8* @"\01??2@YAPAXI@Z"(i32 24) #11
  %9 = bitcast i8* %8 to %"class.simpleproto2::Foo.11"*
  %10 = invoke x86_thiscallcc %"class.simpleproto2::Foo.11"* @"\01??0Foo@simpleproto2@@QAE@XZ"(%"class.simpleproto2::Foo.11"* %9)
          to label %11 unwind label %13

; <label>:11:                                     ; preds = %7
  %12 = getelementptr inbounds %"class.simpleproto2::Bar.23", %"class.simpleproto2::Bar.23"* %3, i32 0, i32 2
  store %"class.simpleproto2::Foo.11"* %9, %"class.simpleproto2::Foo.11"** %12, align 4
  br label %15

; <label>:13:                                     ; preds = %7
  %14 = cleanuppad within none []
  call void @"\01??3@YAXPAX@Z"(i8* %8) #12 [ "funclet"(token %14) ]
...
; <label>:15:                                     ; preds = %11, %1
  ...
  %17 = load %"class.simpleproto2::Foo.11"*, %"class.simpleproto2::Foo.11"** %16, align 4
...
; <label>:11:                                     ; preds = %2
  ...
  call x86_thiscallcc void @"\01?IncrementRecursionDepthAndPushLimit@CodedInputStream@io@protobuf@google@@QAE?AU?$pair@HH@std@@H@Z"(%"class.google::protobuf::io::CodedInputStream"* %12, %"struct.std::pair.44"* sret %7, i32 %13)
...
declare x86_thiscallcc void @"\01?IncrementRecursionDepthAndPushLimit@CodedInputStream@io@protobuf@google@@QAE?AU?$pair@HH@std@@H@Z"(%"class.google::protobuf::io::CodedInputStream"*, %"struct.std::pair.44"* sret, i32) #2
...
; Function Attrs: noinline optnone
define linkonce_odr %"class.simpleproto2::Bar.23"* @"\01??$down_cast@PBVBar@simpleproto2@@$$CBVMessageLite@protobuf@google@@@internal@protobuf@google@@YAPBVBar@simpleproto2@@PBVMessageLite@12@@Z"(%"class.google::protobuf::MessageLite"*) #0 comdat {
  %2 = alloca %"class.google::protobuf::MessageLite"*, align 4
  store %"class.google::protobuf::MessageLite"* %0, %"class.google::protobuf::MessageLite"** %2, align 4
  %3 = load %"class.google::protobuf::MessageLite"*, %"class.google::protobuf::MessageLite"** %2, align 4
  %4 = icmp eq %"class.google::protobuf::MessageLite"* %3, null
...
; Function Attrs: noinline optnone
define x86_thiscallcc void @"\01?MergeFrom@Bar@simpleproto2@@QAEXABV12@@Z"(%"class.simpleproto2::Bar.23"*, %"class.simpleproto2::Bar.23"* dereferenceable(24)) #0 align 2 personality i8* bitcast (i32 (...)* @__CxxFrameHandler3 to i8*) {
  %3 = alloca %"class.simpleproto2::Bar.23"*, align 4
  %4 = alloca %"class.simpleproto2::Bar.23"*, align 4
  %5 = alloca %"class.google::protobuf::internal::LogMessage", align 4
  %6 = alloca i1, align 1
  %7 = alloca %"class.std::allocator", align 1
  %8 = alloca i32, align 4
  store %"class.simpleproto2::Bar.23"* %1, %"class.simpleproto2::Bar.23"** %3, align 4
  store %"class.simpleproto2::Bar.23"* %0, %"class.simpleproto2::Bar.23"** %4, align 4
  %9 = load %"class.simpleproto2::Bar.23"*, %"class.simpleproto2::Bar.23"** %4, align 4
  %10 = load %"class.simpleproto2::Bar.23"*, %"class.simpleproto2::Bar.23"** %3, align 4
...
; <label>:13:                                     ; preds = %2
  %14 = call x86_thiscallcc %"class.google::protobuf::internal::LogMessage"* @"\01??0LogMessage@internal@protobuf@google@@QAE@W4LogLevel@23@PBDH@Z"(%"class.google::protobuf::internal::LogMessage"* %5, i32 3, i8* getelementptr inbounds ([78 x i8], [78 x i8]* @"\01??_C@_0EO@CHGOICEJ@E?3?2work?2local?2private?9contract?9s@", i32 0, i32 0), i32 583)
  store i1 true, i1* %6, align 1
...
; <label>:21:                                     ; preds = %20, %18
  ...
  %24 = load %"class.simpleproto2::Bar.23"*, %"class.simpleproto2::Bar.23"** %3, align 4
  ...
  store i32 0, i32* %8, align 4
  %26 = load %"class.simpleproto2::Bar.23"*, %"class.simpleproto2::Bar.23"** %3, align 4
  %27 = call x86_thiscallcc zeroext i1 @"\01?has_foo@Bar@simpleproto2@@QBE_NXZ"(%"class.simpleproto2::Bar.23"* %26)
  br i1 %27, label %28, label %37

; <label>:28:                                     ; preds = %21
  %29 = call x86_thiscallcc %"class.simpleproto2::Foo.11"* @"\01?mutable_foo@Bar@simpleproto2@@QAEPAVFoo@2@XZ"(%"class.simpleproto2::Bar.23"* %9)
  %30 = load %"class.simpleproto2::Bar.23"*, %"class.simpleproto2::Bar.23"** %3, align 4
  %31 = call x86_thiscallcc dereferenceable(24) %"class.simpleproto2::Foo.11"* bitcast (%"class.simpleproto2::Foo"* (%"class.simpleproto2::Bar"*)* @"\01?foo@Bar@simpleproto2@@QBEABVFoo@2@XZ" to %"class.simpleproto2::Foo.11"* (%"class.simpleproto2::Bar.23"*)*)(%"class.simpleproto2::Bar.23"* %30)
  call x86_thiscallcc void @"\01?MergeFrom@Foo@simpleproto2@@QAEXABV12@@Z"(%"class.simpleproto2::Foo.11"* %29, %"class.simpleproto2::Foo.11"* dereferenceable(24) %31)
  br label %37
...
; <label>:37:                                     ; preds = %28, %21
  %38 = load %"class.simpleproto2::Bar.23"*, %"class.simpleproto2::Bar.23"** %3, align 4
  %39 = call x86_thiscallcc i32 bitcast (i32 (%"class.simpleproto2::Bar"*)* @"\01?i32@Bar@simpleproto2@@QBEHXZ" to i32 (%"class.simpleproto2::Bar.23"*)*)(%"class.simpleproto2::Bar.23"* %38)
  %40 = icmp ne i32 %39, 0
  br i1 %40, label %41, label %44

; <label>:41:                                     ; preds = %37
  %42 = load %"class.simpleproto2::Bar.23"*, %"class.simpleproto2::Bar.23"** %3, align 4
  %43 = call x86_thiscallcc i32 bitcast (i32 (%"class.simpleproto2::Bar"*)* @"\01?i32@Bar@simpleproto2@@QBEHXZ" to i32 (%"class.simpleproto2::Bar.23"*)*)(%"class.simpleproto2::Bar.23"* %42)
  call x86_thiscallcc void bitcast (void (%"class.simpleproto2::Bar"*, i32)* @"\01?set_i32@Bar@simpleproto2@@QAEXH@Z" to void (%"class.simpleproto2::Bar.23"*, i32)*)(%"class.simpleproto2::Bar.23"* %9, i32 %43)
  br label %44

; <label>:44:                                     ; preds = %41, %37
  %45 = load %"class.simpleproto2::Bar.23"*, %"class.simpleproto2::Bar.23"** %3, align 4
  %46 = call x86_thiscallcc float @"\01?f@Bar@simpleproto2@@QBEMXZ"(%"class.simpleproto2::Bar.23"* %45)
  %47 = fcmp une float %46, 0.000000e+00
  br i1 %47, label %48, label %51

; <label>:48:                                     ; preds = %44
  %49 = load %"class.simpleproto2::Bar.23"*, %"class.simpleproto2::Bar.23"** %3, align 4
  %50 = call x86_thiscallcc float @"\01?f@Bar@simpleproto2@@QBEMXZ"(%"class.simpleproto2::Bar.23"* %49)
  call x86_thiscallcc void @"\01?set_f@Bar@simpleproto2@@QAEXM@Z"(%"class.simpleproto2::Bar.23"* %9, float %50)
  br label %51
...
; Function Attrs: noinline nounwind optnone
define linkonce_odr x86_thiscallcc void @"\01?set_f@Bar@simpleproto2@@QAEXM@Z"(%"class.simpleproto2::Bar.23"*, float) #1 comdat align 2 {
  %3 = alloca float, align 4
  %4 = alloca %"class.simpleproto2::Bar.23"*, align 4
  store float %1, float* %3, align 4
  store %"class.simpleproto2::Bar.23"* %0, %"class.simpleproto2::Bar.23"** %4, align 4
...
; Function Attrs: noinline optnone
define linkonce_odr x86_thiscallcc void @"\01??$Own@VBar@simpleproto2@@@Arena@protobuf@google@@QAEXPAVBar@simpleproto2@@@Z"(%"class.google::protobuf::Arena"*, %"class.simpleproto2::Bar.23"*) #0 comdat align 2 {
  %3 = alloca %"class.simpleproto2::Bar.23"*, align 4
  %4 = alloca %"class.google::protobuf::Arena"*, align 4
  %5 = alloca %"class.std::allocator", align 4
  %6 = alloca %"class.std::allocator", align 1
  ...
  %7 = load %"class.google::protobuf::Arena"*, %"class.google::protobuf::Arena"** %4, align 4
  %8 = bitcast %"class.std::allocator"* %6 to %"class.std::allocator"*
  %9 = load %"class.simpleproto2::Bar.23"*, %"class.simpleproto2::Bar.23"** %3, align 4
  call x86_thiscallcc void @"\01??$OwnInternal@VBar@simpleproto2@@@Arena@protobuf@google@@AAEXPAVBar@simpleproto2@@U?$integral_constant@_N$0A@@internal@12@@Z"(%"class.google::protobuf::Arena"* %7, %"class.simpleproto2::Bar.23"* %9, %"class.std::allocator"* byval align 4 %5)
  ret void
}

; Function Attrs: noinline optnone
define linkonce_odr x86_thiscallcc void @"\01??$OwnInternal@VBar@simpleproto2@@@Arena@protobuf@google@@AAEXPAVBar@simpleproto2@@U?$integral_constant@_N$0A@@internal@12@@Z"(%"class.google::protobuf::Arena"*, %"class.simpleproto2::Bar.23"*, %"class.std::allocator"* byval align 4) #0 comdat align 2 {
  %4 = alloca %"class.simpleproto2::Bar.23"*, align 4
  %5 = alloca %"class.google::protobuf::Arena"*, align 4
  store %"class.simpleproto2::Bar.23"* %1, %"class.simpleproto2::Bar.23"** %4, align 4
  store %"class.google::protobuf::Arena"* %0, %"class.google::protobuf::Arena"** %5, align 4
  %6 = load %"class.google::protobuf::Arena"*, %"class.google::protobuf::Arena"** %5, align 4
  %7 = load %"class.simpleproto2::Bar.23"*, %"class.simpleproto2::Bar.23"** %4, align 4
  %8 = icmp ne %"class.simpleproto2::Bar.23"* %7, null
  br i1 %8, label %9, label %13

; <label>:9:                                      ; preds = %3
  %10 = getelementptr inbounds %"class.google::protobuf::Arena", %"class.google::protobuf::Arena"* %6, i32 0, i32 0
  %11 = load %"class.simpleproto2::Bar.23"*, %"class.simpleproto2::Bar.23"** %4, align 4
  %12 = bitcast %"class.simpleproto2::Bar.23"* %11 to i8*
  call x86_thiscallcc void @"\01?AddCleanup@ArenaImpl@internal@protobuf@google@@QAEXPAXP6AX0@Z@Z"(%"class.google::protobuf::internal::ArenaImpl"* %10, i8* %12, void (i8*)* @"\01??$arena_delete_object@VBar@simpleproto2@@@internal@protobuf@google@@YAXPAX@Z")
  br label %13
...
; Function Attrs: noinline nounwind optnone
define linkonce_odr void @"\01??$arena_delete_object@VBar@simpleproto2@@@internal@protobuf@google@@YAXPAX@Z"(i8*) #1 comdat {
  %2 = alloca i8*, align 4
  store i8* %0, i8** %2, align 4
  %3 = load i8*, i8** %2, align 4
...
; <label>:6:                                      ; preds = %1
  ...
  %8 = load i8* (%"class.simpleproto2::Bar.23"*, i32)**, i8* (%"class.simpleproto2::Bar.23"*, i32)*** %7, align 4
  %9 = getelementptr inbounds i8* (%"class.simpleproto2::Bar.23"*, i32)*, i8* (%"class.simpleproto2::Bar.23"*, i32)** %8, i64 0
  %10 = load i8* (%"class.simpleproto2::Bar.23"*, i32)*, i8* (%"class.simpleproto2::Bar.23"*, i32)** %9, align 4
  %11 = call x86_thiscallcc i8* %10(%"class.simpleproto2::Bar.23"* %4, i32 1) #10
  br label %12
...
; Function Attrs: noinline nounwind optnone
define x86_thiscallcc void @"\01??1Bar@simpleproto2@@UAE@XZ"(%"class.simpleproto2::Bar.23"*) unnamed_addr #1 align 2 personality i8* bitcast (i32 (...)* @__CxxFrameHandler3 to i8*) {
  %2 = alloca %"class.simpleproto2::Bar.23"*, align 4
  store %"class.simpleproto2::Bar.23"* %0, %"class.simpleproto2::Bar.23"** %2, align 4
  %3 = load %"class.simpleproto2::Bar.23"*, %"class.simpleproto2::Bar.23"** %2, align 4
  %4 = bitcast %"class.simpleproto2::Bar.23"* %3 to i32 (...)***
  store i32 (...)** bitcast (i8** @"\01??_7Bar@simpleproto2@@6B@" to i32 (...)**), i32 (...)*** %4, align 4
  invoke x86_thiscallcc void @"\01?SharedDtor@Bar@simpleproto2@@AAEXXZ"(%"class.simpleproto2::Bar.23"* %3)
          to label %5 unwind label %8
...
; Function Attrs: noinline optnone
define x86_thiscallcc void @"\01?SharedDtor@Bar@simpleproto2@@AAEXXZ"(%"class.simpleproto2::Bar.23"*) #0 align 2 {
  %2 = alloca %"class.simpleproto2::Bar.23"*, align 4
  store %"class.simpleproto2::Bar.23"* %0, %"class.simpleproto2::Bar.23"** %2, align 4
  %3 = load %"class.simpleproto2::Bar.23"*, %"class.simpleproto2::Bar.23"** %2, align 4
  %4 = call %"class.simpleproto2::Bar.23"* @"\01?internal_default_instance@Bar@simpleproto2@@SAPBV12@XZ"()
...
; <label>:10:                                     ; preds = %6
  ...
  %12 = load i8* (%"class.simpleproto2::Foo.11"*, i32)**, i8* (%"class.simpleproto2::Foo.11"*, i32)*** %11, align 4
  %13 = getelementptr inbounds i8* (%"class.simpleproto2::Foo.11"*, i32)*, i8* (%"class.simpleproto2::Foo.11"*, i32)** %12, i64 0
  %14 = load i8* (%"class.simpleproto2::Foo.11"*, i32)*, i8* (%"class.simpleproto2::Foo.11"*, i32)** %13, align 4
  %15 = call x86_thiscallcc i8* %14(%"class.simpleproto2::Foo.11"* %8, i32 1) #10
  br label %16
...
; Function Attrs: noinline optnone
define x86_thiscallcc %"class.simpleproto2::Foo.11"* @"\01??0Foo@simpleproto2@@QAE@ABV01@@Z"(%"class.simpleproto2::Foo.11"* returned, %"class.simpleproto2::Foo.11"* dereferenceable(24)) unnamed_addr #0 align 2 personality i8* bitcast (i32 (...)* @__CxxFrameHandler3 to i8*) {
  %3 = alloca %"class.simpleproto2::Foo.11"*, align 4
  %4 = alloca %"class.simpleproto2::Foo.11"*, align 4
  %5 = alloca %"class.simpleproto2::Foo.11"*, align 4
  %6 = alloca %"struct.google::protobuf::internal::ArenaStringPtr", align 4
  store %"class.simpleproto2::Foo.11"* %1, %"class.simpleproto2::Foo.11"** %4, align 4
  store %"class.simpleproto2::Foo.11"* %0, %"class.simpleproto2::Foo.11"** %5, align 4
  %7 = load %"class.simpleproto2::Foo.11"*, %"class.simpleproto2::Foo.11"** %5, align 4
  store %"class.simpleproto2::Foo.11"* %7, %"class.simpleproto2::Foo.11"** %3, align 4
...
; <label>:13:                                     ; preds = %2
  ...
  %18 = load %"class.simpleproto2::Foo.11"*, %"class.simpleproto2::Foo.11"** %4, align 4
...
; <label>:24:                                     ; preds = %23
  %25 = load %"class.simpleproto2::Foo.11"*, %"class.simpleproto2::Foo.11"** %4, align 4
  %26 = invoke x86_thiscallcc dereferenceable(24) %"class.std::basic_string"* @"\01?s@Foo@simpleproto2@@QBEABV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@XZ"(%"class.simpleproto2::Foo.11"* %25)
          to label %27 unwind label %56

; <label>:27:                                     ; preds = %24
  %28 = call x86_thiscallcc i32 @"\01?size@?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QBEIXZ"(%"class.std::basic_string"* %26) #10
  %29 = icmp ugt i32 %28, 0
  br i1 %29, label %30, label %41

; <label>:30:                                     ; preds = %27
  %31 = getelementptr inbounds %"class.simpleproto2::Foo.11", %"class.simpleproto2::Foo.11"* %7, i32 0, i32 2
  %32 = load %"class.simpleproto2::Foo.11"*, %"class.simpleproto2::Foo.11"** %4, align 4
...
; <label>:41:                                     ; preds = %40, %27
  %42 = getelementptr inbounds %"class.simpleproto2::Foo.11", %"class.simpleproto2::Foo.11"* %7, i32 0, i32 3
  %43 = bitcast i32* %42 to i8*
  %44 = load %"class.simpleproto2::Foo.11"*, %"class.simpleproto2::Foo.11"** %4, align 4
  %45 = getelementptr inbounds %"class.simpleproto2::Foo.11", %"class.simpleproto2::Foo.11"* %44, i32 0, i32 3
  %46 = bitcast i32* %45 to i8*
  %47 = getelementptr inbounds %"class.simpleproto2::Foo.11", %"class.simpleproto2::Foo.11"* %7, i32 0, i32 4
  %48 = bitcast float* %47 to i8*
  %49 = getelementptr inbounds %"class.simpleproto2::Foo.11", %"class.simpleproto2::Foo.11"* %7, i32 0, i32 3
  ...
  %55 = load %"class.simpleproto2::Foo.11"*, %"class.simpleproto2::Foo.11"** %3, align 4
  ret %"class.simpleproto2::Foo.11"* %55

; <label>:56:                                     ; preds = %37, %30, %24, %23, %20, %13
  %57 = cleanuppad within none []
  call x86_thiscallcc void @"\01??1InternalMetadataWithArenaLite@internal@protobuf@google@@QAE@XZ"(%"class.google::protobuf::internal::InternalMetadataWithArena"* %11) #10 [ "funclet"(token %57) ]
  cleanupret from %57 unwind label %58

; <label>:58:                                     ; preds = %56, %2
  %59 = cleanuppad within none []
  %60 = bitcast %"class.simpleproto2::Foo.11"* %7 to %"class.google::protobuf::MessageLite"*
  call x86_thiscallcc void @"\01??1MessageLite@protobuf@google@@UAE@XZ"(%"class.google::protobuf::MessageLite"* %60) #10 [ "funclet"(token %59) ]
  cleanupret from %59 unwind to caller
}

; Function Attrs: noinline nounwind optnone
define x86_thiscallcc void @"\01?SetCachedSize@Foo@simpleproto2@@ABEXH@Z"(%"class.simpleproto2::Foo.11"*, i32) #1 align 2 {
  %3 = alloca i32, align 4
  %4 = alloca %"class.simpleproto2::Foo.11"*, align 4
  store i32 %1, i32* %3, align 4
  store %"class.simpleproto2::Foo.11"* %0, %"class.simpleproto2::Foo.11"** %4, align 4
...
; Function Attrs: noinline optnone
define dereferenceable(24) %"class.simpleproto2::Foo.11"* @"\01?default_instance@Foo@simpleproto2@@SAABV12@XZ"() #0 align 2 {
  call void @"\01?InitDefaultsFoo@protobuf_SimpleProtoLite2_2eproto@@YAXXZ"()
  %1 = call %"class.simpleproto2::Foo.11"* @"\01?internal_default_instance@Foo@simpleproto2@@SAPBV12@XZ"()
...
; Function Attrs: noinline optnone
define x86_thiscallcc void @"\01?CopyFrom@Foo@simpleproto2@@QAEXABV12@@Z"(%"class.simpleproto2::Foo.11"*, %"class.simpleproto2::Foo.11"* dereferenceable(24)) #0 align 2 {
  %3 = alloca %"class.simpleproto2::Foo.11"*, align 4
  %4 = alloca %"class.simpleproto2::Foo.11"*, align 4
  store %"class.simpleproto2::Foo.11"* %1, %"class.simpleproto2::Foo.11"** %3, align 4
  store %"class.simpleproto2::Foo.11"* %0, %"class.simpleproto2::Foo.11"** %4, align 4
  %5 = load %"class.simpleproto2::Foo.11"*, %"class.simpleproto2::Foo.11"** %4, align 4
  %6 = load %"class.simpleproto2::Foo.11"*, %"class.simpleproto2::Foo.11"** %3, align 4
...
; <label>:9:                                      ; preds = %2
  call x86_thiscallcc void @"\01?Clear@Foo@simpleproto2@@UAEXXZ"(%"class.simpleproto2::Foo.11"* %5)
  %10 = load %"class.simpleproto2::Foo.11"*, %"class.simpleproto2::Foo.11"** %3, align 4
  call x86_thiscallcc void @"\01?MergeFrom@Foo@simpleproto2@@QAEXABV12@@Z"(%"class.simpleproto2::Foo.11"* %5, %"class.simpleproto2::Foo.11"* dereferenceable(24) %10)
  br label %11
...
; Function Attrs: noinline optnone
define x86_thiscallcc void @"\01?Swap@Foo@simpleproto2@@QAEXPAV12@@Z"(%"class.simpleproto2::Foo.11"*, %"class.simpleproto2::Foo.11"*) #0 align 2 {
  %3 = alloca %"class.simpleproto2::Foo.11"*, align 4
  %4 = alloca %"class.simpleproto2::Foo.11"*, align 4
  store %"class.simpleproto2::Foo.11"* %1, %"class.simpleproto2::Foo.11"** %3, align 4
  store %"class.simpleproto2::Foo.11"* %0, %"class.simpleproto2::Foo.11"** %4, align 4
...
; <label>:9:                                      ; preds = %2
  %10 = load %"class.simpleproto2::Foo.11"*, %"class.simpleproto2::Foo.11"** %3, align 4
  call x86_thiscallcc void @"\01?InternalSwap@Foo@simpleproto2@@AAEXPAV12@@Z"(%"class.simpleproto2::Foo.11"* %5, %"class.simpleproto2::Foo.11"* %10)
  br label %11
...
; Function Attrs: noinline optnone
define x86_thiscallcc void @"\01?InternalSwap@Foo@simpleproto2@@AAEXPAV12@@Z"(%"class.simpleproto2::Foo.11"*, %"class.simpleproto2::Foo.11"*) #0 align 2 {
  %3 = alloca %"class.simpleproto2::Foo.11"*, align 4
  %4 = alloca %"class.simpleproto2::Foo.11"*, align 4
  store %"class.simpleproto2::Foo.11"* %1, %"class.simpleproto2::Foo.11"** %3, align 4
  store %"class.simpleproto2::Foo.11"* %0, %"class.simpleproto2::Foo.11"** %4, align 4
  ...
  %7 = load %"class.simpleproto2::Foo.11"*, %"class.simpleproto2::Foo.11"** %3, align 4
  ...
  %12 = load %"class.simpleproto2::Foo.11"*, %"class.simpleproto2::Foo.11"** %3, align 4
  ...
  call void @"\01??$swap@MX@std@@YAXAAM0@Z"(float* dereferenceable(4) %14, float* dereferenceable(4) %13) #10
  ...
  %17 = load %"class.simpleproto2::Foo.11"*, %"class.simpleproto2::Foo.11"** %3, align 4
  ...
  %19 = load %"class.simpleproto2::Foo.11"*, %"class.simpleproto2::Foo.11"** %3, align 4
  ...
  call void @"\01??$swap@HX@std@@YAXAAH0@Z"(i32* dereferenceable(4) %21, i32* dereferenceable(4) %20) #10
  ret void
}
...
define linkonce_odr x86_thiscallcc void @"\01?Swap@ArenaStringPtr@internal@protobuf@google@@QAEXPAU1234@@Z"(%"struct.google::protobuf::internal::ArenaStringPtr"*, %"struct.google::protobuf::internal::ArenaStringPtr"*) #1 comdat align 2 {
  ...
  call void @"\01??$swap@PAV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@X@std@@YAXAAPAV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@0@0@Z"(%"class.std::basic_string"** dereferenceable(4) %8, %"class.std::basic_string"** dereferenceable(4) %7) #10
  ret void
}
...
define linkonce_odr void @"\01??$swap@MX@std@@YAXAAM0@Z"(float* dereferenceable(4), float* dereferenceable(4)) #1 comdat {
  ...
  %7 = call dereferenceable(4) float* @"\01??$move@AAM@std@@YA$$QAMAAM@Z"(float* dereferenceable(4) %6) #10
  %8 = load float, float* %7, align 4
  store float %8, float* %5, align 4
  %9 = load float*, float** %3, align 4
  %10 = call dereferenceable(4) float* @"\01??$move@AAM@std@@YA$$QAMAAM@Z"(float* dereferenceable(4) %9) #10
  %11 = load float, float* %10, align 4
  %12 = load float*, float** %4, align 4
  store float %11, float* %12, align 4
  %13 = call dereferenceable(4) float* @"\01??$move@AAM@std@@YA$$QAMAAM@Z"(float* dereferenceable(4) %5) #10
...
define linkonce_odr void @"\01??$swap@PAV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@X@std@@YAXAAPAV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@0@0@Z"(%"class.std::basic_string"** dereferenceable(4), %"class.std::basic_string"** dereferenceable(4)) #1 comdat {
  ...
  store %"class.std::basic_string"** %0, %"class.std::basic_string"*** %4, align 4
  %6 = load %"class.std::basic_string"**, %"class.std::basic_string"*** %4, align 4
  %7 = call dereferenceable(4) %"class.std::basic_string"** @"\01??$move@AAPAV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@@std@@YA$$QAPAV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@0@AAPAV10@@Z"(%"class.std::basic_string"** dereferenceable(4) %6) #10
  %8 = load %"class.std::basic_string"*, %"class.std::basic_string"** %7, align 4
  store %"class.std::basic_string"* %8, %"class.std::basic_string"** %5, align 4
  %9 = load %"class.std::basic_string"**, %"class.std::basic_string"*** %3, align 4
  %10 = call dereferenceable(4) %"class.std::basic_string"** @"\01??$move@AAPAV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@@std@@YA$$QAPAV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@0@AAPAV10@@Z"(%"class.std::basic_string"** dereferenceable(4) %9) #10
  ...
  %13 = call dereferenceable(4) %"class.std::basic_string"** @"\01??$move@AAPAV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@@std@@YA$$QAPAV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@0@AAPAV10@@Z"(%"class.std::basic_string"** dereferenceable(4) %5) #10
  %14 = load %"class.std::basic_string"*, %"class.std::basic_string"** %13, align 4
  %15 = load %"class.std::basic_string"**, %"class.std::basic_string"*** %3, align 4
...
; Function Attrs: noinline optnone
define x86_thiscallcc %"class.simpleproto2::Bar.23"* @"\01??0Bar@simpleproto2@@QAE@ABV01@@Z"(%"class.simpleproto2::Bar.23"* returned, %"class.simpleproto2::Bar.23"* dereferenceable(24)) unnamed_addr #0 align 2 personality i8* bitcast (i32 (...)* @__CxxFrameHandler3 to i8*) {
  %3 = alloca %"class.simpleproto2::Bar.23"*, align 4
  %4 = alloca %"class.simpleproto2::Bar.23"*, align 4
  %5 = alloca %"class.simpleproto2::Bar.23"*, align 4
  store %"class.simpleproto2::Bar.23"* %1, %"class.simpleproto2::Bar.23"** %4, align 4
  store %"class.simpleproto2::Bar.23"* %0, %"class.simpleproto2::Bar.23"** %5, align 4
  %6 = load %"class.simpleproto2::Bar.23"*, %"class.simpleproto2::Bar.23"** %5, align 4
  store %"class.simpleproto2::Bar.23"* %6, %"class.simpleproto2::Bar.23"** %3, align 4
...
; <label>:12:                                     ; preds = %2
  ...
  %16 = load %"class.simpleproto2::Bar.23"*, %"class.simpleproto2::Bar.23"** %4, align 4
  %17 = getelementptr inbounds %"class.simpleproto2::Bar.23", %"class.simpleproto2::Bar.23"* %16, i32 0, i32 1
  invoke x86_thiscallcc void @"\01?MergeFrom@?$InternalMetadataWithArenaBase@V?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@VInternalMetadataWithArenaLite@internal@protobuf@google@@@internal@protobuf@google@@QAEXABVInternalMetadataWithArenaLite@234@@Z"(%"class.google::protobuf::internal::InternalMetadataWithArenaBase"* %15, %"class.google::protobuf::internal::InternalMetadataWithArena"* dereferenceable(4) %17)
          to label %18 unwind label %51

; <label>:18:                                     ; preds = %12
  %19 = load %"class.simpleproto2::Bar.23"*, %"class.simpleproto2::Bar.23"** %4, align 4
  %20 = invoke x86_thiscallcc zeroext i1 @"\01?has_foo@Bar@simpleproto2@@QBE_NXZ"(%"class.simpleproto2::Bar.23"* %19)
...
; <label>:22:                                     ; preds = %21
  %23 = invoke i8* @"\01??2@YAPAXI@Z"(i32 24) #11
          to label %24 unwind label %51

; <label>:24:                                     ; preds = %22
  %25 = bitcast i8* %23 to %"class.simpleproto2::Foo.11"*
  %26 = load %"class.simpleproto2::Bar.23"*, %"class.simpleproto2::Bar.23"** %4, align 4
  %27 = getelementptr inbounds %"class.simpleproto2::Bar.23", %"class.simpleproto2::Bar.23"* %26, i32 0, i32 2
  %28 = load %"class.simpleproto2::Foo.11"*, %"class.simpleproto2::Foo.11"** %27, align 4
  %29 = invoke x86_thiscallcc %"class.simpleproto2::Foo.11"* @"\01??0Foo@simpleproto2@@QAE@ABV01@@Z"(%"class.simpleproto2::Foo.11"* %25, %"class.simpleproto2::Foo.11"* dereferenceable(24) %28)
          to label %30 unwind label %32

; <label>:30:                                     ; preds = %24
  %31 = getelementptr inbounds %"class.simpleproto2::Bar.23", %"class.simpleproto2::Bar.23"* %6, i32 0, i32 2
  store %"class.simpleproto2::Foo.11"* %25, %"class.simpleproto2::Foo.11"** %31, align 4
  br label %36

; <label>:32:                                     ; preds = %24
  %33 = cleanuppad within none []
  call void @"\01??3@YAXPAX@Z"(i8* %23) #12 [ "funclet"(token %33) ]
...
; <label>:34:                                     ; preds = %21
  ...
  store %"class.simpleproto2::Foo.11"* null, %"class.simpleproto2::Foo.11"** %35, align 4
  br label %36

; <label>:36:                                     ; preds = %34, %30
  %37 = getelementptr inbounds %"class.simpleproto2::Bar.23", %"class.simpleproto2::Bar.23"* %6, i32 0, i32 3
  %38 = bitcast i32* %37 to i8*
  %39 = load %"class.simpleproto2::Bar.23"*, %"class.simpleproto2::Bar.23"** %4, align 4
  ...
  %50 = load %"class.simpleproto2::Bar.23"*, %"class.simpleproto2::Bar.23"** %3, align 4
  ret %"class.simpleproto2::Bar.23"* %50

; <label>:51:                                     ; preds = %32, %22, %18, %12
  %52 = cleanuppad within none []
  call x86_thiscallcc void @"\01??1InternalMetadataWithArenaLite@internal@protobuf@google@@QAE@XZ"(%"class.google::protobuf::internal::InternalMetadataWithArena"* %10) #10 [ "funclet"(token %52) ]
...
; <label>:53:                                     ; preds = %51, %2
  ...
  call x86_thiscallcc void @"\01??1MessageLite@protobuf@google@@UAE@XZ"(%"class.google::protobuf::MessageLite"* %55) #10 [ "funclet"(token %54) ]
  cleanupret from %54 unwind to caller
}

; Function Attrs: noinline nounwind optnone
define x86_thiscallcc void @"\01?SetCachedSize@Bar@simpleproto2@@ABEXH@Z"(%"class.simpleproto2::Bar.23"*, i32) #1 align 2 {
  %3 = alloca i32, align 4
  %4 = alloca %"class.simpleproto2::Bar.23"*, align 4
  store i32 %1, i32* %3, align 4
  store %"class.simpleproto2::Bar.23"* %0, %"class.simpleproto2::Bar.23"** %4, align 4
...
; Function Attrs: noinline optnone
define dereferenceable(24) %"class.simpleproto2::Bar.23"* @"\01?default_instance@Bar@simpleproto2@@SAABV12@XZ"() #0 align 2 {
  call void @"\01?InitDefaultsBar@protobuf_SimpleProtoLite2_2eproto@@YAXXZ"()
  %1 = call %"class.simpleproto2::Bar.23"* @"\01?internal_default_instance@Bar@simpleproto2@@SAPBV12@XZ"()
  ret %"class.simpleproto2::Bar.23"* %1
}

; Function Attrs: noinline optnone
define x86_thiscallcc void @"\01?CopyFrom@Bar@simpleproto2@@QAEXABV12@@Z"(%"class.simpleproto2::Bar.23"*, %"class.simpleproto2::Bar.23"* dereferenceable(24)) #0 align 2 {
  %3 = alloca %"class.simpleproto2::Bar.23"*, align 4
  %4 = alloca %"class.simpleproto2::Bar.23"*, align 4
  store %"class.simpleproto2::Bar.23"* %1, %"class.simpleproto2::Bar.23"** %3, align 4
  store %"class.simpleproto2::Bar.23"* %0, %"class.simpleproto2::Bar.23"** %4, align 4
  %5 = load %"class.simpleproto2::Bar.23"*, %"class.simpleproto2::Bar.23"** %4, align 4
  %6 = load %"class.simpleproto2::Bar.23"*, %"class.simpleproto2::Bar.23"** %3, align 4
...
; <label>:9:                                      ; preds = %2
  call x86_thiscallcc void @"\01?Clear@Bar@simpleproto2@@UAEXXZ"(%"class.simpleproto2::Bar.23"* %5)
  %10 = load %"class.simpleproto2::Bar.23"*, %"class.simpleproto2::Bar.23"** %3, align 4
  call x86_thiscallcc void @"\01?MergeFrom@Bar@simpleproto2@@QAEXABV12@@Z"(%"class.simpleproto2::Bar.23"* %5, %"class.simpleproto2::Bar.23"* dereferenceable(24) %10)
  br label %11
...
; Function Attrs: noinline optnone
define x86_thiscallcc void @"\01?Swap@Bar@simpleproto2@@QAEXPAV12@@Z"(%"class.simpleproto2::Bar.23"*, %"class.simpleproto2::Bar.23"*) #0 align 2 {
  %3 = alloca %"class.simpleproto2::Bar.23"*, align 4
  %4 = alloca %"class.simpleproto2::Bar.23"*, align 4
  store %"class.simpleproto2::Bar.23"* %1, %"class.simpleproto2::Bar.23"** %3, align 4
  store %"class.simpleproto2::Bar.23"* %0, %"class.simpleproto2::Bar.23"** %4, align 4
...
; <label>:9:                                      ; preds = %2
  %10 = load %"class.simpleproto2::Bar.23"*, %"class.simpleproto2::Bar.23"** %3, align 4
  call x86_thiscallcc void @"\01?InternalSwap@Bar@simpleproto2@@AAEXPAV12@@Z"(%"class.simpleproto2::Bar.23"* %5, %"class.simpleproto2::Bar.23"* %10)
  br label %11
...
; Function Attrs: noinline optnone
define x86_thiscallcc void @"\01?InternalSwap@Bar@simpleproto2@@AAEXPAV12@@Z"(%"class.simpleproto2::Bar.23"*, %"class.simpleproto2::Bar.23"*) #0 align 2 {
  %3 = alloca %"class.simpleproto2::Bar.23"*, align 4
  %4 = alloca %"class.simpleproto2::Bar.23"*, align 4
  store %"class.simpleproto2::Bar.23"* %1, %"class.simpleproto2::Bar.23"** %3, align 4
  store %"class.simpleproto2::Bar.23"* %0, %"class.simpleproto2::Bar.23"** %4, align 4
  ...
  call void @"\01??$swap@PAVFoo@simpleproto2@@X@std@@YAXAAPAVFoo@simpleproto2@@0@Z"(%"class.simpleproto2::Foo.11"** dereferenceable(4) %8, %"class.simpleproto2::Foo.11"** dereferenceable(4) %7) #10
  %9 = load %"class.simpleproto2::Bar.23"*, %"class.simpleproto2::Bar.23"** %3, align 4
  ...
  call void @"\01??$swap@HX@std@@YAXAAH0@Z"(i32* dereferenceable(4) %11, i32* dereferenceable(4) %10) #10
  %12 = load %"class.simpleproto2::Bar.23"*, %"class.simpleproto2::Bar.23"** %3, align 4
  ...
  %16 = bitcast %"class.google::protobuf::internal::InternalMetadataWithArena"* %15 to %"class.google::protobuf::internal::InternalMetadataWithArenaBase"*
  %17 = load %"class.simpleproto2::Bar.23"*, %"class.simpleproto2::Bar.23"** %3, align 4
  %18 = getelementptr inbounds %"class.simpleproto2::Bar.23", %"class.simpleproto2::Bar.23"* %17, i32 0, i32 1
  call x86_thiscallcc void @"\01?Swap@?$InternalMetadataWithArenaBase@V?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@VInternalMetadataWithArenaLite@internal@protobuf@google@@@internal@protobuf@google@@QAEXPAVInternalMetadataWithArenaLite@234@@Z"(%"class.google::protobuf::internal::InternalMetadataWithArenaBase"* %16, %"class.google::protobuf::internal::InternalMetadataWithArena"* %18)
  %19 = load %"class.simpleproto2::Bar.23"*, %"class.simpleproto2::Bar.23"** %3, align 4
...
; Function Attrs: noinline nounwind optnone
define linkonce_odr void @"\01??$swap@PAVFoo@simpleproto2@@X@std@@YAXAAPAVFoo@simpleproto2@@0@Z"(%"class.simpleproto2::Foo.11"** dereferenceable(4), %"class.simpleproto2::Foo.11"** dereferenceable(4)) #1 comdat {
  %3 = alloca %"class.simpleproto2::Foo.11"**, align 4
  %4 = alloca %"class.simpleproto2::Foo.11"**, align 4
  %5 = alloca %"class.simpleproto2::Foo.11"*, align 4
  store %"class.simpleproto2::Foo.11"** %1, %"class.simpleproto2::Foo.11"*** %3, align 4
  store %"class.simpleproto2::Foo.11"** %0, %"class.simpleproto2::Foo.11"*** %4, align 4
  %6 = load %"class.simpleproto2::Foo.11"**, %"class.simpleproto2::Foo.11"*** %4, align 4
  %7 = call dereferenceable(4) %"class.simpleproto2::Foo.11"** @"\01??$move@AAPAVFoo@simpleproto2@@@std@@YA$$QAPAVFoo@simpleproto2@@AAPAV12@@Z"(%"class.simpleproto2::Foo.11"** dereferenceable(4) %6) #10
  %8 = load %"class.simpleproto2::Foo.11"*, %"class.simpleproto2::Foo.11"** %7, align 4
  store %"class.simpleproto2::Foo.11"* %8, %"class.simpleproto2::Foo.11"** %5, align 4
  %9 = load %"class.simpleproto2::Foo.11"**, %"class.simpleproto2::Foo.11"*** %3, align 4
  %10 = call dereferenceable(4) %"class.simpleproto2::Foo.11"** @"\01??$move@AAPAVFoo@simpleproto2@@@std@@YA$$QAPAVFoo@simpleproto2@@AAPAV12@@Z"(%"class.simpleproto2::Foo.11"** dereferenceable(4) %9) #10
  %11 = load %"class.simpleproto2::Foo.11"*, %"class.simpleproto2::Foo.11"** %10, align 4
  %12 = load %"class.simpleproto2::Foo.11"**, %"class.simpleproto2::Foo.11"*** %4, align 4
  store %"class.simpleproto2::Foo.11"* %11, %"class.simpleproto2::Foo.11"** %12, align 4
  %13 = call dereferenceable(4) %"class.simpleproto2::Foo.11"** @"\01??$move@AAPAVFoo@simpleproto2@@@std@@YA$$QAPAVFoo@simpleproto2@@AAPAV12@@Z"(%"class.simpleproto2::Foo.11"** dereferenceable(4) %5) #10
  %14 = load %"class.simpleproto2::Foo.11"*, %"class.simpleproto2::Foo.11"** %13, align 4
  %15 = load %"class.simpleproto2::Foo.11"**, %"class.simpleproto2::Foo.11"*** %3, align 4
  store %"class.simpleproto2::Foo.11"* %14, %"class.simpleproto2::Foo.11"** %15, align 4
  ret void
}

; Function Attrs: noinline nounwind optnone
define linkonce_odr dereferenceable(4) %"class.simpleproto2::Foo.11"** @"\01??$move@AAPAVFoo@simpleproto2@@@std@@YA$$QAPAVFoo@simpleproto2@@AAPAV12@@Z"(%"class.simpleproto2::Foo.11"** dereferenceable(4)) #1 comdat {
  %2 = alloca %"class.simpleproto2::Foo.11"**, align 4
  store %"class.simpleproto2::Foo.11"** %0, %"class.simpleproto2::Foo.11"*** %2, align 4
  %3 = load %"class.simpleproto2::Foo.11"**, %"class.simpleproto2::Foo.11"*** %2, align 4
