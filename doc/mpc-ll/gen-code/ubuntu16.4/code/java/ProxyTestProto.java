...
public class ProxyTestProto extends ProxyClient {
    private String irHash = "30d10362668b981a6e705c55ff3385b0";
    ...
    /**
     * Get com.abc.testproto.TestProtoLite.Foo
     */
    public com.abc.testproto.TestProtoLite.Foo getFoo(byte[] val) {
        com.abc.testproto.TestProtoLite.Foo __Foo = null;
        try {
            __Foo = com.abc.testproto.TestProtoLite.Foo.parseFrom(ethECIES.Decrypt(priHexString, val));
    ...
    public com.abc.testproto.TestProtoLite.Foo getFoo(String cipher) {
        return getFoo(Numeric.hexStringToByteArray(cipher));
    }

    /**
     * Get com.abc.testproto.TestProtoLite.Bar
     */
    public com.abc.testproto.TestProtoLite.Bar getBar(byte[] val) {
        com.abc.testproto.TestProtoLite.Bar __Bar = null;
        try {
            __Bar = com.abc.testproto.TestProtoLite.Bar.parseFrom(ethECIES.Decrypt(priHexString, val));
        } catch (InvalidProtocolBufferException e) {
            e.printStackTrace();
        }
        return __Bar;
    ...
    public com.abc.testproto.TestProtoLite.Bar getBar(String cipher) {
        return getBar(Numeric.hexStringToByteArray(cipher));
    }

    /**
     * Get com.abc.testproto.TestProtoLite.Points
     */
    public com.abc.testproto.TestProtoLite.Points getPoints(byte[] val) {
        com.abc.testproto.TestProtoLite.Points __Points = null;
        try {
            __Points = com.abc.testproto.TestProtoLite.Points.parseFrom(ethECIES.Decrypt(priHexString, val));
        } catch (InvalidProtocolBufferException e) {
            e.printStackTrace();
        }
        return __Points;
    ...
    public com.abc.testproto.TestProtoLite.Points getPoints(String cipher) {
