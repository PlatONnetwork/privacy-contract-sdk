 ...
 * IR HASH: 98a2c1ecbd0df02b1a59415d1dec1c88
 * <p>
 * IR FUNC HASH(MD5)                 IR FUNC NAME  IR FUNC PROT
 * 913b11f78f06e4a1d58688a4190afade  TestBarAdd01  TestBarAdd01(Bar,Bar)
 */
 
interface mpc_ii_98a2c1ecbd0df02b1a59415d1dec1c88 extends IIInterface {
}

public class MPCSimpleProto2 implements mpc_ii_98a2c1ecbd0df02b1a59415d1dec1c88 {
    ...
    abstract class MpcCallbackBase_98a2c1ecbd0df02b1a59415d1dec1c88 implements MpcCallbackInterface {
    ...
    abstract class mpc_i_98a2c1ecbd0df02b1a59415d1dec1c88 extends MpcCallbackBase_98a2c1ecbd0df02b1a59415d1dec1c88 {
    }
    
    abstract class mpc_f_913b11f78f06e4a1d58688a4190afade_01 extends mpc_i_98a2c1ecbd0df02b1a59415d1dec1c88 {
        public byte[] input_x_default(){
            return com.abc.simpleproto2.SimpleProtoLite2.Bar.newBuilder().build().toByteArray();
        }
    }

    abstract class mpc_f_913b11f78f06e4a1d58688a4190afade_02 extends mpc_i_98a2c1ecbd0df02b1a59415d1dec1c88 {
        public byte[] input_x_default(){
            return com.abc.simpleproto2.SimpleProtoLite2.Bar.newBuilder().build().toByteArray();
        }
    }
