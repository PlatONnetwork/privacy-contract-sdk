 ...
 * IR HASH: c1b626be2e97855797f7029698ffab1b
 * <p>
...
interface mpc_ii_c1b626be2e97855797f7029698ffab1b extends IIInterface {
}

public class MPCSimpleAndProto implements mpc_ii_c1b626be2e97855797f7029698ffab1b {
    ...
    abstract class MpcCallbackBase_c1b626be2e97855797f7029698ffab1b implements MpcCallbackInterface {
    ...
    abstract class mpc_i_c1b626be2e97855797f7029698ffab1b extends MpcCallbackBase_c1b626be2e97855797f7029698ffab1b {
    }
    
    abstract class mpc_f_d26161114e7457c9be1414e51637c641_01 extends mpc_i_c1b626be2e97855797f7029698ffab1b {
        public byte[] input_x_default(){
            return Data.Int32(0);
        }
    }

    abstract class mpc_f_d26161114e7457c9be1414e51637c641_02 extends mpc_i_c1b626be2e97855797f7029698ffab1b {
        public byte[] input_x_default(){
            return Data.Int32(0);
        }
    }

    abstract class mpc_f_91e30d5109c47916f14cdd5ba7aa1e13_01 extends mpc_i_c1b626be2e97855797f7029698ffab1b {
        public byte[] input_x_default(){
            return com.abc.simpleandproto.SimpleAndProtoLite.Foo.newBuilder().build().toByteArray();
        }
    }

    abstract class mpc_f_91e30d5109c47916f14cdd5ba7aa1e13_02 extends mpc_i_c1b626be2e97855797f7029698ffab1b {
        public byte[] input_x_default(){
            return com.abc.simpleandproto.SimpleAndProtoLite.Foo.newBuilder().build().toByteArray();
        }
    }
