...
@.str.3 = private unnamed_addr constant [41 x i8] c"f == NULL || dynamic_cast<To>(f) != NULL\00", align 1
...
; Function Attrs: noinline optnone uwtable
define void @_ZNK12simpleproto15Point11GetTypeNameB5cxx11Ev(%"class.std::__cxx11::basic_string"* noalias sret, %"class.simpleproto1::Point.3"*) unnamed_addr #4 align 2 personality i8* bitcast (i32 (...)* @__gxx_personality_v0 to i8*) {
  ...
  invoke void @_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEC1EPKcRKS3_(%"class.std::__cxx11::basic_string"* %0, i8* getelementptr inbounds ([19 x i8], [19 x i8]* @.str.2.9, i32 0, i32 0), %"class.std::ios_base::Init"* dereferenceable(1) %4)
...
define linkonce_odr dereferenceable(32) %"class.std::__cxx11::basic_string"* @_ZNK6google8protobuf8internal21ExplicitlyConstructedINSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEEE3getEv(%"class.google::protobuf::internal::ExplicitlyConstructed"*) #5 comdat align 2 {
  ...
  %5 = bitcast %"union.google::protobuf::internal::ExplicitlyConstructed<simpleproto1::Point>::AlignedUnion"* %4 to %"class.std::__cxx11::basic_string"*
