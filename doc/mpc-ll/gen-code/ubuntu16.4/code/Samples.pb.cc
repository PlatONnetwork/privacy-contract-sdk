...
void InitDefaultsBarImpl() {
  ...
  ::google::protobuf::internal::InitProtobufDefaults();
#endif  // GOOGLE_PROTOBUF_ENFORCE_UNIQUENESS
  protobuf_Samples_2eproto::InitDefaultsFoo();
  {
...
void InitDefaultsPointsImpl() {
  ...
  ::google::protobuf::internal::InitProtobufDefaults();
#endif  // GOOGLE_PROTOBUF_ENFORCE_UNIQUENESS
  protobuf_Samples_2eproto::InitDefaultsPoint();
  {
...
void protobuf_AssignDescriptors() {
  ...
  AssignDescriptors(
      "Samples.proto", schemas, file_default_instances, TableStruct::offsets, factory,
...
Bar::Bar()
  : ::google::protobuf::Message(), _internal_metadata_(NULL) {
  if (GOOGLE_PREDICT_TRUE(this != internal_default_instance())) {
    ::protobuf_Samples_2eproto::InitDefaultsBar();
  }
  SharedCtor();
...
Points::Points()
  : ::google::protobuf::Message(), _internal_metadata_(NULL) {
  if (GOOGLE_PREDICT_TRUE(this != internal_default_instance())) {
    ::protobuf_Samples_2eproto::InitDefaultsPoints();
  }
  SharedCtor();
