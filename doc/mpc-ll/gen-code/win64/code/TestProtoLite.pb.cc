...
void InitDefaultsBarImpl() {
  ...
  ::google::protobuf::internal::InitProtobufDefaults();
#endif  // GOOGLE_PROTOBUF_ENFORCE_UNIQUENESS
  protobuf_TestProtoLite_2eproto::InitDefaultsFoo();
  {
...
void InitDefaultsPointsImpl() {
  ...
  ::google::protobuf::internal::InitProtobufDefaults();
#endif  // GOOGLE_PROTOBUF_ENFORCE_UNIQUENESS
  protobuf_TestProtoLite_2eproto::InitDefaultsPoint();
  {
...
Bar::Bar()
  : ::google::protobuf::MessageLite(), _internal_metadata_(NULL) {
  if (GOOGLE_PREDICT_TRUE(this != internal_default_instance())) {
    ::protobuf_TestProtoLite_2eproto::InitDefaultsBar();
  }
  SharedCtor();
...
Points::Points()
  : ::google::protobuf::MessageLite(), _internal_metadata_(NULL) {
  if (GOOGLE_PREDICT_TRUE(this != internal_default_instance())) {
    ::protobuf_TestProtoLite_2eproto::InitDefaultsPoints();
  }
  SharedCtor();
