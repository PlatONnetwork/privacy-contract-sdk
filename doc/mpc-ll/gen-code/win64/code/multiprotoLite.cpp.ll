...
%"class.std::_Tree_comp_alloc" = type { %"class.std::_Compressed_pair.91" }
%"class.std::_Compressed_pair.91" = type { %"class.std::_Compressed_pair.92" }
%"class.std::_Compressed_pair.92" = type { %"class.std::_Tree_val" }
...
%"class.std::_Vector_alloc" = type { %"class.std::_Compressed_pair.108" }
%"class.std::_Compressed_pair.108" = type { %"class.std::_Vector_val" }
...
$"\01??$down_cast@PEBVFoo@multiproto@@$$CBVMessageLite@protobuf@google@@@internal@protobuf@google@@YAPEBVFoo@multiproto@@PEBVMessageLite@12@@Z" = comdat any
...
$"\01??$OwnInternal@VFoo@multiproto@@@Arena@protobuf@google@@AEAAXPEAVFoo@multiproto@@U?$integral_constant@_N$0A@@internal@12@@Z" = comdat any

$"\01??$arena_delete_object@VFoo@multiproto@@@internal@protobuf@google@@YAXPEAX@Z" = comdat any
...
@"\01?once@?1??InitDefaultsFoo@protobuf_FooLite_2eproto@@YAXXZ@4_JA" = internal global i64 0, align 8
...
@2 = private unnamed_addr constant { [18 x i8*] } { [18 x i8*] [i8* bitcast (%rtti.CompleteObjectLocator* @"\01??_R4Foo@multiproto@@6B@" to i8*), i8* bitcast (i8* (%"class.multiproto::Foo.53"*, i32)* @"\01??_GFoo@multiproto@@UEAAPEAXI@Z" to i8*), i8* bitcast (void (%"class.multiproto::Foo.53"*, %"class.std::basic_string"*)* @"\01?GetTypeName@Foo@multiproto@@UEBA?AV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@XZ" to i8*), i8* bitcast (%"class.multiproto::Foo.53"* (%"class.multiproto::Foo.53"*, %"class.google::protobuf::Arena"*)* @"\01?New@Foo@multiproto@@UEBAPEAV12@PEAVArena@protobuf@google@@@Z" to i8*), i8* bitcast (%"class.multiproto::Foo.53"* (%"class.multiproto::Foo.53"*)* @"\01?New@Foo@multiproto@@UEBAPEAV12@XZ" to i8*), i8* bitcast (%"class.google::protobuf::Arena"* (%"class.google::protobuf::MessageLite"*)* @"\01?GetArena@MessageLite@protobuf@google@@UEBAPEAVArena@23@XZ" to i8*), i8* bitcast (i8* (%"class.google::protobuf::MessageLite"*)* @"\01?GetMaybeArenaPointer@MessageLite@protobuf@google@@UEBAPEAXXZ" to i8*), i8* bitcast (void (%"class.multiproto::Foo.53"*)* @"\01?Clear@Foo@multiproto@@UEAAXXZ" to i8*), i8* bitcast (i1 (%"class.multiproto::Foo.53"*)* @"\01?IsInitialized@Foo@multiproto@@UEBA_NXZ" to i8*), i8* bitcast (void (%"class.google::protobuf::MessageLite"*, %"class.std::basic_string"*)* @"\01?InitializationErrorString@MessageLite@protobuf@google@@UEBA?AV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@XZ" to i8*), i8* bitcast (void (%"class.multiproto::Foo.53"*, %"class.google::protobuf::MessageLite"*)* @"\01?CheckTypeAndMergeFrom@Foo@multiproto@@UEAAXAEBVMessageLite@protobuf@google@@@Z" to i8*), i8* bitcast (i1 (%"class.multiproto::Foo.53"*, %"class.google::protobuf::io::CodedInputStream"*)* @"\01?MergePartialFromCodedStream@Foo@multiproto@@UEAA_NPEAVCodedInputStream@io@protobuf@google@@@Z" to i8*), i8* bitcast (i64 (%"class.multiproto::Foo.53"*)* @"\01?ByteSizeLong@Foo@multiproto@@UEBA_KXZ" to i8*), i8* bitcast (void (%"class.multiproto::Foo.53"*, %"class.google::protobuf::io::CodedOutputStream"*)* @"\01?SerializeWithCachedSizes@Foo@multiproto@@UEBAXPEAVCodedOutputStream@io@protobuf@google@@@Z" to i8*), i8* bitcast (i8* (%"class.google::protobuf::MessageLite"*, i8*)* @"\01?SerializeWithCachedSizesToArray@MessageLite@protobuf@google@@UEBAPEAEPEAE@Z" to i8*), i8* bitcast (i32 (%"class.multiproto::Foo.53"*)* @"\01?GetCachedSize@Foo@multiproto@@UEBAHXZ" to i8*), i8* bitcast (i8* (%"class.google::protobuf::MessageLite"*, i1, i8*)* @"\01?InternalSerializeWithCachedSizesToArray@MessageLite@protobuf@google@@UEBAPEAE_NPEAE@Z" to i8*), i8* bitcast (i8* (%"class.google::protobuf::MessageLite"*)* @"\01?InternalGetTable@MessageLite@protobuf@google@@EEBAPEBXXZ" to i8*)] }, comdat($"\01??_7Foo@multiproto@@6B@")
...
@"\01??_R3Foo@multiproto@@8" = linkonce_odr constant %rtti.ClassHierarchyDescriptor { i32 0, i32 0, i32 2, i32 trunc (i64 sub nuw nsw (i64 ptrtoint ([3 x i32]* @"\01??_R2Foo@multiproto@@8" to i64), i64 ptrtoint (i8* @__ImageBase to i64)) to i32) }, comdat
@"\01??_R2Foo@multiproto@@8" = linkonce_odr constant [3 x i32] [i32 trunc (i64 sub nuw nsw (i64 ptrtoint (%rtti.BaseClassDescriptor* @"\01??_R1A@?0A@EA@Foo@multiproto@@8" to i64), i64 ptrtoint (i8* @__ImageBase to i64)) to i32), i32 trunc (i64 sub nuw nsw (i64 ptrtoint (%rtti.BaseClassDescriptor* @"\01??_R1A@?0A@EA@MessageLite@protobuf@google@@8" to i64), i64 ptrtoint (i8* @__ImageBase to i64)) to i32), i32 0], comdat
...
; <label>:40:                                     ; preds = %36
  ...
  %41 = invoke %"class.multiproto::Foo"* bitcast (%"class.multiproto::Foo.53"* (%"class.multiproto::Foo.53"*)* @"\01??0Foo@multiproto@@QEAA@XZ" to %"class.multiproto::Foo"* (%"class.multiproto::Foo"*)*)(%"class.multiproto::Foo"* %0)
...
; <label>:81:                                     ; preds = %61
  call void bitcast (void (%"class.multiproto::Foo.53"*)* @"\01??1Foo@multiproto@@UEAA@XZ" to void (%"class.multiproto::Foo"*)*)(%"class.multiproto::Foo"* %0) #8
  br label %82
...
; <label>:83:                                     ; preds = %79, %45, %44, %42
  ...
  call void bitcast (void (%"class.multiproto::Foo.53"*)* @"\01??1Foo@multiproto@@UEAA@XZ" to void (%"class.multiproto::Foo"*)*)(%"class.multiproto::Foo"* %0) #8 [ "funclet"(token %84) ]
...
; <label>:35:                                     ; preds = %31
  ...
  %36 = invoke %"class.multiproto::Foo"* bitcast (%"class.multiproto::Foo.53"* (%"class.multiproto::Foo.53"*)* @"\01??0Foo@multiproto@@QEAA@XZ" to %"class.multiproto::Foo"* (%"class.multiproto::Foo"*)*)(%"class.multiproto::Foo"* %0)
...
; <label>:76:                                     ; preds = %72, %40, %39, %37
  ...
  call void bitcast (void (%"class.multiproto::Foo.53"*)* @"\01??1Foo@multiproto@@UEAA@XZ" to void (%"class.multiproto::Foo"*)*)(%"class.multiproto::Foo"* %0) #8 [ "funclet"(token %77) ]
...
; <label>:31:                                     ; preds = %27
  ...
  %32 = invoke %"class.multiproto::Foo"* bitcast (%"class.multiproto::Foo.53"* (%"class.multiproto::Foo.53"*)* @"\01??0Foo@multiproto@@QEAA@XZ" to %"class.multiproto::Foo"* (%"class.multiproto::Foo"*)*)(%"class.multiproto::Foo"* %0)
...
; <label>:70:                                     ; preds = %66, %36, %35, %33
  %71 = cleanuppad within none []
  call void bitcast (void (%"class.multiproto::Foo.53"*)* @"\01??1Foo@multiproto@@UEAA@XZ" to void (%"class.multiproto::Foo"*)*)(%"class.multiproto::Foo"* %0) #8 [ "funclet"(token %71) ]
  cleanupret from %71 unwind label %72
...
define i32 @PlatON_entry_TestFooAdd01(i8**, i8**, i32*) {
  ...
  call void bitcast (%"class.multiproto::Foo.53"* (%"class.multiproto::Foo.53"*)* @"\01??0Foo@multiproto@@QEAA@XZ" to void (%"class.multiproto::Foo"*)*)(%"class.multiproto::Foo"* %5)
  ...
  call void bitcast (%"class.multiproto::Foo.53"* (%"class.multiproto::Foo.53"*)* @"\01??0Foo@multiproto@@QEAA@XZ" to void (%"class.multiproto::Foo"*)*)(%"class.multiproto::Foo"* %12)
  ...
  %20 = call i64 bitcast (i64 (%"class.multiproto::Foo.53"*)* @"\01?ByteSizeLong@Foo@multiproto@@UEBA_KXZ" to i64 (%"class.multiproto::Foo"*)*)(%"class.multiproto::Foo"* %4)
  ...
  call void bitcast (void (%"class.multiproto::Foo.53"*)* @"\01??1Foo@multiproto@@UEAA@XZ" to void (%"class.multiproto::Foo"*)*)(%"class.multiproto::Foo"* %4)
  call void bitcast (void (%"class.multiproto::Foo.53"*)* @"\01??1Foo@multiproto@@UEAA@XZ" to void (%"class.multiproto::Foo"*)*)(%"class.multiproto::Foo"* %5)
  call void bitcast (void (%"class.multiproto::Foo.53"*)* @"\01??1Foo@multiproto@@UEAA@XZ" to void (%"class.multiproto::Foo"*)*)(%"class.multiproto::Foo"* %12)
  ret i32 %21
}
...
define void @"\01?InitDefaultsFooImpl@protobuf_FooLite_2eproto@@YAXXZ"() #0 {
  %1 = alloca i8*, align 8
  call void @"\01?VerifyVersion@internal@protobuf@google@@YAXHHPEBD@Z"(i32 3005001, i32 3005000, i8* getelementptr inbounds ([69 x i8], [69 x i8]* @"\01??_C@_0EF@IFHBNMJI@E?3?2work?2local?2private?9contract?9s@", i32 0, i32 0))
  ...
  %4 = call %"class.multiproto::Foo.53"* @"\01??0Foo@multiproto@@QEAA@XZ"(%"class.multiproto::Foo.53"* %3)
...
; Function Attrs: noinline optnone uwtable
define %"class.multiproto::Foo.53"* @"\01??0Foo@multiproto@@QEAA@XZ"(%"class.multiproto::Foo.53"* returned) unnamed_addr #0 align 2 personality i8* bitcast (i32 (...)* @__CxxFrameHandler3 to i8*) {
  %2 = alloca %"class.multiproto::Foo.53"*, align 8
  %3 = alloca %"class.multiproto::Foo.53"*, align 8
  store %"class.multiproto::Foo.53"* %0, %"class.multiproto::Foo.53"** %3, align 8
  %4 = load %"class.multiproto::Foo.53"*, %"class.multiproto::Foo.53"** %3, align 8
  store %"class.multiproto::Foo.53"* %4, %"class.multiproto::Foo.53"** %2, align 8
...
; <label>:10:                                     ; preds = %1
  ...
  %12 = invoke %"class.multiproto::Foo.53"* @"\01?internal_default_instance@Foo@multiproto@@SAPEBV12@XZ"()
...
; <label>:17:                                     ; preds = %16, %13
  invoke void @"\01?SharedCtor@Foo@multiproto@@AEAAXXZ"(%"class.multiproto::Foo.53"* %4)
          to label %18 unwind label %20

; <label>:18:                                     ; preds = %17
  %19 = load %"class.multiproto::Foo.53"*, %"class.multiproto::Foo.53"** %2, align 8
  ret %"class.multiproto::Foo.53"* %19

; <label>:20:                                     ; preds = %17, %15, %10
  %21 = cleanuppad within none []
  call void @"\01??1InternalMetadataWithArenaLite@internal@protobuf@google@@QEAA@XZ"(%"class.google::protobuf::internal::InternalMetadataWithArena"* %8) #8 [ "funclet"(token %21) ]
  cleanupret from %21 unwind label %22

; <label>:22:                                     ; preds = %20, %1
  %23 = cleanuppad within none []
  %24 = bitcast %"class.multiproto::Foo.53"* %4 to %"class.google::protobuf::MessageLite"*
  call void @"\01??1MessageLite@protobuf@google@@UEAA@XZ"(%"class.google::protobuf::MessageLite"* %24) #8 [ "funclet"(token %23) ]
...
; Function Attrs: noinline nounwind optnone uwtable
define linkonce_odr %"class.multiproto::Foo.53"* @"\01?internal_default_instance@Foo@multiproto@@SAPEBV12@XZ"() #1 comdat align 2 {
...
define void @"\01?InitDefaultsFoo@protobuf_FooLite_2eproto@@YAXXZ"() #0 {
  call void @"\01?GoogleOnceInit@protobuf@google@@YAXPEA_JP6AXXZ@Z"(i64* @"\01?once@?1??InitDefaultsFoo@protobuf_FooLite_2eproto@@YAXXZ@4_JA", void ()* @"\01?InitDefaultsFooImpl@protobuf_FooLite_2eproto@@YAXXZ")
  ret void
}

; Function Attrs: noinline optnone uwtable
define void @"\01?SharedCtor@Foo@multiproto@@AEAAXXZ"(%"class.multiproto::Foo.53"*) #0 align 2 {
  %2 = alloca %"class.multiproto::Foo.53"*, align 8
  store %"class.multiproto::Foo.53"* %0, %"class.multiproto::Foo.53"** %2, align 8
  %3 = load %"class.multiproto::Foo.53"*, %"class.multiproto::Foo.53"** %2, align 8
...
define linkonce_odr void @"\01??1InternalMetadataWithArenaLite@internal@protobuf@google@@QEAA@XZ"(%"class.google::protobuf::internal::InternalMetadataWithArena"*) unnamed_addr #1 comdat align 2 {
  ...
  call void @"\01??1?$InternalMetadataWithArenaBase@V?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@VInternalMetadataWithArenaLite@internal@protobuf@google@@@internal@protobuf@google@@QEAA@XZ"(%"class.google::protobuf::internal::InternalMetadataWithArenaBase"* %4) #8
  ret void
}
...
; <label>:14:                                     ; preds = %12
  call void @"\01??1Container@?$InternalMetadataWithArenaBase@V?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@VInternalMetadataWithArenaLite@internal@protobuf@google@@@internal@protobuf@google@@QEAA@XZ"(%"struct.google::protobuf::internal::InternalMetadataWithArenaBase<std::basic_string<char, std::char_traits<char>, std::allocator<char> >, google::protobuf::internal::InternalMetadataWithArenaLite>::Container"* %11) #8
...
define linkonce_odr void @"\01??1Container@?$InternalMetadataWithArenaBase@V?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@VInternalMetadataWithArenaLite@internal@protobuf@google@@@internal@protobuf@google@@QEAA@XZ"(%"struct.google::protobuf::internal::InternalMetadataWithArenaBase<std::basic_string<char, std::char_traits<char>, std::allocator<char> >, google::protobuf::internal::InternalMetadataWithArenaLite>::Container"*) unnamed_addr #1 comdat align 2 {
  ...
  call void @"\01??1?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QEAA@XZ"(%"class.std::basic_string"* %4) #8
  ret void
}
...
; Function Attrs: noinline nounwind optnone uwtable
define linkonce_odr i8* @"\01??_GFoo@multiproto@@UEAAPEAXI@Z"(%"class.multiproto::Foo.53"*, i32) unnamed_addr #1 comdat align 2 {
  %3 = alloca i8*, align 8
  %4 = alloca i32, align 4
  %5 = alloca %"class.multiproto::Foo.53"*, align 8
  store i32 %1, i32* %4, align 4
  store %"class.multiproto::Foo.53"* %0, %"class.multiproto::Foo.53"** %5, align 8
  %6 = load %"class.multiproto::Foo.53"*, %"class.multiproto::Foo.53"** %5, align 8
  %7 = bitcast %"class.multiproto::Foo.53"* %6 to i8*
  store i8* %7, i8** %3, align 8
  %8 = load i32, i32* %4, align 4
  call void @"\01??1Foo@multiproto@@UEAA@XZ"(%"class.multiproto::Foo.53"* %6) #8
  %9 = icmp eq i32 %8, 0
  br i1 %9, label %12, label %10
...
; Function Attrs: noinline optnone uwtable
define void @"\01?GetTypeName@Foo@multiproto@@UEBA?AV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@XZ"(%"class.multiproto::Foo.53"*, %"class.std::basic_string"* noalias sret) unnamed_addr #0 align 2 {
  %3 = alloca %"class.multiproto::Foo.53"*, align 8
  store %"class.multiproto::Foo.53"* %0, %"class.multiproto::Foo.53"** %3, align 8
  %4 = load %"class.multiproto::Foo.53"*, %"class.multiproto::Foo.53"** %3, align 8
  %5 = call %"class.std::basic_string"* @"\01??0?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QEAA@QEBD@Z"(%"class.std::basic_string"* %1, i8* getelementptr inbounds ([15 x i8], [15 x i8]* @"\01??_C@_0P@MBHOJPNG@multiproto?4Foo?$AA@", i32 0, i32 0))
  ret void
}

; Function Attrs: noinline optnone uwtable
define %"class.multiproto::Foo.53"* @"\01?New@Foo@multiproto@@UEBAPEAV12@PEAVArena@protobuf@google@@@Z"(%"class.multiproto::Foo.53"*, %"class.google::protobuf::Arena"*) unnamed_addr #0 align 2 personality i8* bitcast (i32 (...)* @__CxxFrameHandler3 to i8*) {
  %3 = alloca %"class.google::protobuf::Arena"*, align 8
  %4 = alloca %"class.multiproto::Foo.53"*, align 8
  %5 = alloca %"class.multiproto::Foo.53"*, align 8
  store %"class.google::protobuf::Arena"* %1, %"class.google::protobuf::Arena"** %3, align 8
  store %"class.multiproto::Foo.53"* %0, %"class.multiproto::Foo.53"** %4, align 8
  %6 = load %"class.multiproto::Foo.53"*, %"class.multiproto::Foo.53"** %4, align 8
  %7 = call i8* @"\01??2@YAPEAX_K@Z"(i64 40) #13
  %8 = bitcast i8* %7 to %"class.multiproto::Foo.53"*
  %9 = invoke %"class.multiproto::Foo.53"* @"\01??0Foo@multiproto@@QEAA@XZ"(%"class.multiproto::Foo.53"* %8)
          to label %10 unwind label %16

; <label>:10:                                     ; preds = %2
  store %"class.multiproto::Foo.53"* %8, %"class.multiproto::Foo.53"** %5, align 8
...
; <label>:13:                                     ; preds = %10
  ...
  %15 = load %"class.multiproto::Foo.53"*, %"class.multiproto::Foo.53"** %5, align 8
  call void @"\01??$Own@VFoo@multiproto@@@Arena@protobuf@google@@QEAAXPEAVFoo@multiproto@@@Z"(%"class.google::protobuf::Arena"* %14, %"class.multiproto::Foo.53"* %15)
  br label %18
...
; <label>:18:                                     ; preds = %13, %10
  %19 = load %"class.multiproto::Foo.53"*, %"class.multiproto::Foo.53"** %5, align 8
  ret %"class.multiproto::Foo.53"* %19
}

; Function Attrs: noinline optnone uwtable
define linkonce_odr %"class.multiproto::Foo.53"* @"\01?New@Foo@multiproto@@UEBAPEAV12@XZ"(%"class.multiproto::Foo.53"*) unnamed_addr #0 comdat align 2 {
  %2 = alloca %"class.multiproto::Foo.53"*, align 8
  store %"class.multiproto::Foo.53"* %0, %"class.multiproto::Foo.53"** %2, align 8
  %3 = load %"class.multiproto::Foo.53"*, %"class.multiproto::Foo.53"** %2, align 8
  %4 = call %"class.multiproto::Foo.53"* @"\01?New@Foo@multiproto@@UEBAPEAV12@PEAVArena@protobuf@google@@@Z"(%"class.multiproto::Foo.53"* %3, %"class.google::protobuf::Arena"* null)
...
; Function Attrs: noinline optnone uwtable
define void @"\01?Clear@Foo@multiproto@@UEAAXXZ"(%"class.multiproto::Foo.53"*) unnamed_addr #0 align 2 {
  %2 = alloca %"class.multiproto::Foo.53"*, align 8
  %3 = alloca i32, align 4
  store %"class.multiproto::Foo.53"* %0, %"class.multiproto::Foo.53"** %2, align 8
  %4 = load %"class.multiproto::Foo.53"*, %"class.multiproto::Foo.53"** %2, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define zeroext i1 @"\01?IsInitialized@Foo@multiproto@@UEBA_NXZ"(%"class.multiproto::Foo.53"*) unnamed_addr #1 align 2 {
  %2 = alloca %"class.multiproto::Foo.53"*, align 8
  store %"class.multiproto::Foo.53"* %0, %"class.multiproto::Foo.53"** %2, align 8
  %3 = load %"class.multiproto::Foo.53"*, %"class.multiproto::Foo.53"** %2, align 8
  ret i1 true
...
; Function Attrs: noinline optnone uwtable
define void @"\01?CheckTypeAndMergeFrom@Foo@multiproto@@UEAAXAEBVMessageLite@protobuf@google@@@Z"(%"class.multiproto::Foo.53"*, %"class.google::protobuf::MessageLite"* dereferenceable(8)) unnamed_addr #0 align 2 {
  ...
  store %"class.multiproto::Foo.53"* %0, %"class.multiproto::Foo.53"** %4, align 8
  %5 = load %"class.multiproto::Foo.53"*, %"class.multiproto::Foo.53"** %4, align 8
  %6 = load %"class.google::protobuf::MessageLite"*, %"class.google::protobuf::MessageLite"** %3, align 8
  %7 = call %"class.multiproto::Foo.53"* @"\01??$down_cast@PEBVFoo@multiproto@@$$CBVMessageLite@protobuf@google@@@internal@protobuf@google@@YAPEBVFoo@multiproto@@PEBVMessageLite@12@@Z"(%"class.google::protobuf::MessageLite"* %6)
  call void @"\01?MergeFrom@Foo@multiproto@@QEAAXAEBV12@@Z"(%"class.multiproto::Foo.53"* %5, %"class.multiproto::Foo.53"* dereferenceable(40) %7)
  ret void
}

; Function Attrs: noinline optnone uwtable
define zeroext i1 @"\01?MergePartialFromCodedStream@Foo@multiproto@@UEAA_NPEAVCodedInputStream@io@protobuf@google@@@Z"(%"class.multiproto::Foo.53"*, %"class.google::protobuf::io::CodedInputStream"*) unnamed_addr #0 align 2 personality i8* bitcast (i32 (...)* @__CxxFrameHandler3 to i8*) {
  %3 = alloca i1, align 1
  ...
  store %"class.multiproto::Foo.53"* %0, %"class.multiproto::Foo.53"** %5, align 8
  %12 = load %"class.multiproto::Foo.53"*, %"class.multiproto::Foo.53"** %5, align 8
...
; <label>:68:                                     ; preds = %63
  %69 = invoke %"class.std::basic_string"* @"\01?mutable_s@Foo@multiproto@@QEAAPEAV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@XZ"(%"class.multiproto::Foo.53"* %12)
...
; <label>:75:                                     ; preds = %73
  %76 = invoke dereferenceable(32) %"class.std::basic_string"* @"\01?s@Foo@multiproto@@QEBAAEBV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@XZ"(%"class.multiproto::Foo.53"* %12)
          to label %77 unwind label %106

; <label>:77:                                     ; preds = %75
  %78 = call i64 @"\01?length@?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QEBA_KXZ"(%"class.std::basic_string"* %76) #8
  %79 = trunc i64 %78 to i32
  %80 = invoke dereferenceable(32) %"class.std::basic_string"* @"\01?s@Foo@multiproto@@QEBAAEBV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@XZ"(%"class.multiproto::Foo.53"* %12)
          to label %81 unwind label %106

; <label>:81:                                     ; preds = %77
  %82 = call i8* @"\01?data@?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QEBAPEBDXZ"(%"class.std::basic_string"* %80) #8
  %83 = invoke zeroext i1 @"\01?VerifyUtf8String@WireFormatLite@internal@protobuf@google@@SA_NPEBDHW4Operation@1234@0@Z"(i8* %82, i32 %79, i32 0, i8* getelementptr inbounds ([17 x i8], [17 x i8]* @"\01??_C@_0BB@IBBDGMON@multiproto?4Foo?4s?$AA@", i32 0, i32 0))
...
; <label>:104:                                    ; preds = %103, %102
  call void @"\01??1CodedOutputStream@io@protobuf@google@@QEAA@XZ"(%"class.google::protobuf::io::CodedOutputStream"* %9) #8
  call void @"\01??1StringOutputStream@io@protobuf@google@@UEAA@XZ"(%"class.google::protobuf::io::StringOutputStream"* %8) #8
  call void @"\01??1LiteUnknownFieldSetter@internal@protobuf@google@@QEAA@XZ"(%"class.google::protobuf::internal::LiteUnknownFieldSetter"* %7) #8
  %105 = load i1, i1* %3, align 1
  ret i1 %105

; <label>:106:                                    ; preds = %94, %81, %77, %75, %70, %68, %54, %40, %31, %22
  %107 = cleanuppad within none []
  call void @"\01??1CodedOutputStream@io@protobuf@google@@QEAA@XZ"(%"class.google::protobuf::io::CodedOutputStream"* %9) #8 [ "funclet"(token %107) ]
  cleanupret from %107 unwind label %108

; <label>:108:                                    ; preds = %106, %18
  %109 = cleanuppad within none []
  call void @"\01??1StringOutputStream@io@protobuf@google@@UEAA@XZ"(%"class.google::protobuf::io::StringOutputStream"* %8) #8 [ "funclet"(token %109) ]
  cleanupret from %109 unwind label %110

; <label>:110:                                    ; preds = %108, %16, %2
  %111 = cleanuppad within none []
  call void @"\01??1LiteUnknownFieldSetter@internal@protobuf@google@@QEAA@XZ"(%"class.google::protobuf::internal::LiteUnknownFieldSetter"* %7) #8 [ "funclet"(token %111) ]
  cleanupret from %111 unwind to caller
}

; Function Attrs: noinline optnone uwtable
define i64 @"\01?ByteSizeLong@Foo@multiproto@@UEBA_KXZ"(%"class.multiproto::Foo.53"*) #0 align 2 {
  %2 = alloca %"class.multiproto::Foo.53"*, align 8
  %3 = alloca i64, align 8
  %4 = alloca i32, align 4
  store %"class.multiproto::Foo.53"* %0, %"class.multiproto::Foo.53"** %2, align 8
  %5 = load %"class.multiproto::Foo.53"*, %"class.multiproto::Foo.53"** %2, align 8
  store i64 0, i64* %3, align 8
...
; <label>:14:                                     ; preds = %11, %7
  ...
  %16 = call i64 @"\01?size@?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QEBA_KXZ"(%"class.std::basic_string"* %15) #8
  %17 = load i64, i64* %3, align 8
  %18 = add i64 %17, %16
  store i64 %18, i64* %3, align 8
  %19 = call dereferenceable(32) %"class.std::basic_string"* @"\01?s@Foo@multiproto@@QEBAAEBV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@XZ"(%"class.multiproto::Foo.53"* %5)
  %20 = call i64 @"\01?size@?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QEBA_KXZ"(%"class.std::basic_string"* %19) #8
  %21 = icmp ugt i64 %20, 0
  br i1 %21, label %22, label %28

; <label>:22:                                     ; preds = %14
  %23 = call dereferenceable(32) %"class.std::basic_string"* @"\01?s@Foo@multiproto@@QEBAAEBV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@XZ"(%"class.multiproto::Foo.53"* %5)
...
; <label>:28:                                     ; preds = %22, %14
  %29 = call i32 bitcast (i32 (%"class.multiproto::Foo"*)* @"\01?i32@Foo@multiproto@@QEBAHXZ" to i32 (%"class.multiproto::Foo.53"*)*)(%"class.multiproto::Foo.53"* %5)
  %30 = icmp ne i32 %29, 0
  br i1 %30, label %31, label %37

; <label>:31:                                     ; preds = %28
  %32 = call i32 bitcast (i32 (%"class.multiproto::Foo"*)* @"\01?i32@Foo@multiproto@@QEBAHXZ" to i32 (%"class.multiproto::Foo.53"*)*)(%"class.multiproto::Foo.53"* %5)
...
; <label>:37:                                     ; preds = %31, %28
  %38 = call float @"\01?f@Foo@multiproto@@QEBAMXZ"(%"class.multiproto::Foo.53"* %5)
...
; Function Attrs: noinline optnone uwtable
define void @"\01?SerializeWithCachedSizes@Foo@multiproto@@UEBAXPEAVCodedOutputStream@io@protobuf@google@@@Z"(%"class.multiproto::Foo.53"*, %"class.google::protobuf::io::CodedOutputStream"*) unnamed_addr #0 align 2 {
  ...
  %7 = call i32 bitcast (i32 (%"class.multiproto::Foo"*)* @"\01?i32@Foo@multiproto@@QEBAHXZ" to i32 (%"class.multiproto::Foo.53"*)*)(%"class.multiproto::Foo.53"* %6)
  %8 = icmp ne i32 %7, 0
  br i1 %8, label %9, label %12

; <label>:9:                                      ; preds = %2
  %10 = load %"class.google::protobuf::io::CodedOutputStream"*, %"class.google::protobuf::io::CodedOutputStream"** %3, align 8
  %11 = call i32 bitcast (i32 (%"class.multiproto::Foo"*)* @"\01?i32@Foo@multiproto@@QEBAHXZ" to i32 (%"class.multiproto::Foo.53"*)*)(%"class.multiproto::Foo.53"* %6)
...
; <label>:12:                                     ; preds = %9, %2
  %13 = call float @"\01?f@Foo@multiproto@@QEBAMXZ"(%"class.multiproto::Foo.53"* %6)
...
; <label>:15:                                     ; preds = %12
  ...
  %17 = call float @"\01?f@Foo@multiproto@@QEBAMXZ"(%"class.multiproto::Foo.53"* %6)
...
; <label>:18:                                     ; preds = %15, %12
  %19 = call dereferenceable(32) %"class.std::basic_string"* @"\01?s@Foo@multiproto@@QEBAAEBV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@XZ"(%"class.multiproto::Foo.53"* %6)
  %20 = call i64 @"\01?size@?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QEBA_KXZ"(%"class.std::basic_string"* %19) #8
  %21 = icmp ugt i64 %20, 0
  br i1 %21, label %22, label %31

; <label>:22:                                     ; preds = %18
  %23 = call dereferenceable(32) %"class.std::basic_string"* @"\01?s@Foo@multiproto@@QEBAAEBV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@XZ"(%"class.multiproto::Foo.53"* %6)
  %24 = call i64 @"\01?length@?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QEBA_KXZ"(%"class.std::basic_string"* %23) #8
  %25 = trunc i64 %24 to i32
  %26 = call dereferenceable(32) %"class.std::basic_string"* @"\01?s@Foo@multiproto@@QEBAAEBV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@XZ"(%"class.multiproto::Foo.53"* %6)
  ...
  %30 = call dereferenceable(32) %"class.std::basic_string"* @"\01?s@Foo@multiproto@@QEBAAEBV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@XZ"(%"class.multiproto::Foo.53"* %6)
...
; <label>:34:                                     ; preds = %31
  %35 = getelementptr inbounds %"class.multiproto::Foo.53", %"class.multiproto::Foo.53"* %6, i32 0, i32 1
...
; <label>:38:                                     ; preds = %31
  %39 = getelementptr inbounds %"class.multiproto::Foo.53", %"class.multiproto::Foo.53"* %6, i32 0, i32 1
...
; <label>:41:                                     ; preds = %38, %34
  ...
  %43 = call i64 @"\01?size@?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QEBA_KXZ"(%"class.std::basic_string"* %42) #8
  %44 = trunc i64 %43 to i32
  %45 = call zeroext i1 @"\01?GetProto3PreserveUnknownsDefault@internal@protobuf@google@@YA_NXZ"()
  br i1 %45, label %46, label %50

; <label>:46:                                     ; preds = %41
  %47 = getelementptr inbounds %"class.multiproto::Foo.53", %"class.multiproto::Foo.53"* %6, i32 0, i32 1
...
; <label>:50:                                     ; preds = %41
  %51 = getelementptr inbounds %"class.multiproto::Foo.53", %"class.multiproto::Foo.53"* %6, i32 0, i32 1
...
; <label>:53:                                     ; preds = %50, %46
  ...
  %55 = call i8* @"\01?data@?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QEBAPEBDXZ"(%"class.std::basic_string"* %54) #8
...
; Function Attrs: noinline nounwind optnone uwtable
define linkonce_odr i32 @"\01?GetCachedSize@Foo@multiproto@@UEBAHXZ"(%"class.multiproto::Foo.53"*) unnamed_addr #1 comdat align 2 {
  %2 = alloca %"class.multiproto::Foo.53"*, align 8
  store %"class.multiproto::Foo.53"* %0, %"class.multiproto::Foo.53"** %2, align 8
  %3 = load %"class.multiproto::Foo.53"*, %"class.multiproto::Foo.53"** %2, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define linkonce_odr float @"\01?f@Foo@multiproto@@QEBAMXZ"(%"class.multiproto::Foo.53"*) #1 comdat align 2 {
  %2 = alloca %"class.multiproto::Foo.53"*, align 8
  store %"class.multiproto::Foo.53"* %0, %"class.multiproto::Foo.53"** %2, align 8
  %3 = load %"class.multiproto::Foo.53"*, %"class.multiproto::Foo.53"** %2, align 8
...
; Function Attrs: noinline optnone uwtable
define linkonce_odr dereferenceable(32) %"class.std::basic_string"* @"\01?s@Foo@multiproto@@QEBAAEBV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@XZ"(%"class.multiproto::Foo.53"*) #0 comdat align 2 {
  %2 = alloca %"class.multiproto::Foo.53"*, align 8
  store %"class.multiproto::Foo.53"* %0, %"class.multiproto::Foo.53"** %2, align 8
  %3 = load %"class.multiproto::Foo.53"*, %"class.multiproto::Foo.53"** %2, align 8
  %4 = getelementptr inbounds %"class.multiproto::Foo.53", %"class.multiproto::Foo.53"* %3, i32 0, i32 2
...
define linkonce_odr %"class.google::protobuf::internal::LiteUnknownFieldSetter"* @"\01??0LiteUnknownFieldSetter@internal@protobuf@google@@QEAA@PEAVInternalMetadataWithArenaLite@123@@Z"(%"class.google::protobuf::internal::LiteUnknownFieldSetter"* returned, %"class.google::protobuf::internal::InternalMetadataWithArena"*) unnamed_addr #0 comdat align 2 personality i8* bitcast (i32 (...)* @__CxxFrameHandler3 to i8*) {
  ...
  %10 = call %"class.std::basic_string"* @"\01??0?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QEAA@XZ"(%"class.std::basic_string"* %9) #8
...
; <label>:20:                                     ; preds = %15
  call void @"\01?swap@?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QEAAXAEAV12@@Z"(%"class.std::basic_string"* %16, %"class.std::basic_string"* dereferenceable(32) %19) #8
  br label %21
...
; <label>:23:                                     ; preds = %15, %2
  ...
  call void @"\01??1?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QEAA@XZ"(%"class.std::basic_string"* %9) #8 [ "funclet"(token %24) ]
...
; Function Attrs: noinline optnone uwtable
define linkonce_odr %"class.std::basic_string"* @"\01?mutable_s@Foo@multiproto@@QEAAPEAV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@XZ"(%"class.multiproto::Foo.53"*) #0 comdat align 2 {
  %2 = alloca %"class.multiproto::Foo.53"*, align 8
  store %"class.multiproto::Foo.53"* %0, %"class.multiproto::Foo.53"** %2, align 8
  %3 = load %"class.multiproto::Foo.53"*, %"class.multiproto::Foo.53"** %2, align 8
  %4 = getelementptr inbounds %"class.multiproto::Foo.53", %"class.multiproto::Foo.53"* %3, i32 0, i32 2
...
define linkonce_odr void @"\01??1StringOutputStream@io@protobuf@google@@UEAA@XZ"(%"class.google::protobuf::io::StringOutputStream"*) unnamed_addr #1 comdat align 2 {
  ...
  call void @"\01??1ZeroCopyOutputStream@io@protobuf@google@@UEAA@XZ"(%"class.google::protobuf::MessageLite"* %4) #8
  ret void
}
...
define linkonce_odr void @"\01??1LiteUnknownFieldSetter@internal@protobuf@google@@QEAA@XZ"(%"class.google::protobuf::internal::LiteUnknownFieldSetter"*) unnamed_addr #1 comdat align 2 personality i8* bitcast (i32 (...)* @__CxxFrameHandler3 to i8*) {
  ...
  %3 = load %"class.google::protobuf::internal::LiteUnknownFieldSetter"*, %"class.google::protobuf::internal::LiteUnknownFieldSetter"** %2, align 8
  %4 = getelementptr inbounds %"class.google::protobuf::internal::LiteUnknownFieldSetter", %"class.google::protobuf::internal::LiteUnknownFieldSetter"* %3, i32 0, i32 1
  %5 = call zeroext i1 @"\01?empty@?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QEBA_NXZ"(%"class.std::basic_string"* %4) #8
...
; <label>:11:                                     ; preds = %6
  ...
  call void @"\01?swap@?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QEAAXAEAV12@@Z"(%"class.std::basic_string"* %10, %"class.std::basic_string"* dereferenceable(32) %12) #8
  br label %13
...
; <label>:15:                                     ; preds = %6
  ...
  call void @"\01??1?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QEAA@XZ"(%"class.std::basic_string"* %17) #8 [ "funclet"(token %16) ]
...
; <label>:10:                                     ; preds = %2
  ...
  %13 = call dereferenceable(1) %"class.std::allocator"* @"\01?_Getal@?$_String_alloc@U?$_String_base_types@DV?$allocator@D@std@@@std@@@std@@QEAAAEAV?$allocator@D@2@XZ"(%"class.std::_String_alloc"* %12) #8
  %14 = bitcast %"class.std::basic_string"* %6 to %"class.std::_String_alloc"*
  %15 = call dereferenceable(1) %"class.std::allocator"* @"\01?_Getal@?$_String_alloc@U?$_String_base_types@DV?$allocator@D@std@@@std@@@std@@QEAAAEAV?$allocator@D@2@XZ"(%"class.std::_String_alloc"* %14) #8
  call void @"\01??$_Pocs@V?$allocator@D@std@@@std@@YAXAEAV?$allocator@D@0@0@Z"(%"class.std::allocator"* dereferenceable(1) %15, %"class.std::allocator"* dereferenceable(1) %13) #8
  br label %16
...
define linkonce_odr void @"\01??$_Pocs@V?$allocator@D@std@@@std@@YAXAEAV?$allocator@D@0@0@Z"(%"class.std::allocator"* dereferenceable(1), %"class.std::allocator"* dereferenceable(1)) #1 comdat {
  ...
  %9 = getelementptr inbounds %"class.std::allocator", %"class.std::allocator"* %6, i32 0, i32 0
  %10 = load i8, i8* %9, align 1
  call void @"\01??$_Pocs@V?$allocator@D@std@@@std@@YAXAEAV?$allocator@D@0@0U?$integral_constant@_N$0A@@0@@Z"(%"class.std::allocator"* dereferenceable(1) %8, %"class.std::allocator"* dereferenceable(1) %7, i8 %10) #8
  ret void
}
...
define linkonce_odr void @"\01?_Swap_data@?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QEAAXAEAV12@U?$integral_constant@_N$00@2@@Z"(%"class.std::basic_string"*, %"class.std::basic_string"* dereferenceable(32), i8) #1 comdat align 2 {
  ...
  %11 = load %"class.std::basic_string"*, %"class.std::basic_string"** %6, align 8
  %12 = bitcast %"class.std::basic_string"* %11 to %"class.std::_String_alloc"*
  %13 = call dereferenceable(32) %"class.std::_String_val"* @"\01?_Get_data@?$_String_alloc@U?$_String_base_types@DV?$allocator@D@std@@@std@@@std@@QEAAAEAV?$_String_val@U?$_Simple_types@D@std@@@2@XZ"(%"class.std::_String_alloc"* %12) #8
  %14 = call %"class.std::_String_val"* @"\01??$addressof@V?$_String_val@U?$_Simple_types@D@std@@@std@@@std@@YAPEAV?$_String_val@U?$_Simple_types@D@std@@@0@AEAV10@@Z"(%"class.std::_String_val"* dereferenceable(32) %13) #8
  ...
  %19 = call dereferenceable(32) %"class.std::_String_val"* @"\01?_Get_data@?$_String_alloc@U?$_String_base_types@DV?$allocator@D@std@@@std@@@std@@QEAAAEAV?$_String_val@U?$_Simple_types@D@std@@@2@XZ"(%"class.std::_String_alloc"* %18) #8
  %20 = call %"class.std::_String_val"* @"\01??$addressof@V?$_String_val@U?$_Simple_types@D@std@@@std@@@std@@YAPEAV?$_String_val@U?$_Simple_types@D@std@@@0@AEAV10@@Z"(%"class.std::_String_val"* dereferenceable(32) %19) #8
...
; <label>:6:                                      ; preds = %1
  ...
  %10 = call %"struct.google::protobuf::internal::InternalMetadataWithArenaBase<std::basic_string<char, std::char_traits<char>, std::allocator<char> >, google::protobuf::internal::InternalMetadataWithArenaLite>::Container"* @"\01??0Container@?$InternalMetadataWithArenaBase@V?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@VInternalMetadataWithArenaLite@internal@protobuf@google@@@internal@protobuf@google@@QEAA@XZ"(%"struct.google::protobuf::internal::InternalMetadataWithArenaBase<std::basic_string<char, std::char_traits<char>, std::allocator<char> >, google::protobuf::internal::InternalMetadataWithArenaLite>::Container"* %8) #8
...
define linkonce_odr %"struct.google::protobuf::internal::InternalMetadataWithArenaBase<std::basic_string<char, std::char_traits<char>, std::allocator<char> >, google::protobuf::internal::InternalMetadataWithArenaLite>::Container"* @"\01??0Container@?$InternalMetadataWithArenaBase@V?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@VInternalMetadataWithArenaLite@internal@protobuf@google@@@internal@protobuf@google@@QEAA@XZ"(%"struct.google::protobuf::internal::InternalMetadataWithArenaBase<std::basic_string<char, std::char_traits<char>, std::allocator<char> >, google::protobuf::internal::InternalMetadataWithArenaLite>::Container"* returned) unnamed_addr #1 comdat align 2 {
  ...
  %3 = load %"struct.google::protobuf::internal::InternalMetadataWithArenaBase<std::basic_string<char, std::char_traits<char>, std::allocator<char> >, google::protobuf::internal::InternalMetadataWithArenaLite>::Container"*, %"struct.google::protobuf::internal::InternalMetadataWithArenaBase<std::basic_string<char, std::char_traits<char>, std::allocator<char> >, google::protobuf::internal::InternalMetadataWithArenaLite>::Container"** %2, align 8
  %4 = getelementptr inbounds %"struct.google::protobuf::internal::InternalMetadataWithArenaBase<std::basic_string<char, std::char_traits<char>, std::allocator<char> >, google::protobuf::internal::InternalMetadataWithArenaLite>::Container", %"struct.google::protobuf::internal::InternalMetadataWithArenaBase<std::basic_string<char, std::char_traits<char>, std::allocator<char> >, google::protobuf::internal::InternalMetadataWithArenaLite>::Container"* %3, i32 0, i32 0
  %5 = call %"class.std::basic_string"* @"\01??0?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QEAA@XZ"(%"class.std::basic_string"* %4) #8
...
define linkonce_odr %"struct.google::protobuf::internal::InternalMetadataWithArenaBase<std::basic_string<char, std::char_traits<char>, std::allocator<char> >, google::protobuf::internal::InternalMetadataWithArenaLite>::Container"* @"\01??$CreateInternal@UContainer@?$InternalMetadataWithArenaBase@V?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@VInternalMetadataWithArenaLite@internal@protobuf@google@@@internal@protobuf@google@@$$V@Arena@protobuf@google@@AEAAPEAUContainer@?$InternalMetadataWithArenaBase@V?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@VInternalMetadataWithArenaLite@internal@protobuf@google@@@internal@12@_N@Z"(%"class.google::protobuf::Arena"*, i1 zeroext) #0 comdat align 2 {
  ...
  %12 = call %"struct.google::protobuf::internal::InternalMetadataWithArenaBase<std::basic_string<char, std::char_traits<char>, std::allocator<char> >, google::protobuf::internal::InternalMetadataWithArenaLite>::Container"* @"\01??0Container@?$InternalMetadataWithArenaBase@V?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@VInternalMetadataWithArenaLite@internal@protobuf@google@@@internal@protobuf@google@@QEAA@XZ"(%"struct.google::protobuf::internal::InternalMetadataWithArenaBase<std::basic_string<char, std::char_traits<char>, std::allocator<char> >, google::protobuf::internal::InternalMetadataWithArenaLite>::Container"* %10) #8
...
define linkonce_odr void @"\01??$arena_destruct_object@UContainer@?$InternalMetadataWithArenaBase@V?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@VInternalMetadataWithArenaLite@internal@protobuf@google@@@internal@protobuf@google@@@internal@protobuf@google@@YAXPEAX@Z"(i8*) #1 comdat {
  ...
  call void @"\01??1Container@?$InternalMetadataWithArenaBase@V?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@VInternalMetadataWithArenaLite@internal@protobuf@google@@@internal@protobuf@google@@QEAA@XZ"(%"struct.google::protobuf::internal::InternalMetadataWithArenaBase<std::basic_string<char, std::char_traits<char>, std::allocator<char> >, google::protobuf::internal::InternalMetadataWithArenaLite>::Container"* %4) #8
  ret void
}
...
; <label>:8:                                      ; preds = %6
  ...
  call void @"\01??1?$_String_alloc@U?$_String_base_types@DV?$allocator@D@std@@@std@@@std@@QEAA@XZ"(%"class.std::_String_alloc"* %10) #8 [ "funclet"(token %9) ]
...
; Function Attrs: noinline optnone uwtable
define linkonce_odr %"class.multiproto::Foo.53"* @"\01??$down_cast@PEBVFoo@multiproto@@$$CBVMessageLite@protobuf@google@@@internal@protobuf@google@@YAPEBVFoo@multiproto@@PEBVMessageLite@12@@Z"(%"class.google::protobuf::MessageLite"*) #0 comdat {
  %2 = alloca %"class.google::protobuf::MessageLite"*, align 8
  store %"class.google::protobuf::MessageLite"* %0, %"class.google::protobuf::MessageLite"** %2, align 8
  %3 = load %"class.google::protobuf::MessageLite"*, %"class.google::protobuf::MessageLite"** %2, align 8
...
; Function Attrs: noinline optnone uwtable
define void @"\01?MergeFrom@Foo@multiproto@@QEAAXAEBV12@@Z"(%"class.multiproto::Foo.53"*, %"class.multiproto::Foo.53"* dereferenceable(40)) #0 align 2 personality i8* bitcast (i32 (...)* @__CxxFrameHandler3 to i8*) {
  %3 = alloca %"class.multiproto::Foo.53"*, align 8
  %4 = alloca %"class.multiproto::Foo.53"*, align 8
  %5 = alloca %"class.google::protobuf::internal::LogMessage", align 8
  %6 = alloca i1, align 1
  ...
  store %"class.multiproto::Foo.53"* %1, %"class.multiproto::Foo.53"** %3, align 8
  store %"class.multiproto::Foo.53"* %0, %"class.multiproto::Foo.53"** %4, align 8
  %10 = load %"class.multiproto::Foo.53"*, %"class.multiproto::Foo.53"** %4, align 8
  %11 = load %"class.multiproto::Foo.53"*, %"class.multiproto::Foo.53"** %3, align 8
...
; <label>:14:                                     ; preds = %2
  %15 = call %"class.google::protobuf::internal::LogMessage"* @"\01??0LogMessage@internal@protobuf@google@@QEAA@W4LogLevel@23@PEBDH@Z"(%"class.google::protobuf::internal::LogMessage"* %5, i32 3, i8* getelementptr inbounds ([69 x i8], [69 x i8]* @"\01??_C@_0EF@IFHBNMJI@E?3?2work?2local?2private?9contract?9s@", i32 0, i32 0), i32 282)
  store i1 true, i1* %6, align 1
...
; <label>:22:                                     ; preds = %21, %19
  ...
  %25 = load %"class.multiproto::Foo.53"*, %"class.multiproto::Foo.53"** %3, align 8
  ...
  %27 = load %"class.multiproto::Foo.53"*, %"class.multiproto::Foo.53"** %3, align 8
  %28 = call dereferenceable(32) %"class.std::basic_string"* @"\01?s@Foo@multiproto@@QEBAAEBV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@XZ"(%"class.multiproto::Foo.53"* %27)
...
; <label>:31:                                     ; preds = %22
  ...
  %33 = load %"class.multiproto::Foo.53"*, %"class.multiproto::Foo.53"** %3, align 8
...
; <label>:46:                                     ; preds = %31, %22
  %47 = load %"class.multiproto::Foo.53"*, %"class.multiproto::Foo.53"** %3, align 8
  %48 = call i32 bitcast (i32 (%"class.multiproto::Foo"*)* @"\01?i32@Foo@multiproto@@QEBAHXZ" to i32 (%"class.multiproto::Foo.53"*)*)(%"class.multiproto::Foo.53"* %47)
  %49 = icmp ne i32 %48, 0
  br i1 %49, label %50, label %53

; <label>:50:                                     ; preds = %46
  %51 = load %"class.multiproto::Foo.53"*, %"class.multiproto::Foo.53"** %3, align 8
  %52 = call i32 bitcast (i32 (%"class.multiproto::Foo"*)* @"\01?i32@Foo@multiproto@@QEBAHXZ" to i32 (%"class.multiproto::Foo.53"*)*)(%"class.multiproto::Foo.53"* %51)
  call void bitcast (void (%"class.multiproto::Foo"*, i32)* @"\01?set_i32@Foo@multiproto@@QEAAXH@Z" to void (%"class.multiproto::Foo.53"*, i32)*)(%"class.multiproto::Foo.53"* %10, i32 %52)
  br label %53

; <label>:53:                                     ; preds = %50, %46
  %54 = load %"class.multiproto::Foo.53"*, %"class.multiproto::Foo.53"** %3, align 8
  %55 = call float @"\01?f@Foo@multiproto@@QEBAMXZ"(%"class.multiproto::Foo.53"* %54)
  %56 = fcmp une float %55, 0.000000e+00
  br i1 %56, label %57, label %60

; <label>:57:                                     ; preds = %53
  %58 = load %"class.multiproto::Foo.53"*, %"class.multiproto::Foo.53"** %3, align 8
  %59 = call float @"\01?f@Foo@multiproto@@QEBAMXZ"(%"class.multiproto::Foo.53"* %58)
  call void bitcast (void (%"class.multiproto::Foo"*, float)* @"\01?set_f@Foo@multiproto@@QEAAXM@Z" to void (%"class.multiproto::Foo.53"*, float)*)(%"class.multiproto::Foo.53"* %10, float %59)
  br label %60
...
define linkonce_odr void @"\01?DoClear@InternalMetadataWithArenaLite@internal@protobuf@google@@QEAAXXZ"(%"class.google::protobuf::internal::InternalMetadataWithArena"*) #0 comdat align 2 {
  ...
  %4 = bitcast %"class.google::protobuf::internal::InternalMetadataWithArena"* %3 to %"class.google::protobuf::internal::InternalMetadataWithArenaBase"*
  %5 = call %"class.std::basic_string"* @"\01?mutable_unknown_fields@?$InternalMetadataWithArenaBase@V?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@VInternalMetadataWithArenaLite@internal@protobuf@google@@@internal@protobuf@google@@QEAAPEAV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@XZ"(%"class.google::protobuf::internal::InternalMetadataWithArenaBase"* %4)
  call void @"\01?clear@?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QEAAXXZ"(%"class.std::basic_string"* %5) #8
  ret void
}
...
; Function Attrs: noinline optnone uwtable
define linkonce_odr void @"\01??$Own@VFoo@multiproto@@@Arena@protobuf@google@@QEAAXPEAVFoo@multiproto@@@Z"(%"class.google::protobuf::Arena"*, %"class.multiproto::Foo.53"*) #0 comdat align 2 {
  %3 = alloca %"class.multiproto::Foo.53"*, align 8
  %4 = alloca %"class.google::protobuf::Arena"*, align 8
  %5 = alloca %"class.std::allocator", align 1
  %6 = alloca %"class.std::allocator", align 1
  ...
  %9 = load %"class.multiproto::Foo.53"*, %"class.multiproto::Foo.53"** %3, align 8
  %10 = getelementptr inbounds %"class.std::allocator", %"class.std::allocator"* %5, i32 0, i32 0
  %11 = load i8, i8* %10, align 1
  call void @"\01??$OwnInternal@VFoo@multiproto@@@Arena@protobuf@google@@AEAAXPEAVFoo@multiproto@@U?$integral_constant@_N$0A@@internal@12@@Z"(%"class.google::protobuf::Arena"* %7, %"class.multiproto::Foo.53"* %9, i8 %11)
  ret void
}

; Function Attrs: noinline optnone uwtable
define linkonce_odr void @"\01??$OwnInternal@VFoo@multiproto@@@Arena@protobuf@google@@AEAAXPEAVFoo@multiproto@@U?$integral_constant@_N$0A@@internal@12@@Z"(%"class.google::protobuf::Arena"*, %"class.multiproto::Foo.53"*, i8) #0 comdat align 2 {
  %4 = alloca %"class.std::allocator", align 1
  %5 = alloca %"class.multiproto::Foo.53"*, align 8
  %6 = alloca %"class.google::protobuf::Arena"*, align 8
  %7 = getelementptr inbounds %"class.std::allocator", %"class.std::allocator"* %4, i32 0, i32 0
  store i8 %2, i8* %7, align 1
  store %"class.multiproto::Foo.53"* %1, %"class.multiproto::Foo.53"** %5, align 8
  store %"class.google::protobuf::Arena"* %0, %"class.google::protobuf::Arena"** %6, align 8
  %8 = load %"class.google::protobuf::Arena"*, %"class.google::protobuf::Arena"** %6, align 8
  %9 = load %"class.multiproto::Foo.53"*, %"class.multiproto::Foo.53"** %5, align 8
  %10 = icmp ne %"class.multiproto::Foo.53"* %9, null
  br i1 %10, label %11, label %15

; <label>:11:                                     ; preds = %3
  %12 = getelementptr inbounds %"class.google::protobuf::Arena", %"class.google::protobuf::Arena"* %8, i32 0, i32 0
  %13 = load %"class.multiproto::Foo.53"*, %"class.multiproto::Foo.53"** %5, align 8
  %14 = bitcast %"class.multiproto::Foo.53"* %13 to i8*
  call void @"\01?AddCleanup@ArenaImpl@internal@protobuf@google@@QEAAXPEAXP6AX0@Z@Z"(%"class.google::protobuf::internal::ArenaImpl"* %12, i8* %14, void (i8*)* @"\01??$arena_delete_object@VFoo@multiproto@@@internal@protobuf@google@@YAXPEAX@Z")
  br label %15
...
; Function Attrs: noinline nounwind optnone uwtable
define linkonce_odr void @"\01??$arena_delete_object@VFoo@multiproto@@@internal@protobuf@google@@YAXPEAX@Z"(i8*) #1 comdat {
  %2 = alloca i8*, align 8
  store i8* %0, i8** %2, align 8
  %3 = load i8*, i8** %2, align 8
...
; <label>:6:                                      ; preds = %1
  ...
  %8 = load i8* (%"class.multiproto::Foo.53"*, i32)**, i8* (%"class.multiproto::Foo.53"*, i32)*** %7, align 8
  %9 = getelementptr inbounds i8* (%"class.multiproto::Foo.53"*, i32)*, i8* (%"class.multiproto::Foo.53"*, i32)** %8, i64 0
  %10 = load i8* (%"class.multiproto::Foo.53"*, i32)*, i8* (%"class.multiproto::Foo.53"*, i32)** %9, align 8
  %11 = call i8* %10(%"class.multiproto::Foo.53"* %4, i32 1) #8
  br label %12
...
; Function Attrs: noinline nounwind optnone uwtable
define void @"\01??1Foo@multiproto@@UEAA@XZ"(%"class.multiproto::Foo.53"*) unnamed_addr #1 align 2 personality i8* bitcast (i32 (...)* @__CxxFrameHandler3 to i8*) {
  %2 = alloca %"class.multiproto::Foo.53"*, align 8
  store %"class.multiproto::Foo.53"* %0, %"class.multiproto::Foo.53"** %2, align 8
  %3 = load %"class.multiproto::Foo.53"*, %"class.multiproto::Foo.53"** %2, align 8
  %4 = bitcast %"class.multiproto::Foo.53"* %3 to i32 (...)***
  store i32 (...)** bitcast (i8** @"\01??_7Foo@multiproto@@6B@" to i32 (...)**), i32 (...)*** %4, align 8
  invoke void @"\01?SharedDtor@Foo@multiproto@@AEAAXXZ"(%"class.multiproto::Foo.53"* %3)
          to label %5 unwind label %8

; <label>:5:                                      ; preds = %1
  %6 = getelementptr inbounds %"class.multiproto::Foo.53", %"class.multiproto::Foo.53"* %3, i32 0, i32 1
  call void @"\01??1InternalMetadataWithArenaLite@internal@protobuf@google@@QEAA@XZ"(%"class.google::protobuf::internal::InternalMetadataWithArena"* %6) #8
  %7 = bitcast %"class.multiproto::Foo.53"* %3 to %"class.google::protobuf::MessageLite"*
  call void @"\01??1MessageLite@protobuf@google@@UEAA@XZ"(%"class.google::protobuf::MessageLite"* %7) #8
  ret void

; <label>:8:                                      ; preds = %1
  %9 = cleanuppad within none []
  %10 = getelementptr inbounds %"class.multiproto::Foo.53", %"class.multiproto::Foo.53"* %3, i32 0, i32 1
  call void @"\01??1InternalMetadataWithArenaLite@internal@protobuf@google@@QEAA@XZ"(%"class.google::protobuf::internal::InternalMetadataWithArena"* %10) #8 [ "funclet"(token %9) ]
  cleanupret from %9 unwind label %11

; <label>:11:                                     ; preds = %8
  %12 = cleanuppad within none []
  %13 = bitcast %"class.multiproto::Foo.53"* %3 to %"class.google::protobuf::MessageLite"*
  call void @"\01??1MessageLite@protobuf@google@@UEAA@XZ"(%"class.google::protobuf::MessageLite"* %13) #8 [ "funclet"(token %12) ]
...
; Function Attrs: noinline optnone uwtable
define void @"\01?SharedDtor@Foo@multiproto@@AEAAXXZ"(%"class.multiproto::Foo.53"*) #0 align 2 {
  %2 = alloca %"class.multiproto::Foo.53"*, align 8
  store %"class.multiproto::Foo.53"* %0, %"class.multiproto::Foo.53"** %2, align 8
  %3 = load %"class.multiproto::Foo.53"*, %"class.multiproto::Foo.53"** %2, align 8
  %4 = getelementptr inbounds %"class.multiproto::Foo.53", %"class.multiproto::Foo.53"* %3, i32 0, i32 2
...
; Function Attrs: noinline optnone uwtable
define %"class.multiproto::Foo.53"* @"\01??0Foo@multiproto@@QEAA@AEBV01@@Z"(%"class.multiproto::Foo.53"* returned, %"class.multiproto::Foo.53"* dereferenceable(40)) unnamed_addr #0 align 2 personality i8* bitcast (i32 (...)* @__CxxFrameHandler3 to i8*) {
  %3 = alloca %"class.multiproto::Foo.53"*, align 8
  %4 = alloca %"class.multiproto::Foo.53"*, align 8
  %5 = alloca %"class.multiproto::Foo.53"*, align 8
  %6 = alloca %"struct.google::protobuf::internal::ArenaStringPtr", align 8
  store %"class.multiproto::Foo.53"* %1, %"class.multiproto::Foo.53"** %4, align 8
  store %"class.multiproto::Foo.53"* %0, %"class.multiproto::Foo.53"** %5, align 8
  %7 = load %"class.multiproto::Foo.53"*, %"class.multiproto::Foo.53"** %5, align 8
  store %"class.multiproto::Foo.53"* %7, %"class.multiproto::Foo.53"** %3, align 8
...
; <label>:13:                                     ; preds = %2
  ...
  %18 = load %"class.multiproto::Foo.53"*, %"class.multiproto::Foo.53"** %4, align 8
...
; <label>:24:                                     ; preds = %23
  %25 = load %"class.multiproto::Foo.53"*, %"class.multiproto::Foo.53"** %4, align 8
  %26 = invoke dereferenceable(32) %"class.std::basic_string"* @"\01?s@Foo@multiproto@@QEBAAEBV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@XZ"(%"class.multiproto::Foo.53"* %25)
...
; <label>:30:                                     ; preds = %27
  ...
  %32 = load %"class.multiproto::Foo.53"*, %"class.multiproto::Foo.53"** %4, align 8
...
; <label>:42:                                     ; preds = %41, %27
  %43 = getelementptr inbounds %"class.multiproto::Foo.53", %"class.multiproto::Foo.53"* %7, i32 0, i32 3
  %44 = bitcast i32* %43 to i8*
  %45 = load %"class.multiproto::Foo.53"*, %"class.multiproto::Foo.53"** %4, align 8
  %46 = getelementptr inbounds %"class.multiproto::Foo.53", %"class.multiproto::Foo.53"* %45, i32 0, i32 3
  %47 = bitcast i32* %46 to i8*
  %48 = getelementptr inbounds %"class.multiproto::Foo.53", %"class.multiproto::Foo.53"* %7, i32 0, i32 4
  %49 = bitcast float* %48 to i8*
  %50 = getelementptr inbounds %"class.multiproto::Foo.53", %"class.multiproto::Foo.53"* %7, i32 0, i32 3
  ...
  %56 = load %"class.multiproto::Foo.53"*, %"class.multiproto::Foo.53"** %3, align 8
  ret %"class.multiproto::Foo.53"* %56

; <label>:57:                                     ; preds = %37, %30, %24, %23, %20, %13
  %58 = cleanuppad within none []
  call void @"\01??1InternalMetadataWithArenaLite@internal@protobuf@google@@QEAA@XZ"(%"class.google::protobuf::internal::InternalMetadataWithArena"* %11) #8 [ "funclet"(token %58) ]
  cleanupret from %58 unwind label %59

; <label>:59:                                     ; preds = %57, %2
  %60 = cleanuppad within none []
  %61 = bitcast %"class.multiproto::Foo.53"* %7 to %"class.google::protobuf::MessageLite"*
  call void @"\01??1MessageLite@protobuf@google@@UEAA@XZ"(%"class.google::protobuf::MessageLite"* %61) #8 [ "funclet"(token %60) ]
  cleanupret from %60 unwind to caller
}

; Function Attrs: noinline nounwind optnone uwtable
define void @"\01?SetCachedSize@Foo@multiproto@@AEBAXH@Z"(%"class.multiproto::Foo.53"*, i32) #1 align 2 {
  %3 = alloca i32, align 4
  %4 = alloca %"class.multiproto::Foo.53"*, align 8
  store i32 %1, i32* %3, align 4
  store %"class.multiproto::Foo.53"* %0, %"class.multiproto::Foo.53"** %4, align 8
...
; Function Attrs: noinline optnone uwtable
define dereferenceable(40) %"class.multiproto::Foo.53"* @"\01?default_instance@Foo@multiproto@@SAAEBV12@XZ"() #0 align 2 {
  call void @"\01?InitDefaultsFoo@protobuf_FooLite_2eproto@@YAXXZ"()
  %1 = call %"class.multiproto::Foo.53"* @"\01?internal_default_instance@Foo@multiproto@@SAPEBV12@XZ"()
  ret %"class.multiproto::Foo.53"* %1
}

; Function Attrs: noinline optnone uwtable
define void @"\01?CopyFrom@Foo@multiproto@@QEAAXAEBV12@@Z"(%"class.multiproto::Foo.53"*, %"class.multiproto::Foo.53"* dereferenceable(40)) #0 align 2 {
  %3 = alloca %"class.multiproto::Foo.53"*, align 8
  %4 = alloca %"class.multiproto::Foo.53"*, align 8
  store %"class.multiproto::Foo.53"* %1, %"class.multiproto::Foo.53"** %3, align 8
  store %"class.multiproto::Foo.53"* %0, %"class.multiproto::Foo.53"** %4, align 8
  %5 = load %"class.multiproto::Foo.53"*, %"class.multiproto::Foo.53"** %4, align 8
  %6 = load %"class.multiproto::Foo.53"*, %"class.multiproto::Foo.53"** %3, align 8
...
; <label>:9:                                      ; preds = %2
  call void @"\01?Clear@Foo@multiproto@@UEAAXXZ"(%"class.multiproto::Foo.53"* %5)
  %10 = load %"class.multiproto::Foo.53"*, %"class.multiproto::Foo.53"** %3, align 8
  call void @"\01?MergeFrom@Foo@multiproto@@QEAAXAEBV12@@Z"(%"class.multiproto::Foo.53"* %5, %"class.multiproto::Foo.53"* dereferenceable(40) %10)
  br label %11
...
; Function Attrs: noinline optnone uwtable
define void @"\01?Swap@Foo@multiproto@@QEAAXPEAV12@@Z"(%"class.multiproto::Foo.53"*, %"class.multiproto::Foo.53"*) #0 align 2 {
  %3 = alloca %"class.multiproto::Foo.53"*, align 8
  %4 = alloca %"class.multiproto::Foo.53"*, align 8
  store %"class.multiproto::Foo.53"* %1, %"class.multiproto::Foo.53"** %3, align 8
  store %"class.multiproto::Foo.53"* %0, %"class.multiproto::Foo.53"** %4, align 8
...
; <label>:9:                                      ; preds = %2
  %10 = load %"class.multiproto::Foo.53"*, %"class.multiproto::Foo.53"** %3, align 8
  call void @"\01?InternalSwap@Foo@multiproto@@AEAAXPEAV12@@Z"(%"class.multiproto::Foo.53"* %5, %"class.multiproto::Foo.53"* %10)
  br label %11
...
; Function Attrs: noinline optnone uwtable
define void @"\01?InternalSwap@Foo@multiproto@@AEAAXPEAV12@@Z"(%"class.multiproto::Foo.53"*, %"class.multiproto::Foo.53"*) #0 align 2 {
  %3 = alloca %"class.multiproto::Foo.53"*, align 8
  %4 = alloca %"class.multiproto::Foo.53"*, align 8
  store %"class.multiproto::Foo.53"* %1, %"class.multiproto::Foo.53"** %3, align 8
  store %"class.multiproto::Foo.53"* %0, %"class.multiproto::Foo.53"** %4, align 8
  ...
  %7 = load %"class.multiproto::Foo.53"*, %"class.multiproto::Foo.53"** %3, align 8
  ...
  %12 = load %"class.multiproto::Foo.53"*, %"class.multiproto::Foo.53"** %3, align 8
  ...
  %17 = load %"class.multiproto::Foo.53"*, %"class.multiproto::Foo.53"** %3, align 8
  ...
  %19 = load %"class.multiproto::Foo.53"*, %"class.multiproto::Foo.53"** %3, align 8
...
define linkonce_odr void @"\01?DoSwap@InternalMetadataWithArenaLite@internal@protobuf@google@@QEAAXPEAV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@@Z"(%"class.google::protobuf::internal::InternalMetadataWithArena"*, %"class.std::basic_string"*) #0 comdat align 2 {
  ...
  %7 = call %"class.std::basic_string"* @"\01?mutable_unknown_fields@?$InternalMetadataWithArenaBase@V?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@VInternalMetadataWithArenaLite@internal@protobuf@google@@@internal@protobuf@google@@QEAAPEAV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@XZ"(%"class.google::protobuf::internal::InternalMetadataWithArenaBase"* %6)
  %8 = load %"class.std::basic_string"*, %"class.std::basic_string"** %3, align 8
  call void @"\01?swap@?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QEAAXAEAV12@@Z"(%"class.std::basic_string"* %7, %"class.std::basic_string"* dereferenceable(32) %8) #8
  ret void
}
...
define internal void @_GLOBAL__sub_I_module0() #11 {
  call void @"\01??__Estatic_descriptor_initializer@protobuf_Bar_2eproto@@YAXXZ"()
  ret void
}

; Function Attrs: noinline uwtable
define internal void @"\01??__Estatic_descriptor_initializer@protobuf_Bar_2eproto@@YAXXZ"() #11 {
...
define void @"\01?protobuf_AssignDescriptors@protobuf_Bar_2eproto@@YAXXZ"() #0 personality i8* bitcast (i32 (...)* @__CxxFrameHandler3 to i8*) {
  ...
  %3 = load %"class.google::protobuf::MessageFactory"*, %"class.google::protobuf::MessageFactory"** %1, align 8
...
declare void @"\01?AssignDescriptors@internal@protobuf@google@@YAXAEBV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@PEBUMigrationSchema@123@PEBQEBVMessage@23@PEBIPEAVMessageFactory@23@PEAUMetadata@23@PEAPEBVEnumDescriptor@23@PEAPEBVServiceDescriptor@23@@Z"(%"class.std::basic_string"* dereferenceable(32), %"struct.google::protobuf::internal::MigrationSchema"*, %"class.google::protobuf::Message"**, i32*, %"class.google::protobuf::MessageFactory"*, %"struct.google::protobuf::Metadata"*, %"class.google::protobuf::EnumDescriptor"**, %"class.google::protobuf::ServiceDescriptor"**) #2
...
attributes #11 = { noinline uwtable "correctly-rounded-divide-sqrt-fp-math"="false" "disable-tail-calls"="false" "less-precise-fpmad"="false" "no-frame-pointer-elim"="false" "no-infs-fp-math"="false" "no-jump-tables"="false" "no-nans-fp-math"="false" "no-signed-zeros-fp-math"="false" "no-trapping-math"="false" "stack-protector-buffer-size"="8" "target-cpu"="x86-64" "target-features"="+fxsr,+mmx,+sse,+sse2,+x87" "unsafe-fp-math"="false" "use-soft-float"="false" }
