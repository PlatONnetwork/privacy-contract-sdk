...
public class ProxySamples extends ProxyClient {
    private String irHash = "1e058be787b4010a80037d72b46ae5fe";
    ...
    /**
     * Get com.abc.sample.SamplesLite.Foo
     */
    public com.abc.sample.SamplesLite.Foo getFoo(byte[] val) {
        com.abc.sample.SamplesLite.Foo __Foo = null;
        try {
            __Foo = com.abc.sample.SamplesLite.Foo.parseFrom(ethECIES.Decrypt(priHexString, val));
    ...
    public com.abc.sample.SamplesLite.Foo getFoo(String cipher) {
        return getFoo(Numeric.hexStringToByteArray(cipher));
    }

    /**
     * Get com.abc.sample.SamplesLite.Bar
     */
    public com.abc.sample.SamplesLite.Bar getBar(byte[] val) {
        com.abc.sample.SamplesLite.Bar __Bar = null;
        try {
            __Bar = com.abc.sample.SamplesLite.Bar.parseFrom(ethECIES.Decrypt(priHexString, val));
        } catch (InvalidProtocolBufferException e) {
            e.printStackTrace();
        }
        return __Bar;
    ...
    public com.abc.sample.SamplesLite.Bar getBar(String cipher) {
        return getBar(Numeric.hexStringToByteArray(cipher));
    }

    /**
     * Get com.abc.sample.SamplesLite.Points
     */
    public com.abc.sample.SamplesLite.Points getPoints(byte[] val) {
        com.abc.sample.SamplesLite.Points __Points = null;
        try {
            __Points = com.abc.sample.SamplesLite.Points.parseFrom(ethECIES.Decrypt(priHexString, val));
        } catch (InvalidProtocolBufferException e) {
            e.printStackTrace();
        }
        return __Points;
    ...
    public com.abc.sample.SamplesLite.Points getPoints(String cipher) {
