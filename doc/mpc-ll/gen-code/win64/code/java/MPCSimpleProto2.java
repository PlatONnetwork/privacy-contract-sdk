 ...
 * IR HASH: 4aec415545e9d5ea707b8ffb48a2b6be
 * <p>
 * IR FUNC HASH(MD5)                 IR FUNC NAME  IR FUNC PROT
 * 913b11f78f06e4a1d58688a4190afade  TestBarAdd01  TestBarAdd01(Bar,Bar)
 */
 
interface mpc_ii_4aec415545e9d5ea707b8ffb48a2b6be extends IIInterface {
}

public class MPCSimpleProto2 implements mpc_ii_4aec415545e9d5ea707b8ffb48a2b6be {
    ...
    abstract class MpcCallbackBase_4aec415545e9d5ea707b8ffb48a2b6be implements MpcCallbackInterface {
    ...
    abstract class mpc_i_4aec415545e9d5ea707b8ffb48a2b6be extends MpcCallbackBase_4aec415545e9d5ea707b8ffb48a2b6be {
    }
    
    abstract class mpc_f_913b11f78f06e4a1d58688a4190afade_01 extends mpc_i_4aec415545e9d5ea707b8ffb48a2b6be {
        public byte[] input_x_default(){
            return com.abc.simpleproto2.SimpleProtoLite2.Bar.newBuilder().build().toByteArray();
        }
    }

    abstract class mpc_f_913b11f78f06e4a1d58688a4190afade_02 extends mpc_i_4aec415545e9d5ea707b8ffb48a2b6be {
        public byte[] input_x_default(){
            return com.abc.simpleproto2.SimpleProtoLite2.Bar.newBuilder().build().toByteArray();
        }
    }
