...
public class ProxySimpleAndProto extends ProxyClient {
    private String irHash = "991751740327c5f0f0a74ba399ba781f";
    ...
    /**
     * Get com.abc.simpleandproto.SimpleAndProtoLite.Foo
     */
    public com.abc.simpleandproto.SimpleAndProtoLite.Foo getFoo(byte[] val) {
        com.abc.simpleandproto.SimpleAndProtoLite.Foo __Foo = null;
        try {
            __Foo = com.abc.simpleandproto.SimpleAndProtoLite.Foo.parseFrom(ethECIES.Decrypt(priHexString, val));
    ...
    public com.abc.simpleandproto.SimpleAndProtoLite.Foo getFoo(String cipher) {
