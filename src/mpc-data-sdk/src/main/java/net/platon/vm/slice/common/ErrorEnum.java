...
public enum ErrorEnum implements java.io.Serializable
{
    ...
    RedisServiceError(1000),
    
    ConnectionError(1001),
    
    UserPermissionError(1002),
    
    RetrieveNodeCallbackError(1003),
    
    RetrieveNodeCommInfoError(1004),
    ...
    valueOf(int __v)
    {
        ...
        case 1003:
            return RetrieveNodeCallbackError;
        case 1004:
            return RetrieveNodeCommInfoError;
        case 1005:
            return TaskNotFound;
        case 1006:
        ...
        case 1009:
            return CircuitMissed;
        case 1010:
            return ForwardDataError;
        case 1011:
    ...
    __write(IceInternal.BasicStream __os, ErrorEnum __v)
    {
        if(__v == null)
        {
            __os.writeEnum(net.platon.vm.slice.common.ErrorEnum.NoError.value(), 9999);
        }
        else
        {
            __os.writeEnum(__v.value(), 9999);
        }
    }
