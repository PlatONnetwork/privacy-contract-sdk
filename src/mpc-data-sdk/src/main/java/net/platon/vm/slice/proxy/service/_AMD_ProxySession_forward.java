...
final class _AMD_ProxySession_forward extends IceInternal.IncomingAsync implements AMD_ProxySession_forward
{
    public _AMD_ProxySession_forward(IceInternal.Incoming in)
    {
        super(in);
    }
