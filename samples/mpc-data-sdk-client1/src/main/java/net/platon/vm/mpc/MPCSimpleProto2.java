 ...
 * IR HASH: 31de6414162f6b4d65446f2b5c57d92c
 * <p>
 * IR FUNC HASH(MD5)                 IR FUNC NAME  IR FUNC PROT
 * 913b11f78f06e4a1d58688a4190afade  TestBarAdd01  TestBarAdd01(Bar,Bar)
 */
 
interface mpc_ii_31de6414162f6b4d65446f2b5c57d92c extends IIInterface {
}

public class MPCSimpleProto2 implements mpc_ii_31de6414162f6b4d65446f2b5c57d92c {
    ...
    abstract class MpcCallbackBase_31de6414162f6b4d65446f2b5c57d92c implements MpcCallbackInterface {
    ...
    abstract class mpc_i_31de6414162f6b4d65446f2b5c57d92c extends MpcCallbackBase_31de6414162f6b4d65446f2b5c57d92c {
    }
    
    abstract class mpc_f_913b11f78f06e4a1d58688a4190afade_01 extends mpc_i_31de6414162f6b4d65446f2b5c57d92c {
        public byte[] input_x_default(){
            return com.abc.simpleproto2.SimpleProto2.Bar.newBuilder().build().toByteArray();
        }
    }

    abstract class mpc_f_913b11f78f06e4a1d58688a4190afade_02 extends mpc_i_31de6414162f6b4d65446f2b5c57d92c {
        public byte[] input_x_default(){
            return com.abc.simpleproto2.SimpleProto2.Bar.newBuilder().build().toByteArray();
        }
    }
    ...
    final class MPCSimpleProto2_TestBarAdd01_Bar_Bar_01 extends mpc_f_913b11f78f06e4a1d58688a4190afade_01 {
        public byte[] inputImpl(final InputRequestPara para) {
            com.abc.simpleproto2.SimpleProto2.Bar.Builder builder = com.abc.simpleproto2.SimpleProto2.Bar.newBuilder();
            // TODO: assemble data
